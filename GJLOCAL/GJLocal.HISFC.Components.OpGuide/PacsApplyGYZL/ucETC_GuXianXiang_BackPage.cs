...
{
    public partial class ucETC_GuXianXiang_BackPage : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.SOC.HISFC.BizProcess.OrderInterface.OutPatientOrder.IOutPatientOrderPrint
    {
        public ucETC_GuXianXiang_BackPage()
        {
            InitializeComponent();
        }
