...
{
    public partial class ucEndoscopic_DianZiJieChangJing : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.SOC.HISFC.BizProcess.OrderInterface.OutPatientOrder.IOutPatientOrderPrint
    {
        public ucEndoscopic_DianZiJieChangJing()
        {
            InitializeComponent();
        }
        ...
        public void SetPrintValue(IList<FS.HISFC.Models.Order.OutPatient.Order> orderList, bool isPreview)
        {
            ...
            //this.lblDept = orderList[0].ReciptDept.Name;
