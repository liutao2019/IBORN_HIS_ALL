...
{
    public partial class ucCT_BeiGuanChang : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.SOC.HISFC.BizProcess.OrderInterface.OutPatientOrder.IOutPatientOrderPrint
    {
        public ucCT_BeiGuanChang()
        {
            InitializeComponent();
        }
        ...
        public void SetPatientInfo(FS.HISFC.Models.Registration.Register register)
        {
            ...
            FS.HISFC.BizLogic.Admin.FunSetting bizDate = new FS.HISFC.BizLogic.Admin.FunSetting();
            //this.lblAge.Text = this.diagManager.GetAge(register.Birthday, false);
            //this.lblSex.Text = register.Sex.Name;
            //this.lblPhone = register.Phone;
            //lblDate.Text = diagManager.GetDateTimeFromSysDateTime().ToString("yyyy.MM.dd");
            this.lblDate.Text = bizDate.GetDateTimeFromSysDateTime().ToString("yyyy' 年 'M' 月 'd' 日 '");
        }
