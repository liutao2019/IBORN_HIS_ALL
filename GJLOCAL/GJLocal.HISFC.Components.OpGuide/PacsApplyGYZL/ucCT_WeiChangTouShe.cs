...
{
    public partial class ucCT_WeiChangTouShe : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.SOC.HISFC.BizProcess.OrderInterface.OutPatientOrder.IOutPatientOrderPrint
    {
        public ucCT_WeiChangTouShe()
        {
            InitializeComponent();
        }
        ...
        public void SetPatientInfo(FS.HISFC.Models.Registration.Register register)
        {
            ...
            this.lblDate.Text = diagManager.GetDateTimeFromSysDateTime().ToString("yyyy' 年 'M' 月 'd' 日 '");
        }
        ...
        public void SetPrintValue(IList<FS.HISFC.Models.Order.OutPatient.Order> orderList, bool isPreview)
        {
            ...
            this.lblDept.Text = orderList[0].ReciptDept.Name;// +"科";
        ...
        private void ucCT_WeiChangTouShe_Load(object sender, EventArgs e)
        {
