...
{
    public partial class ucEndoscopic_DianZiZhiQiGuanJing : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.SOC.HISFC.BizProcess.OrderInterface.OutPatientOrder.IOutPatientOrderPrint
    {
        public ucEndoscopic_DianZiZhiQiGuanJing()
        {
            InitializeComponent();
        }
