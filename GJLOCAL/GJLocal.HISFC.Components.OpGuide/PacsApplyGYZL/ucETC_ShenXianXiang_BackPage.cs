...
{
    public partial class ucETC_ShenXianXiang_BackPage : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.SOC.HISFC.BizProcess.OrderInterface.OutPatientOrder.IOutPatientOrderPrint
    {
        public ucETC_ShenXianXiang_BackPage()
        {
            InitializeComponent();
        }
