...
namespace GJLocal.HISFC.Components.OpGuide.DrugStore
{
    ...
    public class WorkLoadInterfaceImplement : FS.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.IOutpatientWorkLoad
    {
        ...
        public string Set(FS.FrameWork.Models.NeuObject dept, FS.HISFC.Models.Pharmacy.DrugRecipe drugRecipe, string type, FS.HISFC.Models.Pharmacy.DrugTerminal drugTerminal)
        {
            ...
            {
                //直接发药，计入发药工作量
                GJLocal.HISFC.Components.OpGuide.DrugStore.frmWorkLoad frmWorkLoad = new frmWorkLoad("1", drugRecipe.StockDept.ID, dept.ID, drugRecipe.RecipeQty, drugRecipe.RecipeNO, drugRecipe.PatientName);
            ...
            {
                //配药发药，计入配药工作量
                GJLocal.HISFC.Components.OpGuide.DrugStore.frmWorkLoad frmWorkLoad = new frmWorkLoad("0", drugRecipe.StockDept.ID, dept.ID, drugRecipe.RecipeQty, drugRecipe.RecipeNO, drugRecipe.PatientName);
