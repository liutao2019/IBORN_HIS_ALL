    ...
    public partial class ucHerbalDrugList : UserControl
    {
        ...
        public void ShowData(ArrayList alData, string diagnose, DrugRecipe drugRecipe, DrugTerminal drugTerminal, string hospitalName, DateTime printTime, int pageNO, int maxPageNO,ref decimal totCost,bool isPCC)
        {
            ...
            for (int index = 0; index < alData.Count; index++)
            {
                ...
                this.neuSpread1_Sheet1.Cells[index, 0].Text = FS.SOC.HISFC.BizProcess.Cache.Pharmacy.GetItem(applyInfo.Item.ID).NameCollection.UserCode;
        ...
        public int Print(ArrayList alData, string diagnose, DrugRecipe drugRecipe, DrugTerminal drugTerminal, string hospitalName, DateTime printTime, int isAuto)
        {
            ...
            this.nlbDeptName.Text = "药房名称：" + FS.SOC.HISFC.BizProcess.Cache.Common.GetDeptName(infoTmp.StockDept.ID);
            ...
            this.nlbDocName.Text = FS.SOC.HISFC.BizProcess.Cache.Common.GetEmployeeName(drugRecipe.Doct.ID);
            this.nlbDoctDept.Text = FS.SOC.HISFC.BizProcess.Cache.Common.GetDeptName(drugRecipe.DoctDept.ID);
            ...
            bool isPCC = (FS.SOC.HISFC.BizProcess.Cache.Pharmacy.GetItem(infoTmp.Item.ID).Type.ID == "C") ? true : false;
            if (isPCC)
            {
