...
namespace GJLocal.HISFC.Components.OpGuide.RecipePrint.Controls
{
    public partial class ucTitleBase : UserControl, RecipePrint.Interface.ITitle
    {
        ...
        public int SetTitleInfo(Neusoft.HISFC.Models.Registration.Register regObj, string recipeNo, string speRecipeFlag)
        {
            ...
            npbRecipeNo.Image = Neusoft.SOC.Public.Function.CreateBarCode(recipeNo, this.npbRecipeNo.Width, this.npbRecipeNo.Height);

            npbBarCode.Image = Neusoft.SOC.Public.Function.CreateBarCode(regObj.PID.CardNO, this.npbBarCode.Width, this.npbBarCode.Height);
