...
namespace GJLocal.HISFC.Components.OpGuide.RecipePrint2
{
    /// <summary>
    /// 普通处方(含急诊处方、儿科处方、精二处方）
    /// </summary>
    public partial class ucRecipePrint2 : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.HISFC.BizProcess.Interface.IRecipePrint
    {
        public ucRecipePrint2()
        {
            InitializeComponent();
        }
        ...
        public int SetPatientInfo(Neusoft.HISFC.Models.Registration.Register register)
        {
            ...
            Neusoft.HISFC.Models.RADT.PatientInfo patientInfo = radtManager.QueryComPatientInfo(register.PID.CardNO);
            Neusoft.HISFC.BizProcess.Integrate.Manager managerIntegrate = new Neusoft.HISFC.BizProcess.Integrate.Manager();
            ArrayList al1 = managerIntegrate.GetConstantList(Neusoft.HISFC.Models.Base.EnumConstant.COUNTRY);
            foreach (Neusoft.HISFC.Models.Base.Const con in al1)
            {
