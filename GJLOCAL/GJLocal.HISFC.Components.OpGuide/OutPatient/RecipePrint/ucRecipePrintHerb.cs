...
namespace GJLocal.HISFC.Components.OpGuide.RecipePrint
{
    ...
    /// 草药处方
    /// </summary>
    public partial class ucRecipePrintHerb : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.HISFC.BizProcess.Interface.IRecipePrint
    {
        ...
        private string GetName(Neusoft.HISFC.Models.Order.OutPatient.Order order)
        {
            string itemName = "";
        ...
        private void AddUsageShow(Neusoft.HISFC.Models.Order.OutPatient.Order order, int row)
        {
            //每次量+用法+频次+备注
            string show = "";
        ...
        private void MakaLabel(ArrayList alOrder)
        {
            ...
            for (int index = 0; index < rowCount; index++)
            {
                ...
                {
                    Neusoft.HISFC.Models.Order.OutPatient.Order order = alOrder[index * 3 + 0] as Neusoft.HISFC.Models.Order.OutPatient.Order;
                ...
                {
                    Neusoft.HISFC.Models.Order.OutPatient.Order order = alOrder[index * 3 + 1] as Neusoft.HISFC.Models.Order.OutPatient.Order;
                    string memo = string.IsNullOrEmpty(order.Memo) ? "" : "(" + order.Memo + ")";
                ...
                {
                    Neusoft.HISFC.Models.Order.OutPatient.Order order = alOrder[index * 3 + 2] as Neusoft.HISFC.Models.Order.OutPatient.Order;
                    string memo = string.IsNullOrEmpty(order.Memo) ? "" : "(" + order.Memo + ")";
            ...
            this.lblPhaMoney.Text = Neusoft.FrameWork.Public.String.ToSimpleString(cost, 2) + "元";
