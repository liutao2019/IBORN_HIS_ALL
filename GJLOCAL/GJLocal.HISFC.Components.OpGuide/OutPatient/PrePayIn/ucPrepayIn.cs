    ...
    public partial class ucPrepayIn : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        ...
        protected virtual int Init()
        {
            ...
            try
            {
                ...
                this.cmbPactUnit.AddItems(FS.SOC.HISFC.BizProcess.Cache.Fee.GetAllPactUnit());
                ...
                cmbDept.Tag = FS.SOC.HISFC.BizProcess.Cache.Common.GetEmployeeInfo(this.bedMgr.Operator.ID).Dept.ID;
            }
            finally
            {
        ...
        private void SetPrepatient(FS.HISFC.Models.RADT.PatientInfo pInfo, bool isNew)
        {
            ...
            this.dtBirthday.Value = pInfo.Birthday;//出生日期
            ...
            this.cmbHomePlace.Tag = pInfo.DIST;//出生地
            ...
            this.txtLinkMan.Text = pInfo.Kin.ID;//联系人
            ...
            //指征
            this.neuTextBoxIndications.Text = pInfo.Memo;
        ...
        private void GetPrePatient()
        {
            ...
            if (this.cmbHomePlace.Tag != null)
                this._myPatientInfo.DIST = this.cmbHomePlace.Tag.ToString();//出生地
            ...
            this._myPatientInfo.Kin.ID = this.txtLinkMan.Text;//联系人
            ...
            _myPatientInfo.Memo = this.neuTextBoxIndications.Text;
        ...
        private void QueryData(string PrepayinState, string begin, string end)
        {
            ...
            foreach (FS.HISFC.Models.RADT.PatientInfo obj in arrPrein)
            {
                ...
                {
                    PactInfo pactInfo = FS.SOC.HISFC.BizProcess.Cache.Fee.GetPactUnitInfo(obj.Pact.ID);
                    if (null != pactInfo) obj.Pact.Name = pactInfo.Name;
                }
                string strOperID = obj.User03.Substring(0, 6);
                string strOperName = FS.SOC.HISFC.BizProcess.Cache.Common.GetEmployeeName(strOperID);
        ...
        public int InitInterface()
        {
            ...
            _iPrintInHosNotice = new ucOutPatientNotice();
            return 1;
        }
