...
namespace GJLocal.HISFC.Components.OpGuide
{
    public partial class frmPreviewControl : Form
    {
        ...
        public frmPreviewControl(Dictionary<Int32, List<Control>> previewDictionary)
        {
            ...
            foreach (Int32 keysType in previewDictionary.Keys)
            {
                ...
                for (int i = 0; i < previewDictionary[keysType].Count; i++)
                {
                    ...
                    neuObject.Name = OutPatient.Function.GetMsg(FS.FrameWork.Public.EnumHelper.Current.GetEnumName((EnumOutPatientBill)keysType)) + iCount;
        ...
        private void frmPreviewControl_Load(object sender, EventArgs e)
        {
            ...
            this.Text = OutPatient.Function.GetMsg(this.Text);

            this.tbAllPage.Text = OutPatient.Function.GetMsg(this.tbAllPage.Text);
            this.tbCurrenPage.Text = OutPatient.Function.GetMsg(this.tbCurrenPage.Text);
            this.tbFrontPage.Text = OutPatient.Function.GetMsg(this.tbFrontPage.Text);
            this.tbNextPage.Text = OutPatient.Function.GetMsg(this.tbNextPage.Text);
            this.tbExit.Text = OutPatient.Function.GetMsg(this.tbExit.Text);

            this.TranslateUI(this.Controls);

            //Relocation
            this.neuLabel1.Location = new System.Drawing.Point(480, 20);
            this.clbPreview.Location = new System.Drawing.Point(595, 2);
        ...
        private void InitControl()
        {
            ...
            foreach (FS.FrameWork.Models.NeuObject neuObject in previewList)
            {
                ...
                {
                    neuObject.Name = OutPatient.Function.GetMsg(neuObject.Name);
        ...
        private void ShowPrintDialog(Control uc)
        {
            ...
            this.neuLabel1.Text = (currenPage + 1) + "/" + allPage + "Pages";
        ...
        private void TranslateUI(System.Windows.Forms.Control.ControlCollection controls)
        {
            foreach (Control c in controls)
            {
                    ...
                    )
                {
                    ...
                    c.Text = OutPatient.Function.GetMsg(c.Text) + endChar;
                }

                if (c.Controls.Count > 0)
                {
                    this.TranslateUI(c.Controls);
                }
            }
        }
    }
