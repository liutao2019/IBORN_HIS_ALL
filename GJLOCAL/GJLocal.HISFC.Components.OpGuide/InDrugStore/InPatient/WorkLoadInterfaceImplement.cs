...
namespace GJLocal.HISFC.Components.OpGuide.InDrugStore.InPatient
{
    ...
    public class WorkLoadInterfaceImplement : FS.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.IInpatientWorkLoad
    {
        ...
        {
            GJLocal.HISFC.Components.OpGuide.InDrugStore.InPatient.frmWorkLoad frmWorkLoad = new frmWorkLoad(dept.ID, dept.ID, drugBillClass.Memo, drugBillClass, alApplyOutData.Count);
