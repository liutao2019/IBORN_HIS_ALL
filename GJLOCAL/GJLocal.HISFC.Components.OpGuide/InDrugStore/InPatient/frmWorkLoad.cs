...
using FS.SOC.HISFC.BizProcess.Cache;
...
namespace GJLocal.HISFC.Components.OpGuide.InDrugStore.InPatient
{
    public partial class frmWorkLoad : Form
    {
        public frmWorkLoad(string deptNO, string operDeptNO, string billNO, FS.FrameWork.Models.NeuObject drugBillClass,decimal qty)
        {
            ...
            this.nlbDeptName.Text = "科室：" + FS.SOC.HISFC.BizProcess.Cache.Common.GetDeptName(deptNO);
        ...
        {
            Common.WorkLoadManager workLoadManager = new GJLocal.HISFC.Components.OpGuide.InDrugStore.Common.WorkLoadManager();
