...
{
    public partial class ucDentist1 : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucDentist1()
        {
            InitializeComponent();
        ...
        public void SetValue(System.Collections.Hashtable hsTemp)
        {
            ...
            foreach (System.Windows.Forms.Control c in this.Controls)
            {
                if (hsTemp.Contains("D1" + c.Name))
                {
                    ...
                    {
                        tb = (System.Windows.Forms.TextBox)c;
                        obj = hsTemp["D1" + c.Name] as FS.FrameWork.Models.NeuObject;
                        tb.Text = obj.Memo;
                    }
                }
            }
