...
{
    public partial class ucGeneral1 : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucGeneral1()
        {
            InitializeComponent();
        ...
        public void SetValue(System.Collections.Hashtable hsTemp)
        {
            ...
            foreach (System.Windows.Forms.Control c in this.Controls)
            {
                if (hsTemp.Contains("G1" + c.Name))
                {
                    ...
                    {
                        tb = (System.Windows.Forms.TextBox)c;
                        obj = hsTemp["G1" + c.Name] as FS.FrameWork.Models.NeuObject;
                        tb.Text = obj.Memo;
                    }
                }
            }
