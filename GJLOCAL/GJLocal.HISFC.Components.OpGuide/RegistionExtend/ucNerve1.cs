...
{
    public partial class ucNerve1 : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucNerve1()
        {
            InitializeComponent();
        ...
        public void SetValue(System.Collections.Hashtable hsTemp)
        {
            ...
            foreach (System.Windows.Forms.Control c in this.Controls)
            {
                if (hsTemp.Contains("N1" + c.Name))
                {
                    ...
                    {
                        tb = (System.Windows.Forms.TextBox)c;
                        obj = hsTemp["N1" + c.Name] as FS.FrameWork.Models.NeuObject;
                        tb.Text = obj.Memo;
                    }
                }
            }
