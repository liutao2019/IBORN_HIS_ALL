...
{
    public partial class ucNurseRecords : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucNurseRecords()
        {
            InitializeComponent();
        }
        ...
        public void SetValue(System.Collections.Hashtable hsTemp)
        {
            ...
            foreach (System.Windows.Forms.Control c in this.Controls)
            {
                if (hsTemp.Contains("NR" + c.Name))
                {
                    ...
                    {
                        tb = (System.Windows.Forms.TextBox)c;
                        obj = hsTemp["NR" + c.Name] as FS.FrameWork.Models.NeuObject;
                        tb.Text = obj.Memo;
                    }
                }
            }
