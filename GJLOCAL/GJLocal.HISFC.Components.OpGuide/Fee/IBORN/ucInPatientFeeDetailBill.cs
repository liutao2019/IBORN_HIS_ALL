...
namespace GJLocal.HISFC.Components.OpGuide.Fee.IBORN
{
    ...
    public partial class ucInPatientFeeDetailBill : UserControl, FS.HISFC.BizProcess.Interface.RADT.IBillPrint
    {
        ...
        public int ShowBill(ArrayList alData, FS.HISFC.Models.RADT.PatientInfo patient)
        {
            ...
            decimal CKtotCost = 0m; //产康项目合计
            decimal QTtotCost = 0m;//其他项目合计
            foreach (string recipeNO in drugDictionary.Keys)
            {
                ...
                foreach (FS.HISFC.Models.Fee.Inpatient.FeeInfo obj in feeList)
                {
                    ...
                    {
                        CKtotCost += obj.FT.TotCost;//产康项目合计
                    }
                    else 
                    {
                        QTtotCost += obj.FT.TotCost;//其他项目合计
                    }
                }
                allTotCost += totCost;
            ...
            this.neuSpread1_Sheet1.Cells[iRow, 0].Text = "总合计：" + allTotCost.ToString("F2");
            this.neuSpread1_Sheet1.Cells[iRow, 0].Font = new System.Drawing.Font("宋体", 11.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            this.neuSpread1_Sheet1.Cells[iRow, 0].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            ...
            if (CKtotCost != 0m && patient.PVisit.PatientLocation.NurseCell.Name.Contains("产康"))
            {
                //产康账号余额
                ...
                decimal last = Convert.ToDecimal(CKYE) - CKtotCost;//产康余额抵扣产康项目总计
                decimal sjtotCost = 0m;
                if (last >= 0)//产康余额大于产康项目总计
                {
                    msg = "抵扣后产康基金余 " + Math.Abs(last).ToString("F2") + " 元";
                    sjtotCost = allTotCost - CKtotCost;//全抵扣，实际应收 = 总金额 - 产康抵扣
                }
                else 
                {
                    msg = "抵扣后需补收：" + Math.Abs(last).ToString("F2") + " 元";
                    sjtotCost = allTotCost - Convert.ToDecimal(CKYE);//抵扣部分，实际应收 = 总金额 - 产康余额;
                }
                ...
                this.neuSpread1_Sheet1.Rows.Add(iRow, 1);
                this.neuSpread1_Sheet1.Cells[iRow, 0].ColumnSpan = this.neuSpread1_Sheet1.ColumnCount;
                this.neuSpread1_Sheet1.Cells[iRow, 0].Text = "产康基金：" + CKYE + " 元，定制包项目总金额：" + CKtotCost.ToString("F2") +
                    " 元," + msg;
                this.neuSpread1_Sheet1.Cells[iRow, 0].Font = new System.Drawing.Font("宋体", 11.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
                this.neuSpread1_Sheet1.Cells[iRow, 0].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
                this.neuSpread1_Sheet1.Cells[iRow, 0].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
                ...
                this.neuSpread1_Sheet1.Rows.Add(iRow, 1);
                this.neuSpread1_Sheet1.Cells[iRow, 0].ColumnSpan = this.neuSpread1_Sheet1.ColumnCount;
                this.neuSpread1_Sheet1.Cells[iRow, 0].Text = "其他项目合计：" + QTtotCost.ToString("F2") + "元";
                this.neuSpread1_Sheet1.Cells[iRow, 0].Font = new System.Drawing.Font("宋体", 11.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
                this.neuSpread1_Sheet1.Cells[iRow, 0].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
                this.neuSpread1_Sheet1.Cells[iRow, 0].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
                this.neuSpread1_Sheet1.Cells[iRow, 0].Border = topBorder;
                ...
                this.neuSpread1_Sheet1.Rows.Add(iRow, 1);
                this.neuSpread1_Sheet1.Cells[iRow, 0].ColumnSpan = this.neuSpread1_Sheet1.ColumnCount;
                this.neuSpread1_Sheet1.Cells[iRow, 0].Text = "应收：" + sjtotCost.ToString("F2") + "元";
                this.neuSpread1_Sheet1.Cells[iRow, 0].Font = new System.Drawing.Font("宋体", 11.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
                this.neuSpread1_Sheet1.Cells[iRow, 0].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
                this.neuSpread1_Sheet1.Cells[iRow, 0].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
                this.neuSpread1_Sheet1.Cells[iRow, 0].Border = topBorder;
        ...
        public void Clear()
        {
            ...
            this.lblSex.Text = "性别：";
            this.lblTitleName.Text = "住院费用清单(明细）";
        ...
        public int PrintPreview()
        {
            ...
            else
            {
                ...
                {
                    this.SetPaperSize(paperSize);
                    string printerName = FS.HISFC.Components.Common.Classes.Function.ChoosePrinter();//选择打印机  {3dfa0289-001d-4e1a-954e-f905cbd7c781}
