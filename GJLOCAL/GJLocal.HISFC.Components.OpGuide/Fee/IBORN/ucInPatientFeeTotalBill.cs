...
namespace GJLocal.HISFC.Components.OpGuide.Fee.IBORN
{
    ...
    /// [创建时间: 2017-10]<br></br>
    /// </summary>
    public partial class ucInPatientFeeTotalBill : UserControl, FS.HISFC.BizProcess.Interface.RADT.IBillPrint
    {
        /// <summary>
        /// 清单明细
        /// </summary>
        public ucInPatientFeeTotalBill()
        {
            InitializeComponent();
        ...
        public int ShowBill(ArrayList alData, FS.HISFC.Models.RADT.PatientInfo patient)
        {
            ...
            foreach (string recipeNO in drugDictionary.Keys)
            {
                ...
                this.neuSpread1_Sheet1.Cells[currInfoLan, 2].Text = "合计：" + totCost.ToString("F2") + "  折后价:" + donateCost.ToString("F2") + "  减免:" + dereateCost.ToString("F2");
            ...
            this.neuSpread1_Sheet1.Cells[iRow, 0].Text = "总合计：" + allTotCost.ToString("F2") + "  折后价:" + alldonateCost.ToString("F2") + "  减免:" + alldereateCost.ToString("F2");
            this.neuSpread1_Sheet1.Cells[iRow, 0].Font = new System.Drawing.Font("宋体", 11.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            this.neuSpread1_Sheet1.Cells[iRow, 0].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
