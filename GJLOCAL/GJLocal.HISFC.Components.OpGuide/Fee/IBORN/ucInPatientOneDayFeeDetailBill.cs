...
{
    /// <summary>
    /// [功能描述: 一日清单本地实例化]<br></br>
    /// [创 建 者: lfhm]<br></br>
    /// [创建时间: 2017-10]<br></br>
    /// </summary>
    public partial class ucInPatientOneDayFeeDetailBill : UserControl, FS.HISFC.BizProcess.Interface.RADT.IBillPrint
    {
        /// <summary>
        /// 一日清单
        /// </summary>
        public ucInPatientOneDayFeeDetailBill()
        {
            InitializeComponent();
        ...
        public int ShowBill(ArrayList alData, FS.HISFC.Models.RADT.PatientInfo patient)
        {
            ...
            if (!string.IsNullOrEmpty(patient.User02))
            {
                this.lblFeeDate.Text += patient.User02;
            }
            else
            {
        ...
        public void Clear()
        {
            ...
            this.lblSex.Text = "性别：";
            this.lblTitleName.Text = "住院费用一日清单";
