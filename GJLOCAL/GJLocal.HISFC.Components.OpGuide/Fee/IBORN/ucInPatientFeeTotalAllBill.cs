...
namespace GJLocal.HISFC.Components.OpGuide.Fee.IBORN
{
    ...
    /// [创建时间: 2017-10]<br></br>
    /// </summary>
    public partial class ucInPatientFeeTotalAllBill : UserControl, FS.HISFC.BizProcess.Interface.RADT.IBillPrint
    {
        /// <summary>
        /// 清单明细
        /// </summary>
        public ucInPatientFeeTotalAllBill()
        {
            InitializeComponent();
        ...
        public int ShowBill(ArrayList alData, FS.HISFC.Models.RADT.PatientInfo patient)
        {
            ...
            foreach (string recipeNO in drugDictionary.Keys)
            {
                ...
                this.neuSpread1_Sheet1.Cells[iRow, 2].ColumnSpan = 9; //{282B4236-FFD4-4add-BB53-21B438EAFCDB}
                ...
                foreach (FS.HISFC.Models.Fee.Inpatient.FeeInfo obj in feeList)
                {
                    ...
                    this.neuSpread1_Sheet1.Cells[iRow, 1].Text = obj.Item.ID;
                    ...
                    this.neuSpread1_Sheet1.Cells[iRow, 5].Text = obj.Item.User02;//医保类别
                    this.neuSpread1_Sheet1.Cells[iRow, 6].Text = obj.FT.TotCost.ToString("F2");//原价
                    //添加优惠 赠送金额{18653415-C332-4a7f-8772-A1559E5FA88A}
                    this.neuSpread1_Sheet1.Cells[iRow, 7].Text = obj.FT .DonateCost.ToString ("F2");//折后价
                    this.neuSpread1_Sheet1.Cells[iRow, 8].Text = obj.FT.DerateCost.ToString("F2");//医保价
                    this.neuSpread1_Sheet1.Cells[iRow, 10].Text = obj.FT.DiscountCardEco.ToString("F2"); //自费金额
                    totCost += obj.FT.TotCost;
                    donateCost += obj.FT.DonateCost;
                    dereateCost += obj.FT.DerateCost;
                    selfCost += obj.FT.DiscountCardEco;
                ...
                allselfCost += selfCost;

                this.neuSpread1_Sheet1.Cells[currInfoLan, 2].Text = "合计：" + totCost.ToString("F2") + " 折后价:" + donateCost.ToString("F2") + " 医保:" + dereateCost.ToString("F2") + " 自费:" + selfCost.ToString("F2");
            ...
            this.neuSpread1_Sheet1.Cells[iRow, 0].Text = "总合计：" + allTotCost.ToString("F2") + " 折后价:" + alldonateCost.ToString("F2") + " 医保:" + alldereateCost.ToString("F2") + " 自费:" + allselfCost.ToString("F2");
            this.neuSpread1_Sheet1.Cells[iRow, 0].Font = new System.Drawing.Font("宋体", 11.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            this.neuSpread1_Sheet1.Cells[iRow, 0].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            ...
            this.neuSpread1_Sheet1.Rows.Add(iRow, 1);
            this.neuSpread1_Sheet1.Cells[iRow, 0].ColumnSpan = this.neuSpread1_Sheet1.ColumnCount;
            this.neuSpread1_Sheet1.Cells[iRow, 0].Text = "客户签字：                  ";
            this.neuSpread1_Sheet1.Cells[iRow, 0].Font = new System.Drawing.Font("宋体", 11.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            this.neuSpread1_Sheet1.Cells[iRow, 0].VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.neuSpread1_Sheet1.Cells[iRow, 0].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            this.neuSpread1_Sheet1.Cells[iRow, 0].Border = topBorder; ////{282B4236-FFD4-4add-BB53-21B438EAFCDB}
            ...
            this.neuSpread1_Sheet1.Rows.Add(iRow, 1);
            this.neuSpread1_Sheet1.Cells[iRow, 0].ColumnSpan = 2;
            this.neuSpread1_Sheet1.Cells[iRow, 2].ColumnSpan = 9;
        ...
        public void Clear()
        {
            ...
            this.lblSex.Text = "性别：";
            this.lblTitleName.Text = "住院费用清单(汇总）";
