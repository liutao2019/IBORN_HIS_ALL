...
{
    public partial class ucMainFpReport : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, ICommonReportController.IMainReportForm
    {
        ...
        private void SetFormat()
        {
            ...
            {
                //读取 
                if (System.IO.File.Exists(Neusoft.FrameWork.WinForms.Classes.Function.CurrentPath + dataWindowObject) == false)
                {
                    System.IO.FileStream fs = System.IO.File.Create(Neusoft.FrameWork.WinForms.Classes.Function.CurrentPath + dataWindowObject);
                    this.neuSpread1.Save(fs, false);
                    fs.Close();
                }
                else
                {
                    this.neuSpread1.Open(Neusoft.FrameWork.WinForms.Classes.Function.CurrentPath + dataWindowObject);
                }
            }
        }
