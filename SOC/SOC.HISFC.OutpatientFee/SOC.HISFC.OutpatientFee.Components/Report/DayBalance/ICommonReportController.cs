...
namespace Neusoft.SOC.HISFC.OutpatientFee.Components.Report.DayBalance
{
    [Serializable]
    ...
    /// 通用报表接口
    /// </summary>
    public class ICommonReportController : Neusoft.SOC.HISFC.BizProcess.CommonInterface.ControllerFactroy
    {
        /// <summary>
        /// 过滤时发生
        /// </summary>
    ...
    public class ControlTypeConverter : TypeConverter
    {
        ...
        public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object value, Attribute[] attributes)
        {
            ...
            else if (value is Neusoft.FrameWork.Models.NeuObject)
            {
                return TypeDescriptor.GetProperties(typeof(Neusoft.FrameWork.Models.NeuObject), attributes);
            }
    ...
    public class ComboBoxType : BaseControlType
    {
        ...
        private Neusoft.FrameWork.Models.NeuObject allValue = new Neusoft.FrameWork.Models.NeuObject("ALL", "全部", "");
        [System.ComponentModel.Category("C.一般下拉框")]
        [System.ComponentModel.Description("增加'全部'选项时，全部选项的编码和名称")]
        [TypeConverter(typeof(ControlTypeConverter))]
        public Neusoft.FrameWork.Models.NeuObject AllValue
        {
            get
            {
        ...
        private List<Neusoft.FrameWork.Models.NeuObject> defaultDataSource = new List<Neusoft.FrameWork.Models.NeuObject>();
        [System.ComponentModel.Category("C.一般下拉框")]
        [System.ComponentModel.Description("当数据源为Custom模式时，默认数据集合的定义")]
        public List<Neusoft.FrameWork.Models.NeuObject> DefaultDataSource
        {
            get
            {
        ...
        public void SetGenericTypeValue(Object mainObj, Object genericValue, System.Reflection.PropertyInfo p)
        {
            if (p.Name == "DefaultDataSource" && genericValue != null)
            {
                ...
                foreach (Neusoft.FrameWork.Models.NeuObject step in (System.Collections.ICollection)genericValue)
                {
                    list.Add(step);
                }
