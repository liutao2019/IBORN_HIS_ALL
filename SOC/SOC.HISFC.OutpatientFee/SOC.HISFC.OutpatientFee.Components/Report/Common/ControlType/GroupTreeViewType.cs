...
{
    [Serializable]
    public class GroupTreeViewType : BaseControlType
    {
        ...
        private Dictionary<FS.FrameWork.Models.NeuObject, ArrayList> datasource = new Dictionary<FS.FrameWork.Models.NeuObject, ArrayList>();
        public Dictionary<FS.FrameWork.Models.NeuObject, ArrayList> DataSource
        {
            get
            {
                return datasource;
