...
using Neusoft.SOC.HISFC.OutpatientFee.Components.Report.Common.Interface;
using Neusoft.SOC.HISFC.OutpatientFee.Components.Report.Common.Setting;
...
namespace Neusoft.SOC.HISFC.OutpatientFee.Components.Report.Common.Setting
{
    public partial class frmQueryInfoSetting : Form,ISettingReportForm
    {
        ...
        private void propertyGrid1_SelectedGridItemChanged(object sender, SelectedGridItemChangedEventArgs e)
        {
            ...
            {
                if (e.OldSelection.Value is List<Neusoft.FrameWork.Models.NeuObject>
