...
namespace Neusoft.SOC.HISFC.InpatientFee.Components.Balance
{
    ...
    public partial class frmEleInvoiceManager : FS.FrameWork.WinForms.Forms.BaseForm
    {
        ...
        {
            //patient.ID = CrmWebService.DataBaseHelp.DataExecHelp.GetSequnces("select SEQ_BD_CRM_PATIENT.Nextval from dual");

            //if (string.IsNullOrEmpty(patient.ID))
            //{
            //    this.ErrInfo = "获取患者编码出错！";
            //    return -1;
            //}
        ...
        public DataTable queryEleInvoiceInfo(string serialNo)
        {
            try
            {
                ...
                inpatientFeeManager.ExecQuery(queryEleInvoiceInfo, ref ds);
