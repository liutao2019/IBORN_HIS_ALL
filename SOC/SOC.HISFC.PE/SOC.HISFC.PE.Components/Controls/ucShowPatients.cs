...
namespace FS.SOC.HISFC.PE.Components.Controls
{
    ...
    public partial class ucShowPatients : UserControl
    {
        ...
        /// 体检挂号业务层
        /// </summary>
        protected FS.SOC.HISFC.PE.BizLogic.Register peRegisterManager = new FS.SOC.HISFC.PE.BizLogic.Register();
        ...
        private ArrayList QueryPatientInfosByCardNO(string cardNO)
        {
            ...
            //获得有效天数内的挂号信息
            patients = this.peRegisterManager.QueryValidPatientsByCardNO(cardNO, dtQueryBeginTime);
            ...
            if (this.isUseRecipeNOReplaceCardNO)
            {
                ...
                ArrayList recipePatients = this.peRegisterManager.QueryValidPatientsBySeeNO(this.orgCardNO, dtQueryBeginTime);
                if (recipePatients == null)
                {
                    MessageBox.Show("根据处方号获得患者信息出错!" + peRegisterManager.Err);
