...
namespace FS.SOC.HISFC.RADT.Components.Interface
{
    ...
    public class InterfaceManager
    {
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Register.IPatientList>(typeof(InterfaceManager), new FS.SOC.HISFC.RADT.Components.Base.Inpatient.ucPatientList());
        }
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Register.IInpatient>(typeof(InterfaceManager), new FS.SOC.HISFC.RADT.Components.Base.Inpatient.ucRegisterInfo(),0);
        }
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Register.IInpatient>(typeof(InterfaceManager), new FS.SOC.HISFC.RADT.Components.Base.Inpatient.ucModifyInfo(),1);
        }
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Patient.IQuery>(typeof(InterfaceManager), new FS.SOC.HISFC.RADT.Components.Base.Inpatient.frmQueryPatientInfo());
        }
