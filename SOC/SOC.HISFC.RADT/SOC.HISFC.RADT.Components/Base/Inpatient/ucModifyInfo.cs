...
namespace FS.SOC.HISFC.RADT.Components.Base.Inpatient
{
    ...
    public partial class ucModifyInfo : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.SOC.HISFC.RADT.Interface.Register.IInpatient
    {
        ...
        ///
        /// chenxin 2012-11-06 设置患者信息显示
        /// 
        private void setPatient(PatientInfo patient)
        {
        ...
        private bool isInputValid()
        {
            ...
            //科室长度
            if (!FS.FrameWork.Public.String.ValidMaxLengh(this.cmbDept.Text, 50))
            //if (!FS.FrameWork.Public.String.ValidMaxLengh(this.cmbDept.Text, 16))  修改科室长度 hm 2013-01-09
            {
