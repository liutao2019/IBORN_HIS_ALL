...
namespace FS.SOC.HISFC.RADT.Components.Base.Patient
{
    /// <summary>
    /// [功能描述: 患者基本信息控件]<br></br>
    ...
    public partial class ucPatient : FS.FrameWork.WinForms.Controls.ucBaseControl,IPatient
    {
        ...
        FS.HISFC.Models.RADT.Patient IPatient.GetPatient()
        {
            throw new NotImplementedException();
        }

        int IPatient.ShowPatient(FS.HISFC.Models.RADT.Patient patient)
        {
            throw new NotImplementedException();
        }
