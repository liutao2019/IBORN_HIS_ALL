...
namespace FS.SOC.Local.Order.ZhuHai.ZDWY.InPatient.ExecBill
{
    ...
    /// 执行单打印界面
    /// </summary>
    public partial class ExecTreatmentBillPrintControl : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ExecTreatmentBillPrintControl()
        {
            InitializeComponent();
        ...
        private int SetTitl(FS.HISFC.Models.Order.ExecOrder execOrder, int curPage, int maxPage)
        {
            ...
            string age = FS.SOC.HISFC.BizProcess.Cache.BIZManager.InPatientMgr.GetAge(patientInfo.Birthday);

            this.lblName.Text = "姓名：" + name;

            this.lblsex.Text = "性别：" + patientInfo.Sex;

            this.lblAge.Text = "年龄：" + age;

            this.lblBed.Text = "床号:" + bedNo;

            this.lblDept.Text = "科室：" + execOrder.Order.Patient.PVisit.PatientLocation.Dept.Name;

            this.lblPatientno.Text = "住院号：" + patientInfo.PID.PatientNO.TrimStart('0');
        ...
        {
            this.neuSpread1_Sheet1.Rows.Default.Height = 70F;
            ...
            FarPoint.Win.BevelBorder allBorder = new FarPoint.Win.BevelBorder(FarPoint.Win.BevelBorderType.Raised, System.Drawing.Color.Black, System.Drawing.Color.Black, 1, true, true, true, true);
            ...
            //this.neuSpread1_Sheet1.ColumnHeader.DefaultStyle.Border = topBorder;
                    ...
                    aGroup.ToList().ForEach(execOrder =>
                     {
                         ...
                         this.neuSpread1_Sheet1.Rows[this.neuSpread1_Sheet1.Rows.Count - 1].Border = allBorder;
                         this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 0).Font = new System.Drawing.Font("宋体", 10.5F, System.Drawing.FontStyle.Bold);
                         string memo = string.IsNullOrEmpty(execOrder.Order.Memo) ? "" : "(" + execOrder.Order.Memo + ")";
                         string isrn = (execOrder.Order.Item.Name.Length + memo.Length > 15 || execOrder.Order.Item.Name.Length > 15) ? "\r\n" : "  ";
                         string isr = string.IsNullOrEmpty(memo)? "" : "\r\n";
                         isr = execOrder.Order.Item.Name.Length + execOrder.Order.Frequency.Name.Length < 15 ? "" : "\r\n";
                         this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 0).Text = "开始：" + execOrder.Order.BeginTime.ToString("yyyy-MM-dd") + "  \r\n " + execOrder.Order.Item.Name + isrn + memo + isr + execOrder.Order.Frequency.Name;
                         this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 1).Text = "  ";
                         this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 2).Text = "  ";
                         this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 3).Text = "  ";
                         this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 4).Text = "  ";
                         this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 5).Text = "  ";
                     });
                });
            ...
            this.neuSpread1_Sheet1.Rows.Add(this.neuSpread1_Sheet1.Rows.Count, 1);
            this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 0).Font = new System.Drawing.Font("宋体", 10.5F, System.Drawing.FontStyle.Bold);
            this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 0).ColumnSpan = this.neuSpread1_Sheet1.ColumnCount;
            this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 0).Text = "患者方意见：我已确认接受过上述治疗项目，患者签名：                     日期：";
        ...
        private int Clear()
        {
            ...
            this.lblPatientno.Text = string.Empty;
        ...
        private void PrintDocumentPrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int additionTitleLocalX = this.DrawingMargins.Left + this.lblName.Location.X;
            int additionTitleLocalY = this.DrawingMargins.Top + this.lblName.Location.Y;
            ...
            additionTitleLocalX = this.DrawingMargins.Left + this.lblBed.Location.X;
            additionTitleLocalY = this.DrawingMargins.Top + this.lblBed.Location.Y;

            graphics.DrawString(this.lblBed.Text, this.lblBed.Font, new SolidBrush(this.lblBed.ForeColor), additionTitleLocalX, additionTitleLocalY);

            additionTitleLocalX = this.DrawingMargins.Left + this.lblDept.Location.X;
            additionTitleLocalY = this.DrawingMargins.Top + this.lblDept.Location.Y;
