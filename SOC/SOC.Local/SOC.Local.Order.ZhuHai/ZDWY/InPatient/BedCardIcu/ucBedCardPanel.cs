...
namespace FS.SOC.Local.Order.ZhuHai.ZDWY.InPatient.BedCardIcu
{
    public partial class ucBedCardPanel : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.RADT.IBedCard
    {
        ...
        public int Print()
        {
            ...
            {
                FS.SOC.Local.Order.ZhuHai.ZDWY.InPatient.BedCardIcu.ucBedCardFp ucBed = c as FS.SOC.Local.Order.ZhuHai.ZDWY.InPatient.BedCardIcu.ucBedCardFp;
