...
{
    public partial class ucPacsBillPrintIBORNA4 : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.SOC.HISFC.BizProcess.OrderInterface.InPatientOrder.IInPatientOrderPrint
    {
        public ucPacsBillPrintIBORNA4()
        {
            InitializeComponent();
        }
