    ...
    public partial class ucOrderBillHeader : UserControl
    {
        ...
        public void SetChangedInfo(FS.HISFC.Models.Order.Inpatient.Order order)
        {
            try
            {
                ...
                this.lblAge.Text = this.myPatientInfo.Age;// this.deptMgr.GetAge(this.myPatientInfo.Birthday, order.MOTime);
            }
            catch (Exception ex)
            {
		...
		public void SetPatientInfo(FS.HISFC.Models.RADT.PatientInfo patientInfo)
		{
            ...
            if (this.myPatientInfo != null)
            {
                ...
                //{C5CCA8E3-2893-4268-8680-76242D2CE05A}
                this.lblAge.Text = this.myPatientInfo.Age;//this.deptMgr.GetAge(this.myPatientInfo.Birthday);
                ...
                else { this.lblBedNo.Text = this.myPatientInfo.PVisit.PatientLocation.Bed.ID; }
