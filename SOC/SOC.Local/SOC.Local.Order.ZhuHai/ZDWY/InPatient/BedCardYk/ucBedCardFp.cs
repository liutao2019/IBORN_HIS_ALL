    ...
    public partial class ucBedCardFp : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Classes.IControlPrintable
    {
        ...
        private void SetInfo()
        {
            if (this.Patient != null)
            {
                ...
                this.fpBedCard_Sheet1.Cells[1, 2].Text = this.Patient.Sex.Name;
                this.fpBedCard_Sheet1.Cells[1, 3].Text = this.Patient.Age;
                this.fpBedCard_Sheet1.Cells[2, 2].Text = this.BedDisplay(this.Patient.PVisit.PatientLocation.Bed.ID);
                //this.fpBedCard_Sheet1.Cells[2, 1].Text = this.Patient.PVisit.PatientLocation.Dept.Name;
                this.fpBedCard_Sheet1.Cells[2, 1].Text = this.Patient.PID.PatientNO;
              ...
              //  this.fpBedCard_Sheet1.Cells[3, 5].Text = this.Patient.Disease.Tend.Name;
               // this.fpBedCard_Sheet1.Cells[3, 7].Text = this.Patient.Disease.Memo;
                this.fpBedCard_Sheet1.Cells[3, 1].Text = this.Patient.PVisit.AdmittingDoctor.Name;
        ...
        public object ControlValue
        {
            ...
            set
            {
                ...
                //throw new Exception("The method or operation is not implemented.");
                this.fpBedCard_Sheet1.Cells[1, 0].Text = P.Name;
                //this.fpBedCard_Sheet1.Cells[1, 2].Text = P.Sex.Name;
                //this.fpBedCard_Sheet1.Cells[1, 3].Text = P.Age;
               // this.fpBedCard_Sheet1.Cells[2, 2].Text = this.BedDisplay(P.PVisit.PatientLocation.Bed.ID);
                //this.fpBedCard_Sheet1.Cells[2, 1].Text = P.PVisit.PatientLocation.Dept.Name;
                //this.fpBedCard_Sheet1.Cells[2, 1].Text = P.PID.PatientNO; //病历号
                
                char[] a = { '0' };
                string patientNO = P.PID.PatientNO.TrimStart(a);
                this.fpBedCard_Sheet1.Cells[2, 0].Text = patientNO;
               ...
               // this.fpBedCard_Sheet1.Cells[3, 7].Text = P.Disease.Memo;
                this.fpBedCard_Sheet1.Cells[3, 0].Text = P.PVisit.AdmittingDoctor.Name;
                this.fpBedCard_Sheet1.Cells[4, 0].Text = P.PVisit.AdmittingNurse.Name;
              //this.fpBedCard_Sheet1.Cells[4, 1].Text = P.PVisit.AdmittingNurse.Name;
            }
        }
