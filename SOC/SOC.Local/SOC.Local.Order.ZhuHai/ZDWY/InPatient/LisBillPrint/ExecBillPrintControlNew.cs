...
namespace Neusoft.SOC.Local.Order.ZhuHai.ZDWY.InPatient.ExecBill
{
    ...
    /// 执行单打印界面
    /// </summary>
    public partial class ExecBillPrintControlNew : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ExecBillPrintControlNew()
        {
            InitializeComponent();
        ...
        Neusoft.HISFC.BizLogic.Order.ExecBill execBillMgr = new Neusoft.HISFC.BizLogic.Order.ExecBill();
        ...
        SOC.Windows.Forms.PrintPageSelectDialog socPrintPageSelectDialog = new Neusoft.SOC.Windows.Forms.PrintPageSelectDialog();
        #endregion
        ...
        private void printPage()
        {
            ...
            if (pSize == null)
            {
                printer.SetPageSize(new Neusoft.HISFC.Models.Base.PageSize("execBillPaper", 700, 550));
            }
            else
            {
            ...
            if (((Neusoft.HISFC.Models.Base.Employee)this.inPatientMgr.Operator).IsManager)
            {
        ...
        public int SetExecBill(System.Collections.ArrayList allExecOrder, string execKind, string printType, Dictionary<string, ArrayList> alExecByOrderNO)
        {
            ...
            if (printType == "0")
            {
                #region 按执行单打印
                //this.Clear();
                //this.SetTitle(allExecOrder[0] as Neusoft.HISFC.Models.Order.ExecOrder);
                ...
                foreach (Neusoft.HISFC.Models.Order.ExecOrder execOrder in allExecOrder)
                {
            ...
            else if (printType == "1")
            {
                ...
                allExecOrder.Sort(new Neusoft.SOC.Local.Order.ZhuHai.ZDWY.Common.Comparer.ExecBedCompare());
            ...
            else if (printType == "2")
            {
                ...
                foreach (Neusoft.HISFC.Models.Order.ExecOrder execOrder in allExecOrder)
                {
                    ...
                    if (allExecbill == null || allExecbill.Count == 0)
                    {
                        ...
                        foreach (Neusoft.FrameWork.Models.NeuObject execBill in allExecbill)
                        {
                    ...
                    if (allDrugTypeCons == null || allDrugTypeCons.Count == 0)
                    {
                        ...
                        foreach (Neusoft.HISFC.Models.Base.Const consUsage in allDrugTypeCons)
                        {
                ...
                if (aldifPatient != null && aldifPatient.Count > 0)
                {
                    ...
                    aldifPatient.Sort(new Neusoft.SOC.Local.Order.ZhuHai.ZDWY.Common.Comparer.ExecBedCompare());
                ...
                if (alDifExec != null && alDifExec.Count > 0)
                {
                    ...
                    alDifExec.Sort(new Neusoft.SOC.Local.Order.ZhuHai.ZDWY.Common.Comparer.ExecBillCompare());
        ...
        private void SetDataByPatient(string patientNo, ArrayList allDataByPatient, Dictionary<string, ArrayList> allExecByOrderNo)
        {
            ...
            allDataByPatient.Sort(new Neusoft.SOC.Local.Order.ZhuHai.ZDWY.Common.Comparer.OrderCompareByPatientAndUsage());

            foreach (Neusoft.HISFC.Models.Order.ExecOrder execOrder in allDataByPatient)
            {
                ...
                else
                {
                    ...
                    Neusoft.FrameWork.Models.NeuObject bedObj = new Neusoft.FrameWork.Models.NeuObject();
                    allExecBill.Add(execOrder.Memo);
                }
            }

            allExecBill.Sort(new Neusoft.SOC.Local.Order.ZhuHai.ZDWY.Common.Comparer.ExecBillCompare());
            ...
            foreach (string execBill in allExecBill)
            {
                ...
                this.SetTitl((allExecData[0] as Neusoft.HISFC.Models.Order.ExecOrder), curPageNo, maxPagNo);

                Neusoft.HISFC.Models.RADT.PatientInfo inPatient = this.inPatientMgr.QueryPatientInfoByInpatientNO((allExecData[0] as Neusoft.HISFC.Models.Order.ExecOrder).Order.Patient.ID);
        ...
        private void Print(Neusoft.HISFC.Models.Order.ExecOrder execOrderObj, int curPageNo, int maxPagNo, ArrayList alPrint, Dictionary<string, ArrayList> alExecByOrderNo)
        {
        ...
        public void SetData(string execBill, ArrayList allDataByExec, Dictionary<string, ArrayList> alExecByOrderNo)
        {
            ...
            allDataByExec.Sort(new Neusoft.SOC.Local.Order.ZhuHai.ZDWY.Common.Comparer.OrderCompareByPatientAndUsage());
            ...
            IList<Neusoft.HISFC.Models.Order.ExecOrder> orderDataList = new List<Neusoft.HISFC.Models.Order.ExecOrder>();
            ...
            foreach (Neusoft.HISFC.Models.Order.ExecOrder order in allDataByExec)
            {
                //临嘱无需合并
            ...
            //{
            //    Neusoft.HISFC.Models.Order.ExecOrder execOrder = allDataByExec[i] as Neusoft.HISFC.Models.Order.ExecOrder;
            //    //不存在的患者
            ...
            this.SetTitle(allDataByExec[0] as Neusoft.HISFC.Models.Order.ExecOrder);
            this.SetDetail(execBill, "", allDataByExec, alExecByOrderNo, "0");

            //foreach (int page in dicPage.Keys)
            //{
            //    Neusoft.HISFC.Models.Order.ExecOrder execOrderObj = dicPage[page][0] as Neusoft.HISFC.Models.Order.ExecOrder;
        ...
        /// <returns></returns>
        private int SetTitl(Neusoft.HISFC.Models.Order.ExecOrder execOrder, int curPage, int maxPage)
        {
            this.lblTitle.Text = this.GetBillName(execOrder.Memo.ToString());

            this.lblTitle.Location = new Point(Neusoft.FrameWork.Function.NConvert.ToInt32((this.Width - this.lblTitle.Width) / 2), this.lblTitle.Location.Y);
            //病区
            this.lblDeptName.Text = "病区：" + Neusoft.SOC.HISFC.BizProcess.Cache.Common.GetDeptName(execOrder.Order.Patient.PVisit.PatientLocation.NurseCell.ID);
            //页码
        ...
        /// <param name="maxPage"></param>
        /// <returns></returns>
        private int SetTitle(Neusoft.HISFC.Models.Order.ExecOrder execOrder)
        {
            this.lblTitle.Text = this.GetBillName(execOrder.Memo.ToString());
            ...
            //病区
            //this.lblDeptName.Text = "病区：" + Neusoft.SOC.HISFC.BizProcess.Cache.Common.GetDeptName(execOrder.Order.Patient.PVisit.PatientLocation.NurseCell.ID);
            Neusoft.HISFC.Models.RADT.PatientInfo patientInfo= Neusoft.SOC.HISFC.BizProcess.Cache.BIZManager.InPatientMgr.GetPatientInfoByPatientNO(execOrder.Order.Patient.ID.ToString());
        ...
        private int SetDetail(string name, string bedNO, ArrayList allExecBill, Dictionary<string, ArrayList> alExecByOrderNO, string printType)
        {
            ...
            allExecBill.Cast<Neusoft.HISFC.Models.Order.ExecOrder>()
                ...
                .ToList().ForEach(aGroup =>
                {
                    ...
                    //}
                    this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 2).ColumnSpan = this.neuSpread1_Sheet1.ColumnCount - 2;

                    this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 2).Text = "床号:" + bedNO.ToString() + "    " + "" + name.ToString();


                    this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 2).Font = font1;
                    ...
                    aGroup.ToList().ForEach(execOrder =>
                    {
                        ...
                        execOrder.Order.Combo.Memo = strSubCombNO;
                        if (string.IsNullOrEmpty(name))
                        {
                            ...
                            //FZC 修改 
                            this.neuSpread1_Sheet1.Cells.Get(patientRowIndex, 2).Text = "床号:" + bedNo + "    " + "姓名:" + name.ToString();
                        }
                        ...
                        {
                            this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 3).Text = execOrder.Order.DoseOnce + execOrder.Order.DoseUnit;
                            ...
                            this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 1).Tag = execOrder.Order.Combo.ID;
                            this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 1).Text = execOrder.Order.Combo.Memo;
                            ...
                            if (curcomboNo != execOrder.Order.Combo.ID)
                            {
                                ...
                                if (!execOrder.Order.OrderType.IsCharge)
                                {
                                    if (execOrder.Order.Item.ItemType == Neusoft.HISFC.Models.Base.EnumItemType.Drug)
                                    {
                                        this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 2).Text = "(自备)" + execOrder.Order.Item.Name + orderManager.TransHypotest(execOrder.Order.HypoTest) + memo;
                                    }
                                    else
                                    {
                                        this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 2).Text = "(自备)" + execOrder.Order.Item.Name + orderManager.TransHypotest(execOrder.Order.HypoTest) + memo;
                                ...
                                {
                                    this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 2).Text = execOrder.Order.Item.Name + orderManager.TransHypotest(execOrder.Order.HypoTest) + memo;
                                }
                                ...
                                if (execOrder.Order.OrderType.IsDecompose)
                                {
                                    ...
                                    //else if (execOrder.Order.Item.ItemType != Neusoft.HISFC.Models.Base.EnumItemType.Drug)
                                    else
                                    {
                                        mess += execOrder.ChargeOper.Memo;
                                    }
                                ...
                                this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 6).Text = mess;                                
                            }
                            else
                            {
                                ...
                                this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 6).Text = " ";
                            }
                        }
                        else
                        {
                            ...
                            this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 3).Text = execOrder.Order.Qty + execOrder.Order.Unit + " ";
                            this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 1).Tag = execOrder.Order.Combo.ID;
                            this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 1).Text = execOrder.Order.Combo.Memo;
                            ...
                            if (curcomboNo != execOrder.Order.Combo.ID)
                            {
                                ...
                                if (!execOrder.Order.OrderType.IsCharge)
                                {
                                    if (execOrder.Order.Item.ItemType == Neusoft.HISFC.Models.Base.EnumItemType.Drug)
                                    {
                                        this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 2).Text = "(自备)" + execOrder.Order.Item.Name + memo;
                                    }
                                    else
                                    {
                                        this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 2).Text = "(嘱托)" + execOrder.Order.Item.Name + orderManager.TransHypotest(execOrder.Order.HypoTest) + memo;
                                    }
                                }
                                else
                                {
                        ...
                        if (curcomboNo != execOrder.Order.Combo.ID)
                        {
                            this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 4).Text = Neusoft.SOC.HISFC.BizProcess.Cache.Common.GetUsageName(execOrder.Order.Usage.ID);

                            this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 5).Text = execOrder.Order.Frequency.ID;
                            string mess = string.Empty;
                            if (execOrder.Order.OrderType.IsDecompose)
                            {
                                if (SOC.HISFC.BizProcess.Cache.Common.IsPOUsage(execOrder.Order.Usage.ID))
                        ...
                        curcomboNo = execOrder.Order.Combo.ID;
                        this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 7).Text = ". ";
                    });
                    #endregion
                });
            ...
            Neusoft.SOC.Local.Order.ZhuHai.Classes.Function.DrawComboLeft(this.neuSpread1_Sheet1, 1, 1);//画组
        ...
        private bool ChoosePrintPageNO(Graphics graphics)
        {
            ...
            int drawingWidth = 800 - this.DrawingMargins.Left - this.DrawingMargins.Right;
            int drawingHeight = 550 - this.DrawingMargins.Top - this.DrawingMargins.Bottom - this.panelTitle.Height;
        ...
        private void SetPaperSize(System.Drawing.Printing.PaperSize paperSize)
        {
            if (paperSize == null)
            {
                paperSize = new System.Drawing.Printing.PaperSize("execBillPaper", 800, 550);
            }
