...
namespace Neusoft.SOC.Local.Order.ZhuHai.ZDWY.InPatient.ExecBill
{
    ...
    /// 执行单打印界面
    /// </summary>
    public partial class ExecBillPrintControl : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
            ...
            allExecBill.Cast<Neusoft.HISFC.Models.Order.ExecOrder>()
                ...
                .ToList().ForEach(aGroup =>
                {
                    ...
                    aGroup.ToList().ForEach(execOrder =>
                    {
                        ...
                        if (curcomboNo != execOrder.Order.Combo.ID)
                        {
                            this.neuSpread1_Sheet1.Cells.Get(this.neuSpread1_Sheet1.Rows.Count - 1, 3).Text = Neusoft.SOC.HISFC.BizProcess.Cache.Common.GetUsageName(execOrder.Order.Usage.ID);
