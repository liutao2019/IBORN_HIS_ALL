...
namespace FS.SOC.Local.Order.ZhuHai.ZDWY.OutPatient.InjectBillPrint
{
    ...
    /// 诊疗单
    /// </summary>
    public partial class ucInjectBillPrintBLE : UserControl, FS.SOC.HISFC.BizProcess.OrderInterface.OutPatientOrder.IOutPatientOrderPrint
    {
        public ucInjectBillPrintBLE()
        {
            InitializeComponent();
        }
        ...
        public void SetPrintValue(IList<FS.HISFC.Models.Order.OutPatient.Order> orderList, bool isPreview)
        {
            ...
            //}
            ZhuHai.Classes.Function.DrawComboLeft(fpSpreadItemsSheet, 6, 1);
