...
{
    public partial class ucPacsBillPrintXBLE : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.SOC.HISFC.BizProcess.OrderInterface.OutPatientOrder.IOutPatientOrderPrint
    {
        public ucPacsBillPrintXBLE()
        {
            InitializeComponent();
        }
        ...
        public void SetPatientInfo(FS.HISFC.Models.Registration.Register register)
        {
           ...
           // this.lblAge.Text = this.diagManager.GetAge(register.Birthday, false);
            ...
            this.caseHistory = FS.SOC.Local.Order.ZhuHai.Classes.CacheManager.OutOrderMgr.QueryCaseHistoryByClinicCode(register.ID);
