...
namespace FS.SOC.Local.Order.ZhuHai.ZDWY.OutPatient.RecipePrint
{
    ...
    /// 麻、精一处方
    /// </summary>
    public partial class ucRecipePrintST : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.IRecipePrint
    {
        ...
        private void MakaLabel(ArrayList alOrder)
        {
            ...
            for (int index = 0; index < alOrder.Count; index++)
            {
                ...
                fpSpreadItemsSheet.Cells[row, (Int32)EnumCol.MC名称].Text = GetName(order);
            ...
            if (fpSpreadItemsSheet.RowCount < 11)
            {
                ...
                fpSpreadItemsSheet.Rows.Add(row, 1);
                fpSpreadItemsSheet.Cells[row, (Int32)EnumCol.MC名称].Text = "余药量____________丢弃，确认人____________/____________";

                fpSpreadItemsSheet.Rows[row].Font = new System.Drawing.Font("微软雅黑", 9.5F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
                //row = fpSpreadItemsSheet.RowCount;
                //fpSpreadItemsSheet.Rows.Add(row, 1);
        ...
        {
            this.labelTitle.Text = FS.FrameWork.Management.Connection.Hospital.Name + "处方";
            if (register == null)
            {
                return 1;
            }
