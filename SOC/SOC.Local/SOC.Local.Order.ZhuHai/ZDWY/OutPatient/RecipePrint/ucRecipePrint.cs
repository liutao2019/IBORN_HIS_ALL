...
namespace FS.SOC.Local.Order.ZhuHai.ZDWY.OutPatient.RecipePrint
{
    ...
    /// </summary>
    public partial class ucRecipePrint : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.IRecipePrint
    {
        ...
        private void MakaLabel(ArrayList alOrder)
        {
            ...
            if (fpSpreadItemsSheet.RowCount < 11)
            {
                ...
                if (speLevl == 2)
                {
                    ...
                    fpSpreadItemsSheet.Rows[row].Font = new System.Drawing.Font("微软雅黑", 8.5F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
        ...
        {
            this.labelTitle.Text = FS.FrameWork.Management.Connection.Hospital.Name + "处方笺";
            if (register == null)
            {
                return 1;
            }
