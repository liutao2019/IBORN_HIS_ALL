...
{
    public partial class ucMedicalReportBLEA5 : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.Order.IMedicalReportPrint
    {
        public ucMedicalReportBLEA5()
        {
            InitializeComponent();
        }
        ...
        private void lbPresentMedicalhistory_Click(object sender, EventArgs e)
        {
