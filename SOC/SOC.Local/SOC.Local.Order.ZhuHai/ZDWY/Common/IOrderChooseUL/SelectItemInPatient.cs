...
namespace FS.SOC.Local.Order.ZhuHai.ZDWY.Common.IOrderChooseUL
{
    public class SelectItemInPatient : FS.SOC.HISFC.BizProcess.OrderInterface.InPatientOrder.IOrderChooseUL
    {
        ...
        FS.SOC.Local.Order.ZhuHai.ZDWY.Common.IOrderChooseUL.ucSelectInPatientItem ucChooseItem = null;

        private void init()
        {
            if (ucChooseItem == null)
            {
                ucChooseItem = new FS.SOC.Local.Order.ZhuHai.ZDWY.Common.IOrderChooseUL.ucSelectInPatientItem();
            }
            ucChooseItem.Clear();
        }
