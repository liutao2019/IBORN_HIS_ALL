        ...
        public ArrayList GetRegSeeList(string cardNo,string clinicCode, DateTime beginDate)
        {
            ...
            try
            {
                ...
                while (Reader.Read())
                {
                    ...
                    regObj.SeeDoct.Dept.Name = SOC.HISFC.BizProcess.Cache.Common.GetDeptName(regObj.SeeDoct.Dept.ID);
                    regObj.SeeDoct.ID = Reader[2].ToString();
                    regObj.SeeDoct.Name = SOC.HISFC.BizProcess.Cache.Common.GetDeptName(regObj.SeeDoct.ID);
