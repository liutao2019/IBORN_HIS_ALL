...
{
    public partial class ucOutPatientNoticeOld : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.HISFC.BizProcess.Interface.IPrintInHosNotice
    {
        public ucOutPatientNoticeOld()
        {
            InitializeComponent();
        }
        ...
        private void ucOutPatientNoticeOld_Load(object sender, EventArgs e)
        {
            initCombo();
        }
