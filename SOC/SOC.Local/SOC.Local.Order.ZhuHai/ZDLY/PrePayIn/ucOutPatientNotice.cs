...
{
    public partial class ucOutPatientNotice : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.HISFC.BizProcess.Interface.IPrintInHosNotice
    {
      ...
      　private Neusoft.HISFC.BizProcess.Integrate.Fee feeIntegrate = new Neusoft.HISFC.BizProcess.Integrate.Fee();
        ...
        private void SetPatient(Neusoft.HISFC.Models.Registration.Register reg)
        {
            ...
            else
            {
                ...
                this.txtAgeOne.Text = this.commonController.GetAge(reg.Birthday);
                ...
                this.dtBirthday.Text = reg.Birthday.ToString("d");
            }
        }
        ...
        public int SetValue(Neusoft.HISFC.Models.RADT.PatientInfo obj)
        {
            try
            {
                if (obj.Name != null)
                {
                   ...
                   // this.txtCardNo.Text = obj.PID.CardNO;//病例号
                    ...
                    this.txtLinkMan.Text = obj.Kin.Name;//联系人
                    ...
                    this.txtDoctor.Text = Neusoft.FrameWork.Management.Connection.Operator.Name;
                    this.txtDoctorCode.Text = Neusoft.FrameWork.Management.Connection.Operator.ID;
                   ...
                   //患者职业，用常规的显示方式在打印的时候显示不出内容，先用这种笨方法
                    switch (obj.Profession.ID)
                    {
                        case "11":
                            this.cmbPos.Text = "国家公务员"; break;
                        case "13":
                            this.cmbPos.Text = "专业技术人员"; break;
                        case "17":
                            this.cmbPos.Text = "职员"; break;
                        case "21":
                            this.cmbPos.Text = "企业管理人员"; break;
                        case "24":
                            this.cmbPos.Text = "工人"; break;
                        case "27":
                            this.cmbPos.Text = "农民"; break;
                        case "31":
                            this.cmbPos.Text = "学生"; break;
                        case "37":
                            this.cmbPos.Text = "现役军人"; break;
                        case "51":
                            this.cmbPos.Text = "自由职业者"; break;
                        case "54":
                            this.cmbPos.Text = "个体经营者"; break;
                        case "70":
                            this.cmbPos.Text = "无业人员"; break;
                        case "80":
                            this.cmbPos.Text = "退（离）休人员"; break;
                        case "90":
                            this.cmbPos.Text = "其他"; break;
                        default: break;
                    }

                    //结算方式，跟职业一样用笨方法
                    switch (obj.Pact.PayKind.ID)
                    { 
                        case "01":
                            this.cmbPayKind.Text = "自费"; break;
                        case "02":
                            this.cmbPayKind.Text = "医保"; break;
                        case "03":
                            this.cmbPayKind.Text = "公费"; break;
                        case "04":
                            this.cmbPayKind.Text = "特约单位"; break;
                        case "05":
                            this.cmbPayKind.Text = "本院职工"; break;
                        default: break;
                    }
                }
            }
        ...
        private void dtBirthday_TextChanged(object sender, EventArgs e)
        {
            ...
            birthday = Neusoft.FrameWork.Function.NConvert.ToDateTime(this.dtBirthday.Text);
