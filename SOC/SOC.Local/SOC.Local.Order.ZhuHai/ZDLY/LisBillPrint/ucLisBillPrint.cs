...
using Neusoft.SOC.Public;

namespace Neusoft.SOC.Local.Order.ZhuHai.ZDLY.LisBillPrint
{
    ...
    public partial class ucLisBillPrint : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.SOC.HISFC.BizProcess.OrderInterface.OutPatientOrder.IOutPatientOrderPrint
    {
        ...
        public void SetPatientInfo(Neusoft.HISFC.Models.Registration.Register register)
        {
            ...
            this.npbBarCode.Image = Function.CreateBarCode(this.myReg.PID.CardNO, this.npbBarCode.Width, this.npbBarCode.Height);
        ...
        public void SetPrintValue(IList<Neusoft.HISFC.Models.Order.OutPatient.Order> IList, bool isPreview)
        {
            ...
            {
                tempItem += IList[i].Item.Name + (string.IsNullOrEmpty(IList[i].Memo) ? "" : "    [备注]" + IList[i].Memo) + "       " + Neusoft.FrameWork.Public.String.ToSimpleString(IList[i].Item.Qty) + IList[i].Unit + "\r\n";
            ...
            foreach (Neusoft.HISFC.Models.Base.Const dept in cons)
            {
