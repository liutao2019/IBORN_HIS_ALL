...
namespace Neusoft.SOC.Local.Order.ZhuHai.ZDLY.RecipePrint
{
    public partial class frmRecipePrint : Form
    {
        ...
        public void AddPage(Neusoft.HISFC.BizProcess.Interface.IRecipePrint recipe, int index)
        {
        ...
        private void btPrintCurrent_Click(object sender, EventArgs e)
        {
            ...
            Neusoft.HISFC.BizProcess.Interface.IRecipePrint recipe = this.tabControl1.SelectedTab.Controls[0] as Neusoft.HISFC.BizProcess.Interface.IRecipePrint;
