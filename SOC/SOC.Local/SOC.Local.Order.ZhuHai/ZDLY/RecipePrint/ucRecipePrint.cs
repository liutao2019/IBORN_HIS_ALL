...
namespace Neusoft.SOC.Local.Order.ZhuHai.ZDLY.RecipePrint
{
    public partial class ucRecipePrint : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.HISFC.BizProcess.Interface.IRecipePrint, Neusoft.HISFC.BizProcess.Interface.Pharmacy.IDrugPrint, Neusoft.SOC.HISFC.BizProcess.OrderInterface.OutPatientOrder.IOutPatientOrderPrint
    {
        ...
        private void SetShowMainInfo()
        {
            ...
            if (this.speRecipeLabel.Length <= 0)
            {
                ...
                //if (regIntegrate.IsEmergencyHolidays((this.alOrder[0] as Neusoft.HISFC.Models.Order.OutPatient.Order).ReciptDept.ID, (this.alOrder[0] as Neusoft.HISFC.Models.Order.OutPatient.Order).MOTime))
                //{
                ...
                else if (SOC.HISFC.BizProcess.Cache.Common.GetDeptName((this.alOrder[0] as Neusoft.HISFC.Models.Order.OutPatient.Order).ReciptDept.ID).IndexOf("儿") >= 0)
                {
        ...
        public void Print()
        {
            ...
            //print.SetPageSize(new Neusoft.HISFC.Models.Base.PageSize("A5", 575, 790));
            print.SetPageSize(Neusoft.SOC.Local.Order.ZhuHai.ZDLY.Common.Function.GetPrintPage(false));
        ...
        public int SetPatientInfo(Neusoft.HISFC.Models.Registration.Register register)
        {
            ...
            this.npbBarCode.Image = SOC.Public.Function.CreateBarCode(this.myReg.PID.CardNO, this.npbBarCode.Width, this.npbBarCode.Height);
        ...
        public void PreviewOutPatientOrderBill(Neusoft.HISFC.Models.Registration.Register regObj, Neusoft.FrameWork.Models.NeuObject reciptDept, Neusoft.FrameWork.Models.NeuObject reciptDoct, IList<Neusoft.HISFC.Models.Order.OutPatient.Order> List, bool isPreview)
        {
            throw new NotImplementedException();
        }
        ...
        public int PrintOutPatientOrderBill(Neusoft.HISFC.Models.Registration.Register regObj, Neusoft.FrameWork.Models.NeuObject reciptDept, Neusoft.FrameWork.Models.NeuObject reciptDoct, ArrayList alOrder, bool isPreview)
        {
            throw new NotImplementedException();
        }
