...
{
    class ResultInterface : Neusoft.HISFC.BizProcess.Interface.Common.ILis
    {
        /// <summary>
        /// 患者类别
        /// </summary>
        ...
        private void Pacs()
        {
            try
            {
                ...
                {
                    //Neusoft.SOC.Local.Order.OutPatientOrder.HuaHaiServices.ConnectHISServiceClient CHS = new Neusoft.SOC.Local.Order.OutPatientOrder.HuaHaiServices.ConnectHISServiceClient();
        ...
        /// 进程管理类
        /// </summary>
        private static Neusoft.SOC.Local.Order.ZhuHai.ZDLY.ResultPrint.ProcessesManager processMrg = new Neusoft.SOC.Local.Order.ZhuHai.ZDLY.ResultPrint.ProcessesManager();
        ...
        public void ECGNET()
        {
            try
            {
                ...
                Neusoft.SOC.Local.Order.ZhuHai.ZDLY.ResultPrint.ProcessesManager.ShellExecute(new IntPtr(), "open", fullFilePath, " -R" + patientNo + " -T0", null, (int)Neusoft.SOC.Local.Order.ZhuHai.ZDLY.ResultPrint.ProcessesManager.ShowWindowCommands.SW_SHOW);
                return;
            }
            catch (Exception ex)
            {
        ...
        private void Efilm()
        {
            ...
            try
            {
                ...
                Neusoft.SOC.Local.Order.ZhuHai.ZDLY.ResultPrint.ProcessesManager.ShellExecute(new IntPtr(), "open", fullFilePath,
                    "," + patientNo + ",,200", null, (int)Neusoft.SOC.Local.Order.ZhuHai.ZDLY.ResultPrint.ProcessesManager.ShowWindowCommands.SW_SHOW);
                return;
            }
            catch (Exception ex)
            {
        ...
        private void Lis()
        {
            ...
            try
            {
                ...
                Neusoft.SOC.Local.Order.ZhuHai.ZDLY.ResultPrint.ProcessesManager.ShellExecute(new IntPtr(), "open", fullFilePath,
                    "report;-1;" + patientNo + ";-1;-1;-1;107;", null, (int)Neusoft.SOC.Local.Order.ZhuHai.ZDLY.ResultPrint.ProcessesManager.ShowWindowCommands.SW_SHOW);
                return;
            }
            catch (Exception ex)
            {
        ...
        public void HICSCRB()
        {
            try
            {
                ...
                {
                    Neusoft.SOC.Local.Order.ZhuHai.ZDLY.ResultPrint.ProcessesManager.ShellExecute(new IntPtr(), "open", fullFilePath, this.myPatientInfo.Memo + ",0," + this.myPatientInfo.PID.PatientNO + "," + this.myPatientInfo.InTimes, null, (int)Neusoft.SOC.Local.Order.ZhuHai.ZDLY.ResultPrint.ProcessesManager.ShowWindowCommands.SW_SHOW);
                }
                else
                {
                    Neusoft.SOC.Local.Order.ZhuHai.ZDLY.ResultPrint.ProcessesManager.ShellExecute(new IntPtr(), "open", fullFilePath, this.myPatientInfo.Memo + ",0," + this.myPatientInfo.PID.CardNO + ",1", null, (int)Neusoft.SOC.Local.Order.ZhuHai.ZDLY.ResultPrint.ProcessesManager.ShowWindowCommands.SW_SHOW);
                }
                return;
            }
            catch (Exception ex)
