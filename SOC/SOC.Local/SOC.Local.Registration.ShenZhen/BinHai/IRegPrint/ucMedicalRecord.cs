...
namespace Neusoft.SOC.Local.Registration.ShenZhen.BinHai.IRegPrint
{
    ...
    public partial class ucMedicalRecord : UserControl
    {
        ...
        public void SetPrintValue(Neusoft.HISFC.Models.Registration.Register regInfo, int printNum)
        {
                  //常数管理类
            ...
            neuObj = conMger.GetConstant("SZPERSONTYPE", regInfo.SIMainInfo.PersonType.ID);
            ...
            if (regInfo.Pact.ID == "1")
                this.lblBirthday.Text = regInfo.Pact.Name;
            else
                this.lblBirthday.Text = neuObj.Name;
        ...
        private void PrintRecord()
        {
            ...
            if (ps == null)
            {
                ps = new Neusoft.HISFC.Models.Base.PageSize("MZTM", 500, 300);
                ps.Left = 0;
                ps.Top = 0;
                ps.Printer = "MZTM";
            }
