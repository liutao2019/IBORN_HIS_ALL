...
namespace FS.SOC.Local.Registration.ShenZhen.BinHai.IPrintBar
{
    ...
    public partial class ucMedicalRecord : UserControl
    {
        ...
        public void SetPrintValue(FS.HISFC.Models.RADT.Patient regInfo, int printNum)
        {
                  //常数管理类
            ...
            if (regInfo is FS.HISFC.Models.Registration.Register)
            {
                if (regInfo.Pact.ID == "2")
                {
                    ...
                    neuObj = conMger.GetConstant("SZPERSONTYPE", ((FS.HISFC.Models.Registration.Register)regInfo).SIMainInfo.PersonType.ID);
            ...
            this.lbhospital.Text = FS.FrameWork.Management.Connection.Hospital.Name;
        ...
        /// <param name="regInfo"></param>
        /// <param name="printNum"></param>
         public void SetPrintValued(FS.HISFC.Models.Registration.Register regInfo, int printNum)
        {
            BarcodeLib.Barcode b = new BarcodeLib.Barcode();
            b.IncludeLabel = true;
        ...
        private void PrintRecord()
        {
            ...
            FS.HISFC.BizLogic.Manager.PageSize pm = new FS.HISFC.BizLogic.Manager.PageSize();
            FS.HISFC.Models.Base.PageSize ps = pm.GetPageSize("MZTM");
            if (ps == null)
            {
                ps = new FS.HISFC.Models.Base.PageSize("MZTM", 185, 120);
                ps.Left = 0;
                ps.Top = 0;
                ps.Printer = "MZTM";
            }
