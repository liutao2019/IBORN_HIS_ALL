...
namespace Neusoft.SOC.Local.Pharmacy.Print.ZDLY
{
    public partial class ucCheckEmptyBill : UserControl, Base.IPharmacyBillPrint
    {
        ...
        {
            this.neuFpEnter1.SaveSchema(Neusoft.FrameWork.WinForms.Classes.Function.CurrentPath + "\\Profile\\PhaCheckEmptyBillSetting.xml");
        }
        ...
        private void SetPrintData(ArrayList al, string title)
        {
            ...
            Neusoft.HISFC.Models.Pharmacy.Check checkStat = itemMgr.GetCheckStat(info.StockDept.ID, info.CheckNO);
            ...
            for (int i = 0; i < al.Count; i++)
            {
                ...
                Neusoft.HISFC.Models.Pharmacy.Check checkDetail = al[i] as Neusoft.HISFC.Models.Pharmacy.Check;
        ...
        public int SetPrintData(System.Collections.ArrayList alPrintData, Neusoft.SOC.Local.Pharmacy.Base.PrintBill printBill)
        {
            if (alPrintData == null)
            {
                Neusoft.FrameWork.WinForms.Classes.Function.ShowControl(this);
                return 0;
            }
            this.neuFpEnter1.ReadSchema(Neusoft.FrameWork.WinForms.Classes.Function.CurrentPath + "\\Profile\\PhaCheckEmptyBillSetting.xml");
