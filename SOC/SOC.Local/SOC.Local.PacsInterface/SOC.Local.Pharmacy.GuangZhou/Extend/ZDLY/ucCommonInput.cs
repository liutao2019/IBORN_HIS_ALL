...
namespace Neusoft.SOC.Local.Pharmacy.Extend.ZDLY
{
    ...
    public partial class ucCommonInput : UserControl, SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.IInputInfoControl
    {
        ...
        /// </summary>
        private Neusoft.HISFC.Models.Pharmacy.Item curItem;
        ...
        private void SetControlEnable(Control c)
        {
            ...
            c.Enabled = Neusoft.FrameWork.Function.NConvert.ToBoolean(enable);
        ...
        void ncmbItemUnit_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (this.ncmbItemUnit.Tag != null && this.ncmbItemUnit.Tag.ToString() == "1")
            {
                ...
                if (Neusoft.FrameWork.Function.NConvert.ToDecimal(this.ntxtPurchasePrice.Text) == this.curItem.PriceCollection.PurchasePrice)
                {
            ...
            else if (this.ncmbItemUnit.Tag != null && this.ncmbItemUnit.Tag.ToString() == "0")
            {
                ...
                if (Neusoft.FrameWork.Function.NConvert.ToDecimal(this.ntxtPurchasePrice.Text) == this.curItem.PriceCollection.PurchasePrice / this.curItem.PackQty)
                {
        ...
        void ntxtPurchasePrice_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                decimal qty = Neusoft.FrameWork.Function.NConvert.ToDecimal(this.ntxtInputQty.Text);

                price = Neusoft.FrameWork.Function.NConvert.ToDecimal(this.ntxtPurchasePrice.Text);
        ...
        void ntxtRetailPrice_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                price = Neusoft.FrameWork.Function.NConvert.ToDecimal(ntxtRetailPrice.Text);
        ...
        void ntxtInputQty_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                qty = Neusoft.FrameWork.Function.NConvert.ToDecimal(this.ntxtInputQty.Text);

                decimal price = Neusoft.FrameWork.Function.NConvert.ToDecimal(ntxtRetailPrice.Text);
                decimal retailCost = price * qty;
                this.ntxtRetailCost.Text = retailCost.ToString("F" + this.costDecimals.ToString());
        ...
        Neusoft.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.Delegate.InputCompletedHander curInputCompletedEven;
        ...
        {
            int param = 1;
            this.settingFile = Neusoft.FrameWork.WinForms.Classes.Function.CurrentPath + "\\Profile\\PharmacyCommonInput.xml";
                ...
                foreach (Control c in this.ngbInputInfo.Controls)
                {
                    ...
                    if (c.Name == this.GetInputCompletedControlName())
                    {
                        ...
                        else
                        {
                            ...
                            {
                                ((Neusoft.FrameWork.WinForms.Controls.NeuTextBox)c).IsEnter2Tab = false;
                            }
                        }
                    }
                    if (c is TextBox)
        ...
        /// <returns>-1失败</returns>
        public int SetInputObject(Neusoft.HISFC.Models.Pharmacy.Item item, Neusoft.HISFC.Models.Pharmacy.Storage storage, bool isUseBatchNO, DateTime defaultValidDate)
        {
            if (item == null)
            {
                return -1;
            ...
            Neusoft.FrameWork.Models.NeuObject packUnit = new Neusoft.FrameWork.Models.NeuObject();
            packUnit.ID = "0";
            packUnit.Name = curItem.PackUnit;
            alUnit.Add(packUnit);
            if (curItem.PackQty > 1)
            {
                Neusoft.FrameWork.Models.NeuObject miniUnit = new Neusoft.FrameWork.Models.NeuObject();
                miniUnit.ID = "1";
        ...
        /// <param name="item">药品</param>
        /// <returns>-1失败</returns>
        public int SetInputObject(Neusoft.HISFC.Models.Pharmacy.Item item)
        {
        ...
        public int SetInputObject(Neusoft.HISFC.Models.Pharmacy.Input input, Neusoft.HISFC.Models.Pharmacy.Item item)
        {
            if (input == null)
            {
                return -1;
        ...
        /// </summary>
        /// <returns></returns>
        public Neusoft.HISFC.Models.Pharmacy.Input GetInputObject()
        {
            ...
            input.PurchaseCost = Neusoft.FrameWork.Function.NConvert.ToDecimal(input.PurchaseCost.ToString("F" + this.costDecimals.ToString()));
            ...
            input.RetailCost = Neusoft.FrameWork.Function.NConvert.ToDecimal(input.RetailCost.ToString("F" + this.costDecimals.ToString()));

            //批发金额
            input.WholeSaleCost = input.Item.PriceCollection.WholeSalePrice * (input.Quantity / input.Item.PackQty);
            input.WholeSaleCost = Neusoft.FrameWork.Function.NConvert.ToDecimal(input.WholeSaleCost.ToString("F" + this.costDecimals.ToString()));
        ...
        public Neusoft.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.Delegate.InputCompletedHander InputCompletedEven
        {
            get
            {
        ...
        private string AutoSaveCompany()
        {
            ...
            Neusoft.SOC.HISFC.BizLogic.Pharmacy.Constant phaConsManager = new Neusoft.SOC.HISFC.BizLogic.Pharmacy.Constant();

            string companyID = "";
            Neusoft.HISFC.Models.Pharmacy.Company com = new Neusoft.HISFC.Models.Pharmacy.Company();
            com.Name = this.ncmbProducer.Text;
            Neusoft.HISFC.Models.Base.Spell spCode = (Neusoft.HISFC.Models.Base.Spell)spellManager.Get(com.Name);
