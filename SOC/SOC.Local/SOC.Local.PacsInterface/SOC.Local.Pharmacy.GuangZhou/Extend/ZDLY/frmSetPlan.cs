...
namespace Neusoft.SOC.Local.Pharmacy.Extend.ZDLY
{
    ...
    public partial class frmSetPlan : Form
    {
        ...
        private Neusoft.HISFC.Models.Pharmacy.EnumDrugStencil curOpenType =  Neusoft.HISFC.Models.Pharmacy.EnumDrugStencil.Plan;
        ...
        public void Init(string deptNO, Neusoft.HISFC.Models.Pharmacy.EnumDrugStencil openType)
        {
        ...
        private void InitConstant()
        {
            ...
            ArrayList alDrugType = constantMgr.GetAllList(Neusoft.HISFC.Models.Base.EnumConstant.ITEMTYPE);
            if (alDrugType != null)
            {
            ...
            if (!string.IsNullOrEmpty(curPriveDept))
            {
                ...
                if (alDrugStencil != null)
                {
                    ...
                    foreach (Neusoft.HISFC.Models.Pharmacy.DrugStencil info in alDrugStencil)
                    {
        ...
        {
            string type = SOC.Public.XML.SettingFile.ReadSetting(Neusoft.FrameWork.WinForms.Classes.Function.CurrentPath + "\\Profile\\PharmacySetting.xml", "Plan", "CreateType", "0");
            try
            {
                CreatePlanType t = (CreatePlanType)(Neusoft.FrameWork.Function.NConvert.ToInt32(type));
        ...
        void nbtOK_Click(object sender, EventArgs e)
        {
            if (this.CheckValid())
            {
                if (this.SetCompletedEven != null)
                {
                    ...
                    SOC.Public.XML.SettingFile.SaveSetting(Neusoft.FrameWork.WinForms.Classes.Function.CurrentPath + "\\Profile\\PharmacySetting.xml", "Plan", "CreateType", ((int)type).ToString());
