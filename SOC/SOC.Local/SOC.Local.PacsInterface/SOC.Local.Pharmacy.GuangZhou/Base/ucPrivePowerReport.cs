...
{
    public partial class ucPrivePowerReport : Neusoft.SOC.Local.Pharmacy.Base.BaseReport
    {
        /// <summary>
        ...
        /// 自定义类别
        /// </summary>
        //private Neusoft.HISFC.Models.Pharmacy.EnumDrugStencil drugStencilType = Neusoft.HISFC.Models.Pharmacy.EnumDrugStencil.Common1;
        ...
        /// 单据类型
        /// </summary>
        //private Neusoft.HISFC.PharmacyInterface.BillType billType;

        /// <summary>
        /// 单据类型
        /// </summary>
        //[Category("扩展信息"), Description("单据类型"), Browsable(true)]
        //public Neusoft.HISFC.Integrate.PharmacyInterface.BillType BillType
        //{
        //    get { return billType; }
        //    set { billType = value; }
        //}
        ...
        //public Neusoft.HISFC.Models.Pharmacy.EnumDrugStencil DrugStencilType
        //{
        ...
        private void InitData()
        {
            ...
            Neusoft.SOC.HISFC.BizLogic.Pharmacy.Constant pconMgr = new Neusoft.SOC.HISFC.BizLogic.Pharmacy.Constant();
            try
            {
                List<Neusoft.HISFC.Models.Pharmacy.Item> alDrug = itemMgr.QueryItemList(true);
                System.Collections.ArrayList alObject = new System.Collections.ArrayList();
                foreach (Neusoft.HISFC.Models.Pharmacy.Item item in alDrug)
                {
                    Neusoft.HISFC.Models.Base.Spell neuObject = item as Neusoft.HISFC.Models.Base.Spell;
                ...
                this.ncmbDrugType.AddItems(conMgr.GetAllList(Neusoft.HISFC.Models.Base.EnumConstant.ITEMTYPE));
        ...
        public override int Print(object sender, object neuObject)
        {
            ...
            //            {
            //                case Neusoft.HISFC.Integrate.PharmacyInterface.BillType.Check:
            //                    Neusoft.HISFC.BizLogic.Manager.Department deptMgr = new Neusoft.HISFC.BizLogic.Manager.Department();
            //                    Neusoft.HISFC.Models.Base.Department d = deptMgr.GetDeptmentById(this.cmbDept.Tag.ToString());
            ...
            //                    }
            //                    break;
            //                case Neusoft.HISFC.Integrate.PharmacyInterface.BillType.Input:
            //                    alPrintData = itemMgr.QueryInputInfoByListID(this.cmbDept.Tag.ToString(), billNO, "AAAA", "AAAA");
            //                    break;
            //                case Neusoft.HISFC.Integrate.PharmacyInterface.BillType.Output:
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (this.cmbDept.alItems != null && this.cmbDept.alItems.Count > 0)
            {
                ...
                this.cmbDept.Tag = (this.cmbDept.alItems[0] as Neusoft.FrameWork.Models.NeuObject).ID;
            }
        ...
        //    try
        //    {
        //        this.dtStart.Value = Neusoft.FrameWork.Function.NConvert.ToDateTime(times[0].Trim());
        //        this.dtEnd.Value = Neusoft.FrameWork.Function.NConvert.ToDateTime(times[1].Trim());
        //    }
        //    catch (Exception ex)
        //    {
