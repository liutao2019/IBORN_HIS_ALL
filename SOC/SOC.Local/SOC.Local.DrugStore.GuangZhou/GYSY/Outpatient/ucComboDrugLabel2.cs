...
namespace FS.SOC.Local.DrugStore.GuangZhou.GYSY.Outpatient
{
    public partial class ucComboDrugLabel2 : UserControl
    {
        ...
        public int PrintDrugLabel(System.Collections.ArrayList alData, FS.HISFC.Models.Pharmacy.DrugRecipe drugRecipe, FS.HISFC.Models.Pharmacy.DrugTerminal drugTerminal, bool isPrintRegularName, string hospitalName, bool isPrintMemo, string qtyShowType, DateTime printTime, string pageNO)
        {
            ...
            this.Clear();
            this.lblClinicNo.Text = drugRecipe.CardNO;// drugRecipe.ClinicNO;
            ...
            FS.HISFC.Models.Pharmacy.Item item1 = SOC.HISFC.BizProcess.Cache.Pharmacy.GetItem(applyOut.Item.ID);
            if (ctrlIntegrate.GetControlParam<bool>("HNPHA2", false, true))
            {
                this.nlbDrugInfo1.Text = item1.NameCollection.RegularName;
            }
            else
            {
                this.nlbDrugInfo1.Text = item1.Name;
            }
            ...
            FS.HISFC.Models.Pharmacy.Item item2 = SOC.HISFC.BizProcess.Cache.Pharmacy.GetItem(applyOut.Item.ID);
            if (ctrlIntegrate.GetControlParam<bool>("HNPHA2", false, true))
            {
                this.nlbDrugInfo2.Text = item2.NameCollection.RegularName;
            }
            else
            {
                this.nlbDrugInfo2.Text = item2.Name;
            }
            ...
            order = SOC.Local.DrugStore.GuangZhou.Common.Function.GetOrder(applyOut.OrderNO);
            if (order != null)
            {
                switch ((Int32)order.HypoTest)
                {
            ...
            FS.HISFC.Models.Pharmacy.Item item3 = SOC.HISFC.BizProcess.Cache.Pharmacy.GetItem(applyOut.Item.ID);
            if (ctrlIntegrate.GetControlParam<bool>("HNPHA2", false, true))
            {
                this.nlbDrugInfo3.Text = item3.NameCollection.RegularName;
            }
            else
            {
                this.nlbDrugInfo3.Text = item3.Name;
            }
            ...
            FS.HISFC.Models.Pharmacy.Item item4 = SOC.HISFC.BizProcess.Cache.Pharmacy.GetItem(applyOut.Item.ID);
            if (ctrlIntegrate.GetControlParam<bool>("HNPHA2", false, true))
            {
                this.nlbDrugInfo4.Text = item4.NameCollection.RegularName;
            }
            else
            {
                this.nlbDrugInfo4.Text = item4.Name;
            }
