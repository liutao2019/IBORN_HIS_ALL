...
namespace FS.SOC.Local.DrugStore.GuangZhou.ZDLY.Inpatient
{
    ...
    public partial class ucInpatientRecipe : UserControl, FS.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.IInpatientBill
    {
        ...
        private void ShowDetailData(ArrayList alData, FS.HISFC.Models.Pharmacy.DrugBillClass drugBillClass, FS.FrameWork.Models.NeuObject stockDept)
        {
            ...
            FS.SOC.Local.DrugStore.GuangZhou.ZDLY.Outpatient.PrintInterfaceImplement diagMgr = new FS.SOC.Local.DrugStore.GuangZhou.ZDLY.Outpatient.PrintInterfaceImplement();
            ...
            foreach (FS.HISFC.Models.Pharmacy.ApplyOut info in alData)
            {
                ...
                if (patient == null || string.IsNullOrEmpty(patient.ID))
                {
                    ...
                    //病案号
                    this.lbPationNO.Text = "住院号：" + patient.PID.PatientNO;
                    //病人姓名
                    ...
                    this.npbBarCode.Image = FS.SOC.Local.DrugStore.GuangZhou.Common.Function.CreateBarCode(patient.PID.PatientNO, this.npbBarCode.Width, this.npbBarCode.Height);
                }
