...
namespace FS.SOC.Local.DrugStore.GuangZhou.GYZL.Inpatient
{
    ...
    public partial class ucTotalDrugBill : UserControl, FS.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.IInpatientBill
    {
        ...
        private void ShowBillTotData(System.Collections.ArrayList alData, FS.HISFC.Models.Pharmacy.DrugBillClass drugBillClass, FS.FrameWork.Models.NeuObject stockDept)
        {
            ...
            this.nlbTitle.Text = drugBillClass.Name + "(汇总)";
            ...
            foreach (FS.HISFC.Models.Pharmacy.ApplyOut info in alData)
            {
                ...
                this.neuSpread1.SetCellValue(0, iRow, "零售金额", FS.FrameWork.Public.String.FormatNumberReturnString(info.Item.PriceCollection.RetailPrice * (info.Operation.ApplyQty / info.Item.PackQty),2));
                ...
                this.neuSpread1.SetCellValue(0, iRow, "数量", info.Operation.ApplyQty.ToString("F4").TrimEnd('0').TrimEnd('.'));
                this.neuSpread1.SetCellValue(0, iRow, "单位", info.Item.MinUnit); 
                ...
                if (this.neuSpread1_Sheet1.Rows.Count > 0)
                {
                    ...
                    for (int pageNO = totPageNO; pageNO > 0; pageNO--)
                    {
                        ...
                        if (pageNO == totPageNO)
                        {
                            ...
                            this.neuSpread1_Sheet1.Cells[index, 0].Font = new Font("楷体", 12f);
        ...
        public void Print()
        {
            ...
            if (pageSize == null)
            {
                pageSize = pageSizeMgr.GetPageSize("InPatientDrugBillT");
                ...
                if (pageSize == null)
                {
                    pageSize = new FS.HISFC.Models.Base.PageSize("InPatientDrugBillT", 800, 1100);
                }
            }
