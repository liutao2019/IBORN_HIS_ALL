...
namespace FS.SOC.Local.DrugStore.GuangZhou.GYZL.Inpatient
{
    ...
    public partial class ucHerbalDrugBill : UserControl, FS.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.IInpatientBill
    {
        ...
        private void SetFormat()
        {
            ...
            this.neuSpread1_Sheet1.Columns[(int)ColSet.ColQty1].Width = 60F;
            ...
            this.neuSpread1_Sheet1.Columns[(int)ColSet.ColQty2].Width = 60F;
            ...
            this.neuSpread1_Sheet1.Columns[(int)ColSet.ColSpeUsage2].Width = 90F;
        ...
        private void ShowDetailData(ArrayList alData, FS.HISFC.Models.Pharmacy.DrugBillClass drugBillClass, FS.FrameWork.Models.NeuObject stockDept)
        {
            ...
            foreach (FS.HISFC.Models.Pharmacy.ApplyOut info in alData)
            {
                ...
                if (iCol == 0)
                {
                    ...
                    this.neuSpread1_Sheet1.Cells[iRow, (int)ColSet.ColCost1].Value = (info.Operation.ApplyQty / info.Item.PackQty * info.Item.PriceCollection.RetailPrice).ToString("F2");
                ...
                else
                {
                    ...
                    this.neuSpread1_Sheet1.Cells[iRow, (int)ColSet.ColCost2].Value = (info.Operation.ApplyQty  / info.Item.PackQty * info.Item.PriceCollection.RetailPrice).ToString("F2");
            ...
            this.neuSpread1_Sheet1.Cells[iRow, 0].Border = new FarPoint.Win.LineBorder(System.Drawing.Color.Black, 2, false, true, false, false);
            this.neuSpread1_Sheet1.Cells[iRow, 0].Text = string.Format("配方人：             核方人：              金额合计：{0}", drugListTotalPrice);
