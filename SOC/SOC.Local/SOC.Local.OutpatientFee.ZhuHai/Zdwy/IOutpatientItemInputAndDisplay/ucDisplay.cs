...
namespace FS.SOC.Local.OutpatientFee.ZhuHai.Zdwy.IOutpatientItemInputAndDisplay
{
    public partial class ucDisplay : UserControl, FS.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientItemInputAndDisplay, FS.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        ...
        /// 是否用折后价格
        /// </summary>
        private bool isOriginalCost = false;
        ...
        FS.HISFC.BizProcess.Interface.Fee.ITruncFee myITruncFee = null;
        ...
        public string IsFeeWhenPriceZero
        {
            get
            {
                ...
                {
                    this.isFeeWhenPriceZero = this.controlParamIntegrate.GetControlParam<string>("FEE001", false, "0");
                }
        ...
        private enum Columns
        {
            ...
            /// <summary>
            /// 处方号
            /// {D0E78E29-2AD7-448f-9AFE-4B4FE0BD8941}
            /// </summary>
            OrderNo = 12,
            ...
            //{8C32B0DF-5382-4157-836B-67AA51C631F1}
            /// <summary>
            /// 优惠
            /// </summary>
            EcoCost = 21,
        ...
        protected int InitControlParams()
        {
            ...
            //是否使用折后价格（套包）
            this.isOriginalCost = this.controlParamIntegrate.GetControlParam<bool>("GZSI03", false, false);
        ...
        private void SetChargeInfo()
        {
            ...
            foreach (FeeItemList f in alChargeInfo)
            {
                ...
                // f.IsPackage = "1";//{F563C1E0-56EE-4126-9E0E-DD79869A9E5F}
                //{BD46CBA6-A670-40cf-A1FD-EAFBC9797D04}
                this.fpSpread1_Sheet1.Cells[currRow, (int)Columns.PackageFlag].Text = f.IsPackage == "1" ? "true" : "false";
                ...
                //{D0E78E29-2AD7-448f-9AFE-4B4FE0BD8941}
                this.fpSpread1_Sheet1.Cells[currRow, (int)Columns.OrderNo].Text = f.RecipeNO;
                if (freqDisplayType == "0")//汉字
                {
                ...
                //{8C32B0DF-5382-4157-836B-67AA51C631F1}
                this.fpSpread1_Sheet1.Cells[currRow, (int)Columns.EcoCost].Value = f.FT.RebateCost;
                ...
                if (!string.IsNullOrEmpty(f.CheckBodyPackage))
                {
                    ...
                    if (this.fpSpread1_Sheet1.Rows[i].Tag != null && this.fpSpread1_Sheet1.Rows[i].Tag is FeeItemList)
                    {
                        ...
                        if (feeItem.FTSource == "0" || feeItem.Item.IsMaterial)//自己批费,可以随便修改
                        {
                            ...
                            if (feeItem.Item.ItemType == EnumItemType.Drug)
                            {
                                ...
                                //{BD46CBA6-A670-40cf-A1FD-EAFBC9797D04}
                                this.fpSpread1_Sheet1.Cells[i, (int)Columns.PackageFlag].Locked = false;
                        ...
                        else//不是自己批费,不可以修改除了院注次数的任何信息
                        {
                            ...
                            for (int j = 0; j < this.fpSpread1_Sheet1.Columns.Count; j++)
                            {
                                ...
                                //{BD46CBA6-A670-40cf-A1FD-EAFBC9797D04}
                                else if (j == (int)Columns.PackageFlag)
                                {
                                    this.fpSpread1_Sheet1.Cells[i, j].Locked = false;
                                }
                                else
            ...
            //{4007AD8C-65AE-4962-95F6-AC1907A07553}添加体检套餐组套
        ...
        private void SetItem(string itemCode, string drugFlag, string exeDeptCode, int row, decimal amount, decimal saleprice, string unitFlag)
        {
            ...
            if (findRow != null)
            {
                ...
                if (drugFlag == "1")
                {
                    ...
                    FS.FrameWork.Models.NeuObject dept = this.managerIntegrate.GetDepartment(exeDept);
                ...
                try
                {
                    if (this.rInfo != null)
                    {
                        ...
                        //{6CBD45BC-F6C7-4ae0-A338-2E251423B418}
                        if (this.SIFEEPACT.Contains(this.rInfo.Pact.PayKind.ID) && !this.isDirectSIFEE)
                        {
                            price = unitPrice;
                        }

                        feeItemList.SIPrice = NConvert.ToDecimal(findRow["SP_PRICE"]);

                        if (feeItemList.SIPrice == 0)
                        {
                            feeItemList.SIPrice = unitPrice;
                        }
        ...
        private FS.HISFC.Models.Base.FT ComputCost(decimal price, decimal qty, FeeItemList f)
        {
            ...
            //{6CBD45BC-F6C7-4ae0-A338-2E251423B418}
            FS.HISFC.Models.Base.FT sift = new FS.HISFC.Models.Base.FT();
            ...
            if (this.rInfo.Pact.PayKind.ID == "01")//自费
            {
                ...
                if (myITruncFee != null)
                {
                    ...
                    ft.TotCost = ((FS.HISFC.Models.Base.FT)(myITruncFee.TruncFee(args))[0]).TotCost;
                }
                else
                {
                ...
                {
                    object[] args = new object[] { ft, f };
                    ft.RebateCost = ((FS.HISFC.Models.Base.FT)(myITruncFee.TruncFee(args))[0]).RebateCost;
                }
                else
                {
                    //add by Niuxy修改减免  
            ...
            if (this.rInfo.Pact.PayKind.ID == "02")//医保
            {
                ...
                //{6CBD45BC-F6C7-4ae0-A338-2E251423B418}
                FeeItemList sif = new FeeItemList();
                sif.Item = f.Item.Clone();
                sif.FT = f.FT.Clone();
                sif.Item.Price = f.SIPrice;
                ...
                if (myITruncFee != null)
                {
                    ...
                    //{6CBD45BC-F6C7-4ae0-A338-2E251423B418}
                    object[] argssi = new object[] { f.SIft, sif };
                    sift.TotCost = ((FS.HISFC.Models.Base.FT)(myITruncFee.TruncFee(argssi))[0]).TotCost;
                ...
                else
                {
                    ...
                    //{6CBD45BC-F6C7-4ae0-A338-2E251423B418}
                    sift.TotCost = FS.FrameWork.Public.String.FormatNumber(sif.Item.Price * f.Item.Qty / f.Item.PackQty, 2);
                }
        ...
        private ArrayList ConvertGroupToDetail(FeeItemList f)
        {
            ...
            //{47C91D28-5107-4abd-B0E8-5DE2F53BA1F8}
            ...
            foreach (FS.HISFC.Models.Fee.Item.UndrugComb undrugCombo in undrugCombList)
            {
                ...
                try
                {
                    ...
                    //{6CBD45BC-F6C7-4ae0-A338-2E251423B418}
                    if (this.SIFEEPACT.Contains(this.rInfo.Pact.PayKind.ID) && !this.isDirectSIFEE && !this.isOriginalCost)
                    {
                        price = unitPrice;
                    }

                    feeDetail.SIPrice = SPPrice;

                    if (feeDetail.SIPrice == 0)
                    {
                        feeDetail.SIPrice = price;
                    }
                ...
                //{6CBD45BC-F6C7-4ae0-A338-2E251423B418}
                totSICost = FS.FrameWork.Public.String.FormatNumber(feeDetail.SIPrice * count, 2);

                //{BD46CBA6-A670-40cf-A1FD-EAFBC9797D04}
                feeDetail.IsPackage = f.IsPackage;
                ...
                //{6CBD45BC-F6C7-4ae0-A338-2E251423B418}
                feeDetail.SIft.TotCost = totSICost;
                feeDetail.SIft.OwnCost = totSICost;
                ...
                //{91D9D0F1-9155-415f-BB5B-83E32396DBFE}
                feeDetail.DoctDeptInfo.ID = f.DoctDeptInfo.ID;
                feeDetail.RecipeNO = f.RecipeNO;
                //{f0190940-21f4-46af-8587-c09ca3a63fa8} 收费超过十条时会出问题
                feeDetail.SequenceNO = f.SequenceNO * 100 + undrugCombo.SortID + num;
                num++;
            ...
            if (alTemp.Count > 0)
            {
                if (f.FT.RebateCost > 0)  //所有合同单位都允许有减免
                {
                    ...
                    //减免单独算
                    decimal rebateRate = FS.FrameWork.Public.String.FormatNumber(f.FT.RebateCost / f.FT.OwnCost, 2);
                    decimal tempFix = 0;
                    decimal tempRebateCost = 0;
                    foreach (FeeItemList feeTemp in alTemp)
                    {
        ...
        public int Init()
        {
            ...
            myITruncFee = (FS.HISFC.BizProcess.Interface.Fee.ITruncFee)FS.HISFC.BizProcess.Interface.Fee.InterfaceManager.GetTruncFeeType();
        ...
        protected void chooseItemControl_SelectedItem(string itemCode, string drugFlag, string exeDeptCode, decimal price)
        {
            ...
            if (drugFlag == "2")
            {
                ...
                if (classCode == "UC" || classCode == "UT")   //检查和其他，才允许选择复合明细
                {
                    ...
                    FS.HISFC.Components.Common.Forms.frmChoseItemCommon frmChoseItem = new FS.HISFC.Components.Common.Forms.frmChoseItemCommon();
                    ...
                    if (frmChoseItem.DialogResult == System.Windows.Forms.DialogResult.OK)
                    {
                        ...
                        foreach (FS.HISFC.Models.Base.Item undrug in alSubItems)
                        {
                            //添加明细
        ...
        public ArrayList GetFeeItemList()
        {
            ...
            for (int i = 0; i < this.fpSpread1_Sheet1.RowCount; i++)
            {
                ...
                if (this.fpSpread1_Sheet1.Rows[i].Tag is FeeItemList)
                {
                    ...
                    FeeItemList oldF = outpatientManager.GetFeeItemList(f.RecipeNO, f.SequenceNO);
                    //{858E26D5-DC32-440B-A6DB-5868B33671D6} 为体检设置属性
                    if (oldF != null)
                    {
                        f.Item.Name = oldF.Item.Name;
                        f.MedicalGroupCode.ID = oldF.MedicalGroupCode.ID;
                        f.Item.SpecialFlag1 = oldF.Item.SpecialFlag1;
                        if (f.Item.SpecialFlag1 == "1" || f.Item.SpecialFlag1 == "2") f.NoBackQty = 1;
                    }
                    //858E26D5-DC32-440B-A6DB-5868B33671D6 新增项目开立科室容易丢掉，则重新设置
                    if (!string.IsNullOrEmpty(f.RecipeOper.ID)) doctId = f.RecipeOper.ID;
                    else
                    {
                        if (rInfo != null)
                        {
                            doctId = this.rInfo.DoctorInfo.Templet.Doct.ID;
                            deptId = this.rInfo.DoctorInfo.Templet.Dept.ID;
                        }
                    }
                    if (!string.IsNullOrEmpty(f.DoctDeptInfo.ID))
                    {
                        deptId = f.DoctDeptInfo.ID;
                    }
                    else
                    {
                        if (rInfo != null)
                    ...
                    {
                        //LogHelper.Write("挂号信息:" + rInfo.Name + " " + rInfo.DoctorInfo.Templet.Dept.ID + "  项目信息:"+f.Item .Name);
                        f.RecipeOper.ID = doctId;
                        f.DoctDeptInfo.ID = deptId;
                    ...
                    if (string.IsNullOrEmpty(f.RecipeOper.ID) || string.IsNullOrEmpty(f.DoctDeptInfo.ID))
                    {
                        if (rInfo != null)
                        {
                            f.RecipeOper.ID = this.rInfo.DoctorInfo.Templet.Doct.ID;
                            f.DoctDeptInfo.ID = this.rInfo.DoctorInfo.Templet.Dept.ID;
                            // LogHelper.Write("挂号信息:" +rInfo.Name+" "+ rInfo.DoctorInfo.Templet.Dept.ID+"  ");
                        }
                    }
                    ...
                    if (f.IsGroup)
                    {
                        ...
                        if (f.Item.SpecialFlag1 == "1")
                        {
                            foreach (var item in alDetail)
                            {
                                (item as FeeItemList).Item.SpecialFlag1 = f.Item.SpecialFlag1;
        ...
        /// </summary>
        /// <returns></returns>
        public ArrayList GetFeeItemList(int rowIndex)
        {
            ArrayList feeItemLists = new ArrayList();
            Hashtable hsDoct = new Hashtable();
        ...
        public void SetColumnEnable(int row)
        {
            ...
            {
                //{BD46CBA6-A670-40cf-A1FD-EAFBC9797D04}
                if (j == (int)Columns.InputCode || j == (int)Columns.Select || j == (int)Columns.PackageFlag || j == (int)Columns.MachineNO)
                {
        ...
        private void fpSpread1_CellClick(object sender, CellClickEventArgs e)
        {
            ...
            {
                this.fpSpread1_Sheet1.SetActiveCell(e.Row, (int)Columns.InputCode);
            }
        }
        ...
        private void fpSpread1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Right)
            {
                ...
                mnuItemPackageCancel.Click += new EventHandler(反选ToolStripMenuItem_Click);
                mnuItemPackageCancel.Text = "套餐反选";
                this.rightMenu.Items.Add(mnuItemPackageCancel);

                //3、单项目折扣
                ToolStripMenuItem mnuItemDiscount = new ToolStripMenuItem();
                mnuItemDiscount.Click += new EventHandler(mnuItemDiscount_Click);
                mnuItemDiscount.Text = "单项目折扣";
                this.rightMenu.Items.Add(mnuItemDiscount);

                //4、处方项目折扣
                ToolStripMenuItem mnuAllDiscount = new ToolStripMenuItem();
                mnuAllDiscount.Click += new EventHandler(mnuAllDiscount_Click);
                mnuAllDiscount.Text = "处方项目折扣";
                this.rightMenu.Items.Add(mnuAllDiscount);

                //5、套餐项目折扣
                ToolStripMenuItem mnuPackageItemDiscount = new ToolStripMenuItem();
                mnuPackageItemDiscount.Click += new EventHandler(mnuPackageItemDiscount_Click);
                mnuPackageItemDiscount.Text = "套餐项目折扣";
                this.rightMenu.Items.Add(mnuPackageItemDiscount);

                //6、套餐项目勾选{D1E043F1-B598-4B8E-BEFB-8B4C48E56AB3}
                ToolStripMenuItem mnuPackageItemoption = new ToolStripMenuItem();
                mnuPackageItemoption.Click += new EventHandler(套餐内项目勾选ToolStripMenuItem_Click);
                mnuPackageItemoption.Text = "套餐项目勾选";
                this.rightMenu.Items.Add(mnuPackageItemoption);

                //7
                ToolStripMenuItem mnuFamilyPackageItemoption = new ToolStripMenuItem();
                mnuFamilyPackageItemoption.Click += new EventHandler(家庭套餐内项目勾选ToolStripMenuItem_Click);
                mnuFamilyPackageItemoption.Text = "家庭套餐项目勾选";
                this.rightMenu.Items.Add(mnuFamilyPackageItemoption);



                //项目折0
                ToolStripMenuItem mnuSpecialPackageItemoption = new ToolStripMenuItem();
                mnuSpecialPackageItemoption.Click += new EventHandler(mnuSpecialPackageItemoption_Click);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void mnuItemDiscount_Click(object sender, EventArgs e)
        {
            if (this.fpSpread1_Sheet1.ActiveRow == null || this.fpSpread1_Sheet1.ActiveRowIndex < 0)
            {
                return;
            }
            ...
            //获得所有项目信息,包括组合项目的明细
            ArrayList alFee = this.GetFeeItemList(rowIndex);
            ...
            if (frmDisc.Init())
            {
                frmDisc.ShowDialog();
                //{8C32B0DF-5382-4157-836B-67AA51C631F1}
                this.fpSpread1_Sheet1.Cells[rowIndex, (int)Columns.EcoCost].Value = ((FeeItemList)alFee[0]).FT.RebateCost;
                (this.fpSpread1_Sheet1.Rows[rowIndex].Tag as FeeItemList).FT.RebateCost = ((FeeItemList)alFee[0]).FT.RebateCost;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void mnuAllDiscount_Click(object sender, EventArgs e)
        {
            //获得所有项目信息,包括组合项目的明细
            ...
            if (frmDisc.Init())
            {
                ...
                foreach (Row row in this.fpSpread1_Sheet1.Rows)
                {
                    ...
                    this.fpSpread1_Sheet1.Cells[row.Index, (int)Columns.EcoCost].Value = tmp.FT.RebateCost;
                }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void mnuPackageItemDiscount_Click(object sender, EventArgs e)
        {
            //获得所有项目信息,包括组合项目的明细
            ArrayList alFee = this.GetFeeItemList(-1);
            if (alFee == null || alFee.Count <= 0)
            ...
            ArrayList alPackageFee = new ArrayList();
            foreach (FS.HISFC.Models.Fee.Outpatient.FeeItemList feeItemList in alFee)
            {
                if (feeItemList.IsPackage == "1")
                {
                    alPackageFee.Add(feeItemList);
                }
            }

            if (alPackageFee.Count <= 0)
            {
                MessageBox.Show("无套餐内项目！");
                return;
            }

            frmDiscount frmDisc = new frmDiscount();
            frmDisc.AlFeeItemList = alPackageFee;
            frmDisc.RateType = 1;
        ...
        private void fpSpread1_ButtonClicked(object sender, EditorNotifyEventArgs e)
        {
            ...
            //{BD46CBA6-A670-40cf-A1FD-EAFBC9797D04}
            if (e.Column == (int)Columns.PackageFlag)
            {
                this.SetSameCombPackage(e);
                this.SumCost();
            }
        }

        //{BD46CBA6-A670-40cf-A1FD-EAFBC9797D04}
        private void SetSameCombPackage(EditorNotifyEventArgs e)
        {
            if (this.fpSpread1_Sheet1.Rows[e.Row].Tag == null)
            {
                return;
            ...
            //{BD46CBA6-A670-40cf-A1FD-EAFBC9797D04}
            ((FS.HISFC.Models.Fee.Outpatient.FeeItemList)this.fpSpread1_Sheet1.Rows[e.Row].Tag).IsPackage = this.fpSpread1_Sheet1.Cells[e.Row, (int)Columns.PackageFlag].Text.ToLower() == "false" ? "0" : "1";
            ...
            for (int i = 0; i < this.fpSpread1_Sheet1.RowCount; i++)
            {
                ...
                {
                    this.fpSpread1_Sheet1.Cells[i, (int)Columns.PackageFlag].Value = this.fpSpread1_Sheet1.Cells[e.Row, (int)Columns.PackageFlag].Value;
                    //{BD46CBA6-A670-40cf-A1FD-EAFBC9797D04}
                    ((FS.HISFC.Models.Fee.Outpatient.FeeItemList)this.fpSpread1_Sheet1.Rows[i].Tag).IsPackage = this.fpSpread1_Sheet1.Cells[e.Row, (int)Columns.PackageFlag].Text.ToLower() == "false" ? "0" : "1";
                }
            }
        }
        ...
        /// <summary>
        /// 套餐全选{15E1CDD6-FBA9-4d93-8204-0BC788EBC265}
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void 全选ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            foreach (Row row in fpSpread1_Sheet1.Rows)
            {
                FeeItemList rowFee = row.Tag as FeeItemList;
                if (rowFee != null)
                    rowFee.IsPackage = "1";
                fpSpread1_Sheet1.Cells[row.Index, (int)Columns.PackageFlag].Text = "true";
            }
        }

        /// <summary>
        /// 套餐反选{15E1CDD6-FBA9-4d93-8204-0BC788EBC265}
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void 反选ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            foreach (Row row in fpSpread1_Sheet1.Rows)
            {
                ...
                if (rowFee != null)
                    rowFee.IsPackage = "0";
                fpSpread1_Sheet1.Cells[row.Index, (int)Columns.PackageFlag].Text = "false";
            }
        }

        /// <summary>
        /// {D1E043F1-B598-4B8E-BEFB-8B4C48E56AB3} 门诊套餐结算改造
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void 套餐内项目勾选ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string card_no = this.PatientInfo.PID.CardNO;
            FS.HISFC.BizLogic.MedicalPackage.Fee.PackageDetail bll = new FS.HISFC.BizLogic.MedicalPackage.Fee.PackageDetail();
            ArrayList packageList = bll.QueryDetailByCardNO(card_no);
            //bll.
            if (packageList.Count > 0)
            {
                //ArrayList arr = GetFeeItemList();
                foreach (Row row in fpSpread1_Sheet1.Rows)
                {
                    FeeItemList rowFee = row.Tag as FeeItemList;
                    if (rowFee == null) continue;
                    foreach (var packageItem in packageList)
                    {
                        FS.HISFC.Models.MedicalPackage.Fee.PackageDetail model = packageItem as FS.HISFC.Models.MedicalPackage.Fee.PackageDetail;
                        if (model.Item.ID == rowFee.Item.ID)
                        {
                            fpSpread1_Sheet1.Cells[row.Index, (int)Columns.PackageFlag].Text = "true";
                            rowFee.IsPackage = "1";
                            break;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void 家庭套餐内项目勾选ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string card_no = this.PatientInfo.PID.CardNO;
            FS.HISFC.BizLogic.MedicalPackage.Fee.PackageDetail bll = new FS.HISFC.BizLogic.MedicalPackage.Fee.PackageDetail();
            ArrayList packageList = bll.QueryFamilyPackageDetailByCardNO(card_no);
            //bll.
            if (packageList.Count > 0)
            {
                //ArrayList arr = GetFeeItemList();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void mnuSpecialPackageItemoption_Click(object sender, EventArgs e)
        {
            string card_no = this.PatientInfo.PID.CardNO;
            FS.HISFC.BizLogic.MedicalPackage.Fee.PackageDetail bll = new FS.HISFC.BizLogic.MedicalPackage.Fee.PackageDetail();

            string packageList = bll.QueryPackageDetailItemZeroByCardNO(card_no);
            ...
            if (!string.IsNullOrEmpty(packageList))
            {
                ...
                foreach (Row row in fpSpread1_Sheet1.Rows)
                {
                    ...
                    if (packageList.Contains(rowFee.Item.ID) && rowFee.IsPackage != "1")
                    {
                        conszero = true;
                        this.fpSpread1_Sheet1.Cells[row.Index, (int)Columns.EcoCost].Value = rowFee.FT.TotCost;
                        rowFee.FT.RebateCost = rowFee.FT.TotCost;
                    }
