...
namespace FS.SOC.Local.OutpatientFee.ZhuHai.Zdwy.IMultiScreen
{
    public partial class frmMiltScreen : Form, FS.HISFC.BizProcess.Interface.FeeInterface.IMultiScreen
    {
            ...
            params string[] otherInfomations)
        {
            ...
            if (feeItemLists == null)// || feeItemLists.Count <= 0)
            {
                ...
                //this.Clear();
                this.lblPaient.Text = patient.Name;
                this.lblPaientInfo.Text = "正在划价交费，请稍后";
            }
            ...
            if (ft != null)
            {
                ...
                this.lblPaient.Text = patient.Name;
                this.lblPaientInfo.Text = "应缴金额为 " + ownpay.ToString("F4").TrimEnd('0').TrimEnd('.') + " 元";
            }
