...
namespace FS.SOC.Local.GYZL.PubReport.Components
{
    public partial class ucTrusteeBill : UserControl, FS.FrameWork.WinForms.Classes.IControlPrintable
    {
        ...
        public void SetData(FS.HISFC.Models.RADT.PatientInfo pinfo, FS.SOC.Local.GYZL.PubReport.Models.PubReport report)
        {
            //设置患者信息
            ...
            SetFee(report.YaoPin - report.SpDrugFeeTot, "西药", ref i);
