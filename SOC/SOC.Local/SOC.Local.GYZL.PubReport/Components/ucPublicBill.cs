...
namespace FS.SOC.Local.GYZL.PubReport.Components
{
    public partial class ucPublicBill : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        FS.SOC.Local.GYZL.PubReport.BizLogic.PubReport myReport = new FS.SOC.Local.GYZL.PubReport.BizLogic.PubReport();
        ...
        public int SetStaticPatients(string flag, string inState, string inpatientNo)
        {
            ...
            FS.SOC.Local.GYZL.PubReport.Models.PubReport report = null; //托收单实体
            ...
            foreach (FS.HISFC.Models.RADT.PatientInfo p in alPatient)
            {
                ...
                if (isExist)//患者在此期间已经存在托收信息
                {
                  ...
                  //  report = myReport.GetPubReport(p.ID, dtEnd.Date.ToString());
                    report = myReport.GetPubReportExt(p.ID, dtEnd.ToString());
        ...
        public int Modify()
        {
            ...
            DateTime dtBegin = this.dtpBegin.Value;
            DateTime dtEnd = this.dtpEnd.Value;
            FS.SOC.Local.GYZL.PubReport.Models.PubReport report = null;

            if (this.fpSpread1_Sheet1.Cells[this.fpSpread1_Sheet1.ActiveRowIndex, 0].Tag != null)
            {
                report = myReport.GetPubReport(p.ID, ((FS.SOC.Local.GYZL.PubReport.Models.PubReport)this.fpSpread1_Sheet1.Cells[this.fpSpread1_Sheet1.ActiveRowIndex, 0].Tag).Static_Month.Date.ToString());
            }
            else
            {
                report = myReport.GetPubReport(p.ID, dtEnd.Date.ToString());
        ...
        public int Delete()
        {
            ...
            //			FS.SOC.Local.GYZL.PubReport.Models.PubReport report = myReport.GetPubReport(p.ID, this.dtpEnd.Value.Date.ToString());
            //			if(report == null)
            //			{
            //				t.RollBack();
            ...
            {
                FS.SOC.Local.GYZL.PubReport.Models.PubReport reportTemp = (FS.SOC.Local.GYZL.PubReport.Models.PubReport)(this.fpSpread1_Sheet1.Cells[row, 0].Tag);
        ...
        public void Init()
        {
            try
            {
                ...
                FS.SOC.Local.GYZL.PubReport.BizLogic.PubReport report = new FS.SOC.Local.GYZL.PubReport.BizLogic.PubReport();
        ...
        private int SetPatientInfo(FS.HISFC.Models.RADT.PatientInfo p, FS.SOC.Local.GYZL.PubReport.Models.PubReport report, bool isSelect,
        ...
        private void tbQuery_Click(object sender, System.EventArgs e)
        {
            ...
            foreach (FS.SOC.Local.GYZL.PubReport.Models.PubReport rep in alReport)
            {
