...
namespace FS.SOC.Local.Account.GuangZhou.Zdly.OpenCard
{
    ...
    /// 合同单位选择
    /// </summary>
    public partial class ucPactSelect : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public delegate void CheckedNode(FS.HISFC.Models.Base.PactInfo obj);
        ...
        void tvSelected_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (e.KeyCode == Keys.Enter)
            {
                if (tvUnselected.Focused)
                {
                    ...
                    {
                        this.AddSelected(this.tvUnselected.SelectedNode.Tag as FS.HISFC.Models.Base.PactInfo,true);
                    }
                }
        ...
        void tvSelected_AfterCheck(object sender, TreeViewEventArgs e)
        {
            if (e.Node.Checked)
            {
                ...
                {
                    CheckedNodeEvent(e.Node.Tag as FS.HISFC.Models.Base.PactInfo);
                }
            }
        }
        ...
        void tvUnselected_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (node != null)
            {
                ...
                this.AddSelected(node.Tag as FS.HISFC.Models.Base.PactInfo,true);
            }
        }
        ...
        void tvSelected_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (node != null)
            {
                ...
                this.AddNoSelect(node.Tag as FS.HISFC.Models.Base.PactInfo);
            }
        }
        ...
        public void Clear()
        {
            ...
            {
                this.AddNoSelect(this.tvSelected.Nodes[i].Tag as FS.HISFC.Models.Base.PactInfo);
            }
        ...
        public void ClearSelected()
        {
            for (int i = 0; i < this.tvSelected.Nodes.Count; i++)
            {
                if (selectedList != null && selectedList.Contains(this.tvSelected.Nodes[i].Tag as FS.HISFC.Models.Base.PactInfo))
                {
                    continue;
                }
                this.AddNoSelect(this.tvSelected.Nodes[i].Tag as FS.HISFC.Models.Base.PactInfo);
        ...
        public void AddNoSelect(FS.HISFC.Models.Base.PactInfo obj)
        {
        ...
        public void AddSelected(FS.HISFC.Models.Base.PactInfo obj,bool isCheck)
        {
            if (obj == null||string.IsNullOrEmpty(obj.ID))
            {
                return;
        ...
        public FS.HISFC.Models.Base.PactInfo SelectedDefault
        {
            get
            {
                for (int i = 0; i < this.tvSelected.Nodes.Count; i++)
                {
                    ...
                    {
                        return tvSelected.Nodes[i].Tag as FS.HISFC.Models.Base.PactInfo;
                    }
                }
                return null;
            }
        ...
        public ArrayList SelectedList
        {
            ...
            set
            {
                ...
                {
                    selectedList = value;
                    foreach (FS.HISFC.Models.Base.PactInfo obj in selectedList)
                    {
        ...
        public ArrayList GetSelectedList()
        {
            ...
            for (int i = 0; i < this.tvSelected.Nodes.Count; i++)
            {
                pact = tvSelected.Nodes[i].Tag as FS.HISFC.Models.Base.PactInfo;
                if (pact != null)
                {
                    list.Add(pact);
                }
    ...
    public class ComboBoxPactSelect : FS.FrameWork.WinForms.Controls.NeuComboBox
    {
        #region 成员变量
        ...
        void pactSelect_CheckedNodeEvent(FS.HISFC.Models.Base.PactInfo obj)
        {
            if (obj != null)
            {
                ...
                //if (al != null)
                //{
                //    foreach (FS.HISFC.Models.Base.PactInfo neuObj in al)
                //    {
            ...
            if (isShow)
            {
                if (dropDown != null)
                {
                    if (dropDown.Visible == false)
                    {
                        ...
                        {
                            this.DropDownControl.AddSelected(this.SelectedItem as FS.HISFC.Models.Base.PactInfo, true);
                        }
        ...
        public override int AddItems(ArrayList alItems)
        {
            if (alItems != null)
            {
                foreach (FS.HISFC.Models.Base.PactInfo obj in alItems)
                {
        ...
        public ArrayList GetValues()
        {
            ...
            {
                FS.HISFC.Models.Base.PactInfo pact = this.SelectedItem as FS.HISFC.Models.Base.PactInfo;
                if (pact != null)
                {
                    al.Add(pact);
                }
        ...
        public override Object Tag
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    this.DropDownControl.SelectedDefault = base.SelectedItem as FS.HISFC.Models.Base.PactInfo;
                }
            }
        }
        ...
        protected override void OnSelectedValueChanged(EventArgs e)
        {
            ...
            this.DropDownControl.SelectedDefault = this.SelectedItem as FS.HISFC.Models.Base.PactInfo;
        }

        private FS.HISFC.Models.Base.PactInfo preSelectItem = null;
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            {
                preSelectItem = this.SelectedItem as FS.HISFC.Models.Base.PactInfo;
            }
