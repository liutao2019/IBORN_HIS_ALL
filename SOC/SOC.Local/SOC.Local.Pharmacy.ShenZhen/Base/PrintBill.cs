...
namespace FS.SOC.Local.Pharmacy.ShenZhen.Base
{
    ...
    public class PrintBill
    {
        ...
        {
            PrintBill.CompareByPlaceNO c = new PrintBill.CompareByPlaceNO();
            alPrintData.Sort(c);
        }
        ...
        {
            PrintBill.CompareByPlaceNO2 c = new PrintBill.CompareByPlaceNO2();
            alPrintData.Sort(c);
        }
        public static void SortByPlaceNO1(ref  System.Collections.ArrayList alPrintData)
        {
            PrintBill.CompareByPlaceNO1 c = new PrintBill.CompareByPlaceNO1();
            alPrintData.Sort(c);
        }
        ...
        {
            PrintBill.CompareByTypePlaceNO c = new PrintBill.CompareByTypePlaceNO();
            alPrintData.Sort(c);
        }

        public static void SortByBillNO(ref System.Collections.ArrayList alPrintData)
        {
            PrintBill.CompareByBillNO c = new PrintBill.CompareByBillNO();
            alPrintData.Sort(c);
        }

        public static void SortByCustomerCode(ref System.Collections.ArrayList alPrintData)
        {
            PrintBill.CompareByCustomerCode c = new PrintBill.CompareByCustomerCode();
            alPrintData.Sort(c);
        }

        public static void SortByOtherSpell(ref System.Collections.ArrayList alPrintData)
        {
            PrintBill.CompareByOtherSpell c = new PrintBill.CompareByOtherSpell();
            alPrintData.Sort(c);
        }

        public static void SortByPlaceCodeAndCustomCode(ref System.Collections.ArrayList alPrintData)
        {
            PrintBill.CompareByPlaceNOAndCustomCode c = new CompareByPlaceNOAndCustomCode();
            alPrintData.Sort(c);
        }
