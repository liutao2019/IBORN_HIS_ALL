    ...
    public partial class ucPhaBackOutBill : ucBaseControl, Base.IPharmacyBillPrint
    {
        ...
        private void SetPrintData(ArrayList al, int inow, int icount, string title)
        {
            ...
            for (int i = 0; i < al.Count; i++)
            {
                ...
                this.neuFpEnter1_Sheet1.Cells[i, 0].Text = SOC.HISFC.BizProcess.Cache.Pharmacy.GetItem(output.Item.ID).GBCode; //药品自定义码
                ...
                if (SOC.HISFC.BizProcess.Cache.Common.GetDept(output.StockDept.ID).DeptType.ID.ToString() == "P")
                {
                    ...
                    this.neuFpEnter1_Sheet1.Cells[i, 7].Value = (output.Item.PriceCollection.PurchasePrice / output.Item.PackQty).ToString("F2");//买入价
                    this.neuFpEnter1_Sheet1.Cells[i, 9].Value = (output.Item.PriceCollection.RetailPrice / output.Item.PackQty).ToString("F2");//零售价
                }
                else
                {
                    ...
                    this.neuFpEnter1_Sheet1.Cells[i, 9].Value = output.Item.PriceCollection.RetailPrice;//零售价
                ...
                this.neuFpEnter1_Sheet1.Cells[i, 10].Value = output.RetailCost;//退库金额
            ...
            neuLabel4.Text = "制单日期：" + date.ToShortDateString();
            #endregion
