...
{
    public partial class ucCheckBill : UserControl, Base.IPharmacyBillPrint
    {
        public ucCheckBill()
        {
            InitializeComponent();
        ...
        private void SetPrintData(ArrayList al, int inow, int icount, string title)
        {
            ...
            for (int i = 0; i < al.Count; i++)
            {
                ...
                this.neuFpEnter1_Sheet1.Cells[i, 11].Value = FrameWork.Public.String.FormatNumber((check.AdjustQty - check.FStoreQty) * check.Item.PriceCollection.RetailPrice / check.Item.PackQty, 2);
