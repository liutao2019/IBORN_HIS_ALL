...
{
    public partial class ucMonstoreAdjustStatic : FS.SOC.Local.Pharmacy.ShenZhen.Report.ucPrivePowerReport
    {
        public ucMonstoreAdjustStatic()
        {
            InitializeComponent();
        }
        ...
        public void LoadInit()
        {
            ...
            //标题
            this.Titles = new string[] { "调价统计表", "日期：", "", "" };

            //汇总sql
            string[] sqlTots = { "Report.Pharmacy.MonthStore.AdjustPriceStatic" };
            ...
            //明细sql
            this.DetailSQLIndexs = new string[] { "Report.Pharmacy.MonthStore.AdjustPriceStaticDetail" };

            //汇总的合计列，可以超过实际数据的总列数

            this.SumColIndexs = new int[] { 3, 4, 5 };
            this.SumDetailColIndexs = new int[] { 9, 10, 11 };
            ...
            this.Filters = new string[] { "单号", "科室名称", "科室拼音码" };

            //明细过滤字段
            this.DetailFilters = new string[] { "单号", "科室", "科室拼音码", "拼音码", "通用名拼音码" };
        }
        private void format()
        {
            try
            {
                ...
                this.fpSpread1_Sheet1.Columns[5].Width = 120F;
                ...
                this.fpSpread1_Sheet1.Columns[0].CellType = t;
                this.fpSpread1_Sheet1.Columns[6].CellType = d;


                if (this.fpSpread1.Sheets.Count == 2 && this.fpSpread1.Sheets[1].Visible)
                {
                    //this.fpSpread1_Sheet2.Columns[1].Visible = false;
                    ...
                    this.fpSpread1_Sheet2.Columns[0].Width = 120F;
                    this.fpSpread1_Sheet2.Columns[2].Width = 120F;
                    ...
                    //FarPoint.Win.Spread.CellType.DateTimeCellType d = new FarPoint.Win.Spread.CellType.DateTimeCellType();
                    d.DateTimeFormat = FarPoint.Win.Spread.CellType.DateTimeFormat.LongDateWithTime;
                    this.fpSpread1_Sheet2.Columns[this.fpSpread1_Sheet2.ColumnCount - 1].CellType = d;
                    this.fpSpread1_Sheet2.Columns[this.fpSpread1_Sheet2.ColumnCount - 1].Width = 160F;
        ...
        private void operationEnd(string type)
        {
            ...
            {
                this.format();
                this.lbMainTitle.Text = this.cmbDept.Text + "调价统计表";
