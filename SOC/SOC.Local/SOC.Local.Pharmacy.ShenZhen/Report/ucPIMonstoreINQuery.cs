...
{
    public partial class ucPIMonstoreINQuery : FS.SOC.Local.Pharmacy.ShenZhen.Report.ucPrivePowerReport
    {
        public ucPIMonstoreINQuery()
        {
            InitializeComponent();
        }
        ...
        public void LoadInit()
        {
            ...
            //标题
            this.Titles = new string[] { "入库统计表", "日期：", "", "" };

            //汇总sql
            string[] sqlTots = { "Report.Pharmacy.MonthStore.InputStatic" };
            ...
            //明细sql
            this.DetailSQLIndexs = new string[] { "Report.Pharmacy.MonthStore.InputStaticDetail" };
        ...
        private void operationEnd(string type)
        {
            if (type == "query")
            {
                this.lbMainTitle.Text = this.cmbDept.Text + "入库统计表";
