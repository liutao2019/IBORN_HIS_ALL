...
namespace FS.SOC.Local.Pharmacy.ShenZhen.Report
{
                                            ...
                                            FS.FrameWork.WinForms.Classes.IPreArrange
    {
        ...
        {
            toolBarService.AddToolButton("封帐盘点单", "查询状态为封帐的盘点单", FS.FrameWork.WinForms.Classes.EnumImageList.F封帐, true, false, null);
            toolBarService.AddToolButton("结存盘点单", "查询状态为结存的盘点单", FS.FrameWork.WinForms.Classes.EnumImageList.P盘点结存解封, true, false, null);
            toolBarService.AddToolButton("取消盘点单", "查询状态为取消的盘点单", FS.FrameWork.WinForms.Classes.EnumImageList.Q取消, true, false, null);
            //toolBarService.AddToolButton("历史盘点", "调用历史盘点记录 ", FS.FrameWork.WinForms.Classes.EnumImageList.D查询历史, true, false, null);
            ...
            //toolBarService.AddToolButton("删    除", "删除当前选择药品", FS.FrameWork.WinForms.Classes.EnumImageList.A删除, true, false, null);
            //toolBarService.AddToolButton("全    盘", "根据当前封帐库存更新盘点库存", FS.FrameWork.WinForms.Classes.EnumImageList.C借出, true, false, null);

            //toolBarService.AddToolButton("结存", "按照盘点库存更新当前库存 处理盈亏", FS.FrameWork.WinForms.Classes.EnumImageList.P盘点结存解封, true, false, null);
            //toolBarService.AddToolButton("解封", "作废当前盘点单", FS.FrameWork.WinForms.Classes.EnumImageList.A注销, true, false, null);
        ...
        protected override int OnPrint(object sender, object neuObject)
        {
            ...
            FS.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.IPharmacyBill Ipharmacybill = null;

            Ipharmacybill = (FS.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.IPharmacyBill)FS.FrameWork.WinForms.Classes.UtilInterface.CreateObject(this.GetType(), typeof(FS.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.IPharmacyBill));

            if (Ipharmacybill == null)
            {
                return -1;
            }

            //if (FS.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.IPharmacyBill == null)
            //{
            //    FS.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.IPharmacyBill = FS.FrameWork.WinForms.Classes.UtilInterface.CreateObject(this.GetType(), typeof(FS.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.IPharmacyBill)) as FS.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.IPharmacyBill;
            //}

            if (Ipharmacybill != null)
            {
                Ipharmacybill.PrintBill("0305", "01", this.GetAllData());
            }
            return 1;
        }
        ...
        public void SetFormat()
        {
            ...
            this.neuSpread1_Sheet1.Columns[(int)ColumnSet.PlaceNO].Visible = true;
            ...
            try
            {
                ...
                foreach (FS.HISFC.Models.Pharmacy.Check check in alDetail)
                {
                    ...
                    else
                    {
                        ...
                        if (check.Item == null)
                        {
                            FS.HISFC.Components.Pharmacy.Function.ShowMsg("加载药品基本信息时出错" + this.itemManager.Err);
                            return -1;
                        }
                    }
        ...
        //            FS.HISFC.Components.Pharmacy.Function.ShowMsg("解封操作失败" + this.itemManager.Err);
        //            return -1;
        //        }
        //        if (i == 0)
        //        {
        //            FS.FrameWork.Management.PublicTrans.RollBack();
        //            FS.HISFC.Components.Pharmacy.Function.ShowMsg("数据发生变化请刷新！" + this.itemManager.Err);
        //            return -1;
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        //        FS.FrameWork.Management.PublicTrans.RollBack();
        //        FS.HISFC.Components.Pharmacy.Function.ShowMsg("解封操作失败" + ex.Message);
        //        return -1;
        //    }

        //    FS.FrameWork.Management.PublicTrans.Commit();

        //    FS.HISFC.Components.Pharmacy.Function.ShowMsg("解封操作成功");
        ...
        //        {
        //            FS.FrameWork.Management.PublicTrans.RollBack();
        //            FS.HISFC.Components.Pharmacy.Function.ShowMsg("结存操作失败" + this.itemManager.Err);
        //            return -1;
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        //        FS.FrameWork.Management.PublicTrans.RollBack();
        //        FS.HISFC.Components.Pharmacy.Function.ShowMsg("结存操作失败" + ex.Message);
        //        return -1;
        //    }

        //    FS.FrameWork.Management.PublicTrans.Commit();

        //    FS.HISFC.Components.Pharmacy.Function.ShowMsg("结存操作成功");
        ...
        public Type[] InterfaceTypes
        {
            get
            {
                ...
                printType[0] = typeof(FS.SOC.Local.Pharmacy.ShenZhen.Base.PrintBill);
