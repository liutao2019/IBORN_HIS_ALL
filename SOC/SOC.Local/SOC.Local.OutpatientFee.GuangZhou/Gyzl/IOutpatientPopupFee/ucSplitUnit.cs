...
namespace FS.SOC.Local.OutpatientFee.GuangZhou.Gyzl.IOutpatientPopupFee
{
    public partial class ucSplitUnit : UserControl
    {
        ...
        private FS.HISFC.Models.Fee.Outpatient.Balance invoice = new FS.HISFC.Models.Fee.Outpatient.Balance();//发票实体
        ...
        public FS.HISFC.Models.Fee.Outpatient.Balance Invoice
        {
            ...
            set
            {
                ...
                this.lbCost.Text = invoice.FT.TotCost.ToString() + " 大写: " + FS.FrameWork.Public.String.LowerMoneyToUpper(invoice.FT.TotCost);
