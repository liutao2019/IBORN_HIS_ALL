...
namespace Neusoft.SOC.Local.OutpatientFee.GuangZhou.Gyzl.IOutpatientItemInputAndDisplay
{
    public class DiagPubFee
    {
        ...
        public decimal GetNumber(Neusoft.HISFC.Models.Registration.Register r, ref string errInfo)
        {
            ...
            string sql = @"select sum(t.pub_cost) from fin_opb_feedetail t  where t.clinic_code='{0}' and t.item_code='{1}' and ((t.cancel_flag='1' and t.pay_flag='1') or t.pay_flag='0')";
