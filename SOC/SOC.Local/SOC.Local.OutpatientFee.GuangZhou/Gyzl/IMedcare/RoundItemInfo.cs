...
namespace Neusoft.SOC.Local.OutpatientFee.GuangZhou.Gyzl.IMedcare
{
    public class RoundItemInfo
    {
        ...
        public void OutPatientFeeRoundOff(Neusoft.HISFC.Models.Registration.Register r, decimal payCost,decimal pubCost, ref Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList feeItemList, string recipeSequence)
        {
            ...
            this.roundFeeItemCode = "F00000053238";
            {
                ...
                feeItemList.Item.Price = 0;
                feeItemList.OrgPrice = 0;
                feeItemList.SpecialPrice = 0;
                ...
                feeItemList.FT.TotCost = 0;
                feeItemList.FT.PayCost = payCost;
                feeItemList.FT.PubCost = pubCost;
