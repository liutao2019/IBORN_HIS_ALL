...
namespace Neusoft.SOC.Local.OutpatientFee.GuangZhou.Gyzl.IMedcare
{

    /// <summary>
    /// 广州医学院附属肿瘤医院公费算法
    /// </summary>
    class GZComputePubFee : Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcare, Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareExtend
    {
        #region 属性
        /// <summary>
        /// 错误编码
        ...
        private static Neusoft.FrameWork.Public.ObjectHelper helper = new Neusoft.FrameWork.Public.ObjectHelper();
        ...
        public int GetRegInfoInpatient(Neusoft.HISFC.Models.RADT.PatientInfo patient)
        {
            ...
            //获取项目的限额
            Neusoft.HISFC.Models.Base.PactInfo ObjPactInfo = PactManagment.GetPactUnitInfoByPactCode(patient.Pact.ID);
            if (ObjPactInfo == null)
            {
        ...
        public int QueryCanMedicare(Neusoft.HISFC.Models.Registration.Register r)
        {
            return 1;
        }
        ...
        public int RecomputeFeeItemListInpatient(Neusoft.HISFC.Models.RADT.PatientInfo patient, Neusoft.HISFC.Models.Fee.Inpatient.FeeItemList feeItemList)
        {
            ...
            //如果是退费。不重新计算比例
            //if (feeItemList.TransType == Neusoft.HISFC.Object.Base.TransTypes.Negative)
            //{
            //    return 1;
            //}
            ...
            Neusoft.HISFC.Models.Base.FTRate RateLimit = null;
            ...
            {
                RateLimit = new Neusoft.HISFC.Models.Base.FTRate();
                RateLimit.OwnRate = 1;
            }
            ...
            //求费用比例
            Neusoft.HISFC.Models.Base.FTRate Rate = this.ComputeFeeRate(patient.Pact.ID, feeItemList.Item);
            if (Rate == null)
            {
                return -1;
            }
            ...
            //床位限额
            decimal BedLimit = Neusoft.FrameWork.Public.String.FormatNumber(patient.FT.BedLimitCost, 2);
            //监护床位限额
            decimal IcuLimit = Neusoft.FrameWork.Public.String.FormatNumber(patient.FT.AirLimitCost, 2);
            Neusoft.FrameWork.Models.NeuObject conBedMinFee = conManager.GetConstant("BEDLIMITMINFEE", "1");
            ...
            Neusoft.FrameWork.Models.NeuObject conICUBedMinFee = conManager.GetConstant("BEDLIMITMINFEE", "2");
        ...
        private int SpecialItemPactLimit(string pactCode, Neusoft.HISFC.Models.Fee.Inpatient.FeeItemList feeItem)
        {
        ...
        private void SetOwnPayItem(bool bSHX, bool bSX, bool bZF, Neusoft.HISFC.Models.Fee.Inpatient.FeeItemList feeitem)
        {
            Neusoft.SOC.HISFC.Fee.BizLogic.ComItemExtendInfo comItemExtendMgr = new Neusoft.SOC.HISFC.Fee.BizLogic.ComItemExtendInfo();
            ...
            Neusoft.SOC.HISFC.Fee.Models.ComItemExtend itemExtend = null;
            if (hsComItemExtendInfo.Count > 0 && hsComItemExtendInfo.Contains(feeitem.Item.ID))
            {
                itemExtend = (Neusoft.SOC.HISFC.Fee.Models.ComItemExtend)hsComItemExtendInfo[feeitem.Item.ID];
            }
            else
            {
                List<Neusoft.SOC.HISFC.Fee.Models.ComItemExtend> lst = comItemExtendMgr.QueryItemListByItemCode(feeitem.Item.ID);
                ...
                {
                    itemExtend = lst[0] as Neusoft.SOC.HISFC.Fee.Models.ComItemExtend;
        ...
        /// <returns>失败null；成功 Neusoft.HISFC.Object.Base.FtRate</returns>
        ...
        public int Clear()
        {
            helper = new Neusoft.FrameWork.Public.ObjectHelper();
            return 1;
        }
        ...
        public int GetSpecialPactItemPubCost(Register r, ref ArrayList feeDetails)
        {
            ...
            foreach (Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList f in feeDetails)
            {
                ...
                //bigai f.FT.User03;
                f.FT.OwnCost = Neusoft.FrameWork.Public.String.FormatNumber(Neusoft.FrameWork.Function.NConvert.ToDecimal(f.FT.User03), 2);
                f.FT.PayCost = Neusoft.FrameWork.Public.String.FormatNumber((f.FT.TotCost - f.FT.OwnCost) * f.NewItemRate, 2);
        ...
        public int GetCommomPactItemPubCost(Register r, ref ArrayList feeDetails)
        {
            ...
            Neusoft.HISFC.BizLogic.Fee.Outpatient MgrOutPatient = new Neusoft.HISFC.BizLogic.Fee.Outpatient();
            decimal DayDrugFee = MgrOutPatient.GetDayDrugFee(r.SSN);
            if (DayDrugFee == -1)
            {
                return -1;
            }
            ...
            Neusoft.HISFC.BizLogic.Manager.PactStatRelation myRelation = new Neusoft.HISFC.BizLogic.Manager.PactStatRelation();
            ...
            foreach (Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList f in feeDetails)
            {
                ...
                if (f.ItemRateFlag == "3")
                {
                    f.FT.OwnCost = Neusoft.FrameWork.Public.String.FormatNumber(Neusoft.FrameWork.Function.NConvert.ToDecimal(f.FT.User03), 2);//修改比例设置的自费金额
                    //先算记账金额，在算自付金额

                    f.FT.PayCost = Neusoft.FrameWork.Public.String.FormatNumber((f.FT.TotCost - f.FT.OwnCost) * f.NewItemRate, 2);
                    f.FT.PubCost = f.FT.TotCost - f.FT.OwnCost - f.FT.PayCost;
                    //f.FT.PubCost = Neusoft.FrameWork.Public.String.FormatNumber((f.FT.TotCost - f.FT.OwnCost) * (1 - f.NewItemRate), 4);
                ...
                //当前项目在项目限额记录集合中的项目信息
                Neusoft.FrameWork.Models.NeuObject CurrentItemLimit = new Neusoft.FrameWork.Models.NeuObject();
                ...
                {
                    f.NewItemRate = Neusoft.FrameWork.Function.NConvert.ToDecimal(CurrentItemLimit.User02);//自负比例
                }
                ...
                if (Neusoft.FrameWork.Function.NConvert.ToDecimal(f.NewItemRate) == 1)
                {
                    f.FT.OwnCost = f.FT.TotCost;
                    f.FT.PayCost = 0;// Neusoft.NFC.Public.String.FormatNumber(f.FT.TotCost * f.NewItemRate, 2);
                    f.FT.PubCost = 0;
                    f.FT.ExcessCost = 0;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //最小费用累加器
                        decimal tempTotCost = Neusoft.FrameWork.Function.NConvert.ToDecimal(relation.User01);//临时总费用
                        decimal limitCost = Neusoft.FrameWork.Function.NConvert.ToDecimal(relation.Memo);//临时总限额
                        //----------------------0914记得加参数其他医院不这么走
                        ...
                        if (f.FT.TotCost - f.FT.OwnCost + tempTotCost > limitCost)
                        {
                            ...
                            //做超标处理
                            Neusoft.FrameWork.Models.NeuObject OverLoadObj = null;
                            ...
                            {
                                //创建超标实体，用来标识已经遇到了超标
                                OverLoadObj = new Neusoft.FrameWork.Models.NeuObject();
                                OverLoadObj.ID = relation.ID;
                                this.AddObjectToHelper(ref  OverLoadObj, relation.Name);

                                f.FT.OwnCost = Neusoft.FrameWork.Public.String.FormatNumber(f.FT.TotCost + tempTotCost - limitCost, 4);
                                //f.FT.PayCost = Neusoft.FrameWork.Public.String.FormatNumber((limitCost - tempTotCost) * f.NewItemRate, 4);
                                //f.FT.PubCost = f.FT.TotCost - f.FT.OwnCost - f.FT.PayCost;

                                f.FT.PubCost = Neusoft.FrameWork.Public.String.FormatNumber((limitCost - tempTotCost) * (1 - f.NewItemRate), 4);
                                f.FT.PayCost = f.FT.TotCost - f.FT.OwnCost - f.FT.PubCost;

                                f.FT.ExcessCost = f.FT.OwnCost;//非真正的药品超标金额,所有的超标金额
                                relation.User01 = limitCost.ToString();//下次超标
                                //累加当前公费记帐金额
                                //obj.User01= System.Convert.ToString(f.FT.PayCost + f.FT.PubCost + Neusoft.FrameWork.Function.NConvert.ToDecimal(obj.User01));
                            }
                            else
                            {
                                f.FT.OwnCost = f.FT.TotCost;
                        ...
                        else
                        {
                            ...
                            f.FT.ExcessCost = 0;
                            //累加当前公费记帐金额
                            relation.User01 = System.Convert.ToString(f.FT.PayCost + f.FT.PubCost + Neusoft.FrameWork.Function.NConvert.ToDecimal(relation.User01));
                            //设置药品自费金额
                            f.FT.DrugOwnCost = 0;
                        }
                        //用来记录该患者所有的超标部分的金额
                        tot += Neusoft.FrameWork.Function.NConvert.ToDecimal(f.FT.ExcessCost);//目前视乎没用到
                    }
                }
            }
        ...
        {
            Neusoft.HISFC.BizLogic.Fee.PactUnitItemRate PactItemRate = new Neusoft.HISFC.BizLogic.Fee.PactUnitItemRate();
            Neusoft.HISFC.BizLogic.Fee.PactUnitInfo PactManagmentForLimit = new Neusoft.HISFC.BizLogic.Fee.PactUnitInfo();
            if (this.trans != null)
            {
                PactItemRate.SetTrans(this.trans);
            ...
            Neusoft.HISFC.Models.Base.PactInfo PactUnitInfolimit = PactManagmentForLimit.GetPactUnitInfoByPactCode(PactID);
            ...
            //用来保存项目的限额信息
            Neusoft.FrameWork.Models.NeuObject objLimit = null;
            ...
            try
            {
                ...
                //记录该合同单位下已经维护限额的最小费用
                foreach (Neusoft.HISFC.Models.Base.PactItemRate ObjPactItemRate in MinFeelist)
                {
                    //该最小费用维护了限额
                    ...
                    {
                        //创建一条记录维护限额的最小费用
                        objLimit = new Neusoft.FrameWork.Models.NeuObject();
                        //标识获取的限额为最小费用的限额
        ...
        private void GetCurrentItemFeeLimitCostByItem(Neusoft.HISFC.Models.Registration.Register r, ArrayList ItemFeeLimitList, Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList f, ref Neusoft.FrameWork.Models.NeuObject CurrentItemLimit)
        {
            //该项目限记额录中已经存在该项目的限额信息记录，则不需要重新读取项目限额信息，直接从项目限额记录中读取即可。    
            for (int i = 0; i < ItemFeeLimitList.Count; i++)
            {
                Neusoft.FrameWork.Models.NeuObject ItemFeeLimit = ItemFeeLimitList[i] as Neusoft.FrameWork.Models.NeuObject;
            ...
            {
                //获取该项目的限额信息
                Neusoft.HISFC.Models.Base.FTRate ItemlimitCost = this.GetItemFeeRate(r.Pact.ID, f.Item);
                //表示存在该项目的限额信息  
        ...
        /// <returns>限额</returns>
        public Neusoft.HISFC.Models.Base.FTRate GetItemRateLimit(string PactID, Neusoft.HISFC.Models.Base.Item item)
        {
        ...
        /// <returns></returns>
        /// bigai
        public Neusoft.FrameWork.Models.NeuObject GetCurrentMinFeeLimitCostByItem(string ItemID, ArrayList MinFeeLimitList)
        {
            Neusoft.FrameWork.Models.NeuObject MinFeeObj = null;
            foreach (Neusoft.FrameWork.Models.NeuObject obj in MinFeeLimitList)
            {
                if (ItemID == obj.ID)
                {
                    MinFeeObj = obj;
        ...
        /// </summary>
        /// <param name="f"></param>
        private static void SetItemPubCostWhenItemNoLimitCost(Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList f)
        {
            f.FT.PubCost = f.FT.TotCost - f.FT.PayCost;
            f.FT.ExcessCost = 0;
            f.FT.DrugOwnCost = 0;
        ...
        /// <returns></returns>
        private void GetItemPubCost(Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList f, ref Neusoft.FrameWork.Models.NeuObject obj)
        {
            //最小费用累加器
            decimal tempTotCost = Neusoft.FrameWork.Function.NConvert.ToDecimal(obj.User02);
            decimal limitCost = Neusoft.FrameWork.Function.NConvert.ToDecimal(obj.User01);
            ...
            else
            {
                ...
                f.FT.ExcessCost = 0;
                //累加当前公费记帐金额
                obj.User02 = System.Convert.ToString(f.FT.PayCost + f.FT.PubCost + Neusoft.FrameWork.Function.NConvert.ToDecimal(obj.User02));
                //设置药品自费金额
                f.FT.DrugOwnCost = 0;
            }
        }
        ...
        /// <param name="f"></param>
        /// <returns></returns>
        private bool IsOverLoad(Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList f, decimal totTempCost, decimal limitCost)
        {
            //公费报销部分金额+已经累计的公费金额大于当前限额，说明超标
        ...
        /// <returns></returns>
        private void DealItemOverLoad(Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList f,
            ref  Neusoft.FrameWork.Models.NeuObject obj, decimal tempTotCost, decimal limitCost)
        {
            //做超标处理
            Neusoft.FrameWork.Models.NeuObject OverLoadObj = null;
            //如果没有则说明是第一次超标，否则不是第一次超标
            ...
            if (OverLoadObj == null)
            {
                ...
                f.FT.OwnCost = Neusoft.FrameWork.Public.String.FormatNumber(f.FT.TotCost + tempTotCost - limitCost, 2);
                f.FT.PayCost = Neusoft.FrameWork.Public.String.FormatNumber((limitCost - tempTotCost) * f.NewItemRate, 2);
                f.FT.PubCost = f.FT.TotCost - f.FT.OwnCost - f.FT.PayCost;
                f.FT.ExcessCost = f.FT.OwnCost;//非真正的药品超标金额,所有的超标金额
        ...
        private void AddObjectToHelper(ref Neusoft.FrameWork.Models.NeuObject obj, string FEE_STAT_NAME)
        {
        ...
        /// <param name="r"></param>
        /// <param name="f"></param>
        private void GetItemOwnCostByItemRateFlag(Neusoft.HISFC.Models.Registration.Register r, Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList f)
        {
            //先判断项目类别标志
            //如果为自费项目
            if (f.ItemRateFlag == "1")
            ...
            {
                Neusoft.HISFC.Models.Base.FTRate ItemRate = this.GetItemRateLimit(r.Pact.ID, f.Item);
                //该项目没有维护项目比率
                if (ItemRate == null)
                {
                    //continue;
                ...
                {
                    f.FT.OwnCost = Neusoft.FrameWork.Public.String.FormatNumber(f.FT.TotCost * ItemRate.OwnRate, 2);
                }
            }
            else if (f.ItemRateFlag == "3")//特殊项目，则不取项目比率，直接取界面维护的比率
            {
                //特殊项目，则自费部分为总金额*新维护的自费比例，这一部分不计入日限额中
                f.FT.OwnCost = Neusoft.FrameWork.Public.String.FormatNumber(f.FT.TotCost * f.NewItemRate, 2);
            }
        }
        ...
        /// <param name="r"></param>
        /// <param name="feeDetails"></param>
        private void ComputeFee(Neusoft.HISFC.Models.Registration.Register r, System.Collections.ArrayList feeDetails)
        {
            decimal totCost = 0;
            decimal payCost = 0;
            decimal pubcost = 0;
            ...
            Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList fPubMax = null;
            Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList fPayMax = null;
            ...
            foreach (Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList f in feeDetails)
            {
                ...
                f.FT.PubCost = Neusoft.FrameWork.Public.String.FormatNumber(f.FT.PubCost, 2);
                f.FT.OwnCost = Neusoft.FrameWork.Public.String.FormatNumber(f.FT.OwnCost, 2);
            ...
            if (chaePubCost != 0)
            {
                ...
                roundItemInfo.OutPatientFeeRoundOff(r, -chaePubCost, chaePubCost, ref feeItemList, ((FeeItemList)feeDetails[0]).RecipeSequence);
        ...
        private Neusoft.FrameWork.Models.NeuObject GetRelation(ArrayList stats, ArrayList relations)
        {
            foreach (Neusoft.FrameWork.Models.NeuObject stat in stats)
            {
                foreach (Neusoft.FrameWork.Models.NeuObject obj in relations)
                {
                    if (stat.ID == obj.ID)
                    {
                        return obj;
        ...
        public Neusoft.HISFC.Models.Base.FTRate GetItemFeeRate(string PactID, Neusoft.HISFC.Models.Base.Item item)
        {
        ...
        private string GetPactLimitType(string pactCode)
        {
            ...
            Neusoft.FrameWork.Models.NeuObject limitType = null;
        ...
        private void SetOwnPayItem(bool bSHX, bool bSX, bool bZF, ref ArrayList alFee)
        {
            ...
            foreach (Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList feeitem in alFee)
            {
                Neusoft.SOC.HISFC.Fee.Models.ComItemExtend itemExtend = null;
