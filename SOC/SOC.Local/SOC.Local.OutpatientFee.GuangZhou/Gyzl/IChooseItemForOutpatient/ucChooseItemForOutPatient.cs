...
using System.Xml;
namespace FS.SOC.Local.OutpatientFee.GuangZhou.Gyzl.IChooseItemForOutpatient
{
    /// <summary>
    /// 门诊收费项目列表
    /// </summary>
    public partial class ucChooseItemForOutPatient : UserControl, FS.HISFC.BizProcess.Integrate.FeeInterface.IChooseItemForOutpatient
    {
        ...
        private void InitDataTable()
        {
            ...
            else
            {
                ...
                dtItem.Columns.AddRange(new DataColumn[]{   new DataColumn("自定义码", str),
														...
														new DataColumn("价格一", str),
														new DataColumn("价格二", str),// {5A6C578A-D565-42c8-B3FA-B4A52D1FABFB}
														new DataColumn("价格三", str),
        ...
        public int GetSelectedItem()
        {
            ...
            decimal price = FrameWork.Function.NConvert.ToDecimal(fpSpread1_Sheet1.Cells[this.fpSpread1_Sheet1.ActiveRowIndex, (int)Cols.UintPrice1].Text);
        ...
        public int Init()
        {
            ...
            this.fpSpread1_Sheet1.Columns[(int)Cols.UintPrice3].Visible = true ;
        ...
        public void SetDataSet(DataSet dsItem)
        {
            ...
            foreach (DataRow row in dsItem.Tables[0].Rows)
            {
                ...
                IRow["规格"] = row["SPECS"];
                IRow["价格一"] = row["UNIT_PRICE"];
                IRow["价格二"] = row["CHILD_PRICE"];// {5A6C578A-D565-42c8-B3FA-B4A52D1FABFB}
                IRow["价格三"] = row["SP_PRICE"];
            ...
            this.fpSpread1_Sheet1.Columns[(int)Cols.UintPrice1].CellType = new FarPoint.Win.Spread.CellType.TextCellType();
        }
        ...
        private void SetFilter(string inputChar)
        {
            ...
            {
                dvItem.Sort = "sort DESC, 自定义码 ASC";
            }
            else
            {
                dvItem.Sort = "sort asc," + this.strSortString;
            }
        ...
        protected override bool ProcessDialogKey(Keys keyData)
        {
            if (keyData.GetHashCode() == Keys.Enter.GetHashCode())
            {
                ...
                //物资收费{40DFDC91-0EC1-4cd4-81BC-0EAE4DE1D3AB}
                //SelectedItem(itemCode, drugFlag, exeDept);
                decimal price = FrameWork.Function.NConvert.ToDecimal(this.fpSpread1_Sheet1.Cells[this.fpSpread1_Sheet1.ActiveRowIndex, (int)Cols.UintPrice1].Text);
                SelectedItem(itemCode, drugFlag, exeDept, price);
        ...
        private enum Cols
        {
            ...
            UintPrice1,//价格一
            UintPrice2,//价格二
            UintPrice3,//价格三// {5A6C578A-D565-42c8-B3FA-B4A52D1FABFB}
            NowStore,//库存量
            PackUnit,//单位 
            ExeDept,//执行科室
            SpellCode,//拼音码
