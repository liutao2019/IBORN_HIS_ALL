namespace FS.SOC.Local.OutpatientFee.GuangZhou.Gyzl.IOutpatientInfomation
{
    ...
    partial class ucPatientInfo
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fpRecipeSeq_Sheet1.Columns.Get(0).CellType = checkBoxCellType2;
            this.fpRecipeSeq_Sheet1.Columns.Get(0).Width = 22F;
            this.fpRecipeSeq_Sheet1.Columns.Get(1).CellType = textCellType3;
            this.fpRecipeSeq_Sheet1.Columns.Get(1).Locked = true;
            this.fpRecipeSeq_Sheet1.Columns.Get(1).Width = 113F;
            this.fpRecipeSeq_Sheet1.Columns.Get(2).CellType = textCellType4;
            ...
            this.fpRecipeSeq_Sheet1.Columns.Get(3).CellType = numberCellType2;
