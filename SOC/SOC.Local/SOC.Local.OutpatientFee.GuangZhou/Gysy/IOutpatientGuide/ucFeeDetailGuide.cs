...
namespace FS.SOC.Local.OutpatientFee.GuangZhou.Gysy.IOutpatientGuide
{
    public partial class ucFeeDetailGuide : UserControl
    {
        ...
        private void AddHospitalInfo()
        {
            ...
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = "广州医学院第四附属医院";
        ...
        private void AddFeeHeader()
        {
            ...
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 2].Text = "单位";
