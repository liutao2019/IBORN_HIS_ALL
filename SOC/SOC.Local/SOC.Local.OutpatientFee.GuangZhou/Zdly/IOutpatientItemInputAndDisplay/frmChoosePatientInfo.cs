...
namespace FS.SOC.Local.OutpatientFee.GuangZhou.Zdly.IOutpatientItemInputAndDisplay
{
	...
	public class frmChoosePatientInfo : BaseForm {
		...
		private void InitializeComponent() {
            ...
            this.ckquery.CheckedChanged += new System.EventHandler(this.ckquery_CheckedChanged);
            // 
        ...
        private void ckquery_CheckedChanged(object sender, EventArgs e)
        {
            dtpBeginDate.Enabled = !ckquery.Checked;
            dtpEndDate.Enabled = !ckquery.Checked;
            if (ckquery.Checked)
                label1.Text = "发票号:";
            else
                label1.Text = "病历号:";
