...
namespace FS.SOC.Local.Order.HeYuan.DrugCard
{
    ...
    public partial class ucDrugTransfusionPanel : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.IPrintTransFusion
    {
        ...
        /// 瓶贴卡
        /// </summary>
        InfusionLabel.ucInfusionLabel ucLabel = new FS.SOC.Local.Order.HeYuan.DrugCard.InfusionLabel.ucInfusionLabel();
        ...
        private ArrayList GetValidControl()
        {
            ...
            FS.SOC.Local.Order.HeYuan.DrugCard.InfusionLabel.ucInfusionLabel cTemp = null;
            foreach (System.Windows.Forms.Control c in this.pnCard.Controls)
            {
                if (c.GetType().ToString() == "FS.SOC.Local.Order.HeYuan.DrugCard.InfusionLabel.ucInfusionLabel")
                {
                    cTemp = c as FS.SOC.Local.Order.HeYuan.DrugCard.InfusionLabel.ucInfusionLabel;
        ...
        private void chkAll_CheckedChanged(object sender, EventArgs e)
        {
            foreach (Control con in pnCard.Controls)
            {
                try
                {
                    FS.SOC.Local.Order.HeYuan.DrugCard.InfusionLabel.ucInfusionLabel ucIn = con as FS.SOC.Local.Order.HeYuan.DrugCard.InfusionLabel.ucInfusionLabel;
