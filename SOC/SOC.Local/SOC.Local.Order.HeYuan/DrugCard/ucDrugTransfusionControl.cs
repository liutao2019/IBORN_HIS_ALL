        ...
        public object ControlValue
        {
            ...
            set
            {
                ...
                for (int i = 0; i < al.Count; i++)
                {
                    ...
                    string hypoTest = outOrderMgr.TransHypotest(order.Order.HypoTest);

                    if (i == 0)
                    {
                        this.lblName.Text = order.Order.Patient.Name;
                        this.lblBed.Text = Classes.Function.BedDisplay(order.Order.Patient.PVisit.PatientLocation.Bed.ID);
                    ...
                    if (i == 0)
                    {
                        ...
                        if (FS.FrameWork.Function.NConvert.ToInt32(order.User01) > 1)//非第一页没有主药
                    ...
                    //    FS.WinForms.Report.Common.Code39 code39 = new FS.WinForms.Report.Common.Code39();
