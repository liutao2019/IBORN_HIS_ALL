            ...
            set
            {
                ...
                foreach (FS.HISFC.Models.Order.ExecOrder info in alInfusionData)
                {
                    ...
                    try
                    {
                        ...
                        if (FS.SOC.Local.Order.HeYuan.Classes.Function.GetPhaItem(info.Order.Item.ID) != null && FS.SOC.Local.Order.HeYuan.Classes.Function.GetPhaItem(info.Order.Item.ID).IsAllergy)
                        {
