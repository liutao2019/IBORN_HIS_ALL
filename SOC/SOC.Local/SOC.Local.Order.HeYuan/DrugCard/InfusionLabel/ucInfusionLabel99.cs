...
namespace FS.SOC.Local.Order.HeYuan.DrugCard.InfusionLabel
{
    ...
    /// [创建时间: 2010-01]<br></br>
    /// </summary>
    public partial class ucInfusionLabel99 : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Classes.IControlPrintable
    {
        public ucInfusionLabel99()
        {
            InitializeComponent();
        }
