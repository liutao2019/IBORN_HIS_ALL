    ...
    public partial class ucCircuitCardFP : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.IPrintTransFusion
    {
        ...
        private void AddToFP(ArrayList list)
        {
            ...
            foreach (FS.HISFC.Models.Order.ExecOrder execOrder in list)
            {
                ...
                //}
                if (FS.SOC.Local.Order.HeYuan.Classes.Function.SubItemNameFP(itemName, length).Count > 1)
                {
                    this.neuSpread1_Sheet1.Rows[index].Height = 2 * this.neuSpread1_Sheet1.Rows[index].Height;
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            if (FS.SOC.Local.Order.HeYuan.Classes.Function.GetPhaItem(objExc.Order.Item.ID) != null && FS.SOC.Local.Order.HeYuan.Classes.Function.GetPhaItem(objExc.Order.Item.ID).IsAllergy)
                            {
        ...
        protected void SetValues(ArrayList alValues)
        {
            ...
            if (alValues != null)
            {
                ...
                FS.SOC.Local.Order.HeYuan.Classes.Function.DrawComboLeft(this.neuSpread1_Sheet1, (int)(int)ExecBillCols.ComboNo, (int)ExecBillCols.ComboMemo);
