namespace FS.SOC.Local.OutpatientFee.ShenZhen.BinHai.IOutpatientInfomation
{
    ...
    partial class ucPatientInfo
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fpRecipeSeq_Sheet1.Columns.Get(0).CellType = checkBoxCellType3;
            this.fpRecipeSeq_Sheet1.Columns.Get(0).Width = 22F;
            this.fpRecipeSeq_Sheet1.Columns.Get(1).CellType = textCellType5;
            this.fpRecipeSeq_Sheet1.Columns.Get(1).Locked = true;
            this.fpRecipeSeq_Sheet1.Columns.Get(1).Width = 113F;
            this.fpRecipeSeq_Sheet1.Columns.Get(2).CellType = textCellType6;
            this.fpRecipeSeq_Sheet1.Columns.Get(2).Locked = true;
            this.fpRecipeSeq_Sheet1.Columns.Get(2).Width = 75F;
            this.fpRecipeSeq_Sheet1.Columns.Get(3).CellType = numberCellType3;
