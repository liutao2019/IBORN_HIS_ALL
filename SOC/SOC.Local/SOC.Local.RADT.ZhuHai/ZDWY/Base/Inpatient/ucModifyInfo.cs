...
namespace FS.SOC.Local.RADT.ZhuHai.ZDWY.Base.Inpatient
{
    ...
    public partial class ucModifyInfo : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.SOC.HISFC.RADT.Interface.Register.IInpatient
    {
        ...
        private bool isCanModifyPatientNo = false;// {1470D480-E0E3-4ab7-AECE-2B75E9101D4E}

        private bool isShowPrePay = false;
        ...
        private bool isInputLinkMan = false;

        // {6BF1F99D-7307-4d05-B747-274D24174895}
        ...
        private void setPatientInfo(PatientInfo patient)
        {
            ...
            else if (patient.InTimes > 1&&patient.IsBaby)
            {
        ...
        private void setPatient(FS.HISFC.Models.RADT.PatientInfo patient)
        {
            ...
            this.txtLinkMan.Text = patient.Kin.Name;//联系人姓名ss
            ...
            this.cmbPatientType.Tag = patient.PatientType.ID;//患者类型// {F6204EF5-F295-4d91-B81A-736A268DD394}
        ...
        private PatientInfo getPatientInfomation()
        {
            ...
            patient.PatientType.ID = this.cmbPatientType.Tag.ToString();
            patient.PatientType.Name = this.cmbPatientType.Text;
            ...
            patient.AreaCode = txtBirthArea.Text;
            return patient;
        }
        ...
        private bool isInputValid()
        {
            ...
            //判断字符超长籍贯
            if (!FS.FrameWork.Public.String.ValidMaxLengh(this.cmbBirthArea.Text, 100))
            {
            ...
            //判断字符超长联系人
            if (!FS.FrameWork.Public.String.ValidMaxLengh(this.txtLinkMan.Text, 32))
            {
        ...
        /// <returns></returns>
        /// // {ED831FEC-F3FE-4697-BADF-120F7C64A883}
        ...
        */
        ...
        void rbtnTempPatientNO_CheckedChanged(object sender, EventArgs e)
        {
            if (this.rbtnTempPatientNO.Checked)
            {
                ...
                if (Function.GetAutoTempPatientNOByType(this.cmbPatientType.Tag.ToString(),ref tempPatientNO) > 0)
                {
        ...
        public int Init()
        {
            ...
            this.cmbPatientType.Enabled = this.isCanModifyPatientNo;// {1470D480-E0E3-4ab7-AECE-2B75E9101D4E}
            this.txtName.Enabled = this.isCanModifyName;
            this.rbtnTempPatientNO.Visible = this.isCanModifyPatientNo;
            this.rdoInpatientNO.Visible = this.isCanModifyPatientNo;
            this.txtInpatientNO.Visible = this.isCanModifyPatientNo;
            this.foucs();
            return 1;
        }
        ...
        public void Clear()
        {
            ...
            this.cmbPatientType.Tag = "";// {F6204EF5-F295-4d91-B81A-736A268DD394}
