...
using FS.SOC.Local.RADT.ZhuHai.ZDWY.Register;


namespace FS.SOC.Local.RADT.ZhuHai.ZDWY.Modify
{
    /// <summary>
    ...
    public partial class ucModifyInpatient : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        [Category("参数设置"), Description("是否允许修改患者名字:true 允许 false 不允许"), DefaultValue(false)]
        [FSSetting()]
        ...
        private int initInterface()
        {
            ...
            this.IRegister.IsCanModifyIName = isAllowModifyName;
            this.IRegister.IsCanModifyPatientNo = isAllowModifyPatientNo;// {1470D480-E0E3-4ab7-AECE-2B75E9101D4E}
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolBarService.AddToolButton("腕带补打", "腕带补打", (int)FS.FrameWork.WinForms.Classes.EnumImageList.C重打, true, false, null);
        ...
        {           
            Base.Inpatient.ucDayLimitTot uc = new Base.Inpatient.ucDayLimitTot();
            FS.FrameWork.WinForms.Classes.Function.PopShowControl(uc);
        }
        /// <summary>
        /// 腕带补打
        /// </summary>
        public void RePrintBracelet()
        {
            if (this.patientInfo == null || string.IsNullOrEmpty(this.patientInfo.ID))
            {
                MessageBox.Show("患者信息为空，请确认是否输入患者！", "", MessageBoxButtons.OK);
                return;
            }
            if (this.patientInfo.IsBaby)
            {
                MessageBox.Show("新生儿患者，请在护士站补打！", "", MessageBoxButtons.OK);
                return;
            }

            ucPatientBracelet uc = new ucPatientBracelet();
            uc.myPatientInfo = this.patientInfo;
            uc.Print();
        }
        /// <summary>
        /// 提示方法
        ...
        private int save()
        {
            ...
            if (this.patientInfo.InTimes == -1)
            {
                ...
                this.myMessageBox("保存失败，原因：获取最大住院次数出错", MessageBoxIcon.Error);
                return -1;
            }
