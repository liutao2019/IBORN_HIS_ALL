...
namespace FS.SOC.Local.RADT.ZhuHai.ZDWY.IOutPrint
{
    /// <summary>
    /// 出院通知单打印
    /// </summary>
    public partial class ucOutPrint : UserControl,FS.HISFC.BizProcess.Interface.IPrintInHosNotice
    {
        ...
        and w.inpatient_no='{0}' ";
           ...
           // this.lblBlood.Text = patient.BloodType.Name ;//血型 
            ...
            this.lblDept.Text = patient.PVisit.PatientLocation.NurseCell.Name + ":" + FS.FrameWork.Management.Connection.Operator.Name; ;//病区:操作员
            ...
            this.lblWjMoney.Text = FS.FrameWork.Public.String.ToSimpleString(patient.FT.TotCost);//未结总金额
            this.lblAjMoney.Text = FS.FrameWork.Public.String.ToSimpleString(patient.FT.PrepayCost);//预交金总金额   + patient.FT.BalancedPrepayCost
            //医何患者类型
            ...
            #region 医保类型复选框 注释by zhaorong at 2013-7-25 修改为直接显示类型文本
            ////初始医保类型checked为false
            ...
            //    case "医保-门诊统筹":
            //    case "生育保险":
            //        //update by zhaorong start at 2013-7-24 通知单上自动反映医生选择的医保类型
            ...
            //        //肿瘤
            //        this.cbCancer.Visible = true;
            //        this.cbCancer.Text = "肿瘤";
            //        if ("1".Equals(healthCareType)) this.cbCancer.Checked = true;
            //        break;
            //        //update by zhaorong end at 2013-7-24 通知单上自动反映医生选择的医保类型
            //}
            #endregion
            ...
            if (ds1 != null && ds1.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < ds1.Tables[0].Rows.Count; i++)
                {
                    ...
                    this.lblTotal.Text = (Convert.ToDouble(ds1.Tables[0].Rows[i][0]) + Convert.ToDouble(ds1.Tables[0].Rows[i][1]) + Convert.ToDouble(ds1.Tables[0].Rows[i][2])).ToString() + "元";                     
                }
            }
