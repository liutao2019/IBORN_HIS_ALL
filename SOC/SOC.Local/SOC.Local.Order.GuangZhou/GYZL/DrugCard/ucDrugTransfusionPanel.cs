...
namespace FS.SOC.Local.Order.GuangZhou.GYZL.DrugCard
{
    /// <summary>
    /// [功能描述: 输液卡控件]<br></br>
    /// [创 建 者: wolf]<br></br>
    ...
    public partial class ucDrugTransfusionPanel : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.IPrintTransFusion
    {
        ...
        public void Print()
        {
            try
            {
                ...
                FS.HISFC.Models.Base.PageSize pSize = pgMgr.GetPageSize("NurseDrugT");
                if (pSize != null)
                {
                ...
                {
                    FS.SOC.Local.Order.GuangZhou.GYZL.DrugCard.ucInfusionLabel cTemp = c as FS.SOC.Local.Order.GuangZhou.GYZL.DrugCard.ucInfusionLabel;
                    if (cTemp.IsSelected)
                    {
                        cTemp.SetPrint();
                ...
                else
                {
                    ...
                    for (int i = 0; i < page; i++)
                    {
                        ...
                        for (int k = 0; k < dicCombNo[key].Count; k++)
                        {
                            ...
                            {
                                ((FS.HISFC.Models.Order.ExecOrder)dicCombNo[key][k]).Order.User03 = i.ToString() + "/" + page.ToString();
        ...
        protected void SetValues(ArrayList alValues)
        {
            ...
            if (alValues != null)
            {
                ...
                FS.SOC.Local.Order.GuangZhou.GYZL.DrugCard.ucInfusionLabel ucLabel = new ucInfusionLabel();
