...
namespace FS.SOC.Local.Order.GuangZhou.GYZL.IOrderChooseUL
{
    public class SelectItem : FS.SOC.HISFC.BizProcess.OrderInterface.OutPatientOrder.IOrderChooseUL
    {
        ...
        FS.SOC.Local.Order.GuangZhou.GYZL.IOrderChooseUL.ucSelectItem ucChooseItem = null;

        private void init()
        {
            if (ucChooseItem == null)
            {
                ucChooseItem = new FS.SOC.Local.Order.GuangZhou.GYZL.IOrderChooseUL.ucSelectItem();
            }
            ucChooseItem.Clear();
        }
