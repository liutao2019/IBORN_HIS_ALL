    ...
    public partial class ucDrugTransfusionPanel : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.IPrintTransFusion
    {
        ...
        public void Print()
        {
            try
            {
                ...
                {
                    FS.SOC.Local.Order.GuangZhou.ZDLY.DrugCard.ucInfusionLabel cTemp = c as FS.SOC.Local.Order.GuangZhou.ZDLY.DrugCard.ucInfusionLabel;
                    if (cTemp.IsSelected)
                    {
                        cTemp.SetPrint();
        ...
        protected void SetValues(ArrayList alValues)
        {
            ...
            if (alValues != null)
            {
                ...
                FS.SOC.Local.Order.GuangZhou.ZDLY.DrugCard.ucInfusionLabel ucLabel = new ucInfusionLabel();
