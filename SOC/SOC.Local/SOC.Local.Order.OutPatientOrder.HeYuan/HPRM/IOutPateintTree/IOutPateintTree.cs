...
namespace Neusoft.SOC.Local.Order.OutPatientOrder.HeYuan.HPRM.IOutPateintTree
{
    /// <summary>
    /// 查找卡号加载到医生未诊列表接口
    /// </summary>
    ...
    {
        Neusoft.HISFC.BizProcess.Integrate.Registration.Registration regIntergrate = new Neusoft.HISFC.BizProcess.Integrate.Registration.Registration();
        ...
        /// <returns></returns>
        public int AfterAddToTree(Neusoft.HISFC.Models.Registration.Register regObj)
        {
            return 1;
        }
        ...
        /// <param name="regObj"></param>
        /// <returns></returns>
        public int BeforeAddToTree(Neusoft.HISFC.Models.Registration.Register regObj)
        {
            try
            {
                #region 提前看诊给出提示
                ...
                Neusoft.HISFC.Models.Registration.RegLevel doctRegLevel = this.regIntergrate.GetRegLevl(this.GetReciptDept().ID, reciptDoct.ID, (((Neusoft.HISFC.Models.Base.Employee)reciptDoct).Level.ID));
        ...
        private Neusoft.HISFC.Models.Base.Employee reciptDoct = null;
        ...
        public Neusoft.FrameWork.Models.NeuObject GetReciptDept()
        {
            try
            {
                if (this.reciptDept == null)
                {
                    ...
                    this.reciptDept = ((Neusoft.HISFC.Models.Base.Employee)Neusoft.FrameWork.Management.Connection.Operator).Dept.Clone(); //开立科室

                    this.reciptDoct = (Neusoft.HISFC.Models.Base.Employee)Neusoft.FrameWork.Management.Connection.Operator;
                }
            }
            catch (Exception ex)
            {
