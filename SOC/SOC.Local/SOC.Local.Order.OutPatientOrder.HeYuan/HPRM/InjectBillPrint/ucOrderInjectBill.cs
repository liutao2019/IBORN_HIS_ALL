    ...
    public partial class ucOrderInjectBill : UserControl, Neusoft.SOC.HISFC.BizProcess.OrderInterface.OutPatientOrder.IOutPatientOrderPrint
    {
        ...
        private void PrintOnePage(ArrayList alData, int current, int total, Neusoft.HISFC.Models.Registration.Register regObj, Neusoft.FrameWork.Models.NeuObject reciptDept, Neusoft.FrameWork.Models.NeuObject reciptDoct)
        {
            ...
            try
            {
                ...
                this.lbPage.Text = current.ToString() + "/" + total.ToString() + "页";
        ...
        private void PrintOnePage(IList<Neusoft.HISFC.Models.Order.OutPatient.Order> orderList, int current, int total, Neusoft.HISFC.Models.Registration.Register regObj, Neusoft.FrameWork.Models.NeuObject reciptDept, Neusoft.FrameWork.Models.NeuObject reciptDoct)
        {
        ...
        {
            PrintOnePage(orderList, 1, 1, regObj, reciptDept, reciptDoct);
        }
