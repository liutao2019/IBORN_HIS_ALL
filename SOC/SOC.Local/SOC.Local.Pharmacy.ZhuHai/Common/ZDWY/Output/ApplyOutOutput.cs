...
namespace FS.SOC.Local.Pharmacy.ZhuHai.Common.ZDWY.Output
{
    ...
    /// 2、暂存按钮插入出库申请表
    /// </summary>
    public class ApplyOutOutput : FS.SOC.HISFC.Components.Pharmacy.Base.IBaseBiz
    {
        ...
        public int SaveTemporary()
        {
            ...
            foreach (DataRow dr in dtAddMofity.Rows)
            {
                ...
                if (temporaryBillNo == "")
                {
                    temporaryBillNo = SOC.HISFC.Components.Pharmacy.Function.GetApplyListNO(this.curStockDept.ID);
        ...
        public int ChooseApplyBill()
        {
            ...
            FS.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.ChooseDataSetting chooseDataSetting = SOC.HISFC.Components.Pharmacy.Function.GetBizChooseDataSetting("0320", curPriveType.Memo, curPriveType.ID, "3", ref errInfo);
