...
namespace FS.SOC.Local.Pharmacy.ZhuHai.Common.ZDWY.Output
{
    ...
    /// [创建时间: 2011-3]<br></br>
    /// </summary>
    public class OutputBizManager : FS.SOC.HISFC.Components.Pharmacy.Base.IPharmacyBizManager
    {
        /// <summary>
        /// 根据出库类别获取业务流程管接口的实现
        /// </summary>
        ...
        /// <returns></returns>
        public FS.SOC.HISFC.Components.Pharmacy.Base.IBaseBiz GetBizImplement(FS.FrameWork.Models.NeuObject outputType)
        {
            ...
            {
                //财务核准出库
                return new SOC.HISFC.Components.Pharmacy.Common.Fin.ApproveOuput();
            }
