...
namespace FS.SOC.Local.Pharmacy.ZhuHai.Common.ZDWY.Input
{
    ...
    /// </summary>
    public class OutputAfterInput : FS.SOC.HISFC.Components.Pharmacy.Base.IBaseBiz
    {
        ...
        {
            ArrayList alOutDept = SOC.HISFC.Components.Pharmacy.Function.QueryAllDept();
        ...
        protected int Save()
        {
            ...
            foreach (FS.HISFC.Models.Pharmacy.Input inp in alInput)
            {
                ...
                if (outBillNO == "")
                {
                    outBillNO = SOC.HISFC.Components.Pharmacy.Function.GetBillNO(this.curStockDept.ID, "0320", "01", ref errInfo);
            ...
            SOC.HISFC.Components.Pharmacy.Function.PrintBill("0310", "01", alInput);
            SOC.HISFC.Components.Pharmacy.Function.PrintBill("0320", "01", alOutput);
        ...
        void IDataChooseList_ChooseCompletedEvent()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        this.ucCommonInput.SetInputObject(item, null, false, DateTime.Now.AddYears(-2));
                    }
                    else
                    {
