...
namespace FS.SOC.Local.Pharmacy.ZhuHai.Common.ZDWY.Input
{
    ...
    /// </summary>
    public class OuterInputApply : FS.SOC.HISFC.Components.Pharmacy.Base.IBaseBiz
    {
        ...
        protected int SaveTemporary()
        {
            ...
            foreach (DataRow dr in this.dtDetail.Rows)
            {
                ...
                {
                    billNO = SOC.HISFC.Components.Pharmacy.Function.GetApplyListNO(this.curStockDept.ID);
