...
namespace FS.SOC.Local.Pharmacy.ZhuHai.Base
{
    ...
    public class PrintBill
    {
        ...
        internal class CompareByPlaceNOAndUserCode : System.Collections.IComparer
        {
            public int Compare(object x, object y)
            {
                string oX = "";
                ...
                {
                    oX = (x as FS.HISFC.Models.Pharmacy.Check).Clone().PlaceNO + (x as FS.HISFC.Models.Pharmacy.Check).Clone().Item.UserCode;
                    oY = (y as FS.HISFC.Models.Pharmacy.Check).Clone().PlaceNO + (y as FS.HISFC.Models.Pharmacy.Check).Clone().Item.UserCode;
                }
        ...
        {
            FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByPlaceNO c = new FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByPlaceNO();
            alPrintData.Sort(c);
        }
        ...
        {
            FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByPlaceNO2 c = new FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByPlaceNO2();
            alPrintData.Sort(c);
        }
        public static void SortByPlaceNO1(ref  System.Collections.ArrayList alPrintData)
        { 
            FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByPlaceNO1 c =  new FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByPlaceNO1();
            alPrintData.Sort(c);
        }
        ...
        {
            FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByTypePlaceNO c = new FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByTypePlaceNO();
            alPrintData.Sort(c);
        }

        public static void SortByBillNO(ref System.Collections.ArrayList alPrintData)
        {
            FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByBillNO c = new FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByBillNO();
            alPrintData.Sort(c);
        }

        public static void SortByCustomerCode(ref System.Collections.ArrayList alPrintData)
        {
            FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByCustomerCode c = new FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByCustomerCode();
            alPrintData.Sort(c);
        }

        public static void SortByOtherSpell(ref System.Collections.ArrayList alPrintData)
        {
            FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByOtherSpell c = new FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByOtherSpell();
            alPrintData.Sort(c);
        }

        public static void SortByPlaceCodeAndCustomCode(ref System.Collections.ArrayList alPrintData)
        {
            FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByPlaceNOAndCustomCode c = new CompareByPlaceNOAndCustomCode();
            alPrintData.Sort(c);
        }

        public static void SortByPlaceCodeAndUserCode(ref System.Collections.ArrayList alPrintData)
        {
            FS.SOC.Local.Pharmacy.ZhuHai.Base.PrintBill.CompareByPlaceNOAndUserCode c = new CompareByPlaceNOAndUserCode();
            alPrintData.Sort(c);
        }
