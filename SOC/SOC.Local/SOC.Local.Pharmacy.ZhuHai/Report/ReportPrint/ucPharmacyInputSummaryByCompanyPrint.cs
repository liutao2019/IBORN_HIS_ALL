...
namespace FS.SOC.Local.Pharmacy.ZhuHai.Print.ZDWY.Report.ReportPrint
{
    ...
    /// 东莞药品入库单据打印
    /// </summary>
    public partial class ucPharmacyInputSummaryByCompanyPrint : ucBaseControl
    {
        ...
        /// 药品入库打印单
        /// </summary>
        public ucPharmacyInputSummaryByCompanyPrint()
        {
            InitializeComponent();
        ...
        private System.Drawing.Printing.Margins DrawingMargins = new System.Drawing.Printing.Margins(30, 0, 200, 30);
        ...
        private void PrintDocumentPrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            FarpointHeight =  (int)(this.neuFpEnter1.Sheets[0].Rows.Default.Height * printBill.RowCount + this.neuFpEnter1_Sheet1.ColumnHeader.Rows.Get(0).Height); 
            ...
            additionTitleLocalY = this.DrawingMargins.Top + this.nlbOper.Location.Y + this.neuPanel4.Height + FarpointHeight;
        ...
        private void SetPrintData(DataTable dt, int inow, int icount, string title,DateTime beginTime,DateTime endTime)
        {
            ...
            for (int i = 0; i < this.dt.Rows.Count; i++)
            {
                ...
                this.neuFpEnter1_Sheet1.Rows[i].Height = 50F;
                DataRow dr = dt.Rows[i];
                this.neuFpEnter1_Sheet1.Cells[i, 0].Text = dr["药品分类"].ToString();
                this.neuFpEnter1_Sheet1.Cells[i, 1].Text = dr["买入金额"].ToString();
                this.neuFpEnter1_Sheet1.Cells[i, 2].Text = dr["零售金额"].ToString();
                this.neuFpEnter1_Sheet1.Cells[i, 3].Text = dr["购零差"].ToString();
