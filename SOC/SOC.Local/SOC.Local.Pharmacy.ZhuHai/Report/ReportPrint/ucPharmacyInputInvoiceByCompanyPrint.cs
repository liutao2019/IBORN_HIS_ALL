...
namespace FS.SOC.Local.Pharmacy.ZhuHai.Print.ZDWY.Report.ReportPrint
{
    ...
    /// 东莞药品入库单据打印
    /// </summary>
    public partial class ucPharmacyInputInvoiceByCompanyPrint : ucBaseControl
    {
        ...
        /// 药品入库打印单
        /// </summary>
        public ucPharmacyInputInvoiceByCompanyPrint()
        {
            InitializeComponent();
        ...
        private void PrintDocumentPrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int additionTitleLocalX = this.DrawingMargins.Left + this.lblAdjustResson.Location.X;
            int additionTitleLocalY = this.DrawingMargins.Top + this.lblAdjustResson.Location.Y;
            ...
            FarpointHeight =  (int)(this.neuFpEnter1.Sheets[0].Rows.Default.Height * printBill.RowCount + 50);
        ...
        private void SetPrintData(DataTable dt, int inow, int icount, string title)
        {
            ...
            for (int i = 0; i < this.dt.Rows.Count; i++)
            {
                ...
                this.neuFpEnter1_Sheet1.Cells[i, 0].Text = dr["公司名称"].ToString();
                this.lblTitle.Text = dr["公司名称"].ToString();
                this.neuFpEnter1_Sheet1.Cells[i, 1].Text = dr["发票号"].ToString();
                this.neuFpEnter1_Sheet1.Cells[i, 2].Text = dr["发票金额"].ToString();
                try
                {
                    this.neuFpEnter1_Sheet1.Cells[i, 3].Text = dr["发票日期"].ToString().Substring(0, 10);
                }
                catch { }
                sumPreTotCost += FS.FrameWork.Function.NConvert.ToDecimal(dr["发票金额"].ToString());
            }
            ...
            this.neuFpEnter1_Sheet1.Cells[this.neuFpEnter1_Sheet1.Rows.Count - 1, 2].Text = sumPreTotCost.ToString("F2"); 
            #endregion
        ...
        public int SetPrintData(DataTable dt)
        {
            if (dt != null && dt.Rows.Count > 0)
            {
                this.dt = dt;
            ...
            this.SetPrintData(dt, 1, 1, string.Empty);
            return this.Print();
        }
