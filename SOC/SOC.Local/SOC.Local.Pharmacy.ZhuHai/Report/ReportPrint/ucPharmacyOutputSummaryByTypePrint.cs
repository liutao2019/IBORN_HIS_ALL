...
namespace FS.SOC.Local.Pharmacy.ZhuHai.Print.ZDWY.Report.ReportPrint
{
    ...
    /// 东莞药品入库单据打印
    /// </summary>
    public partial class ucPharmacyOutputSummaryByTypePrint : ucBaseControl
    {
        ...
        /// 药品入库打印单
        /// </summary>
        public ucPharmacyOutputSummaryByTypePrint()
        {
            InitializeComponent();
        ...
        private System.Drawing.Printing.Margins DrawingMargins = new System.Drawing.Printing.Margins(30, 0, 190, 30);
        ...
        private void SetPrintData(DataTable dt, int inow, int icount, string title,DateTime beginTime,DateTime endTime)
        {
            ...
            for (int i = 0; i < this.dt.Rows.Count; i++)
            {
                ...
                sumDif += FS.FrameWork.Function.NConvert.ToDecimal(dr["进销差额"].ToString());
            }
            this.neuFpEnter1_Sheet1.Rows.Add(this.neuFpEnter1_Sheet1.Rows.Count, 1);
            this.neuFpEnter1_Sheet1.Rows[this.neuFpEnter1_Sheet1.Rows.Count - 1].Height = 50F;
