...
namespace FS.SOC.Local.Pharmacy.ZhuHai.Print.ZDWY.Report.ReportPrint
{
    ...
    /// 东莞药品入库单据打印
    /// </summary>
    public partial class ucCheckReportTotPrint : ucBaseControl
    {
        ...
        private void PrintDocumentPrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            FarpointHeight =  (int)(this.neuFpEnter1.Sheets[0].Rows.Default.Height * this.neuFpEnter1_Sheet1.Rows.Count +110);
        ...
        private void SetPrintData(DataTable dt, int inow, int icount, string title,DateTime beginTime,DateTime endTime,string deptCode)
        {
            ...
            for (int i = 0; i < this.dt.Rows.Count; i++)
            {
                ...
                this.neuFpEnter1_Sheet1.Cells[i, 0].Text = dr["类别"].ToString();
                this.neuFpEnter1_Sheet1.Cells[i, 1].Text = dr["类别1"].ToString();
                this.neuFpEnter1_Sheet1.Cells[i, 2].Text = dr["账本金额"].ToString();
                this.neuFpEnter1_Sheet1.Cells[i, 3].Text = dr["实存金额"].ToString();
                this.neuFpEnter1_Sheet1.Cells[i, 4].Text = dr["增减金额"].ToString();
            }
            #endregion
