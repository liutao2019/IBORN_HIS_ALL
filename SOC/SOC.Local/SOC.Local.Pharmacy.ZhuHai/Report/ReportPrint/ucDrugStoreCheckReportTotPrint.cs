...
namespace FS.SOC.Local.Pharmacy.ZhuHai.Print.ZDWY.Report.ReportPrint
{
    ...
    /// 东莞药品入库单据打印
    /// </summary>
    public partial class ucDrugStoreCheckReportTotPrint : ucBaseControl
    {
        ...
        /// 药品入库打印单
        /// </summary>
        public ucDrugStoreCheckReportTotPrint()
        {
            InitializeComponent();
        ...
        private System.Drawing.Printing.Margins DrawingMargins = new System.Drawing.Printing.Margins(30, 0, 140, 30);
        ...
        private void PrintDocumentPrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            FarpointHeight =  (int)(this.neuFpEnter1.Sheets[0].Rows.Default.Height * printBill.RowCount +70);
            ...
            additionTitleLocalY = this.DrawingMargins.Top + this.label2.Location.Y + this.neuPanel3.Height + FarpointHeight - 70;
            ...
            additionTitleLocalY = this.DrawingMargins.Top + this.nlbOper.Location.Y + this.neuPanel3.Height + FarpointHeight - 70;
        ...
        private void SetPrintData(DataTable dt, int inow, int icount, string title,DateTime beginTime,DateTime endTime,string deptCode)
        {
            ...
            this.lblTitle.Text = ajustMgr.Hospital.Name + SOC.HISFC.BizProcess.Cache.Common.GetDeptName(deptCode) + "药品盘点表";
            #region Farpoint赋值
            for (int i = 0; i < this.dt.Rows.Count; i++)
            {
               
                DataRow dr = dt.Rows[i];
                if (dr["类别1"].ToString() == "零售")
                {
                    continue;
                }
                if (dr["类别1"].ToString() == "购入")
                {
                    this.neuFpEnter1_Sheet1.AddRows(this.neuFpEnter1_Sheet1.Rows.Count, 1);
                    this.neuFpEnter1_Sheet1.Cells[this.neuFpEnter1_Sheet1.Rows.Count - 1, 0].Text = dr["类别"].ToString();
                    this.neuFpEnter1_Sheet1.Cells[this.neuFpEnter1_Sheet1.Rows.Count - 1, 1].Text = dr["账本金额"].ToString();
                    this.neuFpEnter1_Sheet1.Cells[this.neuFpEnter1_Sheet1.Rows.Count - 1, 2].Text = dr["实存金额"].ToString();
                    this.neuFpEnter1_Sheet1.Cells[this.neuFpEnter1_Sheet1.Rows.Count - 1, 3].Text = (FS.FrameWork.Function.NConvert.ToDecimal(dr["实存金额"]) - FS.FrameWork.Function.NConvert.ToDecimal(dr["账本金额"])).ToString();
                }
        ...
        public int SetPrintData(DataTable dt,DateTime beginTime,DateTime endTime,string deptCode)
        {
            if (dt != null && dt.Rows.Count > 0)
            {
                this.dt = dt;
            ...
            this.SetPrintData(dt, 1, 1, string.Empty, beginTime, endTime, deptCode);
            return this.Print();
        }
