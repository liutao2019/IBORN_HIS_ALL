...
{
    public partial class InpatientAntimicrobialsConsumption:FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        #region SQL
...
//order by bb.custom_code
        #endregion
        public InpatientAntimicrobialsConsumption()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.DeptOfMedcine.InpatientAntimicrobialsConsumption";
            //this.PriveClassTwos = "0320";
            this.MainTitle = "住院科室抗菌药消耗费用";
            //this.DeptType = "P";
