...
{
    public partial class InPatientOutAntUsePerson:FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        #region SQL
...
//order by bb.custom_code
        #endregion
        public InPatientOutAntUsePerson()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.DeptOfMedcine.InPatientOutAntUsePerson";
            //this.PriveClassTwos = "0320";
            this.MainTitle = "各科室抗菌药使用出院人数";
            //this.DeptType = "P";
