...
{
    public partial class DrugWarehouseSummary:FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        #region SQL
...
//order by bb.custom_code
        #endregion
        public DrugWarehouseSummary()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.DeptOfMedcine.DrugWarehouseSummary";
            //this.PriveClassTwos = "0320";
            this.MainTitle = "全院药品入库汇总表(按药品)";
            //this.DeptType = "P";
