...
{
    public partial class InPatientDrugConsumption:FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        #region SQL
...
//order by bb.custom_code
        #endregion
        public InPatientDrugConsumption()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.DeptOfMedcine.InPatientDrugConsumption";
            //this.PriveClassTwos = "0320";
            this.MainTitle = "住院药品消耗数据（按药品）";
            //this.DeptType = "P";
