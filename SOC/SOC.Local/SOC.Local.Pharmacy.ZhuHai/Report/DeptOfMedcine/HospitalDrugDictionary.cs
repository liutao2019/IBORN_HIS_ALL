...
{
    public partial class HospitalDrugDictionary:FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        #region SQL
...
//order by bb.custom_code
        #endregion
        public HospitalDrugDictionary()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.DeptOfMedcine.HospitalDrugDictionary";
            //this.PriveClassTwos = "0320";
            this.MainTitle = "药品类别字典（全院）";
            //this.DeptType = "P";
