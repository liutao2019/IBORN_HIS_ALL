...
{
    public partial class HospitalDrugConsumption:FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        #region SQL
...
//order by bb.custom_code
        #endregion
        public HospitalDrugConsumption()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.DeptOfMedcine.HospitalDrugConsumption";
            //this.PriveClassTwos = "0320";
            this.MainTitle = "全院药品消耗(按药品)";
            //this.DeptType = "P";
