...
{
    public partial class DrugWarehouseSummaryByDeptBaseDrugCode:FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        #region SQL
...
//order by bb.custom_code
        #endregion
        public DrugWarehouseSummaryByDeptBaseDrugCode()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.DeptOfMedcine.DrugWarehouseSummaryByDeptBaseDrugCode";
            //this.PriveClassTwos = "0320";
            this.MainTitle = "全院药房消耗汇总表(按基本药物)";
            //this.DeptType = "P";
