...
{
    public partial class BaseDrugReport:FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        #region SQL
...
//order by bb.custom_code
        #endregion
        public BaseDrugReport()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.DeptOfMedcine.BaseDrugReport";
            //this.PriveClassTwos = "0320";
            this.MainTitle = "药学部基本药物报表";
            //this.DeptType = "P";
