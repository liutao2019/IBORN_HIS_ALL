...
{
    public partial class ucOutpatientDeptDrugUseRate:FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        /// <summary>
        /// 门诊科室处方用药使用率排名
        /// </summary>
        public ucOutpatientDeptDrugUseRate()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.SunnyDrug.ucOutpatientDeptDrugUseRate";
            this.MainTitle = "门诊科室处方用药使用率排名";
