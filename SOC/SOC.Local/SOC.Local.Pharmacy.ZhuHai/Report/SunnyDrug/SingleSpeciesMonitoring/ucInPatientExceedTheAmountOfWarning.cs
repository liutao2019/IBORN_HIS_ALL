...
{
    public partial class ucInPatientExceedTheAmountOfWarning : FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        ...
        /// 住院药品超过规定金额预警
        /// </summary>
        public ucInPatientExceedTheAmountOfWarning()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.SunnyDrug.InPatientExceedTheAmountOfWarning";
            this.MainTitle = "住院药品超过规定金额预警";
