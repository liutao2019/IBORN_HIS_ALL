...
{
    public partial class ucInpatientDoctorDrugRate:FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        /// <summary>
        /// 住院医生药品比例排名
        /// </summary>
        public ucInpatientDoctorDrugRate()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.SunnyDrug.ucInpatientDoctorDrugRate";
            this.MainTitle = "住院医生药品比例排名";
