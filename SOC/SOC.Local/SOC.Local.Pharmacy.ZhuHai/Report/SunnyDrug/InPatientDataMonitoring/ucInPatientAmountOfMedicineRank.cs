...
{
    public partial class ucInPatientAmountOfMedicineRank: FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        /// <summary>
        /// 住院科室用药金额数量排名
        /// </summary>
        public ucInPatientAmountOfMedicineRank()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.SunnyDrug.InPatientAmountOfMedicineRank.Amount";
            this.MainTitle = "住院科室用药金额数量排名";
        ...
        protected override int OnQuery(object sender, object neuObject)
        {
            ...
            {
                this.SQLIndexs = "Pharmacy.NewReport.SunnyDrug.InPatientAmountOfMedicineRank.TotCost";
            }
            else
            {
                this.SQLIndexs = "Pharmacy.NewReport.SunnyDrug.InPatientAmountOfMedicineRank.Amount";
