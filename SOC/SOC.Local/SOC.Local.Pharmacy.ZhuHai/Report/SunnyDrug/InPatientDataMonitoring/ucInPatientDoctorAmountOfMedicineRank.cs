...
{
    public partial class ucInPatientDoctorAmountOfMedicineRank:FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        /// <summary>
        /// 住院医生用药金额数量排名
        /// </summary>
        public ucInPatientDoctorAmountOfMedicineRank()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.SunnyDrug.InPatientDoctorAmountOfMedicineRank.Amount";
            this.MainTitle = "住院医生用药金额数量排名";
        ...
        protected override int OnQuery(object sender, object neuObject)
        {
            ...
            {
                this.SQLIndexs = "Pharmacy.NewReport.SunnyDrug.InPatientDoctorAmountOfMedicineRank.TotCost";
            }
            else
            {
                this.SQLIndexs = "Pharmacy.NewReport.SunnyDrug.InPatientDoctorAmountOfMedicineRank.Amount";
