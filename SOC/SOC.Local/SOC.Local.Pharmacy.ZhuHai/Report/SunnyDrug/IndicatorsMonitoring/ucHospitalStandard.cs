...
{
    public partial class ucHospitalStandard : FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        /// <summary>
        /// 全院监控
        /// </summary>
        public ucHospitalStandard()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.SunnyDrug.HospitalStandard";
            this.MainTitle = "全院监控";
