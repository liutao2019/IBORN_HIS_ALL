...
{
    public partial class ucInpatientStandard : FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        /// <summary>
        /// 住院监控
        /// </summary>
        public ucInpatientStandard()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.SunnyDrug.InpatientStandard";
            this.MainTitle = "住院监控";
