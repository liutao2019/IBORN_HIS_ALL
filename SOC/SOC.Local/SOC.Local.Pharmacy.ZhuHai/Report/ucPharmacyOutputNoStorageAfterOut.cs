...
{
    public partial class ucPharmacyOutputNoStorageAfterOut : FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        #region SQL
 ...
 //order by t.apply_billcode, b.custom_code
        #endregion
        public ucPharmacyOutputNoStorageAfterOut()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.InOut.PharmacyOutputNoStorageAfterOut";
            //this.PriveClassTwos = "0320";
            this.MainTitle = "中山大学附属第五医院出库后零库存报表";
            //this.DeptType = "P";
            this.PriveClassTwos = "0320";
