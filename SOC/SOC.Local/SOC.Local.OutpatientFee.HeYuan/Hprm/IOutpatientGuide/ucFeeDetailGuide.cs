        ...
        private void AddFeeDetail(ArrayList alFeeDetail)
        {
            ...
            foreach (FS.HISFC.Models.Fee.Outpatient.FeeItemList feeItemList in alFeeDetail)
            {
                ...
                if (feeItemList.FeePack.Equals("1"))//包装单位
                {
                    ...
                    this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 2].Text = feeItemList.Item.Price.ToString("F2");
                ...
                else
                {
                    ...
                    this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 2].Text = (feeItemList.Item.Price / feeItemList.Item.PackQty).ToString("F2");
