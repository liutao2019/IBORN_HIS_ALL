    ...
    public partial class ucPrepayIn : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        ...
        protected virtual int Init()
        {
            ...
            try
            {
               ...
               // this.cmbPreDoc.AddItems(this.managerIntegrate.QueryEmployee(EnumEmployeeType.D));
                ...
                //this.lblDocName.Text = FS.FrameWork.Management.Connection.Operator.Name;
                //this.lblDocID.Text = FS.FrameWork.Management.Connection.Operator.ID;
        ...
        private void getPrePatient(FS.HISFC.Models.RADT.PatientInfo obj)
        {
            try
            {
                ...
                {
                    this.ucQueryInpatientNo2.Text = obj.Name;//姓名                     
                    ...
                    this.dtpBirthDay.Text = obj.Birthday.ToString();//出生日期
        ...
        private bool checkValid()
        {
            ...
            //科室长度
            if (!FS.FrameWork.Public.String.ValidMaxLengh(this.cmbDept.Text, 18))
            {
        ...
        private void setPrePatient()
        {
            try
            {
                ...
                this.myPatientInfo.PID.CardNO = txtCardNo2.Text;//病例号
                ...
                this.myPatientInfo.Name = this.ucQueryInpatientNo2.Text.ToString();//姓名
                ...
                this.myPatientInfo.IDCard = this.txtIdentity.Text.ToString();//身份证号
                ...
                this.myPatientInfo.AddressHome = this.txtHomeAddrd.Text.ToString();//家庭住址
                this.myPatientInfo.PhoneHome = this.txtLinkTel.Text;//家庭电话
        ...
        private void cmbDept_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (alNurseCell != null)
            {
                FS.FrameWork.Models.NeuObject nurseCell = alNurseCell[0] as FS.FrameWork.Models.NeuObject;
                if (nurseCell != null)
                {
