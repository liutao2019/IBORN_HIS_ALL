    ...
    public partial class ucOutPatientNotice : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.IPrintInHosNotice
    {
      ...
      　private FS.HISFC.BizProcess.Integrate.Fee feeIntegrate = new FS.HISFC.BizProcess.Integrate.Fee();
            ...
            try
            {
                if (obj.Name != null)
                {
                   ...
                   // this.txtCardNo.Text = obj.PID.CardNO;//病例号
                    ...
                    this.txtDoctor.Text = FS.FrameWork.Management.Connection.Operator.Name;
                    this.txtDoctorCode.Text = FS.FrameWork.Management.Connection.Operator.ID;
        ...
        private void dtBirthday_TextChanged(object sender, EventArgs e)
        {
            ...
            birthday = FS.FrameWork.Function.NConvert.ToDateTime(this.dtBirthday.Text);
