...
{
    public partial class ucPrepayInOld : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public ucPrepayInOld()
        {
            InitializeComponent();
        }
        ...
        private void setPrePatient()
        {
            try
            {
                ...
                this.myPatientInfo.AddressHome = this.txtHomeAddr.Text;//家庭住址
                ...
                this.myPatientInfo.Kin.RelationAddress = this.txtLinkManAddr.Text;//联系人住址
        ...
        #region 事件
        private void ucPrepayInOld_Load(object sender, EventArgs e)
        {
            if (!this.DesignMode)
            {
                Init();
