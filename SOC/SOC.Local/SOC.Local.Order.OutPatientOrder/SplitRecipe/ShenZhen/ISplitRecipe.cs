...
namespace FS.SOC.Local.Order.OutPatientOrder.SplitRecipe.ShenZhen
{
    /// <summary>
    /// 默认分处方接口
    /// </summary>
        ...
        public bool SetNoteNo(ArrayList feeDetails, ref string errText,FS.HISFC.Models.Registration.Register r)
        {
            ...
            while (feeDetails.Count > 0)
            {
                ...
                foreach (FeeItemList f in feeDetails)
                {
                    ...
                    //        //下面判断 其他非药品也和某些药品一个处方，这个先不管吧
                    //        //非药品只判断组合号
                    //        //if (f.Item.IsMaterial && f.Order.Combo.ID == compareItem.Order.Combo.ID)
                    //        //{
                    //        //    sameNotes.Add(f);
                    //        //}
                    //        //else
                    ...
                    //            && f.ExecOper.Dept.ID == compareItem.ExecOper.Dept.ID
                    //            && f.Days == compareItem.Days
                    //            && f.Order.Combo.ID == compareItem.Order.Combo.ID
                    //            )
                    //        {
                    //            sameNotes.Add(f);
                    //        }
