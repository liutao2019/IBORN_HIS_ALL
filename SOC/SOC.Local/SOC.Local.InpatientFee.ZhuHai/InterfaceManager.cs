...
namespace FS.SOC.Local.InpatientFee.ZhuHai
{
    ...
    public class InterfaceManager
    {
        ...
        {
            return FS.SOC.HISFC.BizProcess.CommonInterface.ControllerFactroy.CreateFactory().CreateInferface<FS.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrintmy>(typeof(InterfaceManager), null);
        }
    }
}
