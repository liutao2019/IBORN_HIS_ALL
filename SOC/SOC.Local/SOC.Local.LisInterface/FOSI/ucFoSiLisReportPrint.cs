...
{
    public partial class ucFoSiLisReportPrint : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.Order.ISaveOrder, FS.HISFC.BizProcess.Interface.Order.ILisReportPrint
    {
        public ucFoSiLisReportPrint()
        {
            InitializeComponent();
        }
            ...
            set
            {
                ...
                if (alLisItems != null && alLisItems.Count > 0)
                {
                    ...
                    for (int i = 0; i < alLisItems.Count; i++)
                    {
                        ...
                        itemName = orderItem.Item.Name + "[" + orderItem.Item.Qty.ToString() + orderItem.Unit + "]"+"(标本："+orderItem.Sample.ToString()+")";
        ...
        private void SetPatientInfo(FS.HISFC.Models.Registration.Register register)
        {
            ...
            lbCilicCode.Text = "门诊号： " + register.PID.CardNO;
        ...
        public int LisReportPrintForInPatient(FS.HISFC.Models.RADT.PatientInfo patientInfo, FS.FrameWork.Models.NeuObject reciptDept, FS.FrameWork.Models.NeuObject reciptDoct, System.Collections.ArrayList alLisOrder)
        {
            return  1;
        }

        public int LisReportPrintForOutPatient(FS.HISFC.Models.Registration.Register regObj, FS.FrameWork.Models.NeuObject reciptDept, FS.FrameWork.Models.NeuObject reciptDoct, System.Collections.ArrayList alLisOrder)
        {
            return this.LisReportPrint(regObj, alLisOrder, true);
        }
        ...
        /// <returns></returns>
        private int LisReportPrint(FS.HISFC.Models.Registration.Register regObj, ArrayList alOrder, bool isShowNoNote)
        {
            try
            {
                this.RegInfo = regObj;
        ...
        {
            return this.LisReportPrint(regObj, alOrder, false);
        }
