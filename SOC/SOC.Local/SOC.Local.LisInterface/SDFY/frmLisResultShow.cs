    ...
    public partial class frmLisResultShow : FS.FrameWork.WinForms.Forms.BaseForm
    {
        ...
        public int ShowResultByPatient()
        {
            ...
            if (this.cbxIsAll.Checked)
            {
                ...
                url = "http://201.201.201.6:5555/transaction/search_for_his/list.asp?ptnt_no_type=" + patientType + "&ptnt_name=" + patientName + "&ptnt_no=" + patientNo + "&sqnc_no=" + clinicNo + "&dept_key=" + "";
            }
            else
            {
                ...
                url = "http://201.201.201.6:5555/transaction/search_for_his/list.asp?ptnt_no_type=" + patientType + "&ptnt_name=" + patientName + "&ptnt_no=" + "" + "&sqnc_no=" + clinicNo + "&dept_key=" + deptCode;
            }
