...
{
    public partial class ucMatInputInvoicedCAD : Base.ucCrossQueryBaseForFarPoint
    {
        public ucMatInputInvoicedCAD()
        {
            InitializeComponent();
        }
        ...
        protected override int OnQuery(object sender, object neuObject)
        {
            ...
            this.QuerySql = "SOC.Local.Material.Report.Input.Invoiced.CompAndKind";
