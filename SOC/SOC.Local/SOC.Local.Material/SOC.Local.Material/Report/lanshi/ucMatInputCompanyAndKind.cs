...
{
    public partial class ucMatInputCompanyAndKind : Base.ucCrossQueryBaseForFarPoint
    {
        public ucMatInputCompanyAndKind()
        {
            InitializeComponent();
        }
        ...
        protected override int OnQuery(object sender, object neuObject)
        {
            ...
            this.QuerySql = "SOC.Local.Material.Report.lanshi.Input.CompanyAndKind";
