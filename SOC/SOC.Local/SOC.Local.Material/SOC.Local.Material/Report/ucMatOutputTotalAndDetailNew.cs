...
{
    public partial class ucMatOutputTotalAndDetailNew : Base.ucPrivePowerReport
    {
        public ucMatOutputTotalAndDetailNew()
        {
            InitializeComponent();
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (this.totType == EnumOutTotalType.按领用科室汇总)
            {
                ...
                this.SQLIndexs = "SOC.Local.Material.Report.Target.OutputTotal.New";
                this.DetailSQLIndexs = "SOC.Local.Material.Report.Target.OutputDetail";
            }
            else if (this.totType == EnumOutTotalType.按类别汇总)
            {
                this.MainTitle = "按类别汇总、明细出库表";
                this.SQLIndexs = "SOC.Local.Material.Report.Kind.OutputTotal.New";
            ...
            else if (this.totType == EnumOutTotalType.按出库单汇总)
            {
                ...
                this.SQLIndexs = "SOC.Local.Material.Report.Bill.OutputTotal.New";
            ...
            else if (this.totType == EnumOutTotalType.按物品汇总)
            {
                ...
                this.SQLIndexs = "SOC.Local.Material.Report.Gods.OutputTotal.New";
