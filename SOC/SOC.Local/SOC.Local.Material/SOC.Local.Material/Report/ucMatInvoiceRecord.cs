...
{
    public partial class ucMatInvoiceRecord : Base.BaseReport
    {
        public ucMatInvoiceRecord()
        {
            InitializeComponent();
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            this.MainTitle = "项目入出库汇总表";

            this.SQLIndexs = "SOC.Local.Material.Report.RecordTotal";
