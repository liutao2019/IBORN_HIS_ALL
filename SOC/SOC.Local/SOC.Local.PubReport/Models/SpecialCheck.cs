...
namespace FS.SOC.Local.PubReport.Models
{
    ...
    public string WorkPlace
    {
        ...
        new public SOC.Local.PubReport.Models.SpecialCheck Clone()
        {
            SOC.Local.PubReport.Models.SpecialCheck obj = base.Clone() as SOC.Local.PubReport.Models.SpecialCheck;
            return obj;
        }
