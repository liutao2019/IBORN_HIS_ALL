    ...
    public partial class frmMiltScreen : Form, Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMultiScreen
    {
        ...
        public System.Collections.Generic.List<Object> ListInfo
        {
            ...
            set
            {
                ...
                {
                    //患者信息，卡号，收费员id，收费员姓名
                    this.SetShowInfomation(value[0] as Neusoft .HISFC .Models .RADT .PatientInfo , value[1] as string, value[2] as string, value[3] as string);
        ...
        public void SetShowInfomation(Neusoft .HISFC .Models .RADT .PatientInfo a, string b, string c, string d)
        {
            if (c.ToString() == "")
            { 
