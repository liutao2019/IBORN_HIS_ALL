namespace FS.SOC.Local.Registration.GuangZhou.Gyzl.ICompletionAddress
{
    partial class frmSelectAddress
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 0).Value = "地址";
            this.fpSpread1_Sheet1.Columns.Get(0).CellType = textCellType1;
            this.fpSpread1_Sheet1.Columns.Get(0).Label = "地址";
            this.fpSpread1_Sheet1.Columns.Get(0).Width = 500F;
            ...
            this.label1.Text = "地址信息,通过上下键选择项目";
            // 
            // frmSelectAddress
            // 
