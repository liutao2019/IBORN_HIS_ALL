...
namespace FS.SOC.Local.DrugStore.ZhuHai.ZDWY.InPatient
{
    ...
    public class PrintInterfaceImplement : FS.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.IInpatientDrug, FS.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.IInPatientDrugTotalPrint
    {
        ...
        ucAnestheticDrugBill ucAnestheticDrugBill;
            ...
            foreach (SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.InpatientBillType billType in listBillType)
            {
                ...
                else if (billType == FS.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.InpatientBillType.明细)
                {
                    ...
                    if (drugBillClass.ID == "P")
                    {
                        ...
                        {
                            if (SOC.HISFC.BizProcess.Cache.Common.GetDrugQualitySystem(applyInfo.Item.Quality.ID) == "S" || SOC.HISFC.BizProcess.Cache.Common.GetDrugQualitySystem(applyInfo.Item.Quality.ID) == "P")
                            {
