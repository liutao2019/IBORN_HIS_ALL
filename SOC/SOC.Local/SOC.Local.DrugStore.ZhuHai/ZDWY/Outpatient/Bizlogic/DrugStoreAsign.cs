...
namespace FS.SOC.Local.DrugStore.ZhuHai.ZDWY.Outpatient.Bizlogic
{
    /// <summary>
    /// 药房叫号业务层
    /// </summary>
    public class DrugStoreAsign:FrameWork.Management.Database
    {
        ...
        /// <returns></returns>
        protected object[] myGetParmInsertQueue(FS.SOC.Local.DrugStore.ZhuHai.ZDWY.Outpatient.Models.DrugStoreAsign  drugStoreAsign)
        {
            object[] strParm ={	
        ...
        /// <returns></returns>
        public int Insert(FS.SOC.Local.DrugStore.ZhuHai.ZDWY.Outpatient.Models.DrugStoreAsign drugStoreAsign)
        {
            string strSQL = "";
            //取插入操作的SQL语句
