...
{
    public partial class ucInPatientDrugWorkLoad : FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        public ucInPatientDrugWorkLoad()
        {
            #region SQL
 ...
 //order by ccc.billclass_name,aa.dept_code
            ...
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.InPatientDrugStore.WorkLoadP";
            this.IsNeedDetailData = true;
            this.DetailSQLIndexs = "Pharmacy.NewReport.InPatientDrugStore.WorkLoadPDetail";
            this.DetailDataQueryType = EnumQueryType.汇总条件活动行;
            this.QueryConditionColIndexs = "1";
            //this.PriveClassTwos = "0320";
            this.MainTitle = "住院药房工作量统计";
            //this.DeptType = "P";
            this.PriveClassTwos = "0320";
            this.SumColIndexs = "4";
