...
{
    public partial class ucOutPatientDrugWorkLoad : FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        private FS.HISFC.BizLogic.Manager.Constant consMgr = new FS.HISFC.BizLogic.Manager.Constant();

        public ucOutPatientDrugWorkLoad()
        {
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.OutPatientDrugStore.WorkLoadP";
            //this.PriveClassTwos = "0320";
            this.MainTitle = "门诊药房工作量统计";
            //this.DeptType = "P";
            this.PriveClassTwos = "0320";
