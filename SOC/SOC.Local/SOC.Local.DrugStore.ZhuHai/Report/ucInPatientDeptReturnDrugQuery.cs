...
{
    public partial class ucInPatientDeptReturnDrugQuery : FS.SOC.Local.Pharmacy.Base.BaseReport
    {
        public ucInPatientDeptReturnDrugQuery()
        {
            #region SQL
 ...
 //order by ccc.billclass_name,aa.dept_code
            ...
            InitializeComponent();
            this.SQLIndexs = "Pharmacy.NewReport.InPatientDrugStore.DeptReturnDrugQuery";
            //this.PriveClassTwos = "0320";
            this.MainTitle = "病区退药确认查询";
            this.DeptType = "N,T";
            this.IsAllowAllDept = true;
            this.SumColIndexs = "11";
