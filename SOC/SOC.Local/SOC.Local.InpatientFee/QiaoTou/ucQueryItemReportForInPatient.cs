...
{
    /// <summary>
    /// 住院项目使用情况查询{B6EC1AC8-5BDE-4b31-A070-1A16AF19099E}
    /// </summary>
    public partial class ucQueryItemReportForInPatient : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucQueryItemReportForInPatient()
        {
            InitializeComponent();
        }
        ...
        private int QueryReport()
        {
            ...
            if (this.ItemFlag == "0")
            {
                if (this.feeMgr.QueryItemReportForInPatient(begin, end, itemCode, "0", ref dsResult) == -1)
                {
            ...
            {
                if (this.feeMgr.QueryItemReportForInPatient(begin, end, itemCode, "1", ref dsResult) == -1)
                {
                    MessageBox.Show(this.feeMgr.Err);
                    return -1;
                }
        ...
        private void ShowData(DataSet dsResult, string itemCode)
        {
            ...
            //>>{41D26AD0-0356-4ef2-9924-709F64478026}统计由sql完成
