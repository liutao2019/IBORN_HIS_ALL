...
{
    public partial class ucFinIpbPatientDayFeeByStatGZ : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucFinIpbPatientDayFeeByStatGZ()
        {
            InitializeComponent();
        }
            ...
            foreach (string inpatientNo in inpatientLine)
            {
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    ...
                    foreach (DictionaryEntry item in objHash)
                    {
                        ...
                        this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 5].Text = "日期:" + dtBeginTime.ToShortDateString();
                        ...
                        this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 2, 0].Text = "今天金额：";
                        ...
                        this.neuSpread1_Sheet1.Rows.Add(this.neuSpread1_Sheet1.RowCount, 1);
                        this.neuSpread1_Sheet1.Models.Span.Add(this.neuSpread1_Sheet1.RowCount - 1, 0, 1, 6);
                        this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = "备注：此清单结算费用仅供参考，最终以医保结算为准。打印时间：" + DateTime.Now.ToString();
