    ...
    public partial class ucInpatientDayBalanceReport : UserControl
    {
        ...
        {      
            ...
            try
            {
                ...
                sheet.Cells[sheet.RowCount - 1, 2].Text = "上缴卡数：";
                ...
                sheet.RowCount += 1;
                //顺德社保
                sheet.Cells[sheet.RowCount - 1, 0].Text = "顺德社保：";
                sheet.Cells[sheet.RowCount - 1, 1].Tag = EnumCellName.A007;
                //优惠优待
                sheet.Cells[sheet.RowCount - 1, 2].Text = "优惠优待：";
                ...
                //特约单位
                sheet.Cells[sheet.RowCount - 1, 6].Text = "特约单位：";
                ...
                //现金结算
                sheet.Cells[sheet.RowCount - 1, 2].Text = "刷卡金额：";
                sheet.Cells[sheet.RowCount - 1, 3].Tag = EnumCellName.A013;
                //刷卡结算
                sheet.Cells[sheet.RowCount - 1, 4].Text = "注销押金：";
                ...
                sheet.RowCount += 1;
                //有效押金数
                sheet.Cells[sheet.RowCount - 1, 0].Text = "有效押金数：";
                sheet.Cells[sheet.RowCount - 1, 1].Tag = EnumCellName.A014;
                //作废押金数
                sheet.Cells[sheet.RowCount - 1, 2].Text = "作废押金数：";
                ...
                sheet.RowCount += 1;
                //押金总额
                sheet.Cells[sheet.RowCount - 1, 0].Text = "预交金总额：";
                ...
                //刷卡结算
                sheet.Cells[sheet.RowCount - 1, 4].Text = "刷卡金额：";
