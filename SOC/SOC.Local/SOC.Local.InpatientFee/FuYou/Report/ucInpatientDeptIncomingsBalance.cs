...
{
    public partial class ucInpatientDeptIncomingsBalance : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucInpatientDeptIncomingsBalance()
        {
            InitializeComponent();
        ...
        protected override int OnQuery(object sender, object neuObject)
        {
            ...
            if (this.inpatientFeeMgr.QueryInpatientDeptIncomingBalance(strDeptID, this.dtpBeginDate.Value, this.dtpEndDate.Value, ref ds) == -1)
            {
