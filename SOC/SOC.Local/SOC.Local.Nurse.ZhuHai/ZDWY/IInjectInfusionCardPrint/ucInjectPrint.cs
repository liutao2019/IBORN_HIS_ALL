...
namespace Neusoft.SOC.Local.Nurse.ZhuHai.ZDWY.IInjectPrint
{
    public partial class ucInjectPrint : UserControl, Neusoft.HISFC.BizProcess.Interface.Nurse.IInjectPrint
    {
        ...
        /// 频次帮助类
        /// </summary>
        private Neusoft.FrameWork.Public.ObjectHelper freqHelper = new Neusoft.FrameWork.Public.ObjectHelper();

        /// <summary>
        /// 公用方法类
        /// </summary>
        private Neusoft.SOC.Local.Nurse.ZhuHai.ZDWY.Common comManager = new Neusoft.SOC.Local.Nurse.ZhuHai.ZDWY.Common();
        ...
        /// alPrintData[1] Neusoft.HISFC.Models.Registration.Register 患者信息
        /// alPrintData[2] ArrayList 选择的打印注射项目
        ///                Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList itemInfo
        /// </summary>
        ...
        public void Init(System.Collections.ArrayList alPrintData)
        {
            ...
            this.register = alPrintData[1] as Neusoft.HISFC.Models.Registration.Register;
        ...
        private int countInjectItem(ArrayList alInjectItem)
        {
            ...
            for (int i = 0; i < alInjectItem.Count; i++)
            {
                rowCount += 3;//一个项目占3行
                comboItemCount++;
                Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList detail = alInjectItem[i] as Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList;
        ...
        private int setInjectItem(ArrayList alInjectItem)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < alInjectItem.Count; i++)
                {
                    ...
                    {
                        Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList nextDetail = alInjectItem[i + 1] as Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList;
