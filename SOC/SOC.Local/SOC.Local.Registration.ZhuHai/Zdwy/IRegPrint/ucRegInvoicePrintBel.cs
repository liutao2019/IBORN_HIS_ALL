...
namespace FS.SOC.Local.Registration.ZhuHai.Zdwy.IRegPrint
{
    ...
    /// </summary>
    public partial class ucRegInvoicePrintBel : UserControl, FS.HISFC.BizProcess.Interface.Registration.IRegPrint
    {
        public ucRegInvoicePrintBel()
        {
            InitializeComponent();
        }
        ...
        public int SetPrintValue(FS.HISFC.Models.Registration.Register register)
        {
            try
            {
                    ...
                    && string.IsNullOrEmpty(register.DoctorInfo.Templet.Dept.ID))
                {
                    ...
                    this.lblHospitalName.Text = curDepartment.HospitalName;
                    ...
                    //挂号员号
                    this.lblRegOper.Text = "挂号员：" + SOC.HISFC.BizProcess.Cache.Common.GetEmployeeName(register.InputOper.ID) + "(" + register.InputOper.ID + ")";
                ...
                else
                {
                    ...
                    //this.lblTime.Text = "挂号时间：" + register.InputOper.OperTime.ToString();
                    this.lblTime.Text = "挂号时间：" + register.InputOper.OperTime.ToString("HH:mm:ss");
                    //this.lblCardNo.Text = "就诊卡号：" + register.PID.CardNO;
                    this.lblCardNo.Text = register.PID.CardNO;
