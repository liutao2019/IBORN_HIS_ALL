...
namespace FS.SOC.Local.HISWebService.PE
{
    /// <summary>
    /// Account 的摘要说明。
    /// </summary>
    public class PEChargeService_Db : FS.FrameWork.Management.Database
    {
        /// <summary>
        /// 构造函数
        /// </summary>
		...
		/// <returns></returns>
		public int InsertPERegister(FS.HISFC.Models.Registration.Register register)
		{
			string sql="";
			...
			try
			{
				sql = string.Format(sql,register.ID,    register.PID.CardNO,
                    ...
                    FS.FrameWork.Function.NConvert.ToInt32(register.IsEncrypt),register.NormalName) ;
        ...
        /// <returns></returns>
        public FS.HISFC.Models.Account.PatientAccount GetPatientInfo(string cardNO, string temp)
        {
            ...
            if (this.Sql.GetSql("Fee.Account.SelectPatientWhere10", ref SqlWhere) == -1)
                return null;
            FS.HISFC.Models.Account.PatientAccount patientInfo = null;
            try
            {
              ...
              where and a.card_no='{0}'
                ...
                while (this.Reader.Read())
                {
                    ...
                    patientInfo.Birthday = FS.FrameWork.Function.NConvert.ToDateTime(Reader[5]);//出生日期
                    ...
                    patientInfo.IsEncrypt = FS.FrameWork.Function.NConvert.ToBoolean(Reader[53]);
                    if (Reader[54] != DBNull.Value)
                        patientInfo.NormalName = Reader[54].ToString();
                    if (patientInfo.IsEncrypt)
                    {
                        //patientInfo.DecryptName = FS.FrameWork.Interface.Classes.Function.Decrypt3DES(patientInfo.NormalName);
                    }
                    else
                    {
        ...
        /// <param name="cardNO"></param>
        /// <returns></returns>
        public FS.HISFC.Models.Account.PatientAccount GetPatientInfo(string cardNO)
        {
            string Sql = string.Empty;
            string SqlWhere = string.Empty;
            ...
            try
            {
              ...
              where and a.card_no='{0}'
                ...
                if (Reader[4] != DBNull.Value)
                    ...
                    if (patientInfo.IsEncrypt)
                    {
                        //patientInfo.DecryptName = FS.Models.Interface.Classes.Function.Decrypt3DES(patientInfo.NormalName);
                    }
                    else
                    {
                        patientInfo.DecryptName = patientInfo.Name;
        ...
        /// <returns></returns>
        public List<FS.HISFC.Models.Account.PatientAccount> GetPatientInfo(string name, string idenNO, string birthday, string homestr)
        {
            string Sql = string.Empty;
            string SqlWhere = string.Empty;
            if (this.Sql.GetSql("Fee.Account.SelectPatient", ref Sql) == -1) return null;
            ...
            FS.HISFC.Models.Account.PatientAccount patientInfo = null;
            List<FS.HISFC.Models.Account.PatientAccount> list = new List<FS.HISFC.Models.Account.PatientAccount>();
            try
            {
                ...
                if (Reader[4] != DBNull.Value)
                    ...
                    if (Reader[20] != DBNull.Value) patientInfo.Kin.RelationAddress = Reader[20].ToString();//联系人地址
                    if (Reader[21] != DBNull.Value) patientInfo.Kin.Relation.ID = Reader[21].ToString();//联系人关系
                    patientInfo.IsEncrypt = FS.FrameWork.Function.NConvert.ToBoolean(Reader[53]);//是否加密姓名
        ...
        public int UpdatePatient(FS.HISFC.Models.Account.PatientAccount patientInfo)
        {
            string Sql = string.Empty;
            ...
            try
            {
                ...
                Sql = string.Format(Sql,
                                   ...
                                   FS.FrameWork.Function.NConvert.ToInt32(patientInfo.IsEncrypt),//是否加密姓名
        ...
        /// </summary>
        /// <param name="patientInfo"></param>
        public int UpdatePatientInfo(FS.HISFC.Models.RADT.PatientInfo patientinfo, FS.HISFC.Models.RADT.PatientInfo patientinfo_old)
        {
            ...
            string change_type=string .Empty;
             if(patientinfo_old.Name!=patientinfo.Name)
              ...
              FS.HISFC.BizLogic.Manager.EmployeeRecord emp = new FS.HISFC.BizLogic.Manager.EmployeeRecord();
        ...
        /// <returns></returns>
        public int InsertPatient(FS.HISFC.Models.Account.PatientAccount patientInfo)
        {
            string Sql = string.Empty;
...
//        /// <param name="cardNO"></param>
//        /// <returns></returns>
//        public FS.HISFC.Models.Account.AccountCard GetMarkByCardNo(string cardNO, string markType)
//        {
//            FS.HISFC.Models.Account.AccountCard accountCard = null;
//            try
//            {
...
//                                    FS.FrameWork.Function.NConvert.ToInt32(accountCard.IsValid).ToString() //状态'1'正常'0'停用 
//                                    );
//            }
//            catch (Exception ex)
//            {
...
//        #endregion
       ...
       ///// <returns></returns>
       // public bool AccountPrePay(FS.HISFC.Models.Account.AccountRecord accountRecord)
       // {
       ...
       // public bool GetCardNoByMarkNo(string markNo, FS.HISFC.Models.Account.MarkTypes markType, ref string cardNo)
       // {
       //     string Sql = string.Empty;
       ...
       //             account.AccountCard.MarkType.ID = FS.FrameWork.Function.NConvert.ToInt32(Reader[2]);
       //             account.AccountCard.IsValid = FS.FrameWork.Function.NConvert.ToBoolean(this.Reader[3]);
       //         }
       //         if (account == null)
       //         {
       ...
       //         {
       //             MessageBox.Show(FS.FrameWork.Management.Language.Msg("帐户余额" + accountVacancy.ToString() + "不足" + money.ToString() + "！"), FS.FrameWork.Management.Language.Msg("提示"), MessageBoxButtons.OK, MessageBoxIcon.Information);
       //             return false;
       //         }
       ...
       //         accountRecord.Oper = (this.Operator as FS.HISFC.Models.Base.Employee).ID;//操作员
       ...
       //         {
       //             MessageBox.Show(FS.FrameWork.Management.Language.Msg("插入交易数据失败！"), FS.FrameWork.Management.Language.Msg("提示"), MessageBoxButtons.OK, MessageBoxIcon.Error);
       //             return false;
       //         }
       //         #endregion
       ...
       //         {
       //             MessageBox.Show(FS.FrameWork.Management.Language.Msg("更新帐户余额失败！"), FS.FrameWork.Management.Language.Msg("提示"), MessageBoxButtons.OK, MessageBoxIcon.Error);
       //             return false;
       //         }

       //         #endregion

       //         MessageBox.Show(FS.FrameWork.Management.Language.Msg("支付费用" + money.ToString() + "成功！"), FS.FrameWork.Management.Language.Msg("提示"), MessageBoxButtons.OK, MessageBoxIcon.Information);
       //         return true;
       //     }
       //     catch
       //     {
       //         MessageBox.Show(FS.FrameWork.Management.Language.Msg("支付费用失败！"), FS.FrameWork.Management.Language.Msg("错误"), MessageBoxButtons.OK, MessageBoxIcon.Error);
       //         return false;
       //     }
       ...
       //         accountRecord.Money = -money;//金额
       //         accountRecord.Oper = (this.Operator as FS.HISFC.Models.Base.Employee).ID;//操作员
       //         accountRecord.OperType.ID = ((int)FS.HISFC.Models.Account.OperTypes.CancelPay).ToString();//操作类型
       ...
       //         #region 废弃
       //         //FS.HISFC.Models.Account.AccountRecord accountRecord = this.GetAccountRecord(cardNO, reMark);
       ...
       //         //{
       //         //    MessageBox.Show(FS.FrameWork.Management.Language.Msg("该费用已退，不可在退！"), FS.FrameWork.Management.Language.Msg("提示"), MessageBoxButtons.OK, MessageBoxIcon.Information);
       //         //    return false;
       //         //}
       //         //FS.HISFC.Models.Account.AccountRecord oldRecord = accountRecord.Clone();
       //         //accountRecord.Vacancy = vacancy + money;
       //         //accountRecord.OperType.ID = ((int)FS.HISFC.Models.Account.OperTypes.CancelPay).ToString();
       ...
       //         //accountRecord.Oper = (this.Operator as FS.HISFC.Models.Base.Employee).ID;
       ...
       //         #region 更新原交易记录状态 （废弃）
       //         ////int result = this.UpdateAccountRecordState(((int)FS.FrameWork.Function.NConvert.ToInt32(false)).ToString(), //状态
       //         ////                                             cardNO,//门诊卡号
       ...
       //             if (Reader[2] != DBNull.Value) accountRecord.Money = FS.FrameWork.Function.NConvert.ToDecimal(Reader[2]);
       //             accountRecord.DeptCode = Reader[3].ToString();
       //             accountRecord.Oper = Reader[4].ToString();
       //             accountRecord.OperTime = FS.FrameWork.Function.NConvert.ToDateTime(Reader[5]);
       //             if (Reader[5] != DBNull.Value) accountRecord.ReMark = Reader[6].ToString();
       //             accountRecord.IsValid = FS.FrameWork.Function.NConvert.ToBoolean(Reader[7]);
       //             if (Reader[8] != DBNull.Value) accountRecord.Vacancy = FS.FrameWork.Function.NConvert.ToDecimal(Reader[8]);
       ...
       // private FS.HISFC.Models.Account.AccountRecord GetAccountRecord(string cardNO, string invoiceNO)
       // {
       //     string Sql = string.Empty;
       //     string SqlWhere = string.Empty;
       //     if (this.Sql.GetSql("Fee.Account.SelectAccountRecord", ref Sql) == -1)
       ...
       //                           FS.FrameWork.Function.NConvert.ToInt32(accountRecord.IsValid),
       ...
       // #endregion
        ...
        //                            FS.FrameWork.Function.NConvert.ToInt32(account.IsValid).ToString() //是否有效
        //                            );
        ...
        ///// <param name="cardNO"></param>
        ///// <returns></returns>
        //public FS.HISFC.Models.Account.Account GetAccount(string cardNO)
        //{
        //    string Sql = string.Empty;
        ...
        //        {
        //            account = new FS.HISFC.Models.Account.Account();
        //            if (this.Reader[1] != DBNull.Value) account.IsValid = FS.FrameWork.Function.NConvert.ToBoolean(this.Reader[1]);
        //            if (this.Reader[2] != DBNull.Value) account.Vacancy = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[2]);
        ...
        //        {
        //            account.AccountCard.CardNO = this.Reader[0].ToString();
        //            account.IsValid = FS.FrameWork.Function.NConvert.ToBoolean(this.Reader[1]);
        //            account.Vacancy = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[2]);
        //            account.PassWord = this.Reader[3].ToString();
        //            account.DayLimit = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[4]);
        //        }
        //        return account;
        //    }
        //    catch (Exception ex)
        ...
        ///// <returns></returns>
        //public int SelectAccountPassWord(string idenno, ref List<FS.FrameWork.Models.NeuObject> list)
        //{
        //    string Sql = string.Empty;
        ...
        //            return -1;
        //        }
        //        list = new List<FS.FrameWork.Models.NeuObject>();
        //        while (this.Reader.Read())
        //        {
        ...
        /// <param name="patientInfo">患者实体</param>
        /// <returns></returns>
        public int InsertPatientZDZL(FS.HISFC.Models.Account.PatientAccount patientInfo)
        {
            string Sql = string.Empty;
        ...
        public int UpdatePrintID(string icCard, string cardNo)
        {
            ...
            if (this.Sql.GetSql("FS.HISFC.Management.Fee.UpdatePrintID", ref strSQL) == -1)
            {
                this.Err = "没有找到FS.HISFC.Management.Fee.UpdatePrintID字段！";
        ...
        public int UpdatePrintIDCase(string icCard, string cardNo)
        {
            ...
            if (this.Sql.GetSql("FS.HISFC.Management.Fee.UpdatePrintIDCase", ref strSQL) == -1)
            {
                this.Err = "FS.HISFC.Management.Fee.UpdatePrintIDCase字段！";
        ...
        public int InsertCardFee(string id, string oper, DateTime operTime, string newFlag, decimal cost, string printNo, string patientNo, string patientName, string extend1, string extend2, string extend3, string validstat)
        {
            ...
            if (this.Sql.GetSql("FS.HISFC.Management.Fee.InsertCardFee", ref strSQL) == -1)
            {
                this.Err = "没有找到FS.HISFC.Management.Fee.InsertCardFee字段！";
        ...
        /// <returns></returns>
        public int InsertPatientPhoto(FS.FrameWork.Management.Transaction trans, string icCard ,Byte[] photo)
        {
            //try
            //{
            ...
            //    //this.command.Connection = FS.FrameWork.Management.Connection.Instance;
        ...
        /// <param name="register"></param>
        /// <returns></returns>
        public int UpdatePERegister(FS.HISFC.Models.Registration.Register register)
        {
            string sql = "";
