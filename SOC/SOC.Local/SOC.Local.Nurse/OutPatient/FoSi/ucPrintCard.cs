...
{
    public partial class ucPrintCard : System.Windows.Forms.UserControl, FS.HISFC.BizProcess.Interface.Nurse.IInjectCurePrint
    {
        #region 域
        ...
        public void Init(ArrayList al)
        {
            ...
            //FS.HISFC.Models.Base.PageSize pSize = pgMgr.GetPageSize("MZZSBQ");
            //System.Drawing.Printing.PaperSize curPaperSize = new System.Drawing.Printing.PaperSize();
            //if (pSize == null)
            //{
            //    pSize = new FS.HISFC.Models.Base.PageSize("MZZSBQ", 812, 583);
            //    pSize.Top = 0;
            //    pSize.Left = 0;
            //}
