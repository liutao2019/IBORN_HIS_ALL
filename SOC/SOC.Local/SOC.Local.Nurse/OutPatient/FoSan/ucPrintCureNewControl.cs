...
namespace FS.SOC.Local.Nurse.FoSan
{
    ...
    public partial class ucPrintCureNewControl : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        public void SetData(List<FS.HISFC.Models.Nurse.Inject> alData, int totPage, int currPage,bool isRePrint)
        {
        ...
        /// <param name="totPage"></param>
        /// <param name="currPage"></param>
        private void SetLable(List<FS.HISFC.Models.Nurse.Inject> alData, int totPage, int currPage,bool isReprint)
        {
            //标题
