...
namespace FS.SOC.Local.Nurse.FoSan
{
    ...
    ///		/>
    /// </summary>
    public partial class ucPrintCureNew : FS.FrameWork.WinForms.Controls.ucBaseControl,FS.HISFC.BizProcess.Interface.Nurse.IInjectItineratePrint,FS.HISFC.BizProcess.Interface.Nurse.IInjectCurePrint
    {
        #region 构造函数
        ...
        public void Init(System.Collections.ArrayList alPrintData)
        {
            ...
            foreach (string key in htInject.Keys)
            {
                ...
                ucPrint.SetData(htInject[key] as List<FS.HISFC.Models.Nurse.Inject>, totPageCount, pageCount, this.IsReprint);
                pageCount++;
