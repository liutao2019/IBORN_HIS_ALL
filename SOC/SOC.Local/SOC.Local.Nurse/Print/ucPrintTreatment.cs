...
{
    public partial class ucPrintTreatment : Neusoft.FrameWork.WinForms.Controls.ucBaseControl,Neusoft.HISFC.BizProcess.Interface.Nurse.ITreatmentPrint
    {
        ...
        private void SetBill(ArrayList alFeeItem)
        {
            ...
            {
                Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList feeItem = alFeeItem[i] as Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList;
            ...
            if (allItem.Count > 0)
            {
                Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList feeItemList = allItem[0] as Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList;
                ...
                {
                    Neusoft.HISFC.Models.Registration.Register r = registerMgr.GetByClinic(feeItemList.Patient.ID);
                    if (r != null)
                    {
                ...
                //取医院名称
                this.neuLabel1.Text = Neusoft.HISFC.BizProcess.Integrate.Function.GetHosName() + "检验检查单";
                this.neuSpread1_Sheet1.RowCount = alFeeItem.Count;
            }
            int rowIndex = 0;
            foreach (Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList f in allItem)
            {
                ...
                if (string.IsNullOrEmpty(f.Order.Memo))
                {
                    ...
                    //Neusoft.HISFC.Models.Order.OutPatient.Order order = orderMgr.GetOneOrder(f.Patient.ID, f.Order.ID);
                    //if (order != null)
                    //{
            ...
            {
                Neusoft.HISFC.Components.Common.Classes.Function.DrawCombo(this.neuSpread1_Sheet1, (int)ColPrint.ComboCode, (int)ColPrint.Combo);
            }
        ...
        public void PrintBill()
        {
            ...
            Neusoft.HISFC.Models.Base.PageSize pSize = pgMgr.GetPageSize("MZZLD");
            System.Drawing.Printing.PaperSize curPaperSize = new System.Drawing.Printing.PaperSize();
            if (pSize == null)
            {

                pSize = new Neusoft.HISFC.Models.Base.PageSize("xsk", 450, 380);
            }
