...
namespace FS.SOC.Local.RADT.GuangZhou.ZDLY.Interface
{
    ...
    public class InterfaceManager
    {
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Register.IPatientList>(typeof(InterfaceManager), new FS.SOC.Local.RADT.GuangZhou.ZDLY.Base.Inpatient.ucPatientList());
        }
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Register.IInpatient>(typeof(InterfaceManager), new FS.SOC.Local.RADT.GuangZhou.ZDLY.Base.Inpatient.ucRegisterInfo());
        }
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Register.IInpatient>(typeof(InterfaceManager), new FS.SOC.Local.RADT.GuangZhou.ZDLY.Base.Inpatient.ucModifyInfo());
        }
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Patient.IQuery>(typeof(InterfaceManager), new FS.SOC.Local.RADT.GuangZhou.ZDLY.Base.Inpatient.frmQueryPatientInfo());
        }
