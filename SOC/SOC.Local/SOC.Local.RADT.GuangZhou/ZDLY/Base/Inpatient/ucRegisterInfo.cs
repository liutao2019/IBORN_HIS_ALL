...
namespace FS.SOC.Local.RADT.GuangZhou.ZDLY.Base.Inpatient
{
    /// <summary>
    /// 入院登记界面
    /// </summary>
    public partial class ucRegisterInfo : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.SOC.HISFC.RADT.Interface.Register.IInpatient
    {
        ...
        private void initCombo()
        {
            ...
            ArrayList alDist = commonController.QueryConstant(EnumConstant.DIST);
        ...
        private bool isInputValid()
        {
            ...
            if (patientInfoList != null)
            {
                ...
                {
                    if (patient.IDCard.Length == this.txtIDNO.Text.Trim().Length && patient.PID.PatientNO == this.txtInpatientNO.Text.Trim() && patient.IDCard != this.txtIDNO.Text.Trim())
                    {
        ...
        private void convertBirthdayByAge(bool isUpdateAgeText)
        {
            ...
            //else
            {
                ...
                {
                    this.dtpBirthDay.Text = birthDay.ToString("HH:mm:ss");
                }
                else
                {
                    this.dtpBirthDay.TextChanged -= new EventHandler(dtpBirthDay_TextChanged);
        ...
        private void cmbDept_TextChanged(object sender, EventArgs e)
        {
            ...
            if (al != null)
            {
                ...
                if (nurseCell != null)
                {
                    ...
                    this.cmbNurseCell.ReadOnly = true;
                }
            }
        ...
        private void dtpBirthDay_TextChanged(object sender, EventArgs e)
        {
            ...
            if (this.ckHour.Checked)
            {
                ...
                birthday = FS.FrameWork.Function.NConvert.ToDateTime(dtNow.Date.ToString("yyyy-MM-dd") + " " + this.dtpBirthDay.Text);
        ...
        void ckHour_CheckedChanged(object sender, EventArgs e)
        {
            this.getAge(0, 0, 0);
            if (ckHour.Checked)
            {
                ...
                this.dtpBirthDay.Leave += new EventHandler(this.dtpBirthDay_Leave);
                this.dtpBirthDay.Text = commonController.GetSystemTime().ToString("HH:mm:ss");
        ...
        void dtpBirthDay_Leave(object sender, EventArgs e)
        {
            if (this.dtpBirthDay.Text == null)
            {
                return;
        ...
        public int Init()
        {
            ...
            if (!isAutoPatientNO)
            {
                this.rbtnTempPatientNO.Text = "门特号(F2)";
                SendKeys.Send("{F2}");
            }
        ...
        public int InitInvoice()
        {
            ...
            FS.HISFC.Models.Base.Employee oper = this.feeInpatient.Operator as FS.HISFC.Models.Base.Employee;
        ...
        string FS.SOC.HISFC.RADT.Interface.Register.IInpatient.CardNo
        {
            get
            {
                throw new NotImplementedException();
        ...
        void FS.SOC.HISFC.RADT.Interface.Register.IInpatient.Clear()
        {
            throw new NotImplementedException();
        }

        Size FS.SOC.HISFC.RADT.Interface.Register.IInpatient.ControlSize
        {
            get
            {
                throw new NotImplementedException();
        ...
        string FS.SOC.HISFC.RADT.Interface.Register.IInpatient.FileName
        {
            set { throw new NotImplementedException(); }
        }

        PatientInfo FS.SOC.HISFC.RADT.Interface.Register.IInpatient.GetPatientInfo(PatientInfo patientInfo)
        {
            throw new NotImplementedException();
        }

        FS.HISFC.Models.Fee.Inpatient.Prepay FS.SOC.HISFC.RADT.Interface.Register.IInpatient.GetPrepay()
        {
            throw new NotImplementedException();
        }

        int FS.SOC.HISFC.RADT.Interface.Register.IInpatient.Init()
        {
            throw new NotImplementedException();
        }

        bool FS.SOC.HISFC.RADT.Interface.Register.IInpatient.IsArriveProcess
        {
            get
            {
                throw new NotImplementedException();
        ...
        bool FS.SOC.HISFC.RADT.Interface.Register.IInpatient.IsAutoPatientNO
        {
            get
            {
                throw new NotImplementedException();
        ...
        bool FS.SOC.HISFC.RADT.Interface.Register.IInpatient.IsCanModifyIName
        {
            get
            {
                throw new NotImplementedException();
        ...
        bool FS.SOC.HISFC.RADT.Interface.Register.IInpatient.IsCanModifyInTime
        {
            get
            {
                throw new NotImplementedException();
        ...
        bool FS.SOC.HISFC.RADT.Interface.Register.IInpatient.IsCanModifyPatientNo
        {
            get
            {
                throw new NotImplementedException();
        ...
        bool FS.SOC.HISFC.RADT.Interface.Register.IInpatient.IsInputDiagnose
        {
            get
            {
                throw new NotImplementedException();
        ...
        bool FS.SOC.HISFC.RADT.Interface.Register.IInpatient.IsInputLinkMan
        {
            get
            {
                throw new NotImplementedException();
        ...
        bool FS.SOC.HISFC.RADT.Interface.Register.IInpatient.IsInputValid()
        {
            throw new NotImplementedException();
        }

        bool FS.SOC.HISFC.RADT.Interface.Register.IInpatient.IsShowPrePay
        {
            get
            {
                throw new NotImplementedException();
        ...
        void FS.SOC.HISFC.RADT.Interface.Register.IInpatient.ModifyPatientInfo(PatientInfo patientInfo)
        {
            throw new NotImplementedException();
        }

        event FS.SOC.HISFC.RADT.Interface.Register.SelectPatientInfo FS.SOC.HISFC.RADT.Interface.Register.IInpatient.OnQueryPatientInfo
        {
            add { throw new NotImplementedException(); }
            remove { throw new NotImplementedException(); }
        }

        event EventHandler FS.SOC.HISFC.RADT.Interface.Register.IInpatient.OnSavePatientInfo
        {
            add { throw new NotImplementedException(); }
            remove { throw new NotImplementedException(); }
        }

        void FS.SOC.HISFC.RADT.Interface.Register.IInpatient.SetPatientInfo(PatientInfo patientInfo, bool isAll)
        {
            throw new NotImplementedException();
        }
