...
namespace FS.SOC.Local.RADT.GuangZhou.ZDLY.Register
{
    /// <summary>
    /// 入院登记主界面
    /// 用接口方式实现 列表显示和登记界面
    ...
    public partial class ucInpatient : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private int initInterface()
        {
            ...
            if (this.IRegister is FS.SOC.Local.RADT.GuangZhou.ZDLY.Base.Inpatient.ucRegisterInfo)
            {
                (IRegister as FS.SOC.Local.RADT.GuangZhou.ZDLY.Base.Inpatient.ucRegisterInfo).IsFertilityPatientNO = this.isFertilityPatientNO;
            }
        ...
        public int ReadCard()
        {
         ...
         Base.Inpatient.frmSiRegisterInfo frmSiRegisterInfo = new FS.SOC.Local.RADT.GuangZhou.ZDLY.Base.Inpatient.frmSiRegisterInfo();
