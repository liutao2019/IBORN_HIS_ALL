...
namespace Neusoft.SOC.Local.RADT.GuangZhou.ZDLY.IOutPrint
{
    ...
    public partial class ucOutPrint : UserControl,Neusoft.HISFC.BizProcess.Interface.IPrintInHosNotice
    {
        ...
        {
            Neusoft.HISFC.Models.RADT.PatientInfo pInfo = inpatientRadt.QueryPatientInfoByInpatientNO(patient.ID);
            if (pInfo != null)
            {
                patient = pInfo;
            }
        ...
        and w.inpatient_no='{0}' ";
            ...
            try
            {
                System.IO.MemoryStream me = new System.IO.MemoryStream(((Neusoft.HISFC.Models.Base.Hospital)inpatientRadt.Hospital).HosLogoImage);
