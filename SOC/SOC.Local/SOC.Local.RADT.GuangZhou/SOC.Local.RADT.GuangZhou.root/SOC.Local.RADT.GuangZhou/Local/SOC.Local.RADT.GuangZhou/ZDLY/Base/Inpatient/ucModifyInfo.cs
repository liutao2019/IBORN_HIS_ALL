...
namespace Neusoft.SOC.Local.RADT.GuangZhou.ZDLY.Base.Inpatient
{
    ...
    /// 患者信息修改界面
    /// </summary>
    public partial class ucModifyInfo : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.SOC.HISFC.RADT.Interface.Register.IInpatient
    {
        public ucModifyInfo()
        {
            InitializeComponent();
        ...
        private Neusoft.HISFC.Models.RADT.PatientInfo patientInfoOld = null;
        ...
        private void setPatient(Neusoft.HISFC.Models.RADT.PatientInfo patient)
        {
            //如果是已出院状态则不给修改
        ...
        {
            Neusoft.HISFC.Models.RADT.PatientInfo patient = this.patientInfoOld;
            if (patient == null)
            {
            ...
            patient.AddressHome = this.txtAddressNow.Text; //现住地址
            ...
            patient.FT.DayLimitCost = Neusoft.FrameWork.Function.NConvert.ToDecimal(this.txtDayLimit.Text);     //公费日限
            patient.FT.BedLimitCost = Neusoft.FrameWork.Function.NConvert.ToDecimal(this.txtBedLimit.Text);          //普通标准
            patient.FT.AirLimitCost = Neusoft.FrameWork.Function.NConvert.ToDecimal(this.txtAirLimit.Text);      //监护床
        ...
        private bool isInputValid()
        {
            ...
            //判断字符超长籍贯
            if (!Neusoft.FrameWork.Public.String.ValidMaxLengh(this.cmbBirthArea.Text, 100))
            {
            ...
            //判断字符超长联系人
            if (!Neusoft.FrameWork.Public.String.ValidMaxLengh(this.txtLinkMan.Text, 32))
            {
