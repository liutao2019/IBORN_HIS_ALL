...
namespace Neusoft.SOC.Local.RADT.GuangZhou.ZDLY.Controls
{
    ...
    { 
        ...
        Neusoft.HISFC.Models.Base.Employee employee = ((Neusoft.HISFC.Models.Base.Employee)Neusoft.FrameWork.Management.Connection.Operator);
        /// <summary>
        /// 控制参数业务类
        /// </summary>
        ...
        public void initControl()
        {
            ...
            try
            {
                ...
                {
                    string billValue = ctrlIntegrate.GetControlParam<string>("RADT02", true, "Neusoft.WinForms.Report.InpatientFee.ucPatientMoneyAlter");
