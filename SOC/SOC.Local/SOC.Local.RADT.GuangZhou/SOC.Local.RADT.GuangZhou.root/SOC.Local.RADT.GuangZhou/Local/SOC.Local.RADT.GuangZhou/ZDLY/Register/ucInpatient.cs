...
using Neusoft.SOC.Local.RADT.GuangZhou.ZDLY.Interface;

namespace Neusoft.SOC.Local.RADT.GuangZhou.ZDLY.Register
{
    /// <summary>
    /// 入院登记主界面
    /// 用接口方式实现 列表显示和登记界面
    ...
    public partial class ucInpatient : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        public int ReadCard()
        {
         ...
         Base.Inpatient.frmSiRegisterInfo frmSiRegisterInfo = new Neusoft.SOC.Local.RADT.GuangZhou.ZDLY.Base.Inpatient.frmSiRegisterInfo();
