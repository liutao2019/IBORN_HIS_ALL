...
namespace Neusoft.SOC.Local.RADT.GuangZhou.GYZL.Interface
{
    ...
    public class ModifyPatient
    {
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<Neusoft.SOC.HISFC.RADT.Interface.Register.IInpatient>(typeof(ModifyPatient), new Neusoft.SOC.Local.RADT.GuangZhou.GYZL.Base.Inpatient.ucModifyInfo());
        }
    }
}
