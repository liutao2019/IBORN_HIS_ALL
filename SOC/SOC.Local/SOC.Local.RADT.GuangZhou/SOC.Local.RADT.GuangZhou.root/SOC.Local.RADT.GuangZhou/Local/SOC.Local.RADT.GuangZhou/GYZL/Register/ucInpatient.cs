...
using Neusoft.SOC.Local.RADT.GuangZhou.GYZL.Interface;
...
namespace Neusoft.SOC.Local.RADT.GuangZhou.GYZL.Register
{
    ...
    public partial class ucInpatient : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        public int ReadCard()
        {
         ...
         Base.Inpatient.frmSiRegisterInfo frmSiRegisterInfo = new Neusoft.SOC.Local.RADT.GuangZhou.GYZL.Base.Inpatient.frmSiRegisterInfo();
