...
{
    public partial class ucPrepayPrint : UserControl, Neusoft.HISFC.BizProcess.Interface.FeeInterface.IPrepayPrint
    {
        ...
        {
            string[] sReturn = new string[10];
            string strCash = Neusoft.FrameWork.Public.String.FormatNumber(Cash, 2).ToString("############.00");
            if (strCash.Length > 10)//return null;
            {
                strCash = strCash.Substring(strCash.Length - 10);
            }
        ...
        public int Print()
        {
            ...
            {
                //默认大小
                ps = new Neusoft.HISFC.Models.Base.PageSize("PrepayPrint", 830, 420);                
            }
        ...
        public int SetValue(Neusoft.HISFC.Models.RADT.PatientInfo PatientInfo, Neusoft.HISFC.Models.Fee.Inpatient.Prepay Prepay)
        {            
