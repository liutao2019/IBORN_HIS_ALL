...
namespace Neusoft.SOC.Local.RADT.GuangZhou
{
    public  class Function
    {
        ...
        public static int GetAutoPatientNOByYk(ref string patientNO, ref bool isRecycle)
        {
            ...
            //if (!isRecycle)
            {
                ...
                try
                {
                    ...
                    MaxPatientNo = Neusoft.FrameWork.Public.String.AddNumber(MaxPatientNo, 1);
        ...
        public static string GetCardNOByPatientNO(string cardNO, string patientNO)
        {
            ...
            if (string.IsNullOrEmpty(cardNO) || Neusoft.FrameWork.Public.String.IsNumeric(cardNO) == false)
            {
