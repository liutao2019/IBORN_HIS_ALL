...
namespace Neusoft.SOC.Local.RADT.GuangZhou.GYSY.Modify
{
    /// <summary>
    ...
    public partial class ucModifyInpatient : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        protected override Neusoft.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolBarService.AddToolButton("限额累计", "限额累计", (int)Neusoft.FrameWork.WinForms.Classes.EnumImageList.L累计开始, true, false, null);
        ...
        {           
            Neusoft.SOC.Local.RADT.GuangZhou.GYSY.Base.Inpatient.ucDayLimitTot uc = new Neusoft.SOC.Local.RADT.GuangZhou.GYSY.Base.Inpatient.ucDayLimitTot();
