...
namespace FS.SOC.Local.RADT.GuangZhou.GYZL.Interface
{
    ...
    public class InterfaceManager
    {
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Register.IPatientList>(typeof(InterfaceManager), new FS.SOC.Local.RADT.GuangZhou.GYZL.Base.Inpatient.ucPatientList());
        }
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Register.IInpatient>(typeof(InterfaceManager), new FS.SOC.Local.RADT.GuangZhou.GYZL.Base.Inpatient.ucRegisterInfo());
        }
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Register.IInpatient>(typeof(InterfaceManager), new FS.SOC.Local.RADT.GuangZhou.GYZL.Base.Inpatient.ucModifyInfo());
        }
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Patient.IQuery>(typeof(InterfaceManager), new FS.SOC.Local.RADT.GuangZhou.GYZL.Base.Inpatient.frmQueryPatientInfo());
        }
