...
namespace FS.SOC.Local.RADT.GuangZhou.GYZL.Common
{

    public partial class ucBank : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        private System.Windows.Forms.Label lblBank;
        private FS.FrameWork.WinForms.Controls.NeuComboBox cmbBank;
        ...
        private void InitializeComponent()
        {
            ...
            this.cmbBank = new FS.FrameWork.WinForms.Controls.NeuComboBox(this.components);
        ...
        private void ucBank_Load(object sender, System.EventArgs e)
        {
            ...
            {
                //添加银行列表
                this.cmbBank.AddItems(managerIntegrate.GetConstantList(FS.HISFC.Models.Base.EnumConstant.BANK));
                //只能从列表中选择
