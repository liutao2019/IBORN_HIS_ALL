    ...
    public partial class ucOutPrint : UserControl,FS.HISFC.BizProcess.Interface.IPrintInHosNotice
    {
        ...
        and w.inpatient_no='{0}' ";
           ...
           // this.lblBlood.Text = patient.BloodType.Name ;//血型 
            ...
            this.lblAjMoney.Text = FS.FrameWork.Public.String.ToSimpleString(patient.FT.PrepayCost + patient.FT.BalancedPrepayCost);//预交金总金额
            this.lblOperName.Text = FS.FrameWork.Management.Connection.Operator.Name;
            //医何患者类型
