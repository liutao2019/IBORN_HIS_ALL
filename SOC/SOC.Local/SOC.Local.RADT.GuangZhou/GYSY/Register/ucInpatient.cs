...
using FS.SOC.Local.RADT.GuangZhou.GYSY.Interface;

namespace FS.SOC.Local.RADT.GuangZhou.GYSY.Register
{
    /// <summary>
    /// 入院登记主界面
    /// 用接口方式实现 列表显示和登记界面
    ...
    public partial class ucInpatient : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        public int ReadCard()
        {
         ...
         SiPatient.Pact.ID = defaultPactCode;
            Base.Inpatient.frmSiRegisterInfo frmSiRegisterInfo = new FS.SOC.Local.RADT.GuangZhou.GYSY.Base.Inpatient.frmSiRegisterInfo();
