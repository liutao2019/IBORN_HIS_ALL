...
namespace FS.SOC.Local.RADT.GuangZhou.GYSY.Interface
{
    ...
    public class InterfaceManager
    {
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Register.IPatientList>(typeof(InterfaceManager), new FS.SOC.Local.RADT.GuangZhou.GYSY.Base.Inpatient.ucPatientList());
        }
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Register.IInpatient>(typeof(InterfaceManager), new FS.SOC.Local.RADT.GuangZhou.GYSY.Base.Inpatient.ucRegisterInfo());
        }
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Register.IInpatient>(typeof(InterfaceManager), new FS.SOC.Local.RADT.GuangZhou.GYSY.Base.Inpatient.ucModifyInfo());
        }
        ...
        {
            return ControllerFactroy.CreateFactory().CreateInferface<FS.SOC.HISFC.RADT.Interface.Patient.IQuery>(typeof(InterfaceManager), new FS.SOC.Local.RADT.GuangZhou.GYSY.Base.Inpatient.frmQueryPatientInfo());
        }
