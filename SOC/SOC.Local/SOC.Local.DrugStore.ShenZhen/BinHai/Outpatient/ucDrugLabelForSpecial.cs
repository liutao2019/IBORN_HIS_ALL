...
{
    public partial class ucDrugLabelForSpecial : UserControl
    {
        public ucDrugLabelForSpecial()
        {
            InitializeComponent();
        }
        ...
        private int SetOtherInfo(string hospitalName, string diagnose, string recipeNO, string windowName)
        {
            ...
            this.neuLabel1.Text = "86913333-3530";
            return 1;
        }
            ...
            )
        {
            ...
            this.SetOtherInfo(hospitalName, diagnose, drugRecipe.RecipeNO, drugTerminal.Name);
