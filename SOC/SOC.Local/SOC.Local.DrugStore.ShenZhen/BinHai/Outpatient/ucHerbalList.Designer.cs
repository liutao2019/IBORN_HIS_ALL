namespace FS.SOC.Local.DrugStore.ShenZhen.BinHai.Outpatient
{
    partial class ucHerbalList
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.paneltitle.Size = new System.Drawing.Size(850, 94);
            ...
            this.lbRecipeDeptName.Size = new System.Drawing.Size(127, 14);
            this.lbRecipeDeptName.TabIndex = 3;
            this.lbRecipeDeptName.Text = "科室：中医科门诊";
            // 
            // lbPatientInfo
            // 
            ...
            this.panelBottom.Size = new System.Drawing.Size(850, 46);
            ...
            this.fpSpread1.Size = new System.Drawing.Size(850, 301);
            ...
            this.fpSpread1_Sheet1.RowCount = 11;
            ...
            this.fpSpread1_Sheet1.Cells.Get(8, 0).ParseFormatInfo = ((System.Globalization.NumberFormatInfo)(cultureInfo.NumberFormat.Clone()));
            ((System.Globalization.NumberFormatInfo)(this.fpSpread1_Sheet1.Cells.Get(8, 0).ParseFormatInfo)).CurrencySymbol = "¥";
            ((System.Globalization.NumberFormatInfo)(this.fpSpread1_Sheet1.Cells.Get(8, 0).ParseFormatInfo)).NumberDecimalDigits = 0;
            ((System.Globalization.NumberFormatInfo)(this.fpSpread1_Sheet1.Cells.Get(8, 0).ParseFormatInfo)).NumberGroupSizes = new int[] {
        0};
            this.fpSpread1_Sheet1.Cells.Get(8, 0).ParseFormatString = "n";
            this.fpSpread1_Sheet1.Cells.Get(8, 0).Value = 9;
            this.fpSpread1_Sheet1.Cells.Get(9, 0).ParseFormatInfo = ((System.Globalization.NumberFormatInfo)(cultureInfo.NumberFormat.Clone()));
            ((System.Globalization.NumberFormatInfo)(this.fpSpread1_Sheet1.Cells.Get(9, 0).ParseFormatInfo)).CurrencySymbol = "¥";
            ((System.Globalization.NumberFormatInfo)(this.fpSpread1_Sheet1.Cells.Get(9, 0).ParseFormatInfo)).NumberDecimalDigits = 0;
            ((System.Globalization.NumberFormatInfo)(this.fpSpread1_Sheet1.Cells.Get(9, 0).ParseFormatInfo)).NumberGroupSizes = new int[] {
        0};
            this.fpSpread1_Sheet1.Cells.Get(9, 0).ParseFormatString = "n";
            this.fpSpread1_Sheet1.Cells.Get(9, 0).Value = 10;
            ...
            ((System.Globalization.NumberFormatInfo)(this.fpSpread1_Sheet1.Cells.Get(10, 0).ParseFormatInfo)).CurrencySymbol = "¥";
        ...
        0};
            ...
            this.fpSpread1_Sheet1.Cells.Get(10, 0).Value = 11;
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 0).Value = "编码";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 1).Value = "名称";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "每剂量";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "总量";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "用法";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = " ";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = " 编码 ";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = " 名称 ";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = " 每剂量 ";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = " 总量 ";
            ...
            this.fpSpread1_Sheet1.Columns.Get(1).Width = 96F;
            this.fpSpread1_Sheet1.Columns.Get(2).Label = "每剂量";
            this.fpSpread1_Sheet1.Columns.Get(2).Width = 54F;
            this.fpSpread1_Sheet1.Columns.Get(3).Label = "总量";
            this.fpSpread1_Sheet1.Columns.Get(3).Width = 54F;
            this.fpSpread1_Sheet1.Columns.Get(4).Label = "用法";
            ...
            this.fpSpread1_Sheet1.Columns.Get(6).Label = " 编码 ";
            this.fpSpread1_Sheet1.Columns.Get(6).Width = 49F;
            this.fpSpread1_Sheet1.Columns.Get(7).Label = " 名称 ";
            this.fpSpread1_Sheet1.Columns.Get(7).Width = 96F;
            this.fpSpread1_Sheet1.Columns.Get(8).Label = " 每剂量 ";
            this.fpSpread1_Sheet1.Columns.Get(8).Width = 54F;
            this.fpSpread1_Sheet1.Columns.Get(9).Label = " 总量 ";
            this.fpSpread1_Sheet1.Columns.Get(9).Width = 54F;
            ...
            this.fpSpread1_Sheet1.ZoomFactor = 1.2F;
            ...
            this.Name = "ucHerbalList";
            this.Size = new System.Drawing.Size(850, 441);
