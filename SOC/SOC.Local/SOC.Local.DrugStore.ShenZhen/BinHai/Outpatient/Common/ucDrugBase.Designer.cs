...
namespace FS.SOC.Local.DrugStore.ShenZhen.BinHai.Outpatient.Common
{
    partial class ucDrugBase
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ucRecipeDetail1 = new FS.SOC.Local.DrugStore.ShenZhen.BinHai.Outpatient.Common.ucRecipeDetail(this.components);
            this.ucDrugTree1 = new FS.SOC.HISFC.Components.DrugStore.Outpatient.Common.ucRecipeTree();
            ...
            this.ucRecipeDetail1.EnumQtyShowType = FS.SOC.HISFC.Components.DrugStore.Outpatient.Common.Function.EnumQtyShowType.包装单位;
