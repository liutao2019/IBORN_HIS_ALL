...
namespace FS.SOC.Local.Pharmacy.Extend.HuanShi
{
    public class BizExtendInterfaceImplement: FS.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.IPharmacyBizExtend
    {
        ...
        public string GetBillNO(string stockDeptNO, string class2Code, string class3code, ref string errInfo)
        {
            ...
            //FS.HISFC.BizLogic.Manager.Department deptMrg = new FS.HISFC.BizLogic.Manager.Department();
            //FS.HISFC.Models.Base.Department dept = new FS.HISFC.Models.Base.Department();
            //dept = deptMrg.GetDeptmentById(stockDeptNO);
            //string ListNO = "";
            //decimal iSequence = 0;
            ...
            //    {
            //        ListNO = sysDate.Year.ToString() + sysDate.Month.ToString().PadLeft(2, '0') + sysDate.Day.ToString().PadLeft(2, '0') + inOutFlag + iSequence.ToString().PadLeft(3, '0');
            //    }
            //    else
            //    {
            //        ListNO = stockDeptNO + sysDate.Year.ToString().Substring(2, 2) + sysDate.Month.ToString().PadLeft(2, '0') + sysDate.Day.ToString().PadLeft(2, '0') + inOutFlag + iSequence.ToString().PadLeft(3, '0');
            //    }
        ...
        public FS.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.IItemExtendControl GetItemExtendControl()
        {
