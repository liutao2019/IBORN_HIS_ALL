...
namespace FS.SOC.Local.Pharmacy.Print.NanZhuang
{
    ...
    public partial class ucPhaBackOutBill : ucBaseControl, Base.IPharmacyBillPrint
    {
        ...
        private void SetPrintData(ArrayList al, int inow, int icount, string title)
        {
            ...
            this.lblOper.Text = "制单人:" + SOC.HISFC.BizProcess.Cache.Common.GetEmployeeName(info.Operation.ExamOper.ID) + " " + DateTime.Now.ToString(); //BillPrintFun.GetEmplName(info.Operation.ExamOper.ID);
