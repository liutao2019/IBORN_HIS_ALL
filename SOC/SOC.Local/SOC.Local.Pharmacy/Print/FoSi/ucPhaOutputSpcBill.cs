...
namespace FS.SOC.Local.Pharmacy.Print.FoSi
{
    ...
    public partial class ucPhaOutputSpcBill : ucBaseControl, Base.IPharmacyBillPrint
    {
        ...
        private void SetPrintData(ArrayList al, int inow, int icount, string title)
        {
            ...
            this.lblSignOper1.Text = "制单人:" + SOC.HISFC.BizProcess.Cache.Common.GetEmployeeName(info.Operation.ExamOper.ID) + " " + DateTime.Now.ToString();
            this.lblPage.Text = "页：" + inow.ToString() + "/" + icount.ToString();
            this.lblSignOper2.Text = "仓管员：";// +BillPrintFun.GetStockManagerName(info.StockDept.ID); //BillPrintFun.GetEmplName(info.Operation.ExamOper.ID);
            ...
            foreach (ArrayList alPrint in hs.Values)
            {
                ...
                for (int pageNow = 0; pageNow < pageTotNum; pageNow++)
                {
                    if (pageNow == pageTotNum - 1)
                    {
                        ...
                        this.lblSignOper4.Visible = true;
                        this.lblSignOper5.Visible = true;
                    }
                    else
                    {
                        ...
                        this.lblSignOper4.Visible = false;
                        this.lblSignOper5.Visible = false;
                    }
