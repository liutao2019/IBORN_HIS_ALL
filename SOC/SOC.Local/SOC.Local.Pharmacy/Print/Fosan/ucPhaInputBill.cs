    ...
    public partial class ucPhaInputBill : ucBaseControl, Base.IPharmacyBillPrint
    {
        ...
        private void SetPrintData(ArrayList al, int inow, int icount, string title)
        {
            ...
            for (int i = 0; i < al.Count; i++)
            {
                ...
                this.neuFpEnter1_Sheet1.Cells[i, 10].Value = input.BatchNO;

                this.neuFpEnter1_Sheet1.Cells[i, 11].Value = pItem.GetPlaceNO(input.StockDept.ID, input.Item.ID).ToString();
                ...
                {
                    this.neuFpEnter1_Sheet1.Cells[i, 6].Text = input.ValidTime.Date.ToString();
                }
