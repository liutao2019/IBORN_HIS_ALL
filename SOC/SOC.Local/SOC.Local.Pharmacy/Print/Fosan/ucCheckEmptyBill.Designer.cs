namespace FS.SOC.Local.Pharmacy.Print.Fosan
{
    partial class ucCheckEmptyBill
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.neuFpEnter1_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "封账数量";
            ...
            this.neuFpEnter1_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "摘要";
            ...
            this.neuFpEnter1_Sheet1.Columns.Get(4).Label = "封账数量";
            this.neuFpEnter1_Sheet1.Columns.Get(4).Width = 61F;
            ...
            this.neuFpEnter1_Sheet1.Columns.Get(9).Label = "摘要";
            this.neuFpEnter1_Sheet1.Columns.Get(9).Width = 68F;
