        ...
        private void SetPrintData(ArrayList al, int inow, int icount, string title)
        {
            ...
            for (int i = 0; i < al.Count; i++)
            {
                ...
                else
                {
                    ...
                    this.neuFpEnter1_Sheet1.Cells[i, 9].Value = input.Item.PriceCollection.WholeSalePrice;
                }
                this.neuFpEnter1_Sheet1.Cells[i, 3].Text = SOC.HISFC.BizProcess.Cache.Pharmacy.GetCompanyName(input.Producer.ID);//生产厂家
