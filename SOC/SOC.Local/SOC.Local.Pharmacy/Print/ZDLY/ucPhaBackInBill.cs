...
namespace FS.SOC.Local.Pharmacy.Print.ZDLY
{
    ...
    public partial class ucPhaBackInBill: ucBaseControl, Base.IPharmacyBillPrint
    {
        ...
        private void SetPrintData(ArrayList al, int inow, int icount, string title)
        {
            ...
            this.lblRecord.Text = "录单:" + FS.SOC.HISFC.BizProcess.Cache.Common.GetEmployeeName(info.Operation.ApplyOper.ID);
            this.lblOper.Text = "制表:" + FS.SOC.HISFC.BizProcess.Cache.Common.GetEmployeeName(info.Operation.ApplyOper.ID);
            ...
            for (int i = 0; i < al.Count; i++)
            {
                ...
                this.neuFpEnter1_Sheet1.Columns[7].CellType = nPrice;
                this.neuFpEnter1_Sheet1.Columns[8].CellType = nCost;
                this.neuFpEnter1_Sheet1.Columns[9].CellType = nPrice;
                ...
                this.neuFpEnter1_Sheet1.Cells[i, 8].Text = input.PurchaseCost.ToString(Function.GetCostDecimalString());
                this.neuFpEnter1_Sheet1.Cells[i, 10].Text = input.PurchaseCost.ToString(Function.GetCostDecimalString());
