...
{
    public partial class ucPharmacyRecord : Base.BaseReport
    {
        ...
        private void QueryEnd()
        {
            ...
            Neusoft.HISFC.Models.Pharmacy.Item item = Neusoft.SOC.HISFC.BizProcess.Cache.Pharmacy.GetItem(this.ncmbDrug.Tag.ToString());
