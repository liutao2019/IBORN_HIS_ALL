...
{
    public partial class ucDeptDrugPercentage : Base.BaseReport
    {
        public ucDeptDrugPercentage()
        {
            ...
            this.SQLIndexs = "SOC.Pharmacy.Report.SunnyDrug.DeptDrugPercentage";

            this.QueryDataWhenInit = false;
        }

        private void ucDeptDrugPercentage_Load(object sender, EventArgs e)
        {
