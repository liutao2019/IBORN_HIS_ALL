...
{
    public partial class ucSiChildrenBlanceList : UserControl, FS.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrintmy
    {
        public ucSiChildrenBlanceList()
        {
            InitializeComponent();
        }
           ...
           // FS.HISFC.BizLogic.Order.CheckSlip checkSlip = new FS.HISFC.BizLogic.Order.CheckSlip();
            ...
            try
            {
                ...
                if (patientInfo.SIMainInfo.OutDiagnose != null)
                {
                    ...
                    this.lbloutDiagNose.Text = patientInfo.SIMainInfo.OutDiagnose.ToString();
                }
                ...
                if (patientInfo.Pact.ID == "2")
                {
                   ...
                   // lblpaykind.Text = SiInterface.GetBalanceOutDiagnose(patientInfo.ID);
                }
        ...
        private int SetBalanceInfo(FS.HISFC.Models.RADT.PatientInfo patientInfo, FS.HISFC.Models.Fee.Inpatient.Balance balanceInfo, System.Collections.ArrayList alBalanceList, System.Collections.ArrayList alPayList)
        {
            ...
            {
                string invoiceNO = "";
                ArrayList alAllBill = feeInpatient.QueryBalancesByInpatientNO(patientInfo.ID, "ALL");//出院结算发票。
        ...
        FS.HISFC.Models.Base.EBlanceType FS.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrintmy.IsMidwayBalance
        {
            get
            {
        ...
        int FS.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrint.Clear()
        {
            throw new NotImplementedException();
        }

        string FS.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrint.InvoiceType
        {
            get { throw new NotImplementedException(); }
        }

        FS.HISFC.Models.RADT.PatientInfo FS.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrint.PatientInfo
        {
            set { throw new NotImplementedException(); }
        }

        int FS.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrint.Print()
        {
            throw new NotImplementedException();
        }

        int FS.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrint.PrintPreview()
        {
            throw new NotImplementedException();
        }

        void FS.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrint.SetTrans(IDbTransaction trans)
        {
            throw new NotImplementedException();
        }

        int FS.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrint.SetValueForPreview(FS.HISFC.Models.RADT.PatientInfo patientInfo, FS.HISFC.Models.Fee.Inpatient.Balance balanceInfo, ArrayList alBalanceList, ArrayList alPayList)
        {
            throw new NotImplementedException();
        }

        int FS.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrint.SetValueForPrint(FS.HISFC.Models.RADT.PatientInfo patientInfo, FS.HISFC.Models.Fee.Inpatient.Balance balanceInfo, ArrayList alBalanceList, ArrayList alPayList)
        {
            throw new NotImplementedException();
        }

        IDbTransaction FS.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrint.Trans
        {
            get
            {
                throw new NotImplementedException();
