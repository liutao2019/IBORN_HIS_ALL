...
{
    public partial class ucSiBlancelist : UserControl//, Neusoft.HISFC.BizProcess.Interface.FeeInterface.IBalanceInvoicePrintmy
    {
        ...
        public int SetValueForPreviewNew(Neusoft.HISFC.Models.RADT.PatientInfo patientInfo, Neusoft.HISFC.Models.Fee.Inpatient.Balance balanceInfo, System.Collections.ArrayList alBalanceList, System.Collections.ArrayList alPayList)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private int SetPatientInfo(Neusoft.HISFC.Models.RADT.PatientInfo patientInfo, Neusoft.HISFC.Models.Fee.Inpatient.Balance balanceInfo, System.Collections.ArrayList alBalanceList, System.Collections.ArrayList alPayList)
        {
            //常数管理类
        ...
        /// <returns></returns>
        private int SetBalanceInfo(Neusoft.HISFC.Models.RADT.PatientInfo patientInfo, Neusoft.HISFC.Models.Fee.Inpatient.Balance balanceInfo, System.Collections.ArrayList alBalanceList, System.Collections.ArrayList alPayList)
        {
            ...
            {
                Neusoft.HISFC.Models.Fee.Inpatient.BalanceList bl = (Neusoft.HISFC.Models.Fee.Inpatient.BalanceList)alBalanceList[i];
            ...
            fpTotal_Sheet1.Cells[2, 2].Text = Neusoft.FrameWork.Function.NConvert.ToCapital(patientInfo.SIMainInfo.PubCost);
            ...
            //操作员
            fpSign_Sheet1.Cells[7, 0].Text = ((Neusoft.HISFC.Models.Base.Employee)Neusoft.FrameWork.Management.Connection.Operator).Name;
            //操作时间
