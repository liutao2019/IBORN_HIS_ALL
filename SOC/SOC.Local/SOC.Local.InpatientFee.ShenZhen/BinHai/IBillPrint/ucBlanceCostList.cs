...
{
    public partial class ucBlanceCostList : UserControl
    {
        ...
        public int SetValueForPreview(FS.HISFC.Models.RADT.PatientInfo curPatientInfo, FS.HISFC.Models.Fee.Inpatient.Balance balanceInfo,
        ...
        public int SetValueForPrintNew(FS.HISFC.Models.RADT.PatientInfo curPatientInfo, FS.HISFC.Models.Fee.Inpatient.FeeInfo balanceInfo,
    System.Collections.ArrayList alBalanceList, System.Collections.ArrayList alFeeItemList, System.Collections.ArrayList alPayList)
        {
            SetPatientInfo(curPatientInfo);
            SetBalanceInfo(alBalanceList);
        ...
        private int SetPatientInfo(FS.HISFC.Models.RADT.PatientInfo curPatientInfo)
        {
            //常数管理类
            ...
            for (int i = 0; i < balanceListsort.Count; i++)
            {
                ...
                FS.HISFC.Models.Fee.Inpatient.BalanceList bl = (FS.HISFC.Models.Fee.Inpatient.BalanceList)balanceListsort[i];
                   ...
                   decimal totCost1 = 0m;
                    ...
                    int mm =1;
                    foreach (FS.HISFC.Models.Fee.Inpatient.BalanceList c1 in alBalanceList)
                    {
