...
namespace FS.SOC.Local.InpatientFee.ShenZhen.BinHai.Inpatient
{
    ...
    public partial class ucModifyInfo : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.SOC.HISFC.RADT.Interface.Register.IInpatient
    {
        ...
        private void setPatient(FS.HISFC.Models.RADT.Patient patient)
        {
            ...
            //}
            this.txtHomeAddress.Text = patient.AreaCode;//户口地址
        ...
        private PatientInfo getPatientInfomation()
        {
            ...
            patient.AddressHome = this.txtAddressNow.Text;//现地址
            patient.AreaCode = this.txtHomeAddress.Text;//户口地址
            patient.HomeZip = this.txtHomeZip.Text;//家庭地址邮编
            patient.AddressBusiness = this.txtWorkAddress.Text;//单位地址
