...
namespace FS.SOC.Local.InpatientFee.ShenZhen.BinHai.Components
{
    ...
    public partial class ucBedFeeItemModify : UserControl
    {
        ...
        ///固定费用实体
        /// </summary>
        private FS.SOC.Local.InpatientFee.ShenZhen.BinHai.Models.Fee.BedFeeItem bedFeeItem = new FS.SOC.Local.InpatientFee.ShenZhen.BinHai.Models.Fee.BedFeeItem();

        /// <summary>
        /// 代理
        /// </summary>
        /// <param name="bedFeeItem"></param>
        public delegate int ClickSave(FS.SOC.Local.InpatientFee.ShenZhen.BinHai.Models.Fee.BedFeeItem bedFeeItem);
        ...
        /// </summary>
        private BizLogic.Fee.BedFeeItem bedFeeItemManager = new BizLogic.Fee.BedFeeItem();
        ...
        /// 原始床位费用信息
        /// </summary>
        private FS.SOC.Local.InpatientFee.ShenZhen.BinHai.Models.Fee.BedFeeItem originalFeeItem = null;
        #endregion
        ...
        /// 固定费用实体
        /// </summary>
        public FS.SOC.Local.InpatientFee.ShenZhen.BinHai.Models.Fee.BedFeeItem BedFeeItem
        {
            get
            {
        ...
        /// 增加在用、停用、废弃下拉框
        /// </summary>
        protected virtual void InitUseLimit()
        {
            ArrayList useLimit = new ArrayList();
            ...
            this.cmbUseLimit.AddItems(useLimit);
            this.cmbUseLimit.SelectedIndex = 0;
        }
        ...
        protected virtual void Modify()
        {
            ...
            this.ckExtFlag.Checked = FS.FrameWork.Function.NConvert.ToBoolean(this.bedFeeItem.ExtendFlag);
            this.ckOutFeeFlag.Checked = this.bedFeeItem.IsOutFeeFlag;
            this.cmbUseLimit.Tag = this.bedFeeItem.UseLimit;
        ...
        protected virtual int Confirm()
        {
            ...
            this.bedFeeItem.UseLimit = this.cmbUseLimit.Tag.ToString();  //使用限制
            this.bedFeeItem.ExtendFlag = FS.FrameWork.Function.NConvert.ToInt32(this.ckExtFlag.Checked).ToString();
            this.bedFeeItem.IsOutFeeFlag = this.ckOutFeeFlag.Checked;
            ...
            try
            {
                ...
                funIntegrate.SaveChange<FS.HISFC.Models.Fee.BedFeeItem>("BedF", isInsert, false, this.bedFeeItem.FeeGradeCode + "-" + this.bedFeeItem.ID, (FS.HISFC.Models.Fee.BedFeeItem)this.originalFeeItem, (FS.HISFC.Models.Fee.BedFeeItem)this.bedFeeItem);
