...
{
    partial class ucBedFeeMaintenance
    {
        /// <summary> 
        /// 必需的设计器变量。
        ...
        private void InitializeComponent()
        {
            ...
            this.tvBedGrade = new FS.FrameWork.WinForms.Controls.NeuTreeView();
            ...
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "使用限制";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "婴儿相关";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "时间相关";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "非在院计费";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "出院计费";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "是否有效";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 13).Value = "顺序号";
            ...
            this.neuSpread1_Sheet1.Columns.Get(7).Label = "使用限制";
            this.neuSpread1_Sheet1.Columns.Get(8).CellType = checkBoxCellType1;
            this.neuSpread1_Sheet1.Columns.Get(8).Label = "婴儿相关";
            this.neuSpread1_Sheet1.Columns.Get(8).Width = 62F;
            this.neuSpread1_Sheet1.Columns.Get(9).CellType = checkBoxCellType2;
            this.neuSpread1_Sheet1.Columns.Get(9).Label = "时间相关";
            this.neuSpread1_Sheet1.Columns.Get(9).Width = 65F;
            this.neuSpread1_Sheet1.Columns.Get(10).CellType = checkBoxCellType3;
            this.neuSpread1_Sheet1.Columns.Get(10).Label = "非在院计费";
            this.neuSpread1_Sheet1.Columns.Get(11).CellType = checkBoxCellType4;
            this.neuSpread1_Sheet1.Columns.Get(11).Label = "出院计费";
        ...
        "停用",
        "废弃"};
            this.neuSpread1_Sheet1.Columns.Get(12).CellType = comboBoxCellType1;
            this.neuSpread1_Sheet1.Columns.Get(12).Label = "是否有效";
            numberCellType3.AcceptsArrowKeys = FarPoint.Win.SuperEdit.AcceptsArrowKeys.Arrows;
            this.neuSpread1_Sheet1.Columns.Get(13).CellType = numberCellType3;
            this.neuSpread1_Sheet1.Columns.Get(13).Label = "顺序号";
            ...
            this.tvBedGrade.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
        ...
        private FS.FrameWork.WinForms.Controls.NeuTreeView tvBedGrade;
