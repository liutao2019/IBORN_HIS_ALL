...
{
    public partial class frmCreateCardMultiScreen : Form, FS.HISFC.BizProcess.Interface.FeeInterface.IMultiScreen
    {
        public frmCreateCardMultiScreen()
        {
            InitializeComponent();
        }
...
*/
        ...
        public void SetShowInfomation(FS .HISFC .Models .RADT .PatientInfo a, string b, string c, string d)
        {
            if (c.ToString() == "")
            {
                ...
                //this.tbOwnCost.Text = a.IDCard.ToString();
                //this.tbPubCost.Text = a.AddressHome.ToString();
                //this.tbPayCost.Text = a.Kin.RelationPhone.ToString();
                //this.neuLabel4.Text = a.Pact.Name.ToString();
        ...
        #endregion
        void frmCreateCardMultiScreen_Load(object sender, System.EventArgs e)
        {
            try
            {
                this.neuPanel3.BackgroundImage = System.Drawing.Image.FromFile(Application.StartupPath + "\\Setting\\backgroundimage\\卡发放背景.jpg");
            }
            catch
            {
