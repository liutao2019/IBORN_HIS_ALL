namespace FS.SOC.Local.OutpatientFee.FoSan
{
    partial class frmQueryPatientByName
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "就诊日期";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "地址";
            ...
            this.fpSpread1_Sheet1.Columns.Get(5).Label = "就诊日期";
            this.fpSpread1_Sheet1.Columns.Get(5).Width = 71F;
            this.fpSpread1_Sheet1.Columns.Get(6).CellType = textCellType4;
            this.fpSpread1_Sheet1.Columns.Get(6).Label = "地址";
            this.fpSpread1_Sheet1.Columns.Get(6).Width = 200F;
