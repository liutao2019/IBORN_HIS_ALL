...
namespace FS.SOC.Local.OutpatientFee.FuYou.Models
{
    /// <summary>
    /// 门诊收款日结实体类
    /// </summary>
    public class OutPatientDayBalance : FS.FrameWork.Models.NeuObject
    {
        ...
        /// </summary>
        /// <returns></returns>
        public new OutPatientDayBalance Clone()
        {
            OutPatientDayBalance clinicDayBalance = new OutPatientDayBalance().Clone();
