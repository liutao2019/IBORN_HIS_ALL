...
{
    public partial class ucOutPatientIncoming : FS.WinForms.Report.Common.ucQueryBaseForDataWindow
    {
        public ucOutPatientIncoming()
        {
            InitializeComponent();
        }
        ...
        private void ucOutPatientIncoming_Load(object sender, EventArgs e)
        {
