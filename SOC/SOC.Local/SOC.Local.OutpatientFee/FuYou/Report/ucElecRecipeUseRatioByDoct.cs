...
{
    public partial class ucElecRecipeUseRatioByDoct : FS.WinForms.Report.Common.ucQueryBaseForDataWindow
    {
        public ucElecRecipeUseRatioByDoct()
        {
            InitializeComponent();
        }
        ...
        private void ucElecRecipeUseRatioByDoct_Load(object sender, EventArgs e)
        {
