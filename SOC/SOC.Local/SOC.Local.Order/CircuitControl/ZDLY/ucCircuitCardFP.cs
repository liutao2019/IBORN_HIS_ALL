...
namespace SOC.Local.Order.CircuitControl.ZDLY
{
    ...
    /// </summary>
    /// 
    public partial class ucCircuitCardFP : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.HISFC.BizProcess.Interface.IPrintTransFusion
    {
