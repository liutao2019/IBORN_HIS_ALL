...
using Neusoft.SOC.Local.Order.DrugCard.ZhangCha;
namespace SOC.Local.Order.DrugCard.ZhangCha
{
    ...
    public partial class ucDrugTransfusionPanel : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.HISFC.BizProcess.Interface.IPrintTransFusion
    {
        ...
        /// 瓶贴卡
        /// </summary>
        Neusoft.SOC.Local.Order.DrugCard.ZhangCha.ucInfusionLabel ucLabel = new Neusoft.SOC.Local.Order.DrugCard.ZhangCha.ucInfusionLabel();
