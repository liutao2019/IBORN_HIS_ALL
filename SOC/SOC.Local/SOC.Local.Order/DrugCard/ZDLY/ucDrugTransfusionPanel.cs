...
using Neusoft.SOC.Local.Order.DrugCard.ZDLY;
namespace SOC.Local.Order.DrugCard.ZDLY
{
    ...
    public partial class ucDrugTransfusionPanel : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.HISFC.BizProcess.Interface.IPrintTransFusion
    {
        ...
        /// 瓶贴卡
        /// </summary>
        Neusoft.SOC.Local.Order.DrugCard.GYSY.ucInfusionLabel ucLabel = new Neusoft.SOC.Local.Order.DrugCard.GYSY.ucInfusionLabel();
        ...
        public void Print()
        {
            try
            {
                ...
                foreach (Control c in this.pnCard.Controls)
                {
                    ...
                    Neusoft.SOC.Local.Order.DrugCard.GYSY.ucInfusionLabel cTemp = c as Neusoft.SOC.Local.Order.DrugCard.GYSY.ucInfusionLabel;
                    if (cTemp.IsSelected)
                    {
                        cTemp.SetPrint();
        ...
        public void PrintPanel()
        {
            try
            {
                Neusoft.HISFC.Components.Common.Classes.Function.GetPageSize("InPatientCureCard", ref print);
        ...
        protected void SetValues(ArrayList alValues)
        {
            ...
            if (alValues != null)
            {
                ...
                Neusoft.HISFC.Models.Base.PageSize page = Neusoft.HISFC.Components.Common.Classes.Function.GetPageSize("InPatientCureCard");
                ...
                Neusoft.FrameWork.WinForms.Classes.Function.AddControlToPanel(alValues, ucLabel, this.pnCard, new Size(1100, 1250), 1);
