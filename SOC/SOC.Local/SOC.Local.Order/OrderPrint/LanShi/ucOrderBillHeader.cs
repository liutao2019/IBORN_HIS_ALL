...
namespace Neusoft.SOC.Local.InOrder.OrderPrint.LanShi
{
	...
	public class ucOrderBillHeader : System.Windows.Forms.UserControl
    {
		...
		private void InitializeComponent()
		{
            ...
            this.lblHeader.Location = new System.Drawing.Point(159, 59);
            ...
            this.lblHosName.Location = new System.Drawing.Point(151, 0);
            ...
            this.label1.Text = "入院时间:";
            // 
            // lblInDate
            // 
            this.lblInDate.AutoSize = true;
            this.lblInDate.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            this.lblInDate.Location = new System.Drawing.Point(83, 92);
            this.lblInDate.Name = "lblInDate";
            this.lblInDate.Size = new System.Drawing.Size(61, 20);
            this.lblInDate.TabIndex = 66;
            this.lblInDate.Text = "2012年";
            // 
            // ucOrderBillHeader
            // 
        ...
        Neusoft.HISFC.BizLogic.Manager.Department fee = new Neusoft.HISFC.BizLogic.Manager.Department();
        ...
        Neusoft.HISFC.BizLogic.Order.OutPatient.Order outOrder = new Neusoft.HISFC.BizLogic.Order.OutPatient.Order();
		...
		{	
			try
			{
                ...
                Neusoft.HISFC.Models.Base.Department temp = this.fee.GetDeptmentById(order.InDept.ID);

                this.lblDept.Text = temp.Name;
                this.lblBedNo.Text = order.Patient.PVisit.PatientLocation.Bed.ID.Substring(4);

                temp = this.fee.GetDeptmentById(order.Patient.PVisit.PatientLocation.NurseCell.ID);

                this.lblNurseCell.Text = temp.Name;

                this.lblAge.Text = this.outOrder.GetAge(this.pInfo.Birthday, order.MOTime);
			}
			catch
			{}
		}
        ...
        private string GetAge(DateTime dtBirthday)
        {
            ...
            DateTime systime = this.fee.GetDateTimeFromSysDateTime();
		...
		private void SetPatientInfo()
		{
            ...
            {
                this.Clear();
                //this.lblAge.Text = this.GetAge(this.pInfo.Birthday);
                this.lblAge.Text = this.outOrder.GetAge(this.pInfo.Birthday);
                ...
                this.lblNurseCell.Text = this.pInfo.PVisit.PatientLocation.NurseCell.Name;
                if (this.pInfo.PVisit.PatientLocation.Bed.ID.Length >= 4)
                {
                    this.lblBedNo.Text = this.pInfo.PVisit.PatientLocation.Bed.ID.Substring(4);
                }
                this.lblPatientNo.Text = this.pInfo.PID.PatientNO;

                this.lblInDate.Text = pInfo.PVisit.InTime.Year.ToString() + "年";
            }
		}
