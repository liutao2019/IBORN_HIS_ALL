	...
	public class ucOrderBillHeader : System.Windows.Forms.UserControl
    {
        ...
        public void SetChangedInfo(FS.HISFC.Models.Order.Inpatient.Order order)
        {
            try
            {
                ...
                this.lblAge.Text = this.deptMgr.GetAge(this.pInfo.Birthday, order.MOTime);
            }
            catch (Exception ex)
            {
		...
		private void SetPatientInfo()
		{
            if (this.pInfo != null)
            {
                ...
                this.lblAge.Text = this.deptMgr.GetAge(this.pInfo.Birthday);
                ...
                if (string.IsNullOrEmpty(this.lblName.Text))
                {
                    ...
                    FS.HISFC.Models.RADT.PatientInfo pInfo = radtIntegrate.GetPatientInfoByPatientNO(this.pInfo.ID);
                ...
                this.lblPatientNo.Text = this.pInfo.PID.PatientNO.TrimStart('0');
            }
		}
