...
using FS.WinForms.Report.Order;
namespace FS.SOC.Local.Order.ExecBill
{
    ...
    ///  />
    /// </summary>
    public partial class ucExecBill :  FS.WinForms.Report.Common.ucQueryBaseForDataWindow,FS.HISFC.BizProcess.Interface.IPrintTransFusion
    {
        /// <summary>
        ///  治疗单
        /// </summary>
