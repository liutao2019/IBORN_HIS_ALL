namespace FS.SOC.Local.Order.ExecBill
{
    partial class ucExecBillFP
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.neuSpread1_Sheet1.Columns.Get(4).Label = "医嘱内容（备注、基本计量）";
            this.neuSpread1_Sheet1.Columns.Get(4).Width = 257F;
            ...
            this.neuSpread1_Sheet1.Columns.Get(8).Width = 52F;
            ...
            this.neuSpread1_Sheet1.Columns.Get(9).Label = "时间点";
            this.neuSpread1_Sheet1.Columns.Get(9).Width = 70F;
            this.neuSpread1_Sheet1.Columns.Get(11).Label = "执行时间";
            this.neuSpread1_Sheet1.Columns.Get(11).Width = 42F;
            this.neuSpread1_Sheet1.Columns.Get(12).Label = "是否打印";
            ...
            // panel3
            // 
            this.panel3.Controls.Add(this.btSaveXml);
