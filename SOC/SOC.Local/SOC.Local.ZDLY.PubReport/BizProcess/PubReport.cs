...
namespace FS.SOC.Local.ZDLY.PubReport.BizProcess
{
    public class PubReport : FS.HISFC.BizProcess.Integrate.IntegrateBase
    {
        ...
        FS.SOC.Local.ZDLY.PubReport.BizLogic.PubReport pubMgr = new FS.SOC.Local.ZDLY.PubReport.BizLogic.PubReport();
        ...
        public ArrayList QueryPubFeeInfoClinic(DateTime beginDate, DateTime endDate)
        {
            ...
            {
                FS.SOC.Local.ZDLY.PubReport.Models.PubReport pubReport = new FS.SOC.Local.ZDLY.PubReport.Models.PubReport();
        ...
        public ArrayList QueryPubFeeInfoInpatient(DateTime beginDate, DateTime endDate)
        {
            ...
            {
                FS.SOC.Local.ZDLY.PubReport.Models.PubReport pubReport = ConvertInvoiceToPubReport(invoice);
                if (pubReport != null)
                {
                    alPubFeeInfo.Add(pubReport);
                }
        ...
        /// <returns></returns>
        public FS.SOC.Local.ZDLY.PubReport.Models.PubReport ConvertInvoiceToPubReport(FS.HISFC.Models.Fee.Inpatient.Balance invoice)
        {
        ...
        /// <returns></returns>
        public FS.SOC.Local.ZDLY.PubReport.Models.PubReport ConvertInvoiceToPubReport(FS.HISFC.Models.Fee.Outpatient.Balance invoice)
        {
