...
namespace FS.SOC.Local.ZDLY.PubReport.Components
{
    public partial class ucPublicBill : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        FS.SOC.Local.ZDLY.PubReport.BizLogic.PubReport myReport = new FS.SOC.Local.ZDLY.PubReport.BizLogic.PubReport();
        ...
        public int SetStaticPatients(string flag, string inState, string inpatientNo)
        {
            ...
            FS.SOC.Local.ZDLY.PubReport.Models.PubReport report = null; //托收单实体
            ...
            foreach (FS.HISFC.Models.RADT.PatientInfo p in alPatient)
            {
                ...
                if (isExist)//患者在此期间已经存在托收信息
                {
                  ...
                  //  report = myReport.GetPubReport(p.ID, dtEnd.Date.ToString());
                    report = myReport.GetPubReport(p.ID, dtBegin,dtEnd);
        ...
        public int Modify()
        {
            ...
            DateTime dtBegin = this.dtpBegin.Value;
            DateTime dtEnd = this.dtpEnd.Value;
            FS.SOC.Local.ZDLY.PubReport.Models.PubReport report = null;

            if (this.fpSpread1_Sheet1.Cells[this.fpSpread1_Sheet1.ActiveRowIndex, 0].Tag != null)
            {
                report = myReport.GetPubReport(p.ID, ((FS.SOC.Local.ZDLY.PubReport.Models.PubReport)this.fpSpread1_Sheet1.Cells[this.fpSpread1_Sheet1.ActiveRowIndex, 0].Tag).Begin,((FS.SOC.Local.ZDLY.PubReport.Models.PubReport)this.fpSpread1_Sheet1.Cells[this.fpSpread1_Sheet1.ActiveRowIndex, 0].Tag).End);
            }
            else
            {
                report = myReport.GetPubReport(p.ID,dtBegin,dtEnd);
            ...
            ucModifyPublicBill uc = new ucModifyPublicBill();
            uc.PatientInfo = p;
            uc.Report = report;
            uc.SetInfo();
        ...
        public int Delete()
        {
            ...
            //			FS.SOC.Local.ZDLY.PubReport.Models.PubReport report = myReport.GetPubReport(p.ID, this.dtpEnd.Value.Date.ToString());
            //			if(report == null)
            //			{
            //				t.RollBack();
            ...
            if (r == DialogResult.Yes)
            {
                ...
                FS.SOC.Local.ZDLY.PubReport.Models.PubReport reportTemp = (FS.SOC.Local.ZDLY.PubReport.Models.PubReport)(this.fpSpread1_Sheet1.Cells[row, 0].Tag);
        ...
        public void Init()
        {
            try
            {
                ...
                FS.SOC.Local.ZDLY.PubReport.BizLogic.PubReport report = new FS.SOC.Local.ZDLY.PubReport.BizLogic.PubReport();
        ...
        private int SetPatientInfo(FS.HISFC.Models.RADT.PatientInfo p, FS.SOC.Local.ZDLY.PubReport.Models.PubReport report, bool isSelect,
        ...
        public override int Query(object sender, object neuObject)
        {
            ...
            foreach (FS.SOC.Local.ZDLY.PubReport.Models.PubReport rep in alReport)
            {
