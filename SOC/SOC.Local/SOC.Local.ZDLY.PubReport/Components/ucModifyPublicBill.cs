...
namespace FS.SOC.Local.ZDLY.PubReport.Components
{
    public partial class ucModifyPublicBill : UserControl
    {
        ...
        /// 托收信息
        /// </summary>
        public FS.SOC.Local.ZDLY.PubReport.Models.PubReport Report
        {
            set
            {
                report = value;
        ...
        public int SetInfo()
        {
            ...
            if (report.MR > 0)
            {
                this.lblMR.Visible = true;
                this.tbMR.Visible = true;
                this.tbMR.Text = report.MR.ToString();
                this.lblSYAO.Visible = false;
                this.txtSYAO.Visible = false;
            }
            else if(report.CancerDrugFee>0)
            {
                this.lblMR.Visible = false;
                this.tbMR.Visible = false;
                this.lblSYAO.Visible = true;
                this.txtSYAO.Visible = true;
                this.txtSYAO.Text = report.CancerDrugFee.ToString();
            ...
            //change by zhy 
           // this.tbPay.Text = Math.Round((report.Tot_Cost * report.Pay_Rate),2).ToString();
           // this.tbReal.Text = Math.Round((report.Tot_Cost * (1 - report.Pay_Rate)),2).ToString();
