...
{
    public class LocalWorkLoadManager:Neusoft.FrameWork.Management.Database
    {
        public int UpdateOutPatientWorkLoad(Neusoft.FrameWork.Models.NeuObject neuObj,string operCode,string type)
        {
            int param = -1;
            string strSql = "";
 ...
 where bill_no = '{0}'
   and work_type = '{1}'";
        ...
        /// <returns></returns>
        public Neusoft.FrameWork.Models.NeuObject QueryOutPatientWorkLoad(string recipeNO, string drugDeptNO, string type)
        {
