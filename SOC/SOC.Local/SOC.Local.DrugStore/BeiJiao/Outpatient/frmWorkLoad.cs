...
namespace FS.SOC.Local.DrugStore.BeiJiao.Outpatient
{
    public partial class frmWorkLoad : Form
    {
        ...
        private void SetWorkLoad()
        {
            ...
            if (workLoadManager.SetOutpatientWorkLoad(this.curRecipeNO, this.curDeptNO, this.curOperDeptNO, curType, this.ntbEmplNOBarCode.Text.PadLeft(6, '0'), this.curQty) == 1)
            {
                this.Close();
            }
        }
        ...
        void ntbEmplNOBarCode_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)13)
            {
                ...
                FS.HISFC.Models.Base.Employee empl =personMgr.GetPersonByID(this.ntbEmplNOBarCode.Text.PadLeft(6,'0'));
