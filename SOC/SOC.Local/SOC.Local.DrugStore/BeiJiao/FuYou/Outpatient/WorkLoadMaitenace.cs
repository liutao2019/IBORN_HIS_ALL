...
namespace Neusoft.SOC.Local.DrugStore.FuYou.Outpatient
{
    ...
    /// [创建时间: 2011-1]<br></br>
    /// </summary>
    public class WorkLoadMaitenance : Neusoft.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.IOutpatientWorkLoad
    {
        Neusoft.FrameWork.Models.NeuObject drugOper = new Neusoft.FrameWork.Models.NeuObject();
        Neusoft.FrameWork.Models.NeuObject sendOper = new Neusoft.FrameWork.Models.NeuObject();
        ...
        public string Reassigned(Neusoft.FrameWork.Models.NeuObject dept, string type, Neusoft.HISFC.Models.Pharmacy.DrugTerminal drugTerminal)
        {
            ...
            Neusoft.FrameWork.Models.NeuObject tmpOper1 = new Neusoft.FrameWork.Models.NeuObject();
            Neusoft.FrameWork.Models.NeuObject tmpOper2 = new Neusoft.FrameWork.Models.NeuObject();
            if (frmWorkLoad.DrugedOperCode != "-1")
            {
        ...
        public string Set(Neusoft.FrameWork.Models.NeuObject dept, Neusoft.HISFC.Models.Pharmacy.DrugRecipe drugRecipe, string type, Neusoft.HISFC.Models.Pharmacy.DrugTerminal drugTerminal)
        {
            ...
            {
                //直接发药，计入发药工作量
                Common.WorkLoadManager workLoadMgr = new Neusoft.SOC.Local.DrugStore.Common.WorkLoadManager();
