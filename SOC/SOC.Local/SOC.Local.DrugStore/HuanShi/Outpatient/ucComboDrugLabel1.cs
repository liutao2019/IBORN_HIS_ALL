...
namespace FS.SOC.Local.DrugStore.HuanShi.Outpatient
{
    public partial class ucComboDrugLabel1 : UserControl
    {
        ...
        public int PrintDrugLabel(System.Collections.ArrayList alData, FS.HISFC.Models.Pharmacy.DrugRecipe drugRecipe, FS.HISFC.Models.Pharmacy.DrugTerminal drugTerminal, bool isPrintRegularName, string hospitalName, bool isPrintMemo, string qtyShowType, DateTime printTime, string pageNO)
        {
            ...
            this.nlbPrintTime.Text = string.Format("{0:yyyy年MM月dd日}", drugRecipe.FeeOper.OperTime.Date) + "    时   分";
            ...
            this.nlbSpecs1.Text = SOC.HISFC.BizProcess.Cache.Pharmacy.GetItem(applyOut.Item.ID).BaseDose + applyOut.Item.DoseUnit;
            ...
            this.nlbSpecs2.Text = SOC.HISFC.BizProcess.Cache.Pharmacy.GetItem(applyOut.Item.ID).BaseDose + applyOut.Item.DoseUnit;
            ...
            this.nlbSpecs3.Text = SOC.HISFC.BizProcess.Cache.Pharmacy.GetItem(applyOut.Item.ID).BaseDose + applyOut.Item.DoseUnit;
