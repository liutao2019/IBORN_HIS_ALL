...
namespace FS.SOC.Local.DrugStore.QiaoTou.Inpatient
{
    ...
    public class DrugBillInterfaceImplement : FS.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.IDrugBillClass
    {
        ...
        {
            //摆药单结合剂型判断{49DB3BA4-4D3B-44f7-8134-0D32EB869874}
            FS.HISFC.Models.Pharmacy.DrugBillClass billClass = new FS.HISFC.Models.Pharmacy.DrugBillClass();
            FS.FrameWork.Public.ObjectHelper dosageHelper = new FS.FrameWork.Public.ObjectHelper();
            FS.HISFC.BizProcess.Integrate.Manager manager = new FS.HISFC.BizProcess.Integrate.Manager();         
            dosageHelper = new FS.FrameWork.Public.ObjectHelper(manager.GetConstantList(FS.HISFC.Models.Base.EnumConstant.DOSAGEFORM));
            FS.FrameWork.Models.NeuObject doseObject2 = dosageHelper.GetObjectFromID(applyOut.Item.DosageForm.ID);           
            ...
            //{6528C505-F4F6-4bbb-B9ED-527ADF942776}
            //口服药发送到明细摆药单、
            //{49DB3BA4-4D3B-44f7-8134-0D32EB869874}modify 20120413 结合剂型
            if ((SOC.HISFC.BizProcess.Cache.Common.IsPOUsage(applyOut.Usage.ID))||doseObject2 .Memo =="1")
            {
            ...
            //modify 20120413 针剂长嘱临嘱合并{49DB3BA4-4D3B-44f7-8134-0D32EB869874}
            ////针剂长期医嘱摆药单
            //if (applyOut.OrderType.ID == "CZ")
            //{
            //    billClass.ID = "TC";
