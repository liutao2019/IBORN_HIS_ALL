                ...
                if (this.neuSpread1_Sheet1.Rows.Count > 0)
                {
                    ...
                    for (int pageNO = totPageNO; pageNO > 0; pageNO--)
                    {
                        ...
                        if (pageNO == totPageNO)
                        {
                            ...
                            this.neuSpread1_Sheet1.Cells[index, 0].Text = "发药：            核对：            领药：              页：" + pageNO.ToString() + "/" + totPageNO.ToString();
                        ...
                        //单元格类型修改{6DC3CB07-9DA4-4704-A886-ADB9F85E41A7}
                        FarPoint.Win.Spread.CellType.GeneralCellType generalcell = new FarPoint.Win.Spread.CellType.GeneralCellType();
                        this.neuSpread1_Sheet1.Cells[pageNO * pageRowNum, 6].CellType = generalcell;
