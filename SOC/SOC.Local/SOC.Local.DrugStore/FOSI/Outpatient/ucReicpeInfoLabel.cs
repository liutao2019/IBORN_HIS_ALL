...
namespace FS.SOC.Local.DrugStore.FOSI.Outpatient
{
    public partial class ucReicpeInfoLabel : UserControl
    {
        ...
        /// <returns></returns>
        public int PrintDrugLabel(System.Collections.ArrayList alData, FS.HISFC.Models.Pharmacy.DrugRecipe drugRecipe, FS.HISFC.Models.Pharmacy.DrugTerminal drugTerminal, bool isPrintRegularName, string hospitalName, bool isPrintMemo, string diagnose, DateTime printTime,bool istuiyao)
        {
            ...
            if (istuiyao)
            {
                ...
                this.neuLabel2.Text = "退单";
                this.neuLabel2.Font = new System.Drawing.Font("宋体", 42F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            }
            ...
            this.npbBarCode.Image = this.CreateBarCode(drugRecipe.CardNO);
