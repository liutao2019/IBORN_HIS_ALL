...
namespace FS.SOC.HISFC.Components.PharmacyCommon
{
    ...
    ///  />
    /// </summary>
    public partial class tvDrugType : FS.SOC.HISFC.Components.Common.Base.baseTreeView
    {
        public tvDrugType()
        {
            InitializeComponent();
        ...
        {
            FS.SOC.HISFC.BizLogic.Pharmacy.Constant pharmacyConstant = new FS.SOC.HISFC.BizLogic.Pharmacy.Constant();
