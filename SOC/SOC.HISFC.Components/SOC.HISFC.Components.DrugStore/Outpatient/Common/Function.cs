...
namespace FS.SOC.HISFC.Components.DrugStore.Outpatient.Common
{
    ...
    public class Function
    {
        ...
        public static FS.HISFC.Models.Pharmacy.DrugTerminal TerminalSelect(string stockDept, FS.HISFC.Models.Pharmacy.EnumTerminalType terminalType, bool isShowMessageBox)
        {
            ...
            terminalCode1 = SOC.Public.XML.SettingFile.ReadSetting(FS.FrameWork.WinForms.Classes.Function.CurrentPath + "\\Profile\\OutpatientDrugStore.xml", "TerminalCode", "Dept"+stockDept + terminalType.ToString(), terminalCode1);
            ...
            SOC.Public.XML.SettingFile.SaveSetting(FS.FrameWork.WinForms.Classes.Function.CurrentPath + "\\Profile\\OutpatientDrugStore.xml", "TerminalCode", "Dept" + stockDept + terminalType.ToString(), terminal.ID);
            return terminal;
        }
        ...
        public static FS.HISFC.Models.Pharmacy.DrugTerminal TerminalSelect(string stockDept, string sendTerminal, bool isShowMessageBox)
        {
            ...
            terminalCode2 = SOC.Public.XML.SettingFile.ReadSetting(FS.FrameWork.WinForms.Classes.Function.CurrentPath + "\\Profile\\OutpatientDrugStore.xml", "TerminalCode", "Dept" + stockDept + terminalType.ToString(), terminalCode2);
        ...
        public static uint GetCostDecimals()
        {
            ...
            {
                decimals = ((FS.SOC.HISFC.BizProcess.PharmacyInterface.Pharmacy.IPharmacyBizExtend)interfaceImplement).GetCostDecimals("0320", "M1", "M1");
            }
        ...
        #region 门诊部分发药
        public static int JudgePartSend()
        {
        ...
        /// <param name="isUpdateAdjustParam">是否更新处方调剂参数</param>
        /// <returns>发药确认成功返回1 失败返回-1</returns>
        internal static int OutpatientPartSend(List<FS.HISFC.Models.Pharmacy.ApplyOut> applyOutCollection, FS.FrameWork.Models.NeuObject terminal, FS.FrameWork.Models.NeuObject sendDept, FS.FrameWork.Models.NeuObject sendOper, bool isDirectSave, bool isUpdateAdjustParam)
        {
            FS.HISFC.BizProcess.Integrate.Pharmacy pharmacyIntegrate = new FS.HISFC.BizProcess.Integrate.Pharmacy();
            if (pharmacyIntegrate.OutpatientPartSend(applyOutCollection, terminal, sendDept, sendOper, isDirectSave, isUpdateAdjustParam) != 1)
            {
                System.Windows.Forms.MessageBox.Show(pharmacyIntegrate.Err);
                return -1;
            }
