namespace FS.SOC.HISFC.Components.DrugStore.Outpatient.Common
{
    partial class ucRecipeTree
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tvBaseTree1 = new FS.SOC.HISFC.Components.DrugStore.Outpatient.Base.tvRecipeBaseTree(this.components);
            this.tvBaseTree2 = new FS.SOC.HISFC.Components.DrugStore.Outpatient.Base.tvRecipeBaseTree(this.components);
        ...
        private FS.SOC.HISFC.Components.DrugStore.Outpatient.Base.tvRecipeBaseTree tvBaseTree1;
        private System.Windows.Forms.TabPage tabPage2;
        private FS.SOC.HISFC.Components.DrugStore.Outpatient.Base.tvRecipeBaseTree tvBaseTree2;
