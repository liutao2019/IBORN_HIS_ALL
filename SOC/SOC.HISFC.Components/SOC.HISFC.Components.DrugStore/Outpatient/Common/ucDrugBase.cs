...
namespace FS.SOC.HISFC.Components.DrugStore.Outpatient.Common
{
    ...
    public partial class ucDrugBase : Base.ucDrugBaseComponent
    {
        ...
        {
            get { return this.ucRecipeDetail1.EnumQtyShowType; }
            set { this.ucRecipeDetail1.EnumQtyShowType = value; }
        }
        ...
        FS.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.IOutpatientWorkLoad myIOutpatientWorkLoad;
        /// <summary>
        /// 工作量接口
        /// </summary>
        public FS.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.IOutpatientWorkLoad IOutpatientWorkLoad
        {
            get
            {
                if (this.DesignMode)
                ...
                if (myIOutpatientWorkLoad == null && !isCreateWorkLoad)
                {
                    try
                    {
                        ...
                        myIOutpatientWorkLoad = (InterfaceManager.GetOutpatientWorkLoad() as FS.SOC.HISFC.BizProcess.PharmacyInterface.DrugStore.IOutpatientWorkLoad);
                    }
                    catch
                    {
