...
{
    public partial class ucMaintenanceDeptSelect : FS.FrameWork.WinForms.Controls.ucMaintenance
    {
        public ucMaintenanceDeptSelect()
            : base("const")
        {
            InitializeComponent();
            Init();
        ...
        /// 非药品项目列表
        /// </summary>
        private ArrayList alConst_Dept = null;

        /// <summary>
        /// 非药品项目帮助类
        /// </summary>
        private FS.FrameWork.Public.ObjectHelper constHelper_Dept = null;
        ...
        private int Init()
        {
            ...
            //非药品项目
            alConst_Dept = SOC.HISFC.BizProcess.Cache.Common.GetValidDept();
            if (alConst_Dept == null)
            {
                MessageBox.Show("查询收费项目出错：" + this.feeIntegrate.Err);
                return -1;
            }
            constHelper_Dept = new FS.FrameWork.Public.ObjectHelper(alConst_Dept);
        ...
        private void neuSpread1_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            {
                this.PopItem(this.alConst_Dept, 2);
            }
        }
