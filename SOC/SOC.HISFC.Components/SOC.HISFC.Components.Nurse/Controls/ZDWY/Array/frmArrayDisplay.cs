...
namespace FS.SOC.HISFC.Components.Nurse.Controls.ZDWY.Array
{
    ...
    /// 中大五院门诊护士分诊外屏显示
    /// </summary>
    public partial class frmArrayDisplay : Form, FS.SOC.HISFC.Assign.Interface.Components.IAssignDisplay
    {
        public frmArrayDisplay()
        {
            InitializeComponent();
        ...
        private int Init()
        {
            ...
            for (int col = 0; col < fpSpread1_Sheet1.ColumnCount; col++)
            {
                ...
                fpSpread1_Sheet1.Columns[(Int32)EnumCol.D队列名称].Font = new Font("黑体", doctFontSize,System.Drawing.FontStyle.Bold);
                ...
                fpSpread1_Sheet1.Columns[(Int32)EnumCol.Z在诊患者].Font = new Font("黑体", patientFontSize, System.Drawing.FontStyle.Bold);
                ...
                fpSpread1_Sheet1.Columns[(Int32)EnumCol.D待诊1].Font = new Font("黑体", patientFontSize, System.Drawing.FontStyle.Bold);
                ...
                fpSpread1_Sheet1.Columns[(Int32)EnumCol.D待诊2].Font = new Font("黑体", patientFontSize, System.Drawing.FontStyle.Bold);
        ...
        private int SetQueue()
        {
            ...
            //ArrayList alQueue = localMgr.Query(oper.Nurse.ID, dtNow.Date, noonID);
            //if (alQueue == null)
            //{
