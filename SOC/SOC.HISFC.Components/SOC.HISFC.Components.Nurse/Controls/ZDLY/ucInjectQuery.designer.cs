namespace FS.SOC.HISFC.Components.Nurse.Controls.ZDLY
{
    partial class ucInjectQuery
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.panelList = new FS.FrameWork.WinForms.Controls.NeuPanel();
            ...
            this.dtInjectDate = new FS.FrameWork.WinForms.Controls.NeuDateTimePicker();
            this.dtMixDate = new FS.FrameWork.WinForms.Controls.NeuDateTimePicker();
            ...
            this.cbInjectDate = new FS.FrameWork.WinForms.Controls.NeuCheckBox();
            this.cmbInjectOper = new FS.FrameWork.WinForms.Controls.NeuComboBox(this.components);
            this.cbInjectOper = new FS.FrameWork.WinForms.Controls.NeuCheckBox();
            this.cbMixDate = new FS.FrameWork.WinForms.Controls.NeuCheckBox();
            this.cmbMixOper = new FS.FrameWork.WinForms.Controls.NeuComboBox(this.components);
            this.cbMixOper = new FS.FrameWork.WinForms.Controls.NeuCheckBox();
            this.cbOrder = new FS.FrameWork.WinForms.Controls.NeuCheckBox();
            this.cbRegDate = new FS.FrameWork.WinForms.Controls.NeuCheckBox();
            this.cmbRegOper = new FS.FrameWork.WinForms.Controls.NeuComboBox(this.components);
            this.cbRegOper = new FS.FrameWork.WinForms.Controls.NeuCheckBox();
            ...
            this.panelList.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
            ...
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "日顺序号";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "病历号";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "患者姓名";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "开单医生";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "开单科室";
            ...
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 13).Value = "登记人";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 14).Value = "登记时间";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 15).Value = "配药人";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 16).Value = "配药时间";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 17).Value = "注射人";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 18).Value = "注射时间";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 19).Value = "滴速";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 20).Value = "拔针人";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 21).Value = "拔针时间";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 22).Value = "送急诊时间";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 23).Value = "特殊情况记录";
            ...
            this.neuSpread1_Sheet1.Columns.Get(8).Font = new System.Drawing.Font("仿宋_GB2312", 14.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            ...
            dateTimeCellType1.DateDefault = new System.DateTime(2011, 9, 23, 15, 30, 0, 484);
            dateTimeCellType1.DateTimeFormat = FarPoint.Win.Spread.CellType.DateTimeFormat.UserDefined;
            dateTimeCellType1.TimeDefault = new System.DateTime(2011, 9, 23, 15, 30, 0, 484);
            ...
            dateTimeCellType2.DateDefault = new System.DateTime(2011, 9, 23, 15, 30, 0, 562);
            ...
            dateTimeCellType2.TimeDefault = new System.DateTime(2011, 9, 23, 15, 30, 0, 562);
            ...
            dateTimeCellType3.DateDefault = new System.DateTime(2011, 9, 23, 15, 30, 0, 562);
            ...
            dateTimeCellType3.TimeDefault = new System.DateTime(2011, 9, 23, 15, 30, 0, 562);
            ...
            dateTimeCellType4.DateDefault = new System.DateTime(2011, 9, 23, 15, 30, 0, 562);
            dateTimeCellType4.DateTimeFormat = FarPoint.Win.Spread.CellType.DateTimeFormat.UserDefined;
            dateTimeCellType4.TimeDefault = new System.DateTime(2011, 9, 23, 15, 30, 0, 562);
            ...
            // dtInjectDate
            // 
            this.dtInjectDate.IsEnter2Tab = false;
            ...
            this.dtInjectDate.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
            this.dtInjectDate.TabIndex = 17;
            // 
            // dtMixDate
            // 
            this.dtMixDate.IsEnter2Tab = false;
            ...
            this.dtMixDate.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
            ...
            this.cbInjectDate.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
            ...
            this.cmbInjectOper.IsEnter2Tab = false;
            this.cmbInjectOper.IsFlat = false;
            this.cmbInjectOper.IsLike = true;
            this.cmbInjectOper.IsListOnly = false;
            this.cmbInjectOper.IsPopForm = true;
            this.cmbInjectOper.IsShowCustomerList = false;
            this.cmbInjectOper.IsShowID = false;
            ...
            this.cmbInjectOper.Style = FS.FrameWork.WinForms.Controls.StyleType.Flat;
            ...
            this.cbInjectOper.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
            ...
            this.cbMixDate.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
            ...
            this.cmbMixOper.IsEnter2Tab = false;
            this.cmbMixOper.IsFlat = false;
            this.cmbMixOper.IsLike = true;
            this.cmbMixOper.IsListOnly = false;
            this.cmbMixOper.IsPopForm = true;
            this.cmbMixOper.IsShowCustomerList = false;
            this.cmbMixOper.IsShowID = false;
            ...
            this.cmbMixOper.Style = FS.FrameWork.WinForms.Controls.StyleType.Flat;
            ...
            this.cbMixOper.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
            ...
            this.cbOrder.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
            ...
            this.cbRegDate.Checked = true;
            this.cbRegDate.CheckState = System.Windows.Forms.CheckState.Checked;
            ...
            this.cbRegDate.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
            ...
            this.cmbRegOper.IsEnter2Tab = false;
            this.cmbRegOper.IsFlat = false;
            this.cmbRegOper.IsLike = true;
            this.cmbRegOper.IsListOnly = false;
            this.cmbRegOper.IsPopForm = true;
            this.cmbRegOper.IsShowCustomerList = false;
            this.cmbRegOper.IsShowID = false;
            ...
            this.cmbRegOper.Style = FS.FrameWork.WinForms.Controls.StyleType.Flat;
            ...
            this.cbRegOper.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
        ...
        private FS.FrameWork.WinForms.Controls.NeuPanel panelList;
        private FS.FrameWork.WinForms.Controls.NeuSpread neuSpread1;
        private FarPoint.Win.Spread.SheetView neuSpread1_Sheet1;
        private FS.FrameWork.WinForms.Controls.NeuCheckBox cbInjectDate;
        private FS.FrameWork.WinForms.Controls.NeuComboBox cmbInjectOper;
        private FS.FrameWork.WinForms.Controls.NeuCheckBox cbInjectOper;
        private FS.FrameWork.WinForms.Controls.NeuCheckBox cbMixDate;
        private FS.FrameWork.WinForms.Controls.NeuComboBox cmbMixOper;
        private FS.FrameWork.WinForms.Controls.NeuCheckBox cbMixOper;
        private FS.FrameWork.WinForms.Controls.NeuCheckBox cbOrder;
        private FS.FrameWork.WinForms.Controls.NeuCheckBox cbRegDate;
        private FS.FrameWork.WinForms.Controls.NeuComboBox cmbRegOper;
        private FS.FrameWork.WinForms.Controls.NeuCheckBox cbRegOper;
        private FS.FrameWork.WinForms.Controls.NeuTextBox txtOrder;
        private FS.FrameWork.WinForms.Controls.NeuDateTimePicker dtInjectDate;
        private FS.FrameWork.WinForms.Controls.NeuDateTimePicker dtMixDate;
