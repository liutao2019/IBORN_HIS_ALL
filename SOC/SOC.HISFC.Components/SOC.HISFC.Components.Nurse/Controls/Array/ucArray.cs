...
namespace SOC.HISFC.Components.Nurse.Controls.Array
{
    ...
    public partial class ucArray : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        ...
        /// 显示屏
        /// </summary>
        SOC.HISFC.Components.Nurse.Controls.Array.frmDisplay f = null;
        ...
        private void RefreshQueue()
        {
            ...
            string noonID = SOC.HISFC.Components.Nurse.Controls.Array.Function.GetNoon(current);//午别
            if (noonID == "")
            {
        ...
        private void lvQueue_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (e.Data.GetDataPresent(typeof(FS.HISFC.Models.Registration.Register)))
            {
                ...
                DateTime current = this.assginMgr.GetDateTimeFromSysDateTime();// this.regMgr.GetDateTimeFromSysDateTime();
                string noonID = SOC.HISFC.Components.Nurse.Controls.Array.Function.GetNoon(current);
        ...
        private void CancelTriageUnsee()
        {
            ...
            string noonID = SOC.HISFC.Components.Nurse.Controls.Array.Function.GetNoon(endDate);
            ArrayList al = new ArrayList();
        ...
        private void SetScreen(bool isClose)
        {
            ...
            else
            {
                ...
                //f.NurseCellID = ass.GetNurseCellCode(((FS.HISFC.Models.Base.Employee)FS.FrameWork.Management.Connection.Operator).Dept.ID);
        ...
        private void CalledPatient()
        {
            ...
            try
            {
                ...
                {
                    noonID = SOC.HISFC.Components.Nurse.Controls.Array.Function.GetNoon(current.AddMinutes(-this.extendTime));
                }
