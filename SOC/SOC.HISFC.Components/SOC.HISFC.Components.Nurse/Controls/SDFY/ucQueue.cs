...
namespace FS.SOC.HISFC.Components.Nurse.Controls.SDFY
{
    ...
    public partial class ucQueue : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private void PopWin(string strTag)
        {
            try
            {
                ...
                if (strTag == "2")
                {
                    ...
                    uc.RefList += new ucQueueQuery.RefQueue(uc_RefList);
        ...
        {
            //FS.FrameWork.Management.Transaction tran = new FS.FrameWork.Management.Transaction(this.myQueue.Connection);
            //开始事务
            try
            {
