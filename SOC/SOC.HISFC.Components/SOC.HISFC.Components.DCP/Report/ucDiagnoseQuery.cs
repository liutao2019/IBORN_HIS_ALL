...
{
    public partial class ucDiagnoseQuery : FS.SOC.HISFC.Components.DCP.Report.BaseReport
    {
        ...
        [Category("Title标题设置"), Description("明细标题")]
        ...
        public ucDiagnoseQuery()
        {
            ...
            this.DetailDoubleClickEnd += new DelegateDoubleClickEnd(ucFeeDetailQuery_DetailDoubleClickEnd);
        }

        void ucFeeDetailQuery_DetailDoubleClickEnd()
        {
            this.lbMainTitle.Text = this.detailTitle;
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            ArrayList alDoct = personManager.GetEmployee(FS.HISFC.Models.Base.EnumEmployeeType.D);
            ...
            this.cmbDept.AddItems(alDoct);
            if (this.cmbDept.Items.Count > 0)
            {
