...
namespace FS.SOC.HISFC.Components.Register.SDFY
{
    ...
    public partial class ucRegister : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Forms.IInterfaceContainer, FS.HISFC.BizProcess.Interface.FeeInterface.ISIReadCard
    {
        ...
        [Obsolete("不再使用，由EnumBirthdayInputType代替")]
        ...
        /// 是否显示处方号控件 {63858620-21A6-4080-8520-E5B948C5EE13}
        /// </summary>
        [Category("控件设置"), Description("是否显示熟人控件"), DefaultValue(true)]
        ...
        /// 年龄输入方式
        /// </summary>
        [Category("控件设置"), Description("年龄输入方式"), DefaultValue(EnumBirthdayInputType.Age)]
        ...
        /// 条码打印机端口号
        /// </summary>
        [Category("控件设置"), Description("条码打印机端口号")]
        ...
        private void SetDoctFpStyle(bool IsDisplaySchema)
        {
            ...
            if (IsDisplaySchema)
            {
                ...
                //ygch 显示专家的候诊人数{8BF9E56B-828E-4264-9D2F-B0B74FB920B5}
                ...
                //ygch
                this.fpDoctor.ColumnHeader.Cells[0, 10].Text = "候诊人数";
        ...
        private void cmbDept_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                //顺德妇幼医院需求，挂普通号也选择医生，且选择科室后直接检索出该科室的排班医生，故和选择专家号一样处理  ygch {7DB89B62-4DC3-4827-9035-1B25B190A44D}
        ...
        private int GetDoct()
        {
            ...
            //ygch 查询所有医生时也使用新的sql语句 以获取其候诊人数 {8BF9E56B-828E-4264-9D2F-B0B74FB920B5}
            string noon = this.getNoon(this.regMgr.GetDateTimeFromSysDateTime());
        ...
        private void cmbDoctor_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                //如果不选择医生，可以直接挂号； 但是如果在医生输入框中输入了一些东西，则必须要保证输入的东西是列表中的某个医生 {9EA8A9C5-1F2F-4c65-A2B9-1C158E2CFB0C}  ygch
                if (this.cmbDoctor.Text != "" && this.cmbDoctor.Text != string.Empty)
                {
                    if (this.cmbDoctor.Tag == null || this.cmbDoctor.Tag == "")
                    {
                        MessageBox.Show("医生信息输入错误，请检查后输入");
                        return;
                    }
                }
        ...
        private int save()
        {
            ...
            try
            {
                ...
                //2看诊序号
                if (this.strGetSeeNoType == "2")//2按科室排号
                {
                    deptID = this.regObj.DoctorInfo.Templet.Dept.ID;
                }
                else if (this.strGetSeeNoType == "3")//按诊区排号
                {
                ...
                {
                    if (chSpecialPerson.Checked)//熟人挂号
                    {
                        #region 数据校验
                        if (this.assignNO != string.Empty)
                        {
                            ...
                            if (!isSameDoct)
                            {
                                FS.FrameWork.Management.PublicTrans.RollBack();
                                this.MedcareInterfaceProxy.Rollback();
                                MessageBox.Show("该号已经被用，请重新勾选熟人框，选择新号！");
                                return -1;
                            }
                        }
                        #endregion
            ...
            try
            {
                ...
                if (regTemp == null || regTemp.ID == "")
                {
                    ...
                    if (assignObj != null)
                    {
                        ...
                        {
                            FS.FrameWork.Management.PublicTrans.RollBack();
                            MessageBox.Show(this.assMgr.Err, "提示");
                            return -1;
                        }
                        //队列数量-1
                    ...
                    //{
                    //    FS.FrameWork.Management.PublicTrans.RollBack();
                    //    MessageBox.Show(this.regInteMgr.Err, "提示");
                    //    return -1;
                    //}
                    FS.FrameWork.Management.PublicTrans.Commit();
                }
        ...
        /// <summary>
        /// 处方打印{088448CC-1CC9-4303-A85B-66B207F4DBAE}
        /// </summary>
        ...
        private int valid()
        {
            ...
            //如果医生控件中输入了信息，则必须要求医生控件中选中的医生有效 {9EA8A9C5-1F2F-4c65-A2B9-1C158E2CFB0C} ygch
            if (this.cmbDoctor.Text != "" && this.cmbDoctor.Text != String.Empty)
            {
                if (this.cmbDoctor.Tag == null || this.cmbDoctor.Tag == "")
                {
        ...
        private int getValue()
        {
            ...
            int age = FS.FrameWork.Function.NConvert.ToInt32(strAge.Substring(0, strAge.IndexOf('岁')));
            if (age > 150)
            {
                MessageBox.Show("年龄输入非法！请重新输入！");
                this.dtBirthday.Focus();
                return -1;
            }
        ...
        private void Print(FS.HISFC.Models.Registration.Register regObj, FS.HISFC.BizLogic.Registration.Register regmr)
        {
            ...
            //使用打印处方单的接口 ygch {2CF72240-2263-4de3-999E-3318956851BB}
            ...
            //不打印挂号票 打印处方单 ygch {2CF72240-2263-4de3-999E-3318956851BB}
        ...
        private void Reprint()
        {
            ...
            //使用本地化的重打处方单控件(原为挂号单重打控件)  ygch {2CF72240-2263-4de3-999E-3318956851BB}
        ...
        protected override int OnPrint(object sender, object neuObject)
        {
            ...
            {
                MessageBox.Show("未选择挂号患者！请先保存挂号信息！");
                return -1;
            }
            else
            {
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolBarService.AddToolButton("读卡", "", (int)FS.FrameWork.WinForms.Classes.EnumImageList.A安排, true, false, null);
            toolBarService.AddToolButton("打印条码", "", (int)FS.FrameWork.WinForms.Classes.EnumImageList.D打印, true, false, null);
        ...
        private void dtBirthday_ValueChanged(object sender, EventArgs e)
        {
            ...
            //出生日期转换为精确年龄 ygch{ABB75FA8-BE32-4cb6-AC22-1BE2928A7840}
            this.setAgee(this.dtBirthday.Value);
        }
        ...
        private void SetSpecialPerson()
        {
            ...
            if (list != null && list.Count != 0)
            {
                ...
                if (this.assignNO == string.Empty)
                {
                    DialogResult rs = MessageBox.Show(FS.FrameWork.Management.Language.Msg("熟人不使用预留号？"), "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
                    if (rs == DialogResult.No)
                    {
                        MessageBox.Show("请重新勾选熟人框!");
                        return;
                    }
                }
            }
            ...
            {
                MessageBox.Show("没有预留号！");
            }
        }

        #region 年龄与生日精确对应 ygch{ABB75FA8-BE32-4cb6-AC22-1BE2928A7840}

        private void setAgee(DateTime birthday)
        {
            string age = this.regMgr.GetAge(birthday, true);
            string sYear = age.Substring(0, age.IndexOf("岁"));
            string sMonth = age.Substring(age.IndexOf("岁") + 1, age.IndexOf("月") - age.IndexOf("岁") - 1);
            string sDay = age.Substring(age.IndexOf("月") + 1, age.IndexOf("天") - age.IndexOf("月") - 1);
            if (sYear.Length < 3)
            {
        ...
        private int PrintBarCode()
        {
            ...
            PrintLab.A_Prn_Text_TrueType(62, 35, 24, "黑体", 1, 600, 0, 0, 0, "AL", this.txtCardNo.Text, 1);
