...
{
    partial class ucSysUsageExectimeManager
    {
        /// <summary> 
        /// 必需的设计器变量。
        ...
        private void InitializeComponent()
        {
            ...
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "分解时间";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "拼音码";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "五笔码";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "扩展信息";
            ...
            this.neuSpread1_Sheet1.Columns.Get(2).Label = "分解时间";
            ...
            this.neuSpread1_Sheet1.Columns.Get(5).Label = "扩展信息";
