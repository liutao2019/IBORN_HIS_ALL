...
{
    partial class ucRadiotherapyUsageManager
    {
        /// <summary> 
        /// 必需的设计器变量。
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ucDrugUsageManager));
            ...
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "化疗用法";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "系统类别";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "有效性";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "序号";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "操作员";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "操作时间";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "标志";
            ...
            this.neuSpread1_Sheet1.Columns.Get(2).Width = 99F;
            ...
            this.neuSpread1_Sheet1.Columns.Get(5).CellType = checkBoxCellType1;
            this.neuSpread1_Sheet1.Columns.Get(5).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.neuSpread1_Sheet1.Columns.Get(5).Label = "化疗用法";
            this.neuSpread1_Sheet1.Columns.Get(5).Width = 39F;
            this.neuSpread1_Sheet1.Columns.Get(6).Label = "系统类别";
            this.neuSpread1_Sheet1.Columns.Get(6).Width = 141F;
            this.neuSpread1_Sheet1.Columns.Get(7).CellType = checkBoxCellType2;
            this.neuSpread1_Sheet1.Columns.Get(7).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.neuSpread1_Sheet1.Columns.Get(7).Label = "有效性";
            ...
            this.neuSpread1_Sheet1.Columns.Get(8).Label = "序号";
            this.neuSpread1_Sheet1.Columns.Get(8).Width = 31F;
            this.neuSpread1_Sheet1.Columns.Get(9).CellType = textCellType2;
            this.neuSpread1_Sheet1.Columns.Get(9).Label = "操作员";
            ...
            this.neuSpread1_Sheet1.Columns.Get(10).Width = 78F;
            this.neuSpread1_Sheet1.Columns.Get(11).Label = "标志";
            this.neuSpread1_Sheet1.Columns.Get(11).Visible = false;
            this.neuSpread1_Sheet1.OperationMode = FarPoint.Win.Spread.OperationMode.RowMode;
            this.neuSpread1_Sheet1.RowHeader.Columns.Default.Resizable = true;
            this.neuSpread1_Sheet1.RowHeader.Columns.Get(0).Width = 33F;
