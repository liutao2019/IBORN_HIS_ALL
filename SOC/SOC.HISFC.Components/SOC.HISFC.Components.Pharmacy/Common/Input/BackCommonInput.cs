...
namespace FS.SOC.HISFC.Components.Pharmacy.Common.Input
{
    ...
    /// [创建时间: 2011-4]<br></br>
    /// </summary>
    public class BackCommonInput : Base.IBaseBiz
    {
        ...
        protected int InitDataTable()
        {
            ...
            {
                if (dc.ColumnName == "备注" || dc.ColumnName == "退库量" || dc.ColumnName == "发票号" || dc.ColumnName == "退库购额" || dc.ColumnName == "退库零额" || dc.ColumnName == "退库价" || dc.ColumnName == "发票日期")
                {
                    continue;
                }
                dc.ReadOnly = true;
