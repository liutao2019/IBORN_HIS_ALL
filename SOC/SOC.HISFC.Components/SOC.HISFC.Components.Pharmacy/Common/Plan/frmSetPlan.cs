...
namespace FS.SOC.HISFC.Components.Pharmacy.Common.Plan
{
    ...
    public partial class frmSetPlan : Form
    {
        ...
        public void Init(string apllyDeptNO,string fromDeptNO, FS.HISFC.Models.Pharmacy.EnumDrugStencil openType)
        {
            this.curOpenType = openType;
            this.curPriveDept = apllyDeptNO;
            this.curFromDept = fromDeptNO;
            this.InitTime();
            this.InitDays();
            this.InitConstant();
            this.InitType();
