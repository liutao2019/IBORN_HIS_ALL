...
namespace FS.SOC.HISFC.Components.Pharmacy.Common.Plan
{
    ...
    /// 入库退库申请
    /// </summary>
    public class InnerBackInputApply : Base.IBaseBiz
    {
        ...
        protected int InitChooseData()
        {
            ...
            if (this.curIDataChooseList != null)
            {
                ...
                this.curIDataChooseList.ShowChooseList(chooseDataSetting.ListTile, string.Format(chooseDataSetting.SQL, this.curStockDept.ID, "{0}"), chooseDataSetting.IsNeedDrugType, chooseDataSetting.Filter);
...
;
        ...
        {
            if (this.curStockDept == null || string.IsNullOrEmpty(this.curStockDept.ID))
            {
