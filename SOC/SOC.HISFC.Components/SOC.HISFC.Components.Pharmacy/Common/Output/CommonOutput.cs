...
namespace FS.SOC.HISFC.Components.Pharmacy.Common.Output
{
    ...
    /// </summary>
    public class CommonOutput : Base.IBaseBiz
    {
        ...
        public ArrayList GetTargetDeptArray()
        {
            ...
            if (System.IO.File.Exists(this.settingFromDeptFileName))
            {
                ...
                alOutDept = Function.QueryDeptBySql(sqlID);
            }
            else
            {
                 alOutDept = Function.QueryManagerStockDept();
            }         
        ...
        protected int InitChooseData()
        {
            ...
            if (chooseDataSetting.IsDefault)
            {
                ...
                chooseDataSetting.Filter =Function.GetChooseDataFilter("CommonOutput");
