...
namespace SOC.HISFC.Components.Nurse.AssignShow
{
    public partial class ucQueForDisplay : UserControl
    {
        ...
        {
            get { return this.showCount; }
            set { this.showCount = value; }
        }
        ...
        public FS.HISFC.Models.Nurse.Queue Queue
        {
            ...
            set
            {
                ...
                this.lbldept.Text = queue.AssignDept.Name;
                ...
                this.AddItem(countList, queue);

                this.lblWaitCount.Text = "候诊人数：" + count.ToString();
        ...
        private void AddItem(ArrayList al, FS.HISFC.Models.Nurse.Queue obj)
        {
            if (al != null)
            {
                for (int i = 0; i < al.Count; i++)
                {
                    ...
                    if (isDiaplayName)
                    {
                        this.neuSpread1_Sheet1.Cells[row, 0].Text =assign.Register.Name;
                    }
                    else
                    {
                        ...
                        this.neuSpread1_Sheet1.Cells[row, 0].Text = name;
                    }

                    this.neuSpread1_Sheet1.Cells[row, 0].HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
                    this.neuSpread1_Sheet1.Columns[0].Width = 300;
