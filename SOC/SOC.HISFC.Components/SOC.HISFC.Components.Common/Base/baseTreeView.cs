...
{
    public class baseTreeView  : FS.FrameWork.WinForms.Controls.NeuTreeView
    {
        ...
        {
            FS.SOC.HISFC.Components.Common.Base.frmTreeNodeSearch frm = new FS.SOC.HISFC.Components.Common.Base.frmTreeNodeSearch();
            frm.Init(this);
            frm.ShowDialog();
        }
