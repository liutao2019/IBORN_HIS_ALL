   ...
   public class InpatientDayReport : FS.FrameWork.Management.Database
    {
        ...
        private ArrayList QueryDayReportsBySql(string sql, params string[] args)
        {
            ...
            Object.DayReport dayReport = null;//日结实体
            ...
            try
            {
                ...
                {
                    dayReport = new Object.DayReport();
       ...
       /// <returns>成功 返回日结信息实体 失败 null</returns>
        public SOC.Fee.DayBalance.Object.DayReport GetOperLastDayReport(string operID)
       {
           ...
           return (Object.DayReport)alDayReport[0];
       }
       ...
       public ArrayList QueryWasteBalanceInvNOByOperIDAndTime(DateTime beginDate, DateTime endDate, string operID)
       {
           ...
           while (this.Reader.Read())
           {
               balance = new FS.HISFC.Models.Fee.Inpatient.Balance();
