...
{
    public class BalanceDayReport : FS.FrameWork.Management.Database
    {
        #region "私有方法"
        ...
        private string[] GetDayReportParams(SOC.Fee.DayBalance.Object.DayReport dayReport)
        {
        ...
        private ArrayList QueryDayReportsBySql(string sql, params string[] args)
        {
            ...
            Object.BalanceDayReport dayReport = null;//日结实体
            ...
            try
            {
                ...
                {
                    dayReport = new SOC.Fee.DayBalance.Object.BalanceDayReport();
                    ...
                    dayReport.BeginDate = FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[1].ToString());
                    //结束日期
                    dayReport.EndDate = FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[2].ToString());

                    //操作员代码

                    dayReport.Oper.ID = this.Reader[3].ToString();
                    //统计时间
                    dayReport.Oper.OperTime = FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[4].ToString());

                    //收取预交金金额

                    dayReport.PrepayCost = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[5].ToString());
                    //借方支票金额

                    dayReport.DebitCheckCost = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[6].ToString());
                    //借方银行卡金额

                    dayReport.DebitBankCost = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[7].ToString());
                    //结算预交金金额

                    dayReport.BalancePrepayCost = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[8].ToString());
                    //贷方支票金额

                    dayReport.LenderCheckCost = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[9].ToString());
                    //贷方银行卡金额

                    dayReport.LenderBankCost = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[10].ToString());
                    //公费记帐金额
                    dayReport.BursaryPubCost = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[11].ToString());
                    //市医保帐户支付金额

                    dayReport.CityMedicarePayCost = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[12].ToString());
                    //市医保统筹金额

                    dayReport.CityMedicarePubCost = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[13].ToString());
                    //省医保帐户支付金额

                    dayReport.ProvinceMedicarePayCost = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[14].ToString());
                    //省医保统筹金额

                    dayReport.ProvinceMedicarePubCost = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[15].ToString());
                    //库存金额（上缴金额）
                    dayReport.TurnInCash = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[16].ToString());
                    //预交金发票张数

                    dayReport.PrepayInvCount = FS.FrameWork.Function.NConvert.ToInt32(this.Reader[17].ToString());
                    //结算发票张数
                    dayReport.BalanceInvCount = FS.FrameWork.Function.NConvert.ToInt32(this.Reader[18].ToString());
                    //作废预交金发票号码
                    ...
                    dayReport.PrepayWasteInvCount = FS.FrameWork.Function.NConvert.ToInt32(this.Reader[21].ToString());
                    //作废结算发票张数
                    dayReport.BalanceWasteInvCount = FS.FrameWork.Function.NConvert.ToInt32(this.Reader[22].ToString());
                    //预交金发票区间
                    ...
                    dayReport.BalanceCost = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[26].ToString());
        ...
        public int InsertDayReport(SOC.Fee.DayBalance.Object.DayReport dayReport)
        {
        ...
        public Object.BalanceDayReport GetOperLastDayReport(string operID)
        {
            ...
            return (Object.BalanceDayReport)alDayReport[0];
        }
        ...
        public FS.FrameWork.Models.NeuObject GetPrepayInvoiceZoneByOperIDAndTime(DateTime beginDate, DateTime endDate, string operID)
        {
            string sql = string.Empty;
            FS.FrameWork.Models.NeuObject prepayInvoiceZone = new FS.FrameWork.Models.NeuObject();
        ...
        /// <param name="operID">操作员代码</param>
        /// <returns>返回object ID最小号 name最大号</returns>
        public FS.FrameWork.Models.NeuObject GetBalanceInvoiceZoneByOperIDAndTime(DateTime beginDate, DateTime endDate, string operID)
        {
            string sql = string.Empty;
            FS.FrameWork.Models.NeuObject BalanceInvoiceZone = new FS.FrameWork.Models.NeuObject();
        ...
        public ArrayList QueryWasteBalanceInvNOByOperIDAndTime(DateTime beginDate, DateTime endDate, string operID)
        {
            ...
            FS.HISFC.Models.Fee.Inpatient.Balance balance;
        ...
        /// <returns></returns>
        public DataSet GetLenderPrePayDetail(List<Object.BalanceDayReport> list, int aMod)
        {
            string sqlStr = string.Empty;
            string sqlIndex = string.Empty;
            ...
            try
            {
                ...
                foreach (Object.BalanceDayReport dayReport in list)
                {
        ...
        ///<param name="list">日结实体集合</param>
        /// <returns></returns>
        public DataSet GetLenderPayDetail(List<Object.BalanceDayReport> list)
        {
            string sqlStr = string.Empty;
            string execSql = string.Empty;
        ...
        /// <returns>1:成功 -1 失败</returns>
        public int InsertDayReport(Object.BalanceDayReport dayReport)
        {
        ...
        /// <returns></returns>
        private string[] GetInsertDayReportargs(Object.BalanceDayReport dayReport)
        {
            string[] arrayStr = {
        ...
        /// <param name="dayReport">日结实体</param>
        /// <returns>1:成功 -1：失败</returns>
        public int InsetDayReportDetail(Object.BalanceDayReport dayReport)
        {
            string Sqlstr = string.Empty;
            ...
            try
            {
                int resultValue = 0;
                string ExecSql = string.Empty;
                foreach (Object.Item item in dayReport.ItemList)
                {
        ...
        /// <param name="OperID">操作员</param>
        /// <returns></returns>
        public List<Object.BalanceDayReport> SelectDayReprotInfo(DateTime beginDate, DateTime endDate, string OperID)
        {
            string Sqlstr = string.Empty;
            ...
            try
            {
                ...
                Object.BalanceDayReport dayReport = null;
                List<Object.BalanceDayReport> list = new List<Object.BalanceDayReport>();
                while (this.Reader.Read())
                {
                    dayReport = new SOC.Fee.DayBalance.Object.BalanceDayReport();
        ...
        /// <param name="OperID">操作员</param>
        /// <returns></returns>
        public List<Object.BalanceDayReport> CollectDayReprotInfo(DateTime beginDate, DateTime endDate)
        {
            string Sqlstr = string.Empty;
            string SqlWhere = string.Empty;
            if (this.Sql.GetSql("Fee.InpatientDayReport.QueryDayReportInfo", ref Sqlstr) == -1)
            ...
            try
            {
                ...
                while (this.Reader.Read())
                {
                    dayReport = new Object.BalanceDayReport();
                    dayReport.StatNO = this.Reader[0].ToString();//统计序号
                    dayReport.BeginDate = NConvert.ToDateTime(this.Reader[1]);//开始时间
                    dayReport.EndDate = NConvert.ToDateTime(this.Reader[2]);//终止时间
                    dayReport.Oper.ID = this.Reader[3].ToString();//操作员编码
        ...
        /// <param name="OperID">操作员</param>
        /// <returns></returns>
        public List<Object.BalanceDayReport> CollectCheckedDayReprotInfo(DateTime beginDate, DateTime endDate)
        {
            string Sqlstr = string.Empty;
            string SqlWhere = string.Empty;
        ...
        /// <returns></returns>
        public Object.BalanceDayReport SelectDayReport(string statcodes, int aMod)
        {
            Object.BalanceDayReport dayReprot = null;
            try
            {
        ...
        /// <param name="aMod">0查询，１统计</param>
        /// <returns></returns>
        private Object.BalanceDayReport SetDayReport(string statcodes, int aMod)
        {
            string Sqlstr = string.Empty;
            string sqlIndex = string.Empty;
            if (aMod == 0)
        ...
        private List<Object.Item> SelectDayReportDetail(string sqlIndex, string statcodes)
        {
            string Sqlstr = string.Empty;
            if (this.Sql.GetSql(sqlIndex, ref Sqlstr) == -1)
            {
            ...
            try
            {
                ...
                List<Object.Item> list = new List<Object.Item>();
