...
namespace SOC.Fee.DayBalance.Object
{
    public class BalanceDayReport : FS.FrameWork.Models.NeuObject
    {
        #region "变量"
        ...
        /// </summary>
        /// <returns></returns>
        public new BalanceDayReport Clone()
        {
            Object.BalanceDayReport dayReport = base.Clone() as BalanceDayReport;
            dayReport.Oper = this.Oper.Clone();
            foreach (Object.Item item in this.ItemList)
            {
    ...
    public class Item : FS.FrameWork.Models.NeuObject
    {
        #region 变量
        /// <summary>
        /// 统计大类
        ...
        {
            Object.Item obj = base.Clone() as Item;
            return obj;
        }
        #endregion
    }
