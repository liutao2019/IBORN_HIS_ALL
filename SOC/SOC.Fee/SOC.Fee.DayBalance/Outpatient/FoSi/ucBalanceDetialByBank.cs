...
{
    public partial class ucBalanceDetialByBank : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        /// <summary>
        /// 统计大类业务类
        /// </summary>
        ...
        /// 未退药品的列设置路径
        /// </summary>
        protected string filePathBalanceDetialByBank = FS.FrameWork.WinForms.Classes.Function.SettingPath + @".\BalanceDetialByBank.xml";
        ...
        protected override int OnQuery(object sender, object neuObject)
        {
            ...
            iRes = opDayBalance.QueryDayBalnaceDetialByBank(feecodeStat.Operator.ID, startDate, endDate, payMode, out dtDetial);
            ...
            foreach (DataRow rowDetial in dtDetial.Rows)
            {
                ...
                row["姓名"] = rowDetial[1];
                row["发票序号"] = rowDetial[2];
                row["类型"] = rowDetial[3];
                row["交易类型"] = rowDetial[4];
                row["金额"] = rowDetial[5];
                row["pos机号"] = rowDetial[6];
        ...
        private void ucBalanceDetialByBank_Load(object sender, EventArgs e)
        {
            string startDate = "";
            string endDate = "";
            ...
            //        new DataColumn("发票序号", typeof(string)),
            //        new DataColumn("类型", typeof(string)),
            //        new DataColumn("交易类型", typeof(string)),
            //        new DataColumn("金额", typeof(decimal)),
            //        new DataColumn("pos机号", typeof(string)),
            //     });
