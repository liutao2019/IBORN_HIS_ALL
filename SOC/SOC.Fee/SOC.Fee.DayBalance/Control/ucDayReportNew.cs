...
{
    public partial class ucDayReportNew : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        /// 日结业务层
        /// </summary>
        Manager.BalanceDayReport feeDayreport = new SOC.Fee.DayBalance.Manager.BalanceDayReport();
        private DateTime dtDefaultBeginDate = FS.FrameWork.Function.NConvert.ToDateTime("2006-01-01");
        DataSet ds = null;
        private Object.BalanceDayReport dayReport = new Object.BalanceDayReport();
        private Object.Item item = null;
        private OperType operType = OperType.DayReport;
        private List<Object.BalanceDayReport> listEnviroment = null;
        #endregion
        ...
        protected virtual void Init()
        {
            ...
            if (OperationType == OperType.DayReport)
            {
                ...
                //获取上次日结信息实体
                Object.BalanceDayReport dayReport = new Object.BalanceDayReport();
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            //toolBarService.AddToolButton("补打", "补打已汇总的日结费用统计", (int)FS.FrameWork.WinForms.Classes.EnumImageList.H合并, true, false, null);

            #endregion
            #region {B8DB7B0D-623A-4643-B3B0-F28FA720CF15}
            toolBarService.AddToolButton("汇总补打", "补打已汇总的日结费用统计", (int)FS.FrameWork.WinForms.Classes.EnumImageList.H合并, true, false, null);
        ...
        private void GetDayReprot()
        {
            ...
            dayReport.BeginDate = FS.FrameWork.Function.NConvert.ToDateTime(this.DtBegin);
            //结束日期
            dayReport.EndDate = FS.FrameWork.Function.NConvert.ToDateTime(this.DtEnd);
        ...
        private void ShowDayReportDetail(List<Object.Item> list)
        {
            int Index = 0;
            int iMod = 0;
            decimal TotCost = 0m;
        ...
        protected virtual void Save()
        {
            ...
            feeDayreport.SetTrans(FS.FrameWork.Management.PublicTrans.Trans);
            int result = 0;
            //插入明细
        ...
        private void QueryOrCollectData()
        {
            ...
            DialogResult result = FS.FrameWork.WinForms.Classes.Function.PopShowControl(ucQuery);
        ...
        private void QueryOrCollectDataCheck()
        {
            ...
            //{
            //    FS.FrameWork.WinForms.Classes.Function.MessageBox("该功能属于日结汇总补打，在日结模式无效");
            //    return;
            //} 
            //#endregion
            ucPopDayReportQueryNew ucQuery = new ucPopDayReportQueryNew(OperationType);
        ...
        public void SaveCollectData()
        {
            ...
            this.feeDayreport.SetTrans(FS.FrameWork.Management.PublicTrans.Trans);
            foreach (Object.BalanceDayReport obj in listEnviroment)
            {
