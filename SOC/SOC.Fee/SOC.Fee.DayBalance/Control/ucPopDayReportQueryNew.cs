...
{
    public partial class ucPopDayReportQueryNew : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private Object.BalanceDayReport dayReport = null;
        DateTime BeginDate, EndDate;
        private List<Object.BalanceDayReport> collectEnvironment=new List<Object.BalanceDayReport>();
        /// <summary>
        /// 操作类别
        /// </summary>
        ...
        /// 日结实体
        /// </summary>
        public Object.BalanceDayReport DayReprot
        {
            get
            {
                return dayReport;
        ...
        /// 汇总数据操作员、时间段集合用与查找明细
        /// </summary>
        public List<Object.BalanceDayReport> CollectEnvironment
        {
            get
            {
        ...
        {
            this.BeginDate = FS.FrameWork.Function.NConvert.ToDateTime(this.dtpBeginDate.Value.Date.ToString("yyyy-MM-dd")+" 00:00:00");
            this.EndDate = FS.FrameWork.Function.NConvert.ToDateTime(this.dtpEndDate.Value.Date.ToString("yyyy-MM-dd") + " 23:59:59");
        ...
        {
            List<Object.BalanceDayReport> list=null;
            //查找
        ...
        private void GetQueryResult()
        {
            ...
            Object.BalanceDayReport obj = this.neuSpread1_Sheet1.ActiveRow.Tag as Object.BalanceDayReport;
        ...
        private void GetCollectResult()
        {
            ...
            Object.BalanceDayReport obj = null;
            ...
            for (int i = 0; i < this.neuSpread1_Sheet1.Rows.Count; i++)
            {
                if (this.neuSpread1_Sheet1.Cells[i, 0].Text == "True")
                {
                    ...
                    obj = this.neuSpread1_Sheet1.Rows[i].Tag as Object.BalanceDayReport;
            ...
            if (this.operationType == OperType.CollectDayReport)
            {
                if (this.ckRePrint.Checked == true)
                {
                    if (this.neuSpread1_Sheet1.Cells[e.Row, e.Column].Text == "False")
                    {
                        ...
                        Object.BalanceDayReport dr;
                        dr = this.neuSpread1_Sheet1.Rows[e.Row].Tag as Object.BalanceDayReport;
                        for (int i = 0; i < this.neuSpread1.Sheets[0].RowCount; i++)
                        {
                            Object.BalanceDayReport drCurrent;
                            drCurrent = this.neuSpread1_Sheet1.Rows[i].Tag as Object.BalanceDayReport;
