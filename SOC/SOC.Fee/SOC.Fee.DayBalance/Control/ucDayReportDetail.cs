...
namespace SOC.Fee.DayBalance.Control
{
    public partial class ucDayReportDetail : UserControl
    {
       ...
       ///<param name="list">汇总日结时间段和操作员</param>
        ///<param name="operType">操作类型</param>
        public ucDayReportDetail(List<Object.BalanceDayReport> arrylist, OperType operType)
        {
            InitializeComponent();
            list = arrylist;
            operationType = operType;
        ...
        private List<Object.BalanceDayReport> list = null; 
        /// <summary>
        /// 明细类别
        /// </summary>
        private int amod=0;
        ...
        private void GetSummer(DataSet ds,string sumCol)
        {
            ...
            {
                summer += FS.FrameWork.Function.NConvert.ToDecimal(dr[sumCol]);
            }
