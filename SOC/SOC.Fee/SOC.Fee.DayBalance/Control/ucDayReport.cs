...
namespace SOC.Fee.DayBalance.Control
{
    public partial class ucDayReport : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        /// </summary>
        SOC.Fee.DayBalance.Manager.InpatientDayReport feeDayreport = new SOC.Fee.DayBalance.Manager.InpatientDayReport();
        ...
        private DateTime dtDefaultBeginDate = FS.FrameWork.Function.NConvert.ToDateTime("2006-01-01");
        ...
        protected virtual void Init()
        {
            ...
            if (dayReport == null)
            {
                dayReport = new SOC.Fee.DayBalance.Object.DayReport();
        ...
        /// </summary>
        protected virtual void SetDayReportValue(SOC.Fee.DayBalance.Object.DayReport dayReport)
        {
            ...
            lblDBlank1.Text = "0";
            //借方合计
            this.lblDTotCost.Text = FS.FrameWork.Public.String.ExpressionVal(this.lblDPrepayCost.Text + "+" + this.lblDCashCost.Text
            ...
            //贷方合计
            this.lblLTotCost.Text = FS.FrameWork.Public.String.ExpressionVal(this.lblLPrepayCost.Text + "+" + this.lblLCheckCost.Text
        ...
        protected virtual SOC.Fee.DayBalance.Object.DayReport GetDayReportValue()
        {
            SOC.Fee.DayBalance.Object.DayReport dayReport = new SOC.Fee.DayBalance.Object.DayReport();
            //统计序号
               ...
               //开始时间
                ...
                dayReport.BeginDate = FS.FrameWork.Function.NConvert.ToDateTime(this.lblBeginDate.Text);
               //结束日期
                dayReport.EndDate = FS.FrameWork.Function.NConvert.ToDateTime(this.lblEndDate.Text);

               //操作员代码

               dayReport.Oper.ID = this.feeDayreport.Operator.ID;
               //统计时间
               dayReport.Oper.OperTime = FS.FrameWork.Function.NConvert.ToDateTime(this.lblStatDate.Text);

               //收取预交金金额


               dayReport.PrepayCost = FS.FrameWork.Function.NConvert.ToDecimal(this.lblLPrepayCost.Text);
               //借方支票金额

               dayReport.DebitCheckCost = FS.FrameWork.Function.NConvert.ToDecimal(this.lblDCheckCost.Text) ;
                //借方银行卡金额


               dayReport.DebitBankCost = FS.FrameWork.Function.NConvert.ToDecimal(this.lblDBankCost.Text);
               //结算预交金金额


               dayReport.BalancePrepayCost = FS.FrameWork.Function.NConvert.ToDecimal(this.lblDPrepayCost.Text);
                //贷方支票金额

               dayReport.LenderCheckCost = FS.FrameWork.Function.NConvert.ToDecimal(this.lblLCheckCost.Text);
                //贷方银行卡金额


               dayReport.LenderBankCost = FS.FrameWork.Function.NConvert.ToDecimal(this.lblLBankCost.Text);
               //公费记帐金额
               dayReport.BursaryPubCost = FS.FrameWork.Function.NConvert.ToDecimal(this.lblDBursaryCost.Text);
               //市医保帐户支付金额


               dayReport.CityMedicarePayCost = FS.FrameWork.Function.NConvert.ToDecimal(this.lblDCityAccountCost.Text);
               //市医保统筹金额


               dayReport.CityMedicarePubCost = FS.FrameWork.Function.NConvert.ToDecimal(this.lblDCityPubCost.Text);
               //省医保帐户支付金额


               dayReport.ProvinceMedicarePayCost = FS.FrameWork.Function.NConvert.ToDecimal(this.lblDProvinceAccountCost.Text);
               //省医保统筹金额


               dayReport.ProvinceMedicarePubCost = FS.FrameWork.Function.NConvert.ToDecimal(this.lblDProvinceAccountCost.Text);
               //库存金额（上缴金额）
               dayReport.TurnInCash = FS.FrameWork.Function.NConvert.ToDecimal(this.lblDCashCost.Text);
               //预交金发票张数


               dayReport.PrepayInvCount = FS.FrameWork.Function.NConvert.ToInt32(this.lblPrepayNum.Text);
               //结算发票张数
               dayReport.BalanceInvCount = FS.FrameWork.Function.NConvert.ToInt32(this.lblBalanceNum.Text);
               //作废预交金发票号码
               ...
               //作废预交金发票张数
                ...
                dayReport.PrepayWasteInvCount = FS.FrameWork.Function.NConvert.ToInt32(lblWastePrepayNum.Text);
               //作废结算发票张数
                dayReport.BalanceWasteInvCount = FS.FrameWork.Function.NConvert.ToInt32(this.lblWasteBalanceNum.Text);
               //预交金发票区间
               ...
               //收费员科室
                ...
                dayReport.Oper.Dept.ID = ((FS.HISFC.Models.Base.Employee)this.feeDayreport.Operator).Dept.ID;
                //结算总金额


                dayReport.BalanceCost = FS.FrameWork.Function.NConvert.ToDecimal(lblLBalanceCost.Text);
        ...
        {
            toolBarService.AddToolButton("日结", "开始进行日结费用统计",(int)FS.FrameWork.WinForms.Classes.EnumImageList.S手动录入, true, false, null);

            //toolBarService.AddToolButton("查询", "查询以往日结信息", (int)FS.FrameWork.WinForms.Classes.EnumImageList.A查询, true, false, null);

            //toolBarService.AddToolButton("打印", "打印日结报表", (int)FS.FrameWork.WinForms.Classes.EnumImageList.A打印, true, false, null);

            toolBarService.AddToolButton("时间", "选择日结时间范围", (int)FS.FrameWork.WinForms.Classes.EnumImageList.S设置, true, false, null);

            toolBarService.AddToolButton("帮助", "打开帮助文件", (int)FS.FrameWork.WinForms.Classes.EnumImageList.B帮助, true, false, null);

            //toolBarService.AddToolButton("保存", "保存日结信息", (int)FS.FrameWork.WinForms.Classes.EnumImageList.B保存, true, false, null);
        ...
        protected virtual int ExecDayReport()
        {
            try
            {
                ...
                FS.FrameWork.Models.NeuObject invoiceZone = new FS.FrameWork.Models.NeuObject();
                ...
                else
                {
                    ...
                    {
                        prepay = (FS.HISFC.Models.Fee.Inpatient.Prepay)alWasteNO[i];
                ...
                else
                {
                    ...
                    {
                        balance = (FS.HISFC.Models.Fee.Inpatient.Balance)alWasteBalanceInvNO[j];
        ...
        protected override int OnSave(object sender, object neuObject)
        {
            ...
            {
                FS.FrameWork.WinForms.Classes.Function.Msg("时间范围内没有发生费用！", 111);
                return -1;
            ...
            {
                FS.FrameWork.WinForms.Classes.Function.Msg("保存日结出错！" + this.feeDayreport.Err, 211);
                return -1;
            }
            else
            {
        ...
        protected override int OnPrint(object sender, object neuObject)
        {
            ...
            //if (FS.FrameWork.Function.NConvert.ToDecimal(this.lblLBalanceCost.Text) == 0 && FS.FrameWork.Function.NConvert.ToDecimal(this.lblPrepayCost.Text) == 0)
            //{
            //    FS.FrameWork.WinForms.Classes.Function.Msg("时间范围内没有发生预交金和结算费用！", 111);
        ...
        protected override int OnQuery(object sender, object neuObject)
        {
            ...
            FS.FrameWork.WinForms.Classes.Function.PopShowControl(ucQuery);
        ...
        void ucQuery_OnEndChoose(SOC.Fee.DayBalance.Object.DayReport dayReport)
        {
