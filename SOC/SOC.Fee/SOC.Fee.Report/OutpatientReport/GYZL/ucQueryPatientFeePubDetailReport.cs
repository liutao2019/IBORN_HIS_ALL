...
namespace SOC.Fee.Report.OutpatientReport.GYZL
{
    ...
    /// 门诊公费医疗记账单统计报表
    /// </summary>
    public partial class ucQueryPatientFeePubDetailReport : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucQueryPatientFeePubDetailReport()
        {
            InitializeComponent();
        ...
        private void InitBase()
        {
            ...
            lblInfo.Text = "统计日期：从 " + this.neuDateTimePicker1.Value.ToString("yyyy-MM-dd")
                   + " 至 " + this.neuDateTimePicker2.Value.ToString("yyyy-MM-dd");
            // 当前登录员工
