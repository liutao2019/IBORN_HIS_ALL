...
namespace SOC.Fee.Report.OutpatientReport.ChaoYang
{
    ...
    public partial class ucOutPatientIncomeSummary : FS.SOC.Fee.Report.Base.ucReportBase
    {
        ...
        public DataTable QueryOutpatientRealIncomeByDept(object[] param)
        {
            ...
            DataTable dtReg = base.Query("SOC.Fee.Report.Outpatient.RegcountByDept2", param);
            ...
            DataTable dtDeptFee = base.Query("SOC.Fee.Report.Outpatient.RealIncomeByDept2", param);
