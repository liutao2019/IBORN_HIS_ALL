...
namespace FS.SOC.Fee.Report.Inpatient
{
    ...
    /// 住院科室实收收入月（日报表）
    /// </summary>
    public partial class ucInpatientDeptRealIncomeByPact : FS.SOC.Fee.Report.Base.ucReportBase
    {
        public ucInpatientDeptRealIncomeByPact()
        {
            InitializeComponent();
        }
        ...
        protected override DataTable Query(string strSQL, object[] param)
        {
            ...
            {
                case "1":
                    dtTable = QueryInpatientDeptRealIncomeByPact();
                    break;
        ...
        /// 住院收入报表 -- 按患者所在科室
        /// </summary>
        protected DataTable QueryInpatientDeptRealIncomeByPact()
        {
            ...
            //iReturn = inpatientReport.QueryInpatientIncomeByPact(reportCode, strDept, strEmp, FS.FrameWork.Function.NConvert.ToDateTime(strStartTime), FS.FrameWork.Function.NConvert.ToDateTime(strEndTime), lstFeeStat, out dtReport);
