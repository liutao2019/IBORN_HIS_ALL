...
{
    public partial class ucRealInpatientDeptRealIncome : FS.SOC.Fee.Report.Base.ucReportBase
    {
        public ucRealInpatientDeptRealIncome()
        {
            InitializeComponent();
        }
        ...
        protected DataTable QueryInpatientDeptRealIncome()
        {
            ...
            iReturn = inpatientReport.QueryRealInpatientIncomeByDept(reportCode, strDept, strEmp, FS.FrameWork.Function.NConvert.ToDateTime(strStartTime), FS.FrameWork.Function.NConvert.ToDateTime(strEndTime), lstFeeStat, out dtReport);
        ...
        private DataTable QueryInpatientRealIncomeByDoctor()
        {
            ...
            //先查询所有科室收入
            iReturn = inpatientReport.QueryRealInpatientIncomeByInhosDoctor(reportCode, strDept, strEmp, FS.FrameWork.Function.NConvert.ToDateTime(strStartTime), FS.FrameWork.Function.NConvert.ToDateTime(strEndTime), lstFeeStat, out dtReport);
            return dtReport;
