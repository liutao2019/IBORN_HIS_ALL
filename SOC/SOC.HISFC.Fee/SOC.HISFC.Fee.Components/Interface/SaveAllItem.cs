...
namespace FS.SOC.HISFC.Fee.Components.Interface
{
    ...
    /// [创建时间: 2011-10]<br></br>
    /// </summary>
    public class SaveAllItem : FS.SOC.HISFC.BizProcess.CommonInterface.Common.ISave<ArrayList>
    {
        #region ISave<ArrayList> 成员

        public int SaveCommitting(FS.SOC.HISFC.BizProcess.CommonInterface.Common.EnumSaveType saveType, ArrayList alItem)
        {
            return 1;
        }

        public int Saved(FS.SOC.HISFC.BizProcess.CommonInterface.Common.EnumSaveType saveType, ArrayList alItem)
        {
        ...
        public int Saving(FS.SOC.HISFC.BizProcess.CommonInterface.Common.EnumSaveType saveType, ArrayList alItem)
        {
            return 1;
        }
