...
namespace FS.SOC.HISFC.Fee.Components.Helper
{
    public class CustomProperty
    {
        ...
        protected void OnObjectSourceChanged()
        {
            ...
            object value=null;
            if (_objectSource is Object[])
            {
                value = PropertyInfos[0].GetValue(((Object[])_objectSource)[0], null);
            }
            else
            {
                value = PropertyInfos[0].GetValue(_objectSource, null);
            }
        ...
        protected void OnValueChanged()
        {
            ...
            if (_objectSource is Object[])
            {
                foreach (Object o in ((Object[])_objectSource))
                {
                    foreach (PropertyInfo propertyInfo in PropertyInfos)
                    {
                        propertyInfo.SetValue(o, _value, null);
                    }
                }
            }
            else
        ...
        protected PropertyInfo[] PropertyInfos
        {
            get
            {
                if (_propertyInfos == null)
                {
                    ...
                    if (_objectSource is Object[])
                    {
                        type = ((Object[])_objectSource)[0].GetType();
                    }
                    else
                    {
                        type = _objectSource.GetType();
                    }
