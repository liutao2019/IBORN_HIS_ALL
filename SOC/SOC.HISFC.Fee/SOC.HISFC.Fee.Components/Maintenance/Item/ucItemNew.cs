...
namespace FS.SOC.HISFC.Fee.Components.Maintenance.Item
{
    ...
    /// </修改记录>
    /// </summary>
    partial class ucItemNew : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucItemNew()
        {
            InitializeComponent();
            ...
            //this.chkUnDiscount.CheckedChanged += new EventHandler(chkUnDiscount_CheckedChanged);
        ...
        public int Init()
        {
            ...
            this.cmbFunctionminClass.AddItems(CommonController.CreateInstance().QueryConstant("ITEMPRICEMINTYPE")); //{21a8d31b-c7f1-4ffd-ab81-ced4b7c82c5c}
            ...
            this.cmbManageClass.AddItems(FS.HISFC.Models.Base.ManageEnumService.List());//{6F68AB52-332C-4efa-A6DD-F6BDB37B1283}
        ...
        public void SetUserCode()
        {
            ...
            {
                string userCode = "F" + itemManager.GetSequence("Fee.Item.Undrug.GetUserCode");
        ...
        public void SetItem(FS.SOC.HISFC.Fee.Models.Undrug item, bool isUsed)
        {
            ...
            this.cmbManageClass.Tag = item.ManageClass.ID;//2
            ...
            this.chkUnDiscount.Checked = FS.FrameWork.Function.NConvert.ToBoolean(item.IsDiscount);//16

            this.tbYBcode.Text = item.YbCode;
            ...
            this.cmbFunctionminClass.Tag = item.ItemSecondPriceType;
        ...
        private bool CheckValid()
        {
            ...
            //if (this.cmbManageClass.Text == "")
            //{
            //    CommonController.CreateInstance().MessageBox(FS.FrameWork.Management.Language.Msg("管理级别不能为空!"), MessageBoxIcon.Error);
            //    this.cmbSysClass.Focus();
            //    return false;
            //}
        ...
        private FS.SOC.HISFC.Fee.Models.Undrug GetItem()
        {
            ...
            item.ManageClass.ID = this.cmbManageClass.Tag.ToString();
            item.IsDiscount = FS.FrameWork.Function.NConvert.ToInt32(this.chkUnDiscount.Checked).ToString();
            item.YbCode = this.tbYBcode.Text;
            #region 执行科室
            ...
            else if (this.txtKfDept.Text.Contains("ALL"))
            {
                item.DeptList = "ALL";
            }
            else
            ...
            //{21a8d31b-c7f1-4ffd-ab81-ced4b7c82c5c}
            if (this.cmbFunctionminClass.Tag != null)
            {
                item.ItemSecondPriceType = this.cmbFunctionminClass.Tag.ToString();
            }
        ...
        void chbIsStop_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (this.chbIsStop.Checked == true)
            {
                //Neusoft.SOC.HISFC.Fee.BizProcess.PackageInfoManager pm = new Neusoft.SOC.HISFC.Fee.BizProcess.PackageInfoManager();
                //{CE949D37-D860-4b2a-88B7-FFFC11918999}
                FS.HISFC.BizProcess.Integrate.Fee pm = new FS.HISFC.BizProcess.Integrate.Fee();
                List<string> list = pm.queryPackageContainUnDrug(tbItemCode.Text);

                if (list.Count > 0)
                {
                    string res = "以下套餐包含该项目，请注意调整：\n";
