...
namespace FS.SOC.HISFC.Fee.Components.Maintenance.PYCompareItem
{
    ...
    public partial class ucCenterCompare : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        FS.SOC.HISFC.Fee.Components.Maintenance.PYCompareItem.ucCenterPact centerPact = null;
        FS.SOC.HISFC.Fee.Components.Maintenance.PYCompareItem.ucCompareForCenterType compareForCT = null;
