...
namespace FS.SOC.HISFC.Fee.Components.Maintenance.PYCompareItem
{
    ...
    public partial class ucCompareForCenterType : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            item.User01 = ((FS.SOC.HISFC.Fee.Models.CompareItemModel)this.neuCenterCode.Tag).User01;
            item.User02 = ((FS.SOC.HISFC.Fee.Models.CompareItemModel)this.neuCenterCode.Tag).User02;
