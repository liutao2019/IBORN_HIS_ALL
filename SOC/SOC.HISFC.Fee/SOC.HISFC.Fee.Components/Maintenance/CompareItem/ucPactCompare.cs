...
namespace FS.SOC.HISFC.Fee.Components.Maintenance.CompareItem
{
    public partial class ucPactCompare : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        FS.SOC.HISFC.Fee.Components.Maintenance.CompareItem.ucComparedItem comparedItem = null;
        FS.SOC.HISFC.Fee.Components.Maintenance.CompareItem.ucCompareForPact compareForP = null;
        private void LoadUC()
        {
