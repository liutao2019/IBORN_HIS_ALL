...
namespace FS.SOC.HISFC.Fee.Components.Maintenance.CompareItem
{
    public partial class ucCenterControl : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
       ...
       public string StrPacts
       {
        ...
        FS.SOC.HISFC.Fee.Components.Maintenance.CompareItem.ucCenterCompare centerCompare = null;
        FS.SOC.HISFC.Fee.Components.Maintenance.CompareItem.ucPactCompare pactCompare = null;
