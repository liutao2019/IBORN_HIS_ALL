...
namespace FS.SOC.HISFC.Fee.Components.Maintenance.SiCompareItem
{
    ...
    public partial class ucComparedItem : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        public delegate void ItemComparedSelectedHandle(FS.SOC.HISFC.Fee.Models.CompareItemModel pactInfo);
        public event ItemComparedSelectedHandle itemComparedSelectedHandle;
        ...
        FS.SOC.HISFC.Fee.BizLogic.SiCompareItem compareMsg = new FS.SOC.HISFC.Fee.BizLogic.SiCompareItem();
        ...
        /// Fp设置文件
        /// </summary>
        private string settingFile = FS.FrameWork.WinForms.Classes.Function.SettingPath + "SOC.Fee.SiCompareItem.ComparedItem.xml";

        private string filter = "1=1";


        FS.SOC.HISFC.Fee.Models.CompareItemModel pactInfoTemp;
        ...
        private int setDataRowValue(FS.SOC.HISFC.Fee.Models.CompareItemModel pactInfo)
        {
            ...
            row["医保等级"] = pactInfo.User01;

            pactInfoTemp = pactInfo;
            return 1;
        }
        ...
        {
            FS.SOC.HISFC.Fee.Models.CompareItemModel pactInfo = pactInfoTemp;
            if (this.itemComparedSelectedHandle != null)
            {
                try
                {
                    FS.FrameWork.WinForms.Classes.Function.ShowWaitForm("正在加载医保中心数据...");
                    Application.DoEvents();
                    this.itemComparedSelectedHandle(pactInfo);
        ...
        public void SetComparedItem(string strPacts)
        {
            ...
            if (currentItem!=null && !string.IsNullOrEmpty(strPacts))
            {
