...
namespace FS.SOC.HISFC.Fee.Components.Maintenance.SiCompareItem
{
    ...
    public partial class ucCenterCompare : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        FS.SOC.HISFC.Fee.Components.Maintenance.SiCompareItem.ucCenterPact centerPact = null;
        FS.SOC.HISFC.Fee.Components.Maintenance.SiCompareItem.ucCompareForCenterType compareForCT = null;
        ...
        private void LoadUC()
        {
            ...
            this.pnlCompareForCT.Controls.Add(compareForCT);
                ...
                this.CenterType = centerPact.CenterType;
        ...
        private void centerPact_itemSelectedEvent(string strType,string strPacts)
        {
            ...
            StrPacts = strPacts;
            CenterType = centerPact.CenterType;
