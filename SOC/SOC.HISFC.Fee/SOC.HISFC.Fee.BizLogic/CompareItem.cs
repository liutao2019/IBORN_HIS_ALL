...
namespace FS.SOC.HISFC.Fee.BizLogic
{
    ...
    /// [创建时间: 2011-10]<br></br>
    /// </summary>
    public class CompareItem : FS.FrameWork.Management.Database
    {
        ...
        {
            string strSql = FS.SOC.HISFC.Fee.Data.AbstractCompareItem.Current.QueryLocalItems;
        ...
        {
            string strSql = FS.SOC.HISFC.Fee.Data.AbstractCompareItem.Current.QueryCenterItems;
