...
namespace ProvinceAcrossSI
{
    class test
    {
        ...
        public string testConnect()
        {
            ...
            ProvinceAcrossSI.Business.InPatient.InPatientService funtion = new ProvinceAcrossSI.Business.InPatient.InPatientService();
            string status="";
            string msg="";
            ...
            ProvinceAcrossSI.WebReference.Service1 myWebService1 = new ProvinceAcrossSI.WebReference.Service1();
