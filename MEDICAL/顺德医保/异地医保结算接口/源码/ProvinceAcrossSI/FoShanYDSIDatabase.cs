...
{
    public class ProvinceAcrossSIDatabase : FS.FrameWork.Management.Database
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ArrayList QueryICD(string inpatientNo)
        {
            ArrayList al = new ArrayList();
            string sqlStr = "select 出院主要诊断编码,出院主要诊断,出院其他诊断编码，出院其他诊断 from lgsb@emr1_dblink kk where kk.HIS内部标识 = '{0}'";
...
center_property_name, fda_code  --#6
        ...
        /// <returns></returns>
        public int InsertSIMainInfo(FS.HISFC.Models.Registration.Register patientInfo, ProvinceAcrossSI.Objects.SIPersonInfo personInfo, ProvinceAcrossSI.Objects.OutBalanceInfo outBalanceInfo)
        {
...
";
            ...
            SELECT M.DRUG_CODE,
             ...
             WHERE EE.EMPL_CODE =  M.RECIPE_DOCCODE
               ...
               GROUP BY M.INPATIENT_NO,m.DRUG_CODE,m.DRUG_NAME,
                   ...
                   b.gb_code
               HAVING round(sum(b.wholesale_price / b.pack_qty * M.qty), 2) != 0            
               ";
        ...
        /// <param name="personInfo"></param>    
        /// <returns></returns>
        public int InsertYDInPatientReg(FS.HISFC.Models.RADT.PatientInfo patientInfo, ProvinceAcrossSI.Objects.SIPersonInfo personInfo)
        {
            //医保基本信息保存到表fin_ipr_siinmaininfo
            //佛山医保扩展信息需要另外保存
            string balanceNo = this.GetBalanceNo(patientInfo.ID);
...
";
        ...
        /// <param name="personInfo"></param>
        /// <returns></returns>
        public int QueryInPatientRegInfo(string inpatientNo, ref ProvinceAcrossSI.Objects.SIPersonInfo personInfo)
        {
            int result = 0;
            ...
            string strSql2 = @"select JZDJH,--就诊登记号';  0
                           MCARD_NO,--'医保编号';
                           ...
                           GWYBCZFXE,--公务员本次支付限额
                           JBYLTCLJ, --'基本医疗统筹累计';  20 
                           DBYLTCLJ,--大病医疗统筹累计  21
                           IN_TIMES,--住院次数
                           IN_STATE,--住院状态
                           ECFYSPBZ,--二次返院审批标志
                           ZYBZ,--'转院标志';
                           ...
                           YKC641,--医疗救助金额  105
                           ykc642, --二次救助金额 
                           ykc752, --一至六级残疾军人等医疗补助  107
                           ykc753 --本年度医疗救助累计金额  108
             ...
             try
            {
                ...
                if (this.Reader.Read())
                {
                    ...
                    personInfo.SeeDocType = this.Reader[82].ToString();
                     personInfo.dzrq_date= this.Reader[83].ToString();
                     personInfo.ake149 = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[84].ToString());
                    personInfo.ake026 = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[85].ToString());  
                    personInfo.ake032  = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[86].ToString());  
                    personInfo.ake181  = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[87].ToString());  
                    personInfo.ake173  = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[88].ToString());
                    personInfo.akb067 = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[89].ToString());
                    personInfo.ake038  = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[90].ToString());  
                    personInfo.aae240  = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[91].ToString());  
                    personInfo.aab021  = this.Reader[92].ToString();  
                    personInfo.ake105  = this.Reader[93].ToString();
                    personInfo.akc070 = this.Reader[94].ToString();
                    personInfo.akc071 = this.Reader[95].ToString();
                    personInfo.akc072 = this.Reader[96].ToString();
                    personInfo.ake171 = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[97].ToString());
                    personInfo.InsuredAreaCode = this.Reader[98].ToString();


                    //
                    personInfo.oper_date = this.Reader[99].ToString();
                    personInfo.BNDYLJZLJJE = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[100].ToString());
                    personInfo.BCYLJZZFXE = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[101].ToString());
                    personInfo.oper_State = this.Reader[102].ToString();
                    personInfo.akb068 = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[103].ToString());
                    personInfo.ykc751 = this.Reader[104].ToString();
                    personInfo.ykc641 = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[105].ToString());
                    personInfo.ykc642 = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[106].ToString());
                    personInfo.ykc752 = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[107].ToString());
                    personInfo.ykc753 = FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[108].ToString());
                    result = 1;
                }
                else
                {
        ...
        /// <returns></returns>
        public int UpdateSiinmaininfoValidFlag(FS.HISFC.Models.RADT.PatientInfo patientInfo, ProvinceAcrossSI.Objects.SIPersonInfo personInfo, string validFlag)
        {
        ...
        /// <param name="validFlag"></param>
        /// <returns></returns>
        public int UpdateSiinmaininfoYDBalaceInfo(FS.HISFC.Models.RADT.PatientInfo patientInfo, 
            string RETURN_BALANCE_NO, string RETURN_BALANCE_DATE, string RETURN_DZ_DATE)
        {
            string strSql2 = @"update FIN_IPR_SIINMAININFO_YD
                               set RETURN_BALANCE_NO='{1}'
                                   ,RETURN_BALANCE_DATE='{2}'
                                   ,RETURN_DZ_DATE='{3}'
                                   ,balance_flag = '0'
                              where inpatient_no = '{0}' 
                              and balance_flag = '1'";
            ...
            strSql2 = string.Format(strSql2, patientInfo.ID, RETURN_BALANCE_NO, RETURN_BALANCE_DATE, RETURN_DZ_DATE);
            try
            {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public ArrayList QueryFIN_YD_SI_BALANCE_DETAIL(FS.HISFC.Models.RADT.PatientInfo patientInfo)
        {
            ...
            {
                this.ExecQuery(strSql);
                ProvinceAcrossSI.Objects.SIJiJinclass SIJiJinclass = new ProvinceAcrossSI.Objects.SIJiJinclass();
                if (this.Reader.Read())
                {
                    SIJiJinclass = new ProvinceAcrossSI.Objects.SIJiJinclass();

                    SIJiJinclass.inpatient_no = Reader[0].ToString();
                    SIJiJinclass.aaa157 = Reader[1].ToString();
                    SIJiJinclass.aaa160 = Reader[2].ToString();
                    SIJiJinclass.aad006 = Reader[3].ToString();
                    SIJiJinclass.aae187 = FS.FrameWork.Function.NConvert.ToDecimal(Reader[4].ToString());
                    alTemp.Add(SIJiJinclass);
                }
            }
            catch (Exception e)
            {
        ...
        /// <param name="validFlag"></param>
        /// <returns></returns>
        public int UpdateFIN_YD_SI_BALANCE_DETAIL_IS_valid(FS.HISFC.Models.RADT.PatientInfo patientInfo)
        {
            string strSql2 = @"update FIN_YD_SI_BALANCE_DETAIL
                               set is_valid = '0'
                              where inpatient_no = '{0}' ";

            strSql2 = string.Format(strSql2,  patientInfo.ID);
            try
            {
                if (this.ExecNoQuery(strSql2) < 0)
                {
        ...
        /// <param name="validFlag"></param>
        /// <returns></returns>
        public int InsertFIN_YD_SI_BALANCE_DETAIL(ArrayList list_SIJiJinclass)
        {
            string strSql = @"INSERT INTO FIN_YD_SI_BALANCE_DETAIL
                                 (
                                   inpatient_no ,
                                   aaa157       ,
                                   aaa160       ,
            ...
            foreach (ProvinceAcrossSI.Objects.SIJiJinclass SIJiJinclass in list_SIJiJinclass)
            {
               string strSql2 = string.Format(strSql, 
                                        SIJiJinclass.inpatient_no,
                                        SIJiJinclass.aaa157,
                                        SIJiJinclass.aaa160,
                                        SIJiJinclass.aad006,
                                        SIJiJinclass.aae187,
                                        SIJiJinclass.is_valid);
                try
                {
                    if (this.ExecNoQuery(strSql2) < 0)
                    {
        ...
        /// <param name="outBalanceInfo"></param>
        /// <returns></returns>
        public int InsertSIMainInfoInpatient(FS.HISFC.Models.RADT.PatientInfo patientInfo, ProvinceAcrossSI.Objects.SIPersonInfo personInfo)
        {
            //医保基本信息保存到表fin_ipr_siinmaininfo
            //佛山医保扩展信息需要另外保存
            string balanceNo = this.GetBalanceNo(patientInfo.ID);
            ...
            strSql = @"insert into fin_ipr_siinmaininfo_yd 
                        (
                         ...
                         Diagn3   ,        regTransID,         balanceTransID     ,out_transid   ,dzrq_date ,
                         ake149 ,  ake026 ,  ake032 ,  ake181 ,  ake173 ,
                         akb067 ,  ake038 ,  aae240 ,  aab021 ,  ake105 ,
                         akc070 ,  akc071 ,  akc072 ,  SEEDOCTYPE ,ake171,oper_date,
            ...
            strSql = string.Format(strSql, patientInfo.ID, balanceNo, personInfo.ClinicNo, "", "",
                                   ...
                                   personInfo.Diagn3, personInfo.regTransID, personInfo.balanceTransID, personInfo.Out_TransID, personInfo.dzrq_date,
                                   personInfo.ake149, personInfo.ake026, personInfo.ake032, personInfo.ake181, personInfo.ake173,
                                   personInfo.akb067, personInfo.ake038, personInfo.aae240, personInfo.aab021, personInfo.ake105,
                                   personInfo.akc070, personInfo.akc071, personInfo.akc072, personInfo.SeeDocType, personInfo.ake171,
        ...
        /// <param name="personInfo"></param>
        /// <returns></returns>
        public int QuerySiBalanceInfo(ref FS.HISFC.Models.RADT.PatientInfo patientInfo, ref ProvinceAcrossSI.Objects.SIPersonInfo personInfo)
        {
            int result = 0;
 ...
 WHERE I.INPATIENT_NO = '{0}'
  ...
  ";
        ...
        public int InsertBalanceType(ArrayList arrCenterBalanceItem)
        {
            ...
            foreach (ProvinceAcrossSI.Objects.SICenterBalanceItem obj in arrCenterBalanceItem)
            {
...
";
        ...
        /// <param name="outBalanceInfo"></param>
        /// <returns></returns>
        public int QueryBalancePrint(FS.HISFC.Models.RADT.PatientInfo patient, ref ProvinceAcrossSI.Objects.SIPersonInfo personInfo, ref ProvinceAcrossSI.Objects.OutBalanceInfo outBalanceInfo)
        {
            int result = 0;
  ...
  ";
            ...
            try
            {
                ...
                if (this.Reader.Read())
                {
                    ...
                    {
                        outBalanceInfo = new ProvinceAcrossSI.Objects.OutBalanceInfo();
                    }
