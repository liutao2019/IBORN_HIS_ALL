...
namespace ProvinceAcrossSI.Controls
{
    public partial class ucYDInBalanceInfo : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        public void SetValues(FS.HISFC.Models.RADT.PatientInfo p, ProvinceAcrossSI.Objects.SIPersonInfo ps)
        {
            ...
            this.neuSpread1_Sheet1.Cells["个人自负费用"].Text = ps.GRZF_cost + "" ;
        ...
        private void CommonPrint(FarPoint.Win.Spread.FpSpread fp, int index)
        {
            try
            {
                ...
                FS.HISFC.Models.Base.PageSize ps = pgMgr.GetPageSize("YDInPatientJSD");  //住院佛山异地医保结算单
                if (ps == null)
                {
                    //默认大小
                    ps = new FS.HISFC.Models.Base.PageSize("YDInPatientJSD", 830, 500);
                }
