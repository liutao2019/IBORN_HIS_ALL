...
namespace ProvinceAcrossSI.Controls
{
    public partial class YDInpatientBalance : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        /// 患者医保信息
        /// </summary>
        ProvinceAcrossSI.Objects.SIPersonInfo ps = new ProvinceAcrossSI.Objects.SIPersonInfo();
        ...
        private void InitDiagnoses()
        {
            ...
            this.cmbDiag2.Text = "";
            this.cmbDiag3.Text = "";
            pactCode = this.controlParam.GetControlParam<string>("SWYD01");// {80867F3F-AE91-4525-82AF-0618AB01C92B}
        }
        ...
        private int SetPatientInfo()
        {
            ...
            if (this.inPatientService.QueryInpatienRegInfo(this.p.ID, ref this.ps) < 0)
            {
            ...
            {
                if (this.inPatientService.QueryfeeDetails(this.p, ref this.feeDetails, ref msg) < 0)
                {
                    if (this.ps != null)
                    {
                    ...
                    MessageBox.Show("没有费用信息！" + this.msg, "佛山异地医保");
                    //return;
                }
            }
        ...
        private void DualBanlanceInfo(FS.HISFC.Models.RADT.PatientInfo p, ref ProvinceAcrossSI.Objects.SIPersonInfo ps)
        {
            return;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(pactCode))
            {
                ...
                {
                    MessageBox.Show("该患者合同身份非【省外】异地患者！请修改患者合同身份");// {80867F3F-AE91-4525-82AF-0618AB01C92B}
                    return;
                }
            }
        ...
        private void btCancelReg_Click(object sender, EventArgs e)
        {
            ...
            //FS.HISFC.Models.RADT.PatientInfo patientTemp = this.radtIntegrate.GetPatientInfomation(this.p.ID);
            //if (patientTemp == null)
            //{
            //    MessageBox.Show("患者信息为空！", "佛山异地医保");
            //    return;
            //}
       ...
       /// <param name="e"></param>
        ...
        private void btCancelOutReg_Click(object sender, EventArgs e)
        {
            ...
            if (this.inPatientService.CancelOutReg(this.p, ref this.msg) < 0)
            {
                MessageBox.Show(msg, "佛山异地医保");
                return;
            }
        ...
        private void btUpLoadFeeDetail_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("费用上传成功，请做下一步**出院登记**", "佛山异地医保");
            queryPersonFlag = 2;
        }
        ...
        private void btOutReg_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("出院登记成功，请做下一步**出院结算**", "佛山异地医保");
            queryPersonFlag = 3;
        }
        ...
        private void btCorrentTrain_Click(object sender, EventArgs e)
        {
            msg = "";
            if (string.IsNullOrEmpty(this.txbTrainsID.Text.Trim()))
            {
                MessageBox.Show("请录入交易流水号！");
                return;
            }
            if (queryPersonFlag != 1)
            {
            ...
            if (this.inPatientService.CorrectionTrans(this.ps.InsuredAreaCode,this.cbTrainsType.Tag.ToString(),this.txbTrainsID.Text.Trim(),ref msg) < 0)
            {
                MessageBox.Show(msg, "佛山异地医保");
                return;
            }
        ...
        private void btInReg_Click(object sender, EventArgs e)
        {
            ...
            ProvinceAcrossSIManager ProvinceAcrossSIManager = new ProvinceAcrossSIManager();
            if (ProvinceAcrossSIManager.UploadRegInfoInpatient(this.p) < 0)
            {
                MessageBox.Show("住院登记失败！" + ProvinceAcrossSIManager.ErrMsg);
                return;
