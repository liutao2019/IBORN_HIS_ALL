...
namespace ProvinceAcrossSI.Objects
{
    public class SIPersonInfo
    {
        ...
        /// *[佛山跨省异地] 经办机构支付总额
        /// </summary>
        public decimal ake149 = 0;

        /// <summary>
        /// *[佛山跨省异地] 补充医疗保险基金
        /// </summary>
        public decimal ake026 = 0;

        /// <summary>
        /// *[佛山跨省异地] 伤残人员医疗保障基金
        /// </summary>
        public decimal ake032 = 0;

        /// <summary>
        /// *[佛山跨省异地] 民政补助基金
        /// </summary>
        public decimal ake181 = 0;

        /// <summary>
        /// *[佛山跨省异地] 其他基金支付
        /// </summary>
        public decimal ake173 = 0;

        /// <summary>
        /// *[佛山跨省异地] 个人现金支付
        /// </summary>
        public decimal akb067 = 0;


        /// <summary>
        /// *[佛山跨省异地] 个人账户支付
        /// </summary>
        public decimal ake038 = 0;

        /// <summary>
        /// *[佛山跨省异地] 个人账户余额
        /// </summary>
        public decimal aae240 = 0;

        /// <summary>
        /// *[佛山跨省异地] 隶属关系
        /// </summary>
        public string aab021 = "";

        /// <summary>
        /// *[佛山跨省异地] 全额垫付标志
        /// </summary>
        public string ake105 = "";

        /// <summary>
        /// *[佛山跨省异地] 输出附加信息1
        /// </summary>
        public string akc070 = "";

        /// <summary>
        /// *[佛山跨省异地] 输出附加信息2
        /// </summary>
        public string akc071 = "";

        /// <summary>
        /// *[佛山跨省异地] 输出附加信息3
        /// </summary>
        public string akc072 = "";

        /// <summary>
        /// *[佛山跨省异地] 统筹基金支付范围内费用
        /// </summary>
        public decimal ake171 = 0;
