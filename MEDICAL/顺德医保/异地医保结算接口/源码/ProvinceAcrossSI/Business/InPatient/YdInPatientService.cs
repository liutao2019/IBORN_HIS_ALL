...
namespace ZhuHaiYDSI.Business.InPatient
{
    public class YdInPatientService
    {
        ...
        public string InPatientAccreditation(Neusoft.HISFC.Models.RADT.PatientInfo patient, ref ZhuHaiYDSI.Objects.SIPersonInfo personInfo, ref string status, ref string msg)
        {
            status = "1";
