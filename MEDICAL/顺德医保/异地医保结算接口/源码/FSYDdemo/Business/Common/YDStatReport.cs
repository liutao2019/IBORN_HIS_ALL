...
namespace FoShanYDSI.Business.Common
{
    public class YDStatReport : FS.FrameWork.Management.Database
    {
        ...
        {
            string sql = "select t.control_value from com_controlargument t where t.control_code = 'YDSB01'";
            string sqlStr = "";
        ...
        public int UpdateLiquidInfoTransID(FS.FrameWork.Models.NeuObject obj, FS.FrameWork.Models.NeuObject commObj)
        {
            ...
            sql = string.Format(sql, obj.ID, obj.Name, obj.Memo, commObj.ID, commObj.Name, commObj.User01);
