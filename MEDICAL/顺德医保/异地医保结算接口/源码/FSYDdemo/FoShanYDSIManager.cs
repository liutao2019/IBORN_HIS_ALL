...
{
    public class FoShanYDSIManager : FS.HISFC.BizProcess.Interface.FeeInterface.IMedcare
    {
        private System.Data.IDbTransaction trans = null;
        //private FoShanYDSI.Business.OutPatient.OutPatientService outPatientService = new FoShanYDSI.Business.OutPatient.OutPatientService();
        private FoShanYDSI.Business.Common.CommonService comService = new FoShanYDSI.Business.Common.CommonService();
        private FoShanYDSI.Business.InPatient.InPatientService inPatientService = new FoShanYDSI.Business.InPatient.InPatientService();
        ...
        public int BalanceInpatient(FS.HISFC.Models.RADT.PatientInfo patient, ref System.Collections.ArrayList feeDetails)
        {
            ...
            //        return -1;
            //    }
            //    patient.FT.OwnCost = personInfo.GRZF_cost;
            //    patient.FT.PubCost = personInfo.YBTCZF_cost;
            //    patient.FT.TotCost = personInfo.tot_cost;
            //    patient.Pact.PayKind.ID = "02";
            //    patient.SIMainInfo.OwnCost = personInfo.GRZF_cost;
            //    patient.SIMainInfo.PayCost = 0;
            //    patient.SIMainInfo.PubCost = personInfo.YBTCZF_cost;
            //    patient.SIMainInfo.TotCost = personInfo.tot_cost;
            //    return 1;
            //}
            //else
            //{
            ...
            FoShanYDSI.Controls.YDInpatientBalance YDInpatientBalance = new FoShanYDSI.Controls.YDInpatientBalance();
        ...
        public int GetRegInfoOutpatient(FS.HISFC.Models.Registration.Register r, bool isReadMCard)
        {
            ...
            ////iReadMCard = FS.FrameWork.WinForms.Classes.UtilInterface.CreateObject(typeof(FoShanYDSI.FoShanYDSIManager), typeof(FS.HISFC.BizProcess.Interface.Account.IReadMCard)) as FS.HISFC.BizProcess.Interface.Account.IReadMCard;
            //iReadMCard = new FoShanYDSI.ReadMCardFoShan();
        ...
        public int PreBalanceInpatient(FS.HISFC.Models.RADT.PatientInfo patient, ref System.Collections.ArrayList feeDetails)
        {
            ...
            string msg = string.Empty;
            string status = string.Empty;
            string FoShanPactIDs = "51,52,54,";//佛山医保住院合同单位集合
            //if (FoShanPactIDs.Contains(patient.Pact.ID))
            if (true)
            {
                //TODO:查询佛山医保住院结算信息
                //最大序号的有效结算信息                 
        ...
        public int UploadRegInfoInpatient(FS.HISFC.Models.RADT.PatientInfo patient)
        {
            ...
            FoShanYDSI.Controls.frmInpatientRegYiDi frm = new FoShanYDSI.Controls.frmInpatientRegYiDi();
        ...
        public long Connect()
        {
            ...
            //try
            //{
            //    FoShanYDSIService.outwebserviceClient client = new FoShanYDSI.FoShanYDSIService.outwebserviceClient(new System.ServiceModel.BasicHttpBinding(), new System.ServiceModel.EndpointAddress("http://172.16.0.6/outservice/services/outwebservice"));
            //    if (client == null)
            //    {
        ...
        //string FS.HISFC.BizProcess.Interface.FeeInterface.IMedcare.ErrMsg
        //{
        //    get { throw new NotImplementedException(); }
        //}
