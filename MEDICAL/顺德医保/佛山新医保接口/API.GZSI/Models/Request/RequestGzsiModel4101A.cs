    ...
    public class RequestGzsiModel4101A
    {
        ...
        public class Setlinfo
        {
            ...
            public string prfs_name { get; set; }  //82 职业
             public string psn_no { get; set; }  //82 人员编号
            public string resp_nurs_code { get; set; }  //82 责任护士代码
            public string stas_type { get; set; }  //82 状态分类
            public string mul_nwb_bir_wt { get; set; }  //82 多新生儿出生体重
            public string mul_nwb_adm_wt { get; set; }  //82 多新生儿入院体重
        ...
        public class Oprninfo
        {
            ...
            public string oprn_oprt_begntime { get; set; }  //6 手术操作开始时间   Y
            public string oprn_oprt_endtime { get; set; }  //7 手术操作结束时间   Y
            public string anst_begntime { get; set; }  //8 麻醉开始时间   
            public string anst_endtime { get; set; }  //9 麻醉结束时间   
        }
