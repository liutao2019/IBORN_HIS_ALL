...
namespace API.GZSI.Print.uc4101
{
    public partial class ucPrint4101 : UserControl
    {
        ...
        Models.Response.ResponseGzsiModel4101 responseGzsiModel = new Models.Response.ResponseGzsiModel4101();
        /// <summary>
        /// 请求对象
        /// </summary>
        public Models.Response.ResponseGzsiModel4101 ResponseGzsiModel
        {
            get { return responseGzsiModel; }
            set { responseGzsiModel = value; }
        }
        ...
        private void SetInfo()
        {
            //lb信息赋值
            this.lbSetlId.Text = "";
            if (this.ResponseGzsiModel != null && this.ResponseGzsiModel.output != null && !string.IsNullOrEmpty(this.ResponseGzsiModel.output.setl_list_id)) {
                this.lbSetlId.Text = this.ResponseGzsiModel.output.setl_list_id;// this.RequestModel.setlinfo.setl_id;
            }
            ...
            this.lbHiSetlLv.Text = "二级甲等";//string.IsNullOrEmpty(this.RequestModel.setlinfo.hi_setl_lv) ? "二级甲等" : this.RequestModel.setlinfo.hi_setl_lv;
            ...
            this.lbMedinsFillDept2.Text = this.RequestModel.setlinfo.medins_fill_dept;
            this.lbMedinsFillPsn2.Text = this.RequestModel.setlinfo.medins_fill_psn;
            ...
            this.fpSpread_Sheet1.Cells["psn_part_am"].Value = (this.patientInfo.SIMainInfo.Cash_payamt - this.patientInfo.SIMainInfo.Ownpay_amt).ToString(); //this.patientInfo.SIMainInfo.Psn_part_am.ToString();
