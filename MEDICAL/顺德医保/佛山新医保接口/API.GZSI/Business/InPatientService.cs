...
namespace API.GZSI.Business
{
    ...
    public class InPatient4101A : AbstractService<Models.Request.RequestGzsiModel4101A, Models.Response.ResponseGzsiModel4101>
    {
        public override string InterfaceID
        {
            get
        ...
        protected override int ConvertReceiverMessageToModel(string m, Models.Request.RequestGzsiModel4101A t, ref Models.Response.ResponseGzsiModel4101 e, params object[] appendParams)
        {
            return base.ConvertReceiverMessageToModel(m, t, ref e, appendParams);
        }
    }
    ...
    /// 转院备案
    /// </summary>
    public class InPatient2501A : AbstractService<Models.Request.RequestGzsiModel2501A, Models.Response.ResponseGzsiModel2501A>
    {
        public override string InterfaceID
        {
            get
        ...
        protected override string ConvertModelToSendMessage(Models.Request.RequestGzsiModel2501A t, ref string Infno, params object[] appendParams)
        {
            return base.ConvertModelToSendMessage(t, ref Infno, appendParams);
        }

        protected override int ConvertReceiverMessageToModel(string m, Models.Request.RequestGzsiModel2501A t, ref Models.Response.ResponseGzsiModel2501A e, params object[] appendParams)
        {
            return base.ConvertReceiverMessageToModel(m, t, ref e, appendParams);
        }
    }
    ...
    /// 医药机构信息获取
    /// </summary>
    public class InPatient90111 : AbstractService<Models.Request.RequestGzsiModel90111, Models.Response.ResponseGzsiModel90111>
    {
        public override string InterfaceID
        {
            get
        ...
        protected override string ConvertModelToSendMessage(Models.Request.RequestGzsiModel90111 t, ref string Infno, params object[] appendParams)
        {
            return base.ConvertModelToSendMessage(t, ref Infno, appendParams);
        }

        protected override int ConvertReceiverMessageToModel(string m, Models.Request.RequestGzsiModel90111 t, ref Models.Response.ResponseGzsiModel90111 e, params object[] appendParams)
        {
            return base.ConvertReceiverMessageToModel(m, t, ref e, appendParams);
        }
    }
    ...
    /// 医药机构信息获取
    /// </summary>
    public class InPatient1201 : AbstractService<Models.Request.RequestGzsiModel1201, Models.Response.ResponseGzsiModel1201>
    {
        public override string InterfaceID
        {
            get
