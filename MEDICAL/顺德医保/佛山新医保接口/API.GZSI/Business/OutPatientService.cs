...
namespace API.GZSI.Business
{
    ...
    /// 门诊就诊信息上传
    /// </summary>
    public class OutPatient2203A : AbstractService<Models.Request.RequestGzsiModel2203A, Models.Response.ResponseGzsiModel2203A>
    {
        public override string InterfaceID
        {
            get
        ...
        protected override string ConvertModelToSendMessage(Models.Request.RequestGzsiModel2203A t, ref string Infno, params object[] appendParams)
        {
            return base.ConvertModelToSendMessage(t, ref Infno, appendParams);
        }

        protected override int ConvertReceiverMessageToModel(string m, Models.Request.RequestGzsiModel2203A t, ref Models.Response.ResponseGzsiModel2203A e, params object[] appendParams)
        {
            return base.ConvertReceiverMessageToModel(m, t, ref e, appendParams);
        }
    }
