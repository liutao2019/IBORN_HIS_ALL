...
namespace API.GZSI.UI
{
    public partial class ucOwnPayUpload : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private int InOwnPayUpload(FS.HISFC.Models.RADT.PatientInfo patientInfo)
        {
            ...
            RequestGzsiModel4204.feedetail.fixmedins_code = Models.UserInfo.Instance.userId;
            ...
            RequestGzsiModel4203.fixmedins_code = Models.UserInfo.Instance.userId;
        ...
        private int OutOwnPayDelete(FS.HISFC.Models.RADT.PatientInfo patientInfo)
        {
            ...
            RequestGzsiModel4206.fixmedins_code = Models.UserInfo.Instance.userId;
        ...
        private int Query4207(FS.HISFC.Models.RADT.PatientInfo patientInfo)
        {
            ...
            try
            {
                ...
                RequestGzsiModel4207.fixmedins_code = Models.UserInfo.Instance.userId;
        ...
        private int Query4208(FS.HISFC.Models.RADT.PatientInfo patientInfo)
        {
            ...
            try
            {
                ...
                {
                    if (data.fixmedinsMdtrtId == fixmedinsMdtrtId && data.fixmedinsCode == Models.UserInfo.Instance.userId)
                    {
                        dataList.Add(data);
                    }
                }
        ...
        private int Query4209(FS.HISFC.Models.RADT.PatientInfo patientInfo)
        {
            ...
            try
            {
                ...
                RequestGzsiModel4209.fixmedins_code = Models.UserInfo.Instance.userId;
