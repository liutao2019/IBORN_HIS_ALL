...
namespace API.GZSI.Common
{
    public static class Function
    {
        ...
        public static sbyte[] AuthGetFileData(string fileUrl)
        {
            ...
            sbyte[] mySByte = new sbyte[buff.Length];
            for (int i = 0; i < buff.Length; i++)
            {
                if (buff[i] > 127)
                    mySByte[i] = (sbyte)(buff[i] - 256);
                else
                    mySByte[i] = (sbyte)buff[i];
            }
        ...
        {
            DateTime date = FS.FrameWork.Function.NConvert.ToDateTime(strBirthday);
        ...
        #region ZIP // {ACB49EE2-E85B-4AA0-96CB-2EE7912AA5E8}
        /// <summary>
        ///     压缩文件为zip包
        /// </summary>
