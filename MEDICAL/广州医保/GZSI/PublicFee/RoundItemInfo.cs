...
namespace GZSI.PublicFee
{
    public class RoundItemInfo
    {
        ...
        public void OutPatientFeeRoundOff(FS.HISFC.Models.Registration.Register r, decimal payCost, decimal pubCost, ref FS.HISFC.Models.Fee.Outpatient.FeeItemList feeItemList, string recipeSequence)
        {
