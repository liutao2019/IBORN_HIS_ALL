...
{
    /// <summary>
    /// [功能描述: 医保清单汇总清单本地实例化]<br></br>
    /// [创 建 者: hyg]<br></br>
    /// [创建时间: 2019-11]<br></br>
    /// {DB2F2D38-B825-436d-B4C2-6BBC8BB720DB}
    /// </summary>
    public partial class ucInPatientFeeDetailBill : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        /// <summary>
        /// 汇总清单
        /// </summary>
        ...
        public int ShowBill(ArrayList alData, FS.HISFC.Models.RADT.PatientInfo patient)
        {
            ...
            this.lblAge.Text += this.constantMgr.GetAge(patient.Birthday, false);
        ...
        public int Export()
        {
            try
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    neuSpread1.SaveExcel(fileName,FarPoint.Excel.ExcelSaveFlags.DataOnly);
