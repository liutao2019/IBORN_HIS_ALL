...
namespace IBorn.SI.GuangZhou.Controls
{
    ...
    /// 查询广州医保门诊登记信息
    /// </summary>
    public partial class ucGetSiRegInfoOutPatient : System.Windows.Forms.UserControl
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public ucGetSiRegInfoOutPatient()
        {
            InitializeComponent();
        }
        ...
        /// 当前患者的医保登记信息
        /// </summary>
        private FS.HISFC.Models.Registration.Register selectedInsReg = null;

        /// <summary>
        /// 当前患者的医保登记信息
        /// </summary>
        public FS.HISFC.Models.Registration.Register SelectedInsReg
        {
        ...
        /// 广州医保的住院登记列表
        /// </summary>
        private List<FS.HISFC.Models.Registration.Register> insRegList = null;
        ...
        private void Clear()
        {
            ...
            this.insRegList = new List<FS.HISFC.Models.Registration.Register>();
            this.dtInsReg.Clear();
        ...
        public void DisplayInsReg(List<FS.HISFC.Models.Registration.Register> listInsReg)
        {
            if (listInsReg == null || listInsReg.Count <= 0)
            {
                return;
            }
            listInsReg = listInsReg.OrderBy(m => (m.SeeDoct.OperTime)).ToList<FS.HISFC.Models.Registration.Register>();
            foreach (FS.HISFC.Models.Registration.Register item in listInsReg)
            {
                ...
                dr["登记时间"] = item.DoctorInfo.SeeDate;
        ...
        private void QueryInsRegInfo(string inputCode)
        {
            ...
            IBorn.SI.GuangZhou.OutPatient.GetRegisterList getRegisterManager = new IBorn.SI.GuangZhou.OutPatient.GetRegisterList();
