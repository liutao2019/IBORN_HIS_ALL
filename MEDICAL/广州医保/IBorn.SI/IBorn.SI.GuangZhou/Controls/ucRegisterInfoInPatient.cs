...
namespace IBorn.SI.GuangZhou.Controls
{
    ...
    /// 显示医保登记信息
    /// </summary>
    public partial class ucRegisterInfoInPatient : System.Windows.Forms.UserControl
    {
        ...
        public ucRegisterInfoInPatient()
        {
            InitializeComponent();
        ...
        private FS.HISFC.Models.RADT.PatientInfo register = null;

        public FS.HISFC.Models.RADT.PatientInfo Register
        {
            get
            {
                return register;
        ...
        public int Refreash()
        {
            ...
            this.txtPatientInfo.Text = string.Format("{0} 住院号：{1} 身份证号：{2}", register.Name, register.PID.PatientNO, register.IDCard);
            IBorn.SI.GuangZhou.InPatient.GetRegister getRegisterManager = new IBorn.SI.GuangZhou.InPatient.GetRegister();
            //就诊类别:1.住院2.门诊特定项目3.门诊4.药店  register.SIMainInfo.MedicalType.ID          
            int i = getRegisterManager.CallService(register, ref register, register.IDCard, register.PVisit.InTime.ToString("yyyy-MM-dd HH:mm:ss"), this.register.SIMainInfo.MedicalType.ID, register.Name);
            if (i < 0)
            {
        ...
        private void RefreashSuccess()
        {
            ...
            //this.register.SIMainInfo.MedicalType.ID == "2" ? "门诊特定项目" : "普通住院";            
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            if (this.register != null)
            {
                ucGetSiRegInfoInPatient ucGetSiRegInfoOutPatient = new ucGetSiRegInfoInPatient();
                ...
                ucGetSiRegInfoOutPatient.BeginTime = register.PVisit.InTime;
