...
{
    public partial class ucBalanceInPatient : System.Windows.Forms.UserControl
    {
        ...
        private FS.HISFC.Models.RADT.PatientInfo rInfo = new FS.HISFC.Models.RADT.PatientInfo();//住院信息        
        ...
        /// 住院信息
        /// </summary>
        public FS.HISFC.Models.RADT.PatientInfo RInfo
        {
            set
            {
                this.rInfo = value;
