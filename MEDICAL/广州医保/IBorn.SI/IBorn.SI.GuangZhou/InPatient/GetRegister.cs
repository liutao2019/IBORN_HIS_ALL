...
{
    public class GetRegister : IBorn.SI.GuangZhou.AbstractService<FS.HISFC.Models.RADT.PatientInfo, FS.HISFC.Models.RADT.PatientInfo>
    {
        ...
        protected override int GetResult(System.Data.DataTable dt, FS.HISFC.Models.RADT.PatientInfo t, ref FS.HISFC.Models.RADT.PatientInfo reg, params object[] appendParams)
        {
            if (dt == null)
            {
