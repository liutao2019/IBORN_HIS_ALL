...
namespace API.GZSI.Models.Request
{
    ...
    /// 结算清单上传实体
    /// </summary>
    public class RequestGzsiModel4101A
    {
        /// <summary>
        /// 结算清单信息
        /// </summary>
        ...
        public List<Bldinfo> bldinfo { get; set; }
        ...
        {
            public string psn_no { get; set; }  //3 人员编号   Y
            ...
            public string mul_nwb_bir_wt { get; set; }  //32 多新生儿出生体重   
            public string mul_nwb_adm_wt { get; set; }  //33 多新生儿入院体重   
            ...
            public string resp_nurs_code { get; set; }  //81 责任护士代码   Y　
            public string stas_type { get; set; }  //82 状态分类   
        }
        ...
        public class Oprninfo
        {
            ...
            public string oprn_oprt_begntime { get; set; }  //10 手术操作开始时间   
            public string oprn_oprt_endtime { get; set; }  //10 手术操作结束时间   
            public string anst_begntime { get; set; }  //10 麻醉开始时间   
            public string anst_endtime { get; set; }  //10 麻醉结束时间   
        ...
        {
            public string bld_cat { get; set; }  //1    输血品种   Y
            public string bld_amt { get; set; }  //2    输血量   Y
            public string bld_unt { get; set; }  //3    输血计量单位   Y
            public string scs_cutd_sum_dura { get; set; }  //4    重症监护合计时长   Y
        }
    }
}
