...
{
    public class ResponseGzsiModel1316:ResponseBase
    {
        public List <Output> output { get; set; }

        public class Output
        {
            public string med_list_codg { get; set; }//1-医疗目录编码     Y
            public string hilist_code { get; set; }//2-医保目录编码     Y
            public string list_type { get; set; }//3-目录类别     Y
            ...
            public string memo { get; set; }//7-备注     N
            ...
            public string poolarea_no { get; set; }//19-统筹区     N
        }
    }
}
