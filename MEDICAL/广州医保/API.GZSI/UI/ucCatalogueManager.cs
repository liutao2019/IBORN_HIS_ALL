...
{
    public partial class ucCatalogueManager : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        #region 对照类型枚举
        ...
        {
            this.toolBarService.AddToolButton("条目对照", "条目对照", FS.FrameWork.WinForms.Classes.EnumImageList.B保存, true, false, null);
            this.toolBarService.AddToolButton("删除对照", "删除对照", FS.FrameWork.WinForms.Classes.EnumImageList.Q取消, true, false, null);
            this.toolBarService.AddToolButton("更新目录", "更新目录", FS.FrameWork.WinForms.Classes.EnumImageList.S刷新, true, false, null);
            this.toolBarService.AddToolButton("下载目录", "下载目录", FS.FrameWork.WinForms.Classes.EnumImageList.D导入, true, false, null);
        ...
        public override void ToolStrip_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            switch (e.ClickedItem.Text)
            {
                ...
                case "删除对照":
                    ...
                    break;
                case "更新目录":
                    frmCatalogueDownload frmCatalogueDownload = new frmCatalogueDownload();
                    frmCatalogueDownload.ShowDialog();
                    break;
                case "目录下载":
                    break;
                case "清空":
        ...
        public void Compare()
        {
            ...
            if (isLoadDrug)
            {
                ...
                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                //{B44C94D3-354E-44be-9D16-1B0F52090CAC}
        ...
        //Upload5163 upload5163 = new Upload5163();
        //    Models.Request.RequestGzsiModel5163 requestGzsiModel5163 = new API.GZSI.Models.Request.RequestGzsiModel5163();
        //    Models.Response.ResponseGzsiModel5163 responseGzsiModel5163 = new Models.Response.ResponseGzsiModel5163();

        //    API.GZSI.Models.Request.RequestGzsiModel5163.CataLog cataLog = new API.GZSI.Models.Request.RequestGzsiModel5163.CataLog();
        //    cataLog.fixmedins_hilist_id = "";
        //    cataLog.fixmedins_hilist_name = "";
        //    cataLog.list_type = "";
        //    cataLog.med_list_codg = "";
        //    cataLog.chk_stas = "";
        //    cataLog.begnrow = "0";

        //    requestGzsiModel5163.catalog = cataLog;

        //    returnvalue = upload5163.CallService(requestGzsiModel5163, ref responseGzsiModel5163, SerialNumber, strTransVersion, strVerifyCode);
