...
{
    public partial class frmCatalogueQuery : Form
    {
        /// <summary>
        /// 业务回滚管理类
        /// </summary>
        ...
        private void btn_Click(object sender, EventArgs e)
        {
            ...
            {
                case "1304":
                    Models.Response.ResponseGzsiModel1304 outParamload1304 = p.Download_1304();
                    if (outParamload1304 == null || outParamload1304.output == null)
                    {
                        MessageBox.Show("下载失败。", "提示");
                        return;
                    }
                    // 显示数据
                    List<Models.Response.ResponseGzsiModel1304.Data> listUserClass = new List<Models.Response.ResponseGzsiModel1304.Data>();
                    listUserClass.Add(outParamload1304.output.data);
                    dgvResult.DataSource = listUserClass;
                    break;
                case "1312":
                    List<Models.Response.ResponseGzsiModel1312.Output> outParamloadList = new List<Models.Response.ResponseGzsiModel1312.Output>();
                    outParamloadList = p.Download_1312();
                    dgvResult.DataSource = outParamloadList;
                    break;
                case "1316":
                    Models.Response.ResponseGzsiModel1316 outParamload1316 = p.Download_1316();
                    if (outParamload1316 == null || outParamload1316.output == null)
                    {
                        MessageBox.Show("下载失败。", "提示");
                        return;
                    }
                    // 显示数据
                    BindingList<Models.Response.ResponseGzsiModel1316.Output> BList1316 = new BindingList<Models.Response.ResponseGzsiModel1316.Output>(outParamload1316.output);//赋值给BindingList对象,Form全局变量
                    dgvResult.DataSource = BList1316;
                    break;
                case "1317":
                    Models.Response.ResponseGzsiModel1317 outParamload1317 = p.Download_1317();
                    if (outParamload1317 == null || outParamload1317.output == null)
                    {
                        MessageBox.Show("下载失败。", "提示");
                        return;
                    }
                    // 显示数据
                    BindingList<Models.Response.ResponseGzsiModel1317.Output> BList1317 = new BindingList<Models.Response.ResponseGzsiModel1317.Output>(outParamload1317.output);//赋值给BindingList对象,Form全局变量
                    dgvResult.DataSource = BList1317;
                    break;
                case "1318":

                    Models.Response.ResponseGzsiModel1318 outParamload1318 = p.Download_1318();
                    if (outParamload1318 == null || outParamload1318 == null)
                    {
                        MessageBox.Show("下载失败。", "提示");
                        return;
                    }
                    // 显示数据
                    BindingList<Models.Response.ResponseGzsiModel1318.Output> BList1318 = new BindingList<Models.Response.ResponseGzsiModel1318.Output>(outParamload1318.output);//赋值给BindingList对象,Form全局变量
                    dgvResult.DataSource = BList1318;
                    break;
                case "1319":
                    Models.Response.ResponseGzsiModel1319 outParamload1319 = p.Download_1319();
                    if (outParamload1319 == null || outParamload1319 == null)
                    {
                        MessageBox.Show("下载失败。", "提示");
                        return;
                    }
                    // 显示数据
                    BindingList<Models.Response.ResponseGzsiModel1319.Output> BList1319 = new BindingList<Models.Response.ResponseGzsiModel1319.Output>(outParamload1319.output);//赋值给BindingList对象,Form全局变量
                    dgvResult.DataSource = BList1319;
                    break;                
            }
            return;
        }
