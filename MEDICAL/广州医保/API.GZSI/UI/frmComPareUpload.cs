...
{
    public partial class frmComPareUpload : Form
    {
        /// <summary>
        /// 业务回滚管理类
        /// </summary>
        ...
        private void btn_Click(object sender, EventArgs e)
        {
            ...
            {
                case "3301":
                    Models.Request.RequestGzsiModel3301 requestGzsiModel3301 = new Models.Request.RequestGzsiModel3301();
                    Models.Request.RequestGzsiModel3301.Catalogcompin cc = new Models.Request.RequestGzsiModel3301.Catalogcompin();
                    cc.fixmedinsHilistId = "Y00000000029";
                    cc.fixmedinsHilistName = "阿奇霉素片(希舒美Zithromax)";
                    cc.listType = "101";//101 西药
                    cc.medListCodg = "XJ01FAA051A001010201187";
                    cc.drugadm_strdcod = "86901187000015";
                    cc.begndate = "2018-5-29";
                    cc.aprvno = "国药准字H10960167";
                    cc.spec = "0.25g*6片/盒";
                    cc.pric = "72.30";
                    requestGzsiModel3301.catalogcompin = new List<Models.Request.RequestGzsiModel3301.Catalogcompin>();
                    requestGzsiModel3301.catalogcompin.Add(cc);
                    CommonService3301 upload3301 = new CommonService3301();
                    Models.Response.ResponseGzsiModel3301 responseGzsiModel3301 = new Models.Response.ResponseGzsiModel3301();
                    if (upload3301.CallService(requestGzsiModel3301, ref responseGzsiModel3301) < 0)
                    {
                        MessageBox.Show("目录对照上传接口出错");
                        return;
                    }
                    break;
                case "3302":
                    Models.Request.RequestGzsiModel3302 requestGzsiModel3302 = new Models.Request.RequestGzsiModel3302();
                    Models.Request.RequestGzsiModel3302.Catalog dd = new Models.Request.RequestGzsiModel3302.Catalog();
                    dd.fixmedins_hilist_id = "Y00000000029";
                    dd.fixmedins_code = "H44010600124";
                    dd.list_type = "101";//101 西药
                    dd.med_list_codg = "XJ01FAA051A001010201187";
                    requestGzsiModel3302.catalog = dd;
                    CommonService3302 upload3302 = new CommonService3302();
                    Models.Response.ResponseGzsiModel3302 responseGzsiModel3302 = new Models.Response.ResponseGzsiModel3302();
                    if (upload3302.CallService(requestGzsiModel3302, ref responseGzsiModel3302) < 0)
                    {
                        MessageBox.Show("目录对照撤销接口出错");
                        return;
                    }
                    break;
                case "3360":
                    Models.Request.RequestGzsiModel3360 requestGzsiModel3360 = new Models.Request.RequestGzsiModel3360();
                    Models.Request.RequestGzsiModel3360.Catalog ee = new Models.Request.RequestGzsiModel3360.Catalog();
                    ee.fixmedins_hilist_id = "Y00000000029";
                    ee.fixmedins_hilist_name = "阿奇霉素片(希舒美Zithromax)";
                    ee.list_type = "101";//101 西药
                    ee.med_list_codg = "XJ01FAA051A001010201187";
                    ee.enddate = "2099-12-31";
                    requestGzsiModel3360.catalog = ee;
                    CommonService3360 upload3360 = new CommonService3360();
                    Models.Response.ResponseGzsiModel3360 responseGzsiModel3360 = new Models.Response.ResponseGzsiModel3360();
                    if (upload3360.CallService(requestGzsiModel3360, ref responseGzsiModel3360) < 0)
                    {
                        MessageBox.Show("目录对照作废接口出错");
                        return;
                    }
                    break;
        ...
        private void neuButton1_Click(object sender, EventArgs e)
        {
            ...
            Models.Request.RequestGzsiModel3301 requestGzsiModel3301 = new Models.Request.RequestGzsiModel3301();
            Models.Request.RequestGzsiModel3301.Catalogcompin cc = new Models.Request.RequestGzsiModel3301.Catalogcompin();
            cc.fixmedins_hilist_id = "Y00000000029";
            cc.fixmedins_hilist_name = "阿奇霉素片(希舒美Zithromax)";
            cc.list_type = "101";//101 西药
            cc.med_list_codg = "XJ01FAA051A001010201187";
            cc.drugadm_strdcod = "86901187000015";
            cc.begndate = "2018-5-29";
            cc.enddate = "2099-12-31";
            cc.drugadm_strdcod = string.Empty;
            cc.genname_no = string.Empty;        
            cc.aprvno = "国药准字H10960167";
            cc.dosform = "";
            cc.exept_cont = string.Empty;
            cc.item_cont = string.Empty;
            cc.prcunt = string.Empty;
            cc.pacspec = string.Empty;
            cc.memo = string.Empty;
            cc.spec = "0.25g*6片/盒";
            cc.pric = "72.30";
            requestGzsiModel3301.catalogcompin = new List<Models.Request.RequestGzsiModel3301.Catalogcompin>();
            requestGzsiModel3301.catalogcompin.Add(cc);
        ...
        private void neuButton4_Click(object sender, EventArgs e)
        {
            ...
            patient.ID = "59183";         
            Process p = new Process();
            CommonService4101 upload4101 = new CommonService4101();
            Models.Request.RequestGzsiModel4101 RequestGzsiModel4101 = new Models.Request.RequestGzsiModel4101();
            Models.Response.ResponseGzsiModel4101 ResponseGzsiModel4101 = new Models.Response.ResponseGzsiModel4101();
            Models.Request.RequestGzsiModel4101.Setlinfo setlinfo4101 = Lmr.GetSetlinfo4101(patient.ID);
            CommonService5203 upload5203 = new CommonService5203();
            ...
            Data5203.psn_no = setlinfo4101.certno;
            Data5203.setl_id = setlinfo4101.setl_id;
            Data5203.mdtrt_id = setlinfo4101.mdtrt_id;
            RequestGzsiModel5203.data = Data5203;
            if (upload5203.CallService(RequestGzsiModel5203, ref ResponseGzsiModel5203) < 0)
            {
                MessageBox.Show(upload5203.ErrorMsg);
                return ;
            }
            RequestGzsiModel5203.data = Data5203;
            if (upload5203.CallService(RequestGzsiModel5203, ref ResponseGzsiModel5203) < 0)
            ...
            RequestGzsiModel4101.setlinfo = setlinfo4101;
            List<Models.Request.RequestGzsiModel4101.Payinfo> payinfo4101 = null;
            RequestGzsiModel4101.payinfo = payinfo4101;
            List<Models.Response.ResponseGzsiModel5203.Setldetail> list = new List<Models.Response.ResponseGzsiModel5203.Setldetail>();         
            List<Models.Request.RequestGzsiModel4101.Payinfo> paylist = new List<Models.Request.RequestGzsiModel4101.Payinfo>();
            if (list.Count > 0)
            {
                foreach (Models.Response.ResponseGzsiModel5203.Setldetail item in list)
                {
                    Models.Request.RequestGzsiModel4101.Payinfo Obj = new Models.Request.RequestGzsiModel4101.Payinfo();
                    Obj.fund_pay_type = item.fund_pay_type;
                    Obj.fund_payamt = item.fund_payamt;
                    paylist.Add(Obj);
                }
            }
            payinfo4101 = paylist;
            ...
            // opspdiseinfo4101
            //List<Models.Request.RequestGzsiModel4101.Opspdiseinfo4101> opspdiseinfo4101 = Lmr.GetOpspdiseinfo4101(inPatientNo);
            //RequestGzsiModel4101.opspdiseinfo = opspdiseinfo4101;
            //List<Models.Request.RequestGzsiModel4101.Diseinfo4101> diseinfo4101 = Lmr.GetDiseinfo4101(inPatientNo);
            //RequestGzsiModel4101.diseinfo = diseinfo4101;
            //List<Models.Request.RequestGzsiModel4101.Iteminfo4101> iteminfo4101 = Lmr.GetIteminfo4101(inPatientNo);
            //RequestGzsiModel4101.iteminfo = iteminfo4101;
            //List<Models.Request.RequestGzsiModel4101.Oprninfo4101> oprninfo4101 = Lmr.GetOprninfo4101(inPatientNo);
            //RequestGzsiModel4101.oprninfo = oprninfo4101;
            //List<Models.Request.RequestGzsiModel4101.Icuinfo4101> icuinfo4101 = Lmr.GetIcuinfo4101(inPatientNo);
            //RequestGzsiModel4101.icuinfo = icuinfo4101;

            if (upload4101.CallService(RequestGzsiModel4101, ref ResponseGzsiModel4101) < 0)
            {
                MessageBox.Show(upload4101.ErrorMsg);
                return;
            }

            if (!String.IsNullOrEmpty(ResponseGzsiModel4101.output.setl_list_id))
            {
                //if (Lmr.UpdateSiMainInfoForQD(inPatientNo, ResponseGzsiModel4101.output.setl_list_id) < 0)
                //{
                //    MessageBox.Show("变更住院主表出错！！！");
                //    return ;
                //}
            }
