...
namespace InterfaceInstanceDefault.ISplitInvoice 
{
    ...
    ///  />
    /// </summary>
    class ISplitInvoiceDefault : FS.HISFC.BizProcess.Interface.FeeInterface.ISplitInvoice
    {
        ...
        public ArrayList SplitInvoice(FS.HISFC.Models.Registration.Register register, ref ArrayList feeItemLists)
        {
            ...
            bool isSplitByFeeStatCate = controlParamIntegrate.GetControlParam<bool>(FS.HISFC.BizProcess.Integrate.Const.IS_SPLIT_INVOICE_BY_FEECODE, false, false);
