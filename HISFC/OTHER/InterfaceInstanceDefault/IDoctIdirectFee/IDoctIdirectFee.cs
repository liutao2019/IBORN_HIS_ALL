...
namespace InterfaceInstanceDefault.IDoctIdirectFee
{
    ...
    /// 医生站直接收费
    /// </summary>
    public class IDoctIdirectFee : FS.HISFC.BizProcess.Interface.FeeInterface.IDoctIdirectFee
    {
        ...
        /// 药品综合业务层
        /// </summary>
        private FS.HISFC.BizProcess.Integrate.Pharmacy pharmarcyManager = new FS.HISFC.BizProcess.Integrate.Pharmacy();
        ...
        /// 费用业务层
        /// </summary>
        private FS.HISFC.BizLogic.Fee.Outpatient outPatientFee = new FS.HISFC.BizLogic.Fee.Outpatient();
        ...
        /// 退费申请业务层
        /// </summary>
        private FS.HISFC.BizLogic.Fee.ReturnApply returnApplyManager = new FS.HISFC.BizLogic.Fee.ReturnApply();
        ...
        /// <returns></returns>
        private bool SplitFeeItemList(FS.HISFC.Models.Registration.Register r, ArrayList feeItemLists,ref string errText)
        {
            ...
            foreach (FeeItemList f in feeItemLists)
            {
                ...
                if (r.Pact.ID == "6" || r.Pact.ID == "7")
                {
                    ...
                    {
                        FS.HISFC.Models.Pharmacy.Item item = pharmarcyManager.GetItem(f.Item.ID);
                        if (item == null)
                        {
        ...
        /// </summary>
        /// <returns></returns>
        private bool IdirectFee(FS.HISFC.Models.Registration.Register r, DateTime FeeTime, ref string errText)
        {
            //删除申请数据
            #region 删除申请表
        ...
        /// </summary>
        /// <returns></returns>
        private int CancelOrderConfirm(FS.HISFC.Models.Registration.Register r,FeeItemList f,DateTime cancelTime, ref string errText)
        {
        ...
        /// <returns></returns>
        private int CancelFeeItemList(FS.HISFC.Models.Registration.Register r, FeeItemList f, DateTime cancelTime, ref string errText)
        {
            if (r.Pact.ID == "8")
            {
        ...
        /// <returns></returns>
        private int CancelOrderNOConfirm(FS.HISFC.Models.Registration.Register r,FeeItemList f, DateTime cancelTime, ref string errText)
        {
            if (f.NoBackQty == 0)
            {
                if (f.Item.ItemType == EnumItemType.Drug)
        ...
        public int DoctIdirectFee(FS.HISFC.Models.Registration.Register r, System.Collections.ArrayList feeItemLists, DateTime FeeTime, ref string errText)
        {
            //这都是些什么啊，垃圾，屏蔽
            //普通患者
        ...
        public int UpdateOrderFee(Register r, ArrayList alOrder, DateTime feeTime, ref string errText)
        {
            ...
            //    {
            //        FS.HISFC.Models.Order.OutPatient.Order tempOrder = alOrder[k] as FS.HISFC.Models.Order.OutPatient.Order;

            //        foreach (FS.HISFC.Models.Fee.Outpatient.FeeItemList feeitem in noFeeList)
            //        {
        ...
        /// <param name="errText">错误信息</param>
        /// <returns></returns>
        public int CancelOrder(Register r, FS.HISFC.Models.Order.OutPatient.Order order, ref string errText)
        {
            ////普通患者
            //if (r.Pact.ID == "6" || r.Pact.ID == "7" || r.Pact.ID == "8")
            //{
