...
{
    public class IQueryGFPatientDefault : FS.HISFC.BizProcess.Interface.IQueryGFPatient
    {
        #region IQueryGFPatient 成员

        public int QueryGFPatient(FS.HISFC.Models.RADT.PatientInfo patient, ref string errText, params string[] args)
        {
    ...
    public class GFPatientManager : FS.FrameWork.Management.Database
    {
