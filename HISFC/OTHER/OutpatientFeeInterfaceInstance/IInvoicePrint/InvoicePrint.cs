...
namespace OutpatientInvoicePrint
{
	...
	/// ucInvoiceGY 的摘要说明。
	/// </summary>
    public class ucInvoiceGY : System.Windows.Forms.UserControl, FS.HISFC.BizProcess.Interface.FeeInterface.IInvoicePrint, FS.FrameWork.WinForms.Forms.IInterfaceContainer
	{
		#region windows代码
			...
			ArrayList alInvoiceDetail, ArrayList alFeeItemList, bool isPreview)
		{
            ...
            this.lblPriCost4.Text = FS.FrameWork.Public.String.FormatNumberReturnString(ZFPha, 2);
...
　　　　　　FS.HISFC.BizLogic.Fee.Outpatient  myOutPatient = new FS.HISFC.BizLogic.Fee.Outpatient ();
            ...
            for (int i = 0; i < al.Count; i++)
            {
                ...
                strPayMode += " " + helper.GetObjectFromID(payMode.PayType.ID.ToString()).Name;// +" ";//+FS.FrameWork.Public.String.FormatNumber(payMode.Cost,2);//结算操作员
            }
            ...
            //    else
            //    {
            //        lblFeeCost.Text = FS.FrameWork.Public.String.FormatNumberReturnString(detail.BalanceBase.FT.PayCost + detail.BalanceBase.FT.PubCost, 2);
            //        detail.CTFee = 0;
            //        detail.MRIFee = 0;
            //        //detail.PETFee = 0;
            //        detail.SXFee = 0;
            ...
            //        FS.FrameWork.Function.NConvert.ToDecimal(this.lblPriCost11.Text.Trim())).ToString();
            //}
            //if (ZLTotFee > 0)
            //{
            ...
            //        FS.FrameWork.Function.NConvert.ToDecimal(this.lblPriCost17.Text.Trim())).ToString();
            //}
			if(FS.FrameWork.Function.NConvert.ToDecimal(this.lblPriCost4.Text.Trim()) > 0)
			{
            ...
            {
                if (FS.FrameWork.Function.NConvert.ToDecimal(this.lblPriCost5.Text.Trim()) > 0)
                {
			...
			if(FS.FrameWork.Function.NConvert.ToDecimal(this.lblPriCost24.Text.Trim()) > 0)
			{
            ...
            if (FS.FrameWork.Function.NConvert.ToDecimal(this.lblPriCost8.Text.Trim()) > 0)
            {
            ...
            this.lblPriCost7.Text = DealedCost.ToString();//FS.FrameWork.Public.String.FormatNumberReturnString(DealedCost,2);
            if (FS.FrameWork.Function.NConvert.ToDecimal( this.lblPriCost7.Text.Trim() ) != 0)
            {
            ...
            {
                this.lblPriPub.Text = FS.FrameWork.Public.String.FormatNumberReturnString(invoice.FT.PubCost, 2) + " 医保合计:" + FS.FrameWork.Public.String.FormatNumberReturnString(invoice.FT.PubCost + invoice.FT.PayCost, 2);
                //根据合同单位获取自付比例
                ...
                {
                    this.lblPriPay.Text = FS.FrameWork.Public.String.FormatNumberReturnString( DealOwnPay, 2 ) + " (" + FS.FrameWork.Public.String.FormatNumberReturnString( pactObj.Rate.PayRate * 100, 0 ).Replace( ".", "" ) + "%:" + FS.FrameWork.Public.String.FormatNumberReturnString( invoice.FT.PayCost, 2 ) + ")";
                }
                else
                {
            ...
            else if (regInfo.Pact.PayKind.ID == "02")
            {
                ...
                //{
                //    this.lblPriPay.Text = FS.FrameWork.Public.String.FormatNumberReturnString(DealOwnPay, 2)+"("+invoice.FT.PayCost.ToString()+
		...
		public int Print()
		{
			try
			{
				...
				FS.HISFC.Components.Common.Classes.Function.GetPageSize("MZINVOICE", ref print, ref this.trans);
		...
		public int PrintOtherInfomation()
		{
			...
			//FS.HISFC.Components.Common.Classes.Function.GetPageSize("MZFEEDETAIL", ref print, ref this.trans);
        ...
        string FS.HISFC.BizProcess.Interface.FeeInterface.IInvoicePrint.Description
        {
            get { return null; }
        }

        //string FS.HISFC.BizProcess.Interface.FeeInterface.IInvoicePrint.InvoiceType
        //{
        //    get { return null; }
        //}
