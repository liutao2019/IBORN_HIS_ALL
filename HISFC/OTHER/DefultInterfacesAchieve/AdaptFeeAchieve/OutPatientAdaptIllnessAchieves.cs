...
namespace FS.DefultInterfacesAchieve.AdaptFeeAchieve
{
    ...
    public  class OutPatientAdaptIllnessAchieves:FS.HISFC.BizProcess.Interface.FeeInterface.IAdptIllnessOutPatient
    {
        ...
        /// <returns></returns>
        public int SaveOutPatientFeeDetail(FS.HISFC.Models.Registration.Register registerObj, ref System.Collections.ArrayList alOutFeeDetail)
        {
            Function.SISpecialLimit myManager = new FS.DefultInterfacesAchieve.Function.SISpecialLimit();

            foreach (FS.HISFC.Models.Fee.Outpatient.FeeItemList feeItemList in alOutFeeDetail)
            {
        ...
        /// <returns></returns>
        public int ProcessOutPatientFeeDetail(FS.HISFC.Models.Registration.Register registerObj, ref FS.HISFC.Models.Fee.Outpatient.FeeItemList outFeeDetail)
        {
        ...
        private int QueryItem(FS.HISFC.Models.Registration.Register registerObj, FS.HISFC.Models.Fee.Outpatient.FeeItemList feeitemlist, ref string practicableSymptomText)
        {
