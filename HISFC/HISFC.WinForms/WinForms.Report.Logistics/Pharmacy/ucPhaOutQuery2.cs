...
{
    public partial class ucPhaOutQuery2 : FSDataWindow.Controls.ucQueryBaseForDataWindow
    {       
        #region 变量
        /// <summary>
        /// 综合业务层实例
        ...
        public ucPhaOutQuery2()
        {
            InitializeComponent();
        }

        private void ucPhaOutQuery2_Load(object sender, EventArgs e)
        {
            this.isAcross = true;
            this.isSort = false;
