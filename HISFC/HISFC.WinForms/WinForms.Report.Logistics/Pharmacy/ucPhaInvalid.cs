...
{
    public partial class ucPhaInvalid : FSDataWindow.Controls.ucQueryBaseForDataWindow//Common.ucQueryBaseForDataWindow
    {
        public ucPhaInvalid()
        {
            InitializeComponent();
        ...
        protected override int OnRetrieve(params object[] objects)
        {
            ...
            return base.OnRetrieve(neuDateTimePicker1.Value, deptCode);
        }
    }
}
