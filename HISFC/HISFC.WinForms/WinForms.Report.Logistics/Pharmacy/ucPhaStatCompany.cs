...
{
    public partial class ucPhaStatCompany : FSDataWindow.Controls.ucQueryBaseForDataWindow
    {
        public ucPhaStatCompany()
        {
            InitializeComponent();
        ...
        protected override int OnRetrieve(params object[] objects)
        {
            ...
            return base.OnRetrieve(deptCode,base.beginTime, base.endTime,deptName);
        }
    }
}
