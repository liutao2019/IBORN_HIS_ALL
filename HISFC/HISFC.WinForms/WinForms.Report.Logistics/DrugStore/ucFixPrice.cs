...
{      
	...
	/// liangjz 2005-12
	/// </summary>    
    public partial class ucFixPrice : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucFixPrice()
        {
            InitializeComponent();
        ...
        protected FS.HISFC.BizLogic.Pharmacy.Item myItem = new FS.HISFC.BizLogic.Pharmacy.Item();
		...
		public void AddData(FS.HISFC.Models.Pharmacy.Item item)
		{
			if (item == null)
				return;
		...
		/// </summary>
		/// <param name="item">药品实体</param>
		public void AddData(FS.HISFC.Models.Pharmacy.Item item,string deptCode)
		{
			if (item == null)
				return;
			...
			//add by zengft 2007-4-30
			FS.HISFC.BizLogic.Pharmacy.Item itm = new FS.HISFC.BizLogic.Pharmacy.Item();
			FS.HISFC.Models.Pharmacy.Storage s = new FS.HISFC.Models.Pharmacy.Storage();
		...
		public void DelData()
		{
			if (this.fpSpread1_Sheet1.Rows.Count <= 0)
				return;
			decimal retailPrice = FS.FrameWork.Function.NConvert.ToDecimal(this.fpSpread1_Sheet1.Cells[this.fpSpread1_Sheet1.ActiveRowIndex,(int)ColEnum.ColPrice].Text);
			decimal num = 0;
			try
			{
				num = FS.FrameWork.Function.NConvert.ToDecimal(this.fpSpread1_Sheet1.Cells[this.fpSpread1_Sheet1.ActiveRowIndex,(int)ColEnum.ColNum].Text);
			}
			catch
			{
				num = 0;
		...
		public void Sum()
		{
			...
			{
				cost = cost + FS.FrameWork.Function.NConvert.ToDecimal(this.fpSpread1_Sheet1.Cells[i,(int)ColEnum.ColCost].Text);
                //try
                //{
                //    num = FS.FrameWork.Function.NConvert.ToDecimal(this.fpSpread1_Sheet1.Cells[i,(int)ColEnum.ColNum].Text);
                //}
                //catch
                //{
                //    num = 0;
                ...
                //FS.HISFC.Models.Pharmacy.Item item = this.fpSpread1_Sheet1.Rows[i].Tag as FS.HISFC.Models.Pharmacy.Item;
		...
		public void Count()
		{
            ...
            FS.HISFC.Models.Pharmacy.Item item = this.fpSpread1_Sheet1.Rows[this.fpSpread1_Sheet1.ActiveRowIndex].Tag as FS.HISFC.Models.Pharmacy.Item;
        ...
        private void ucDrugList1_ChooseDataEvent(FarPoint.Win.Spread.SheetView sv, int activeRow)
        {
            ...
            FS.HISFC.Models.Pharmacy.Item item = this.myItem.GetItem(drugCode);

            this.AddData(item,((FS.HISFC.Models.Base.Employee)myItem.Operator).Dept.ID);
        ...
        {
            toolBarService.AddToolButton("新建", "新建", FS.FrameWork.WinForms.Classes.EnumImageList.T添加, true, false, null);
