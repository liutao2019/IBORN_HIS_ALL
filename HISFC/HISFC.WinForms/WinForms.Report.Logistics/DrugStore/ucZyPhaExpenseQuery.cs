...
namespace FS.Report.Logistics.DrugStore
{
    ...
    /// [创建时间: 2009-07]<br></br>
    /// </summary>
    public partial class ucZyPhaExpenseQuery : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public ucZyPhaExpenseQuery()
        {
            InitializeComponent();
        }
        ...
        protected int Query()
        {
            ...
            //    return -1;
            //}
            if(this.neuRadioButton1.Checked == true){
                if (this.dt_begin_quest.Value > this.dt_end_quest.Value)
                {
                    MessageBox.Show("请求时间的开始时间不能大于结束时间");
                }

            }
            
            if(this.neuRadioButton2.Checked ==true){
                 if(this.dt_begin_send.Value>this.dt_end_send.Value){
                    MessageBox.Show("发送时间的开始时间不能大于结束时间");
                }
            }
        ...
        public void Print()
        {
            FS.FrameWork.WinForms.Classes.Print print = new FS.FrameWork.WinForms.Classes.Print();
            print.ControlBorder = FS.FrameWork.WinForms.Classes.enuControlBorder.None;
            print.PrintPage(30, 10, this.plPrint);
        ...
        protected override int OnPrintPreview(object sender, object neuObject)
        {
            ...
            return printer.PrintPreview(10, 10, this.plPrint);
        }
