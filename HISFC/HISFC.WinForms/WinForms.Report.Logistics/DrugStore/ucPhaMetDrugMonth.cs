...
namespace Report.Logistics.DrugStore
{
    public partial class ucPhaMetDrugMonth : FSDataWindow.Controls.ucQueryBaseForDataWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            deptList = deptManager.GetDeptment(FS.HISFC.Models.Base.EnumDepartmentType.P);//药房
            deptListYK = deptManager.GetDeptment(FS.HISFC.Models.Base.EnumDepartmentType.PI);//药库          
