...
namespace FS.HISFC.WinForms.WorkStation
{
    ...
    internal partial class frmWorkStationSet : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.SaveSetting( obj, this.xml );
        ...
        private void fpSpread1_ButtonClicked(object sender, FarPoint.Win.Spread.EditorNotifyEventArgs e)
        {
                ...
                Control c = FS.FrameWork.WinForms.Classes.Function.CreateControl(dllName, controlName);
                if (c == null) return;
                ...
                FS.FrameWork.WinForms.Classes.Function.PopShowControl(property);
