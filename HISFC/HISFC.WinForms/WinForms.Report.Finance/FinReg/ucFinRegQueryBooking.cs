...
namespace FS.Report.Finance.FinReg
{
    ...
    /// 预约情况查询
    /// </summary>
    public partial class ucFinRegQueryBooking : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucFinRegQueryBooking()
        {
            InitializeComponent();
        ...
        private FS.FrameWork.Public.ObjectHelper objHelper =null;       
        /// <summary>
        /// 初始化
        /// </summary>
        private void init()
        ...
        private void addDetail(ArrayList al)
        {
            ...
            {
                this.objHelper = new FS.FrameWork.Public.ObjectHelper(this.interMgr.QueryEmployeeAll());
            }
