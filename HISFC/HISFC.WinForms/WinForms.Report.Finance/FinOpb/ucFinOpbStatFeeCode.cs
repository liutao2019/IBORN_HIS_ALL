...
{
    public partial class ucFinOpbStatFeeCode : FS.HISFC.Components.Common.Report.ucCrossQueryBaseForFarPoint
    {
        public ucFinOpbStatFeeCode()
        {
            InitializeComponent();
        }
        ...
        protected override int OnQuery(object sender, object neuObject)
        {
            ...
            if (comDept.Items[comDept.SelectedIndex]== "按挂号科室查询")
            {
                ...
                this.QuerySql = "WinForms.Report.Finance.FinOpb.ucFinOpbFeeCodeREGDept";
            ...
            {
                this.QuerySqlTypeValue = QuerySqlType.id;
                this.QuerySql = "WinForms.Report.Finance.FinOpb.ucFinOpbFeeCodeEXEDept";
                this.DataCrossValues = "2";
                this.DataCrossColumns = "1";
                this.DataCrossRows = "0";
            }
            if (comDept.Items[comDept.SelectedIndex] == "按执行科室查询")
            {
                ...
                this.QuerySqlTypeValue = QuerySqlType.id;
                this.QuerySql = "WinForms.Report.Finance.FinOpb.ucFinOpbFeeCodeDOCDept";
                this.DataCrossValues = "2";
                this.DataCrossColumns = "1";
                this.DataCrossRows = "0";
            }
