...
namespace FS.WinForms.Report.Finance.FinOpb
{
    ...
    /// 科室收费人数统计表---按照合同单位过滤
    /// </summary>
    public partial class ucDeptFeeNum :FS.HISFC.Components.Common.Report.ucQueryBaseForFarPoint
    {
        public ucDeptFeeNum()
        {
            InitializeComponent();
        ...
        protected override void OnLoad()
        {
           ...
           // cmbPact.Items.Add();
            ...
            FS.HISFC.Models.Base.PactInfo tmpPactInfo = new FS.HISFC.Models.Base.PactInfo();
            tmpPactInfo.ID = "ALL";
            tmpPactInfo.Name = "全部";
            ...
            foreach (FS.HISFC.Models.Base.PactInfo pact in alPactList)
            {
            ...
            if (cmbPact.Items.Count >= 0)
            {
                ...
                pactCode = ((FS.HISFC.Models.Base.PactInfo)cmbPact.Items[0]).ID;
                pactName = ((FS.HISFC.Models.Base.PactInfo)cmbPact.Items[0]).Name;
        ...
        protected override int OnQuery(object sender, object neuObject)
        {
            ...
            QueryParams.Add(new FS.FrameWork.Models.NeuObject("", pactCode, ""));
        ...
        {
            pactCode = ((FS.HISFC.Models.Base.PactInfo)this.cmbPact.Items[this.cmbPact.SelectedIndex]).ID;
            pactName = ((FS.HISFC.Models.Base.PactInfo)this.cmbPact.Items[this.cmbPact.SelectedIndex]).Name;
