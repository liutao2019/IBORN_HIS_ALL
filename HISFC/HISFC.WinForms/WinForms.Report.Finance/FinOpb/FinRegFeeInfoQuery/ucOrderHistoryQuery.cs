...
namespace FS.WinForms.Report.Finance.FinOpb.FinRegFeeInfoQuery
{
    ...
    ///  />
    /// </summary>
    public partial class ucOrderHistoryQuery : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            try
            {
                ...
                FS.HISFC.Components.Common.Classes.Function.ShowOrder(this.fpSpread1_Sheet1, al, FS.HISFC.Models.Base.ServiceTypes.C);
        ...
        public FS.HISFC.Models.Registration.Register Patient
        {
            set
            {
                ...
                foreach (FS.FrameWork.Models.NeuObject obj in al)
                {
                    ...
                    //if (obj.ID != value.ID)
                    //{
                    FS.HISFC.Models.Registration.Register reg = obj as FS.HISFC.Models.Registration.Register;
