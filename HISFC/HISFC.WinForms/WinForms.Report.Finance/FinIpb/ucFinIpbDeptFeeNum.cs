...
{
    public partial class ucFinIpbDeptFeeNum : FSDataWindow.Controls.ucQueryBaseForDataWindow 
    {
        ...
        private void cmbReport_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //    //FS.HISFC.Models.Base.Const constObj = new FS.HISFC.Models.Base.Const();
            //    //foreach (FS.HISFC.Models.Fee.FeeCodeStat feeStatObj in feeStatArry)
            //    //{
            //    //    constObj.ID = feeStatObj.StatCate.ID;
            //    //    constObj.Name = feeStatObj.StatCate.Name;
