...
{
    public partial class ucFinIpbDeptDrugDetail : FSDataWindow.Controls.ucQueryBaseForDataWindow  
    {
        /// <summary>
        /// 全院科室药品费用明细查询
        /// </summary>
        ...
        protected override void OnLoad()
        {
            ...
            FS.HISFC.BizProcess.Integrate.Manager managers = new FS.HISFC.BizProcess.Integrate.Manager();
            System.Collections.ArrayList constantList1 = manager.GetDepartment();

            this.neuComboBox2.Items.Add(top);
            foreach (FS.HISFC.Models.Base.Department con in constantList1)
            {
            ...
            if (neuComboBox2.Items.Count > 0)
            {
                ...
                execcode = ((FS.HISFC.Models.Base.Department)neuComboBox2.Items[0]).ID;
                execname = ((FS.HISFC.Models.Base.Department)neuComboBox2.Items[0]).Name;
            }

            FS.HISFC.BizProcess.Integrate.Manager manageres = new FS.HISFC.BizProcess.Integrate.Manager();
            System.Collections.ArrayList constantList2 = manager.GetDepartment();

            this.neuComboBox3.Items.Add(top);
            foreach (FS.HISFC.Models.Base.Department con in constantList2)
            {
            ...
            if (neuComboBox3.Items.Count > 0)
            {
                ...
                reccode = ((FS.HISFC.Models.Base.Department)neuComboBox3.Items[0]).ID;
                recname = ((FS.HISFC.Models.Base.Department)neuComboBox3.Items[0]).Name;
            }
        }
        ...
        private void neuComboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                execcode = ((FS.HISFC.Models.Base.Department)neuComboBox2.Items[this.neuComboBox2.SelectedIndex]).ID;
                execname = ((FS.HISFC.Models.Base.Department)neuComboBox2.Items[this.neuComboBox2.SelectedIndex]).Name;
            }
        }
        ...
        private void neuComboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                reccode = ((FS.HISFC.Models.Base.Department)neuComboBox3.Items[this.neuComboBox3.SelectedIndex]).ID;
                recname = ((FS.HISFC.Models.Base.Department)neuComboBox3.Items[this.neuComboBox3.SelectedIndex]).Name;
            }
        }
