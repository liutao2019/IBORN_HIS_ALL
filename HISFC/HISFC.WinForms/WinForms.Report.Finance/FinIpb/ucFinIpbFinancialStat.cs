...
{
    public partial class ucFinIpbFinancialStat :FSDataWindow.Controls.ucQueryBaseForDataWindow 
    {
        ...
        protected override void OnLoad()
        {
            ...
            FS.HISFC.Models.Base.Const top = new FS.HISFC.Models.Base.Const();
            top.ID = "ALL";
            top.Name = "全  部";
            ...
            foreach (FS.HISFC.Models.Base.PactInfo pact in pactList)
            {
            ...
            if (ncboPact.Items.Count > 0)
            {
                ...
                pactCode = ((FS.HISFC.Models.Base.PactInfo)ncboPact.Items[0]).ID;
                pactName = ((FS.HISFC.Models.Base.PactInfo)ncboPact.Items[0]).Name;
            }
        }
