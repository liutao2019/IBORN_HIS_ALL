...
{
    public partial class ucFinIpbDeptItemDetail : FSDataWindow.Controls.ucQueryBaseForDataWindow 
    {
        /// <summary>
        /// 全院科室非药品费用明细表
        /// </summary>
        public ucFinIpbDeptItemDetail()
        {
            InitializeComponent();
        }
        ...
        private void neuTextBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("您输入的是特殊字符，请重新输入查询信息");
                return;
            }
