...
{
    public partial class ucQueryBaseForDataWindow45 : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucQueryBaseForDataWindow45()
        {
            InitializeComponent();
        }
        ...
        protected virtual int OnDrawTree() 
        {
            ...
            this.tvLeft.ImageList.Images.Add(FS.FrameWork.WinForms.Classes.Function.GetImage(FS.FrameWork.WinForms.Classes.EnumImageList.X信息));
            this.tvLeft.ImageList.Images.Add(FS.FrameWork.WinForms.Classes.Function.GetImage(FS.FrameWork.WinForms.Classes.EnumImageList.B摆药单));
        ...
        protected override int OnPrintPreview(object sender, object neuObject)
        {
            if (this.dwMain != null)
            {
                frmPreviewDataWindow45 frmPreview = new frmPreviewDataWindow45();
