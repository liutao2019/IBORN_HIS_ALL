...
namespace FS.WinForms.Report.Pharmacy
{
    ...
    public partial class ucUseDrugMonitor : FS.HISFC.Components.Pharmacy.Report.ucQueryBase
    {
        ...
        protected void Init()
        {
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm("正在加载基础查询数据 请稍候...");
            ...
            this.InitItemData(0, FS.HISFC.Components.Pharmacy.Report.CustomItemTypeEnum.Custom, "查询药品：", alData);
