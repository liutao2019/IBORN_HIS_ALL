...
namespace FS.WinForms.Report.InpatientFee
{
    ...
    ///  />
    /// </summary>
    public partial class ucPrepayPrint : FS.FrameWork.WinForms.Controls.ucBaseControl,FS.HISFC.BizProcess.Interface.FeeInterface.IPrepayPrint
    {
        ...
        public void SetPrintValue(FS.HISFC.Models.RADT.PatientInfo patient, FS.HISFC.Models.Fee.Inpatient.Prepay prepay)
        {
            #region 收据打印
            //票据号
            ...
            //预交金额
            this.lblPriJinE.Text = FS.FrameWork.Public.String.FormatNumber(prepay.FT.PrepayCost, 2).ToString();
            //预交金大写
            ...
            //预交金额
            this.lblPriJinE1.Text = FS.FrameWork.Public.String.FormatNumber(prepay.FT.PrepayCost, 2).ToString();
            //预交金大写
            ...
            //预交金额
            this.lblPriJinE2.Text = FS.FrameWork.Public.String.FormatNumber(prepay.FT.PrepayCost, 2).ToString();
            //预交金大写
            ...
            //预交金额
            this.lblPriJinE3.Text = FS.FrameWork.Public.String.FormatNumber(prepay.FT.PrepayCost, 2).ToString();
            //预交金大写
