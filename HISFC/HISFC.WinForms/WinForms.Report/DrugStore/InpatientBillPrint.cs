            ...
            switch (drugBillClass.PrintType.ID.ToString())
            {
                ...
                case "O":           //扩展打印 默认取处方明细单
                    ...
                    else
                    {
                        ...
                        {
                            MessageBox.Show(FS.FrameWork.Management.Language.Msg("根据摆药单号获取摆药单详细信息发生错误") + this.itemManager.Err);
                            return;
                        }
                    }
                ...
                case "T":           //汇总打印
                    ...
                    else
                    {
                        ...
                        {
                            MessageBox.Show(FS.FrameWork.Management.Language.Msg("根据摆药单号获取摆药单汇总信息发生错误"));
                            return;
                        }
                    }
                ...
                case "H":           //草药单
                    ...
                    else
                    {
                        ...
                        {
                            MessageBox.Show(FS.FrameWork.Management.Language.Msg("根据摆药单号获取摆药单详细信息发生错误"));
                            return;
                        }
                    }
