        ...
        public void ShowData(ArrayList alOriginalData, FS.HISFC.Models.Pharmacy.DrugBillClass drugBillClass)
        {
            ...
            try
            {
                if (this.neuSpread1_Sheet1.Rows.Count > 0)
                {
                    ...
                    this.neuSpread1_Sheet1.Cells[iRow, 0].Text = "领药：         发药：         复准：         制表人：" + (FS.FrameWork.Management.Connection.Operator as FS.HISFC.Models.Base.Employee).Name + "      累计：" +totCost.ToString();                     
