...
//using FS.HISFC.HealthCheckup.Object;
...
namespace FS.WinForms.Report.OutpatientFee.DayBalance
{
    public partial class ucClinicDayBalanceNew : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private bool isCanSelectEndDatetime = true;

        public bool IsCanSelectEndDatetime
        {
            get {
                isCanSelectEndDatetime = this.ucClinicDayBalanceDateControl1.dtpBalanceDate.Enabled;
                return isCanSelectEndDatetime; }
            set { isCanSelectEndDatetime = value;
            this.ucClinicDayBalanceDateControl1.dtpBalanceDate.Enabled = isCanSelectEndDatetime;
            }
        }
        private bool isPromptingDayBalance;

        public bool IsPromptingDayBalance
        {
            get
            {
                //isCanSelectEndDatetime = this.ucClinicDayBalanceDateControl1.dtpBalanceDate.Enabled;
                return isPromptingDayBalance;
            }
            set
            {
                isPromptingDayBalance = value;
                //this.ucClinicDayBalanceDateControl1.dtpBalanceDate.Enabled = isCanSelectEndDatetime;
            }
        }
        /// <summary>
        ...
        private void QueryDayBalanceData()
        {
            ...
            this.beginDate = FS.FrameWork.Function.NConvert.ToDateTime(this.lastDate);
            this.endDate = FS.FrameWork.Function.NConvert.ToDateTime(this.dayBalanceDate);
            ...
            #region 有的找所在行加上
            //List<FS.HISFC.HealthCheckup.Object.CHKFeeItem> chkInvoiceInfoDetailsNew = new List<FS.HISFC.HealthCheckup.Object.CHKFeeItem>();
        ...
        //private FS.HISFC.HealthCheckup.BizLogic.CHKFee chkDayReportMag = new FS.HISFC.HealthCheckup.BizLogic.CHKFee();
        ///// <summary>
        ///// 金额信息
        ///// </summary>
        //private FS.HISFC.HealthCheckup.Object.CHKDayReportFeeInfo costInfo = new FS.HISFC.HealthCheckup.Object.CHKDayReportFeeInfo();
        ///// <summary>
        ///// 发票集合
        ///// </summary>
        //private List<FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo> invoiceList = new List<FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo>();
        ///// <summary>
        ///// 正常结算支付信息集合
        ///// </summary>
        //private List<FS.HISFC.HealthCheckup.Object.CHKPayMod> balancePayModList = new List<FS.HISFC.HealthCheckup.Object.CHKPayMod>();
        ///// <summary>
        ///// 退费结算支付信息集合
        ///// </summary>
        //private List<FS.HISFC.HealthCheckup.Object.CHKPayMod> backPayModList = new List<FS.HISFC.HealthCheckup.Object.CHKPayMod>();
        ///// <summary>
        /// 结算票据号
        /// </summary>
        ...
        /// 日结发票明细
        /// </summary>
        //private List<FS.HISFC.HealthCheckup.Object.CHKFeeItem> chkInvoiceInfoDetails = new List<FS.HISFC.HealthCheckup.Object.CHKFeeItem>();
        ///// <summary>
        ///// 结算票据集合
        ///// </summary>
        //private List<FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo> balanceInvoiceList = new List<FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo>();
        ///// <summary>
        /// 结算票据数
        /// </summary>
        ...
        /// 退费票据集合
        /// </summary>
        //private List<FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo> backInvoiceList = new List<FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo>();
        /// <summary>
        /// 重打票据集合
        /// </summary>
        //private List<FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo> cancelInvoiceList = new List<FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo>();
        /// <summary>
        /// 退费票据数
        /// </summary>
        ...
        /// 退费票据字典
        /// </summary>
        //private Dictionary<string, FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo> backInvoiceDic = new Dictionary<string, FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo>();
        ///// <summary>
        ///// 退费票据字典
        ///// </summary>
        //private Dictionary<string, FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo> cancelInvoiceDic = new Dictionary<string, FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo>();
        /// <summary>
        /// 作废票据数
        /// </summary>
        ...
        /// 重打结算支付信息集合
        /// </summary>
        //private List<FS.HISFC.HealthCheckup.Object.CHKPayMod> cancelPayModList = new List<FS.HISFC.HealthCheckup.Object.CHKPayMod>();
        ...
        /// 集体体检费用信息
        /// </summary>
        //List<FS.HISFC.HealthCheckup.Object.CHKFeeItem> list;
        /// <summary>
        /// 支付集合
        /// </summary>
        //private List<FS.HISFC.HealthCheckup.Object.CHKPayMod> payModList = new List<FS.HISFC.HealthCheckup.Object.CHKPayMod>();
        /// <summary>
        /// 查询日结信息
        /// </summary>
        private int queryDayReport()
        {
            ...
            //list = new List<FS.HISFC.HealthCheckup.Object.CHKFeeItem>();
            ////获取集体体检人员的划价汇总费用信息
            //if (this.chkDayReportMag.GetDayBalanceFeeInfo(invoiceNO, ref list) == -1)
            //{
            //    MessageBox.Show(FS.FrameWork.Management.Language.Msg("获取日结费用信息出错！\n") + this.chkDayReportMag.Err, "提示");
            //    return -1;
            //}
            #endregion
            //填充界面显示
        ...
        private void showInfos()
        {
            ...
            if (true)
            {
                ...
                //{
                //    FS.HISFC.HealthCheckup.BizProcess.Function fun = new FS.HISFC.HealthCheckup.BizProcess.Function();
                //    chkInvoiceInfoDetails = fun.Split(list, ref errText);
                //    foreach (FS.HISFC.HealthCheckup.Object.CHKFeeItem cfi in chkInvoiceInfoDetails)
                //    {
            ...
            #endregion
            //显示标题头部信息
            //this.lblOperName.Text = ((FS.HISFC.Models.Base.Employee)this.chkDayReportMag.Operator).Name;
            ...
            //foreach (FS.HISFC.HealthCheckup.Object.CHKPayMod pay in this.payModList)
            //{
            //    if (pay.PayModState == FS.HISFC.HealthCheckup.Object.CHKEnumInvoiceState.Balanced)
            //    {
            ...
            //        ilp++;
            //    }
            //    else if (pay.PayModState == FS.HISFC.HealthCheckup.Object.CHKEnumInvoiceState.BackFee)
            //    {
            ...
            //foreach (FS.HISFC.HealthCheckup.Object.CHKPayMod pay in this.backPayModList)
            //{
            //    if (ilp % 3 == 0)
            //    {
            //        ilp = 0;
            ...
            //foreach (FS.HISFC.HealthCheckup.Object.CHKInvoiceInfo inv in this.invoiceList)
            //{
            //    if (inv.InviceState == FS.HISFC.HealthCheckup.Object.CHKEnumInvoiceState.Balanced)
            //    {
            //        this.balanceInvoiceList.Add(inv);
            //        balanceTotCostINV += inv.Fee.OwnCost;
            //        this.balanceNOsLine += inv.InvoiceNO + "|";
            //    }
            //    else if (inv.InviceState == FS.HISFC.HealthCheckup.Object.CHKEnumInvoiceState.BackFee)
            //    {
            ...
            //this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 1].ColumnSpan = 5;
            //this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 1].Text = FS.FrameWork.Public.String.LowerMoneyToUpper(this.CACost);
