...
namespace FS.WinForms.Report.OutpatientFee.Class
{
    ...
    /// </summary>
    public class OutPatientQuery : FS.FrameWork.Management.Database
    {
        #region 门诊收费综合查询
        ...
        /// <summary>
        /// 根据病历号获取挂号记录
        /// [参数1: FS.HISFC.Models.Registration.Register r - 含有病历号的挂号实体]
        ...
        public int GetRegisterListByCardCode(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
            ...
            // 挂号业务层
            FS.HISFC.BizLogic.Registration.Register function = new FS.HISFC.BizLogic.Registration.Register();
            // 挂号实体
        ...
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByCardCode(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, DateTime dtFrom, DateTime dtTo, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
        ...
        /// <param name="boolLike">是否模糊查询</param>
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByName(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
        ...
        /// <param name="dtTo">截止时间</param>
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByName(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, DateTime dtFrom, DateTime dtTo, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
        ...
        /// <param name="boolLike">是否模糊查询</param>
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByPact(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
        ...
        /// <param name="dtTo">截止时间</param>
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByPact(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, DateTime dtFrom, DateTime dtTo, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
        ...
        /// <param name="boolLike">是否模糊查询</param>
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByDepartment(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
        ...
        /// <param name="dtTo">截止时间</param>
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByDepartment(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, DateTime dtFrom, DateTime dtTo, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
        ...
        /// <param name="boolLike">是否模糊查询</param>
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByDoctor(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
        ...
        /// <param name="dtTo">截止时间</param>
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByDoctor(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, DateTime dtFrom, DateTime dtTo, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
        ...
        /// <param name="boolLike">是否模糊查询</param>
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByMCard(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
        ...
        /// <param name="dtTo">截止时间</param>
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByMCard(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, DateTime dtFrom, DateTime dtTo, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
        ...
        /// <param name="boolLike">是否模糊查询</param>
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByInvoice(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
        ...
        /// <param name="dtTo">截止时间</param>
        /// <returns>1-成功,-1-失败</returns>
        public int GetRegisterListByInvoice(FS.HISFC.Models.Registration.Register r, ArrayList alRegister, DateTime dtFrom, DateTime dtTo, bool boolLike)
        {
            // 返回值
            int intReturn = 0;
            // SELECT语句
