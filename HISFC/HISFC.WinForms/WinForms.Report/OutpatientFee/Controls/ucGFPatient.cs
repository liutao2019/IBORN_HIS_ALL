...
{
    public partial class ucGFPatient : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucGFPatient()
        {
            InitializeComponent();
        ...
        Class.GfPatientManager manager = new FS.WinForms.Report.OutpatientFee.Class.GfPatientManager();
        #endregion
        ...
        {
            toolbarService.AddToolButton("导入", "导入", FS.FrameWork.WinForms.Classes.EnumImageList.D导入, true, false, null);
