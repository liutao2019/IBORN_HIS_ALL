namespace FS.WinForms.Report.OutpatientFee.Query
{
    partial class ucQueryBooking
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.checkBox4 = new FS.FrameWork.WinForms.Controls.NeuCheckBox();
            ...
            this.dateEnd = new FS.FrameWork.WinForms.Controls.NeuDateTimePicker();
            this.dateBegin = new FS.FrameWork.WinForms.Controls.NeuDateTimePicker();
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "预约科室";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "预约专家";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "预约日期";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "开始时间";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "结束时间";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "身份证号";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "联系电话";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "地址";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "挂号?";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 13).Value = "加号?";
            ...
            this.fpSpread1_Sheet1.Columns.Get(4).Label = "预约科室";
            this.fpSpread1_Sheet1.Columns.Get(4).Width = 72F;
            this.fpSpread1_Sheet1.Columns.Get(5).CellType = textCellType5;
            this.fpSpread1_Sheet1.Columns.Get(5).Label = "预约专家";
            this.fpSpread1_Sheet1.Columns.Get(5).Width = 77F;
            this.fpSpread1_Sheet1.Columns.Get(6).Label = "预约日期";
            this.fpSpread1_Sheet1.Columns.Get(6).Width = 98F;
            ...
            this.fpSpread1_Sheet1.Columns.Get(9).Label = "身份证号";
            this.fpSpread1_Sheet1.Columns.Get(9).Width = 130F;
            this.fpSpread1_Sheet1.Columns.Get(10).CellType = textCellType7;
            this.fpSpread1_Sheet1.Columns.Get(10).Label = "联系电话";
            this.fpSpread1_Sheet1.Columns.Get(10).Width = 113F;
            this.fpSpread1_Sheet1.Columns.Get(11).CellType = textCellType8;
            this.fpSpread1_Sheet1.Columns.Get(11).Label = "地址";
            this.fpSpread1_Sheet1.Columns.Get(11).Width = 182F;
            this.fpSpread1_Sheet1.Columns.Get(12).CellType = textCellType9;
            this.fpSpread1_Sheet1.Columns.Get(12).Label = "挂号?";
            this.fpSpread1_Sheet1.Columns.Get(12).Width = 49F;
            this.fpSpread1_Sheet1.Columns.Get(13).CellType = textCellType10;
            this.fpSpread1_Sheet1.Columns.Get(13).Label = "加号?";
            this.fpSpread1_Sheet1.Columns.Get(13).Width = 49F;
            ...
            this.checkBox4.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
            ...
            this.dateEnd.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
            ...
            this.dateBegin.Style = FS.FrameWork.WinForms.Controls.StyleType.Fixed3D;
            ...
            this.txtInvoice.Location = new System.Drawing.Point(75, 94);
            ...
            this.txtName.Location = new System.Drawing.Point(75, 63);
            ...
            this.txtCardNo.Location = new System.Drawing.Point(75, 32);
        ...
        private FS.FrameWork.WinForms.Controls.NeuDateTimePicker dateBegin;
        private FS.FrameWork.WinForms.Controls.NeuDateTimePicker dateEnd;
        ...
        private FS.FrameWork.WinForms.Controls.NeuCheckBox checkBox4;
