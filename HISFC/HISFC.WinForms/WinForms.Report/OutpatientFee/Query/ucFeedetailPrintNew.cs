...
{
    public partial class ucFeedetailPrintNew : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucFeedetailPrintNew()
        {
            InitializeComponent();
        }
        ...
        public void GetInvoiceNo()
        {
            ...
            if (this.neuCheckBox1.Checked)
            {
                ...
                if (this.feeMgr.QueryInvoiceList(this.queryType.ToString(), this.txtInvoiceNo.Text.Trim(), this.beginDate.Value.ToString(), this.endDate.Value.ToString(), ref dtResult) == -1)
                {
            ...
            {
                if (this.feeMgr.QueryInvoiceList(this.queryType.ToString(), this.txtInvoiceNo.Text.Trim(), DateTime.MinValue.AddDays(1).ToString(), DateTime.MaxValue.AddDays(-1).ToString(), ref dtResult) == -1)
                {
                    MessageBox.Show("查询发票的费用明细失败!");
                    return;
                }
            ...
            {
                this.AddFeeDetail(dr[0].ToString());
        ...
        public void SelectItem(string invoiceNo)
        {
            ...
            //this.neuSpread1_Sheet1.ColumnHeader.Cells[1, 0].Text = "发票号：" + drTemp[11].ToString() + "; 自费金额：" + drTemp[13].ToString() + "; 公费金额：" + drTemp[14].ToString();
        ...
        public void AddFeeDetail(string invoiceNo)
        {
            DataSet dsResult = new DataSet();
            int sumItem = 0;
            ...
            //int index = this.neuSpread1_Sheet1.Rows.Count;
            decimal totCost = 0m;
            this.neuSpread1_Sheet1.Rows.Add(this.index, 4);
            this.index = this.neuSpread1_Sheet1.Rows.Count;
            //表头处理
            this.neuSpread1_Sheet1.Cells.Get((this.index - 4), 0).ColumnSpan = 7;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 4), 0).Value = "东莞市桥头医院门诊费用清单";
            this.neuSpread1_Sheet1.Cells.Get((this.index - 4), 0).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 4), 0).VerticalAlignment = FarPoint.Win.Spread.CellVerticalAlignment.Center;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 4), 0).Font = new System.Drawing.Font("宋体", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            
            this.neuSpread1_Sheet1.Cells.Get((this.index - 3), 0).ColumnSpan = 7;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 3), 0).Value = "发票号:";
            this.neuSpread1_Sheet1.Cells.Get((this.index - 3), 0).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 2), 0).ColumnSpan = 2;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 2), 0).Value = "姓名：";
            this.neuSpread1_Sheet1.Cells.Get((this.index - 2), 0).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Left;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 2), 2).ColumnSpan = 5;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 2), 2).Value = "姓名：";
            this.neuSpread1_Sheet1.Cells.Get((this.index - 2), 2).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Right;


            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 0).Value = "项目编码";
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 0).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 1).Value = "名称";
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 1).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 2).Value = "规格";
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 2).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 3).Value = "数量";
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 3).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 4).Value = "单位";
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 4).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 5).Value = "单价";
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 5).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 6).Value = "金额";
            this.neuSpread1_Sheet1.Cells.Get((this.index - 1), 6).HorizontalAlignment = FarPoint.Win.Spread.CellHorizontalAlignment.Center;
            ...
            DataRow drTemp = dt.Rows[0];
            this.neuSpread1_Sheet1.Cells[this.index - sumItem - 3, 0].Text = "发票号：" + drTemp[11].ToString() + "; 自费金额：" + drTemp[13].ToString() + "; 公费金额：" + drTemp[14].ToString() + "; 合同单位：" + drTemp[15].ToString(); ;
            this.neuSpread1_Sheet1.Cells[this.index - sumItem-2, 0].Text = "姓名：" + drTemp[8].ToString();
            this.neuSpread1_Sheet1.Cells[this.index - sumItem-2, 2].Text = "日期：" + drTemp[7].ToString();            
