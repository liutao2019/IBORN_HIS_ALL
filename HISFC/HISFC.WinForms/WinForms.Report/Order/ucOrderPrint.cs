...
{
    /// <summary>
    /// 医嘱单打印{3A9485F2-F5AB-44c5-901C-3B1C271242DA}
    /// </summary>
    public partial class ucOrderPrint : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.IPrintOrder
    {
        ...
        //                            MessageBox.Show(FS.FrameWork.Management.Language.Msg("更新医嘱单行号、页码失败！" + orderBillManager.Err));
        //                            return;
        //                        }
        //                    }
        ...
        //                        //t.RollBack();
        //                        FS.FrameWork.Management.PublicTrans.RollBack();
        //                        MessageBox.Show(FS.FrameWork.Management.Language.Msg("更新医嘱单打印标志失败！" + orderBillManager.Err));
        //                        return;
        //                    }
        //                }
        //            }
