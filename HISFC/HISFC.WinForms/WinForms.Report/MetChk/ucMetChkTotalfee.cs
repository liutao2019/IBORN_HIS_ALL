...
{
    public partial class ucMetChkTotalfee : Common.ucQueryBaseForDataWindow 
    {
        public ucMetChkTotalfee()
        {
            InitializeComponent();
        }
        ...
        protected override int OnDrawTree()
        {
            ...
            System.Collections.ArrayList deptList = new FS.HISFC.BizProcess.Integrate.PhysicalExamination.ExamiManager().QueryCompanyRegister
            ...
            foreach (FS.FrameWork.Models.NeuObject dept in deptList)
            {
