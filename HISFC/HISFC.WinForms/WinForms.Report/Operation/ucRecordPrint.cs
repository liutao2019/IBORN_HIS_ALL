...
#region IRecordFormPrint 成员
        ...
        public FS.HISFC.Models.Operation.OperationRecord OperationRecord
        {
            set 
            {
                ...
                {
                    if (thisRole.RoleType.ID.ToString() == EnumOperationRole.WashingHandNurse1.ToString())//随台护士
                    {
                    ...
                    if (thisRole.RoleType.ID.ToString() == EnumOperationRole.ItinerantNurse1.ToString())//巡回护士
                    {
                        strPrepNurs = thisRole.Name;
                    }
                    else if (thisRole.RoleType.ID.ToString() == EnumOperationRole.ItinerantNurse2.ToString())//巡回护士
                    {
                        if (strPrepNurs != "")
                            strPrepNurs = strPrepNurs + "/";
                        strPrepNurs = strPrepNurs + thisRole.Name;
                    }
                    else if (thisRole.RoleType.ID.ToString() == EnumOperationRole.ItinerantNurse3.ToString())//巡回护士
                    {
                        if (strPrepNurs != "")
                            strPrepNurs = strPrepNurs + "/";
                        strPrepNurs = strPrepNurs + thisRole.Name;
