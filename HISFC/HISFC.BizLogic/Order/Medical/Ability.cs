...
namespace FS.HISFC.BizLogic.Order.Medical
{
    ...
    ///  />
    /// </summary>
    public class Ability : FS.FrameWork.Management.Database
    {
        /// <summary>
        /// 构造函数
        ...
        private List<FS.HISFC.Models.Order.Medical.Ability> QueryBySql(string sqlIndex, params string[] args)
        {
            string sql = string.Empty;
            if (this.Sql.GetCommonSql(sqlIndex, ref sql) == -1)
            {
            ...
            List<FS.HISFC.Models.Order.Medical.Ability> al = new List<FS.HISFC.Models.Order.Medical.Ability>();
            try
            {
                while (this.Reader.Read())
                {
                    FS.HISFC.Models.Order.Medical.Ability fection = new FS.HISFC.Models.Order.Medical.Ability();
                    ...
                    fection.Employee.Birthday = FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[10].ToString());
        ...
        {
            return this.GetParamsBySql("Order.Allergy.GetDrugLevlByID", itemID);
        }
        ...
        {
            return this.GetParamsBySql("Order.Allergy.GetDrugQualityByID", itemID);
        }
        ...
        {
            return this.GetParamsBySql("Order.Allergy.GetOperateTypeByID", itemID);
        }
        ...
        {
            return this.GetParamsBySql("Order.Allergy.CheckPopedomByType", emplID, popedomType, popedomID);
        }
        ...
        {
            return this.GetParamsBySql("Order.Allergy.CheckPopedomOnlyByType", emplID, popedomType);
        }
        ...
        {
            return this.GetParamsBySql("Order.Allergy.CheckInPopedomByID", emplID, popedomType);
        }
        ...
        {
            return NConvert.ToInt32(this.GetParamsBySql("Order.Allergy.CheckByEmplRight", emplID, popedomType, popedomCode));
        }
        ...
        public List<FS.HISFC.Models.Order.Medical.Ability> QueryAbilityByPersonID(string emplID)
        {
            return this.QueryBySql("Order.Allergy.QueryByEmplID", emplID);
        }
        ...
        /// <returns>资质实体</returns>
        public List<FS.HISFC.Models.Order.Medical.Ability> QueryAbilityByDeptID(string deptID)
        {
            return this.QueryBySql("Order.Allergy.QueryByDeptID", deptID);
        }
        ...
        public int InsertAbility(FS.HISFC.Models.Order.Medical.Ability ability)
        {
            return this.UpdateSingleTable("Order.Allergy.Insert",
        ...
        /// <param name="ability">资质实体</param>
        /// <returns>成功 1 失败 -1 没有更新到数据 0</returns>
        public int UpdateAbility(FS.HISFC.Models.Order.Medical.Ability ability)
        {
            return this.UpdateSingleTable("Order.Allergy.Update",
        ...
        {
            return this.UpdateSingleTable("Order.Allergy.Delete", happenNO);
        }
        ...
        {
            return this.GetParamsBySql("Order.Allergy.GetAbilityCountByEmplAndSpeciality", emplCode, speciality);
        }
        ...
        public int CheckPopedom(string emplCode, string itemCode, string sysClass, bool isAllowNonRight, ref string failCause)
        {
            ...
            {
                failCause = "系统类别错误，不是合法参数，请联系信息科！";
                return 1;
            }
            ...
            if (sysClass.Substring(0, 1) == "P")
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            failCause = "您没有此药品性质的处方权限！如有疑问请联系信息科！";

                            return 0;
                        }
                        else
                        {
                            failCause = "执行查询语句失败！请联系信息科！";
            ...
            else if (sysClass == "UO")
            {
                ...
                else
                {
                    ...
                    {
                        failCause = "您无此手术规模权限！如有疑问请联系信息科！";
            ...
            else if (sysClass == "groupManager")
            {
                ...
                {
                    failCause = "您没有组套修改权限！如有疑问请联系信息科！";
        ...
        public List<FS.HISFC.Models.Order.Medical.Ability> QueryDoctorListBySpecLevl(string spec, string levl)
        {
            return this.QueryBySql("Order.Allergy.QuerySpecLevl", spec, levl);
        }
        ...
        /// <returns>成功 1 失败 -1</returns>
        public int InsertPopedom(FS.HISFC.Models.Order.Medical.Popedom ppd)
        {
            return this.UpdateSingleTable("Order.Allergy.InsertPopedom", ppd.EmplCode, ppd.PopedomType.ID, ppd.Popedoms.ID, ppd.CheckFlag);
        }
        ...
        /// <param name="ppd">权限实体</param>
        /// <returns>成功 1 失败 -1</returns>
        public int UpdatePopedom(FS.HISFC.Models.Order.Medical.Popedom ppd)
        {
            return this.UpdateSingleTable("Order.Allergy.UpdatePopedom", ppd.ID, ppd.CheckFlag);
        }
        ...
        {
            return this.UpdateSingleTable("Order.Allergy.DeletePopedom", happenNO);
        }
        ...
        public List<FS.HISFC.Models.Order.Medical.Popedom> QueryPopedomByEmplID(string emplID)
        {
            string sql = string.Empty;
            if (this.Sql.GetCommonSql("Order.Allergy.QueryPopedom", ref sql) == -1)
            {
                this.Err = "没有找到索引为:Order.Allergy.QueryPopedom的SQL语句";
            ...
            List<FS.HISFC.Models.Order.Medical.Popedom> al = new List<FS.HISFC.Models.Order.Medical.Popedom>();
            try
            {
                while (this.Reader.Read())
                {
                    FS.HISFC.Models.Order.Medical.Popedom fection = new FS.HISFC.Models.Order.Medical.Popedom();
        ...
        /// <param name="emplID">人员代码</param>
        /// <returns>成功 权限实体列表 失败 null</returns>
        public List<FS.HISFC.Models.Order.Medical.Popedom> QueryPopedomAll()
        {
            string sql = string.Empty;
            if (this.Sql.GetCommonSql("Order.Allergy.QueryPopedomAll", ref sql) == -1)
            {
                this.Err = "没有找到索引为:Order.Allergy.QueryPopedom的SQL语句";
        ...
        /// </summary>
        /// <returns>资质实体</returns>
        public List<FS.HISFC.Models.Order.Medical.Ability> QueryAbilityList()
        {
            string sql = string.Empty;
            if (this.Sql.GetCommonSql("Order.Allergy.QueryAll", ref sql) == -1)
            {
                this.Err = "没有找到索引为:Order.Allergy.QueryAll的SQL语句";
