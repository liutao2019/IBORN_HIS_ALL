...
{
    public class MedicalTeamForDoct : FS.FrameWork.Management.Database
    {
        #region MyRegion
        ...
        /// <returns></returns>
        private int InsertOrUpdateTable(string sqlIndex, FS.HISFC.Models.Order.Inpatient.MedicalTeamForDoct medicalTeamForDoct)
        {
        ...
        private string[] GetArgs(FS.HISFC.Models.Order.Inpatient.MedicalTeamForDoct medicalTeamForDoct)
        {
            string[] args = new string[]
            {
               ...
               FS.FrameWork.Function.NConvert.ToInt32(medicalTeamForDoct.IsValid).ToString()
        ...
        /// <returns></returns>
        private List<FS.HISFC.Models.Order.Inpatient.MedicalTeamForDoct> ExcuteQueryMedicalTeamForDoctBySql(string strSql)
        {
            ...
            {
                FS.HISFC.Models.Order.Inpatient.MedicalTeamForDoct medicalTeamForDoctObj = new FS.HISFC.Models.Order.Inpatient.MedicalTeamForDoct();
                ...
                medicalTeamForDoctObj.Oper.OperTime = FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[4].ToString());
                medicalTeamForDoctObj.IsValid = FS.FrameWork.Function.NConvert.ToBoolean(this.Reader[6].ToString());
        ...
        /// <returns></returns>
        public List<FS.HISFC.Models.Order.Inpatient.MedicalTeamForDoct> QueryMedicalTeamForDoctBySqlIndex(string whereIndex, params string[] args)
        {
            string strSql = string.Empty;
        ...
        /// <returns></returns>
        public List<FS.HISFC.Models.Order.Inpatient.MedicalTeamForDoct> QueryQueryMedicalTeamForDoctInfo(string deptCode, string doctCode)
        {
        ...
        public List<FS.HISFC.Models.Order.Inpatient.MedicalTeamForDoct> QueryQueryMedicalTeamForDoctInfo()
        {
        ...
        /// <param name="deptCode"></param>
        /// <returns></returns>
        public List<FS.HISFC.Models.Order.Inpatient.MedicalTeamForDoct> QueryQueryMedicalTeamForDoctInfo(string deptCode, string medicalTeamcode, string validFlag)
        {
        ...
        /// <param name="medicalTeam"></param>
        /// <returns></returns>
        public int InsertMedicalTeamForDoct(FS.HISFC.Models.Order.Inpatient.MedicalTeamForDoct medicalTeamForDoct)
        {
        ...
        /// <param name="medicalTeam"></param>
        /// <returns></returns>
        public int UpdateMedicalTeamForDoct(FS.HISFC.Models.Order.Inpatient.MedicalTeamForDoct medicalTeamForDoct)
        {
        ...
        public int DeleteMedicalTeamMedicalTeamForDoct(string deptCode, string medicalTeamCode,string doctCode)
        {
            ...
            int returnValue = this.Sql.GetCommonSql("MedicalTeamForDoct.Delete", ref strSql);
        ...
        public int UpdateValidFlag(string isValidFalg, string deptCode, string medicalTeamCode)
        {
            ...
            int returnValue = this.Sql.GetCommonSql("MedicalTeam.Doctor.update.ValidFlag2", ref strSql);
        ...
        public int UpdateValidFlag(string isValidFalg, string deptCode, string medicalTeamCode,string doctCode)
        {
            ...
            int returnValue = this.Sql.GetCommonSql("MedicalTeam.Doctor.update.ValidFlag1", ref strSql);
