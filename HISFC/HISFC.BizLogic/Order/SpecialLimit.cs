        ...
        private string FormatPharcamyLimit(string strSql, FS.HISFC.Models.Order.PharmacyLimit pharmacyLimit)
        {
            ...
            try
            {
                System.Object[] s = {pharmacyLimit.ID,//住院流水号
									 FS.FrameWork.Function.NConvert.ToInt32(pharmacyLimit.IsLeaderCheck).ToString(),//序列号
									 FS.FrameWork.Function.NConvert.ToInt32(pharmacyLimit.IsNeedRecipe).ToString(),//科室代码
                                     FS.FrameWork.Function.NConvert.ToInt32(pharmacyLimit.IsValid).ToString(),//有效性
            ...
            try
            {
                while (this.Reader.Read())
                {
                    ...
                    try
                    {
                        ...
                        obj.IsValid = FS.FrameWork.Function.NConvert.ToBoolean(this.Reader[3].ToString());//有效性
                        obj.Remark = this.Reader[4].ToString();//备注
                        obj.Oper.ID = this.Reader[5].ToString();//操作员
                        obj.Oper.OperTime = FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[6].ToString());//操作日期
                    }
                    catch (Exception ex)
                    {
