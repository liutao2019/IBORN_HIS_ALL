...
namespace FS.HISFC.BizLogic.Nurse.InjectManager
{
    /// <summary>
    /// [功能描述: 注射项目分解]<br></br>
    /// [创 建 者: 徐伟哲]<br></br>
    ...
    ///  />
    /// </summary> 
    public class Decompound : FS.FrameWork.Management.Database
    {
        public Decompound()
        {
        }
        ...
        public List<FS.HISFC.Models.Nurse.InjectInfo> QueryItemListByCardNoAndClinicCode(string cardNo, string clinicCode)
        {
            ...
            string strsql = "";
            if (this.Sql.GetCommonSql("INJECT_QUERY_CARD_CLINIC", ref strsql) == -1)
            {
            ...
            FS.HISFC.Models.Nurse.InjectInfo items;
            ...
            try
            {
                ...
                {
                    items = new FS.HISFC.Models.Nurse.InjectInfo();
                    items.Order.ReciptNO = this.Reader.IsDBNull(0) ? "" : this.Reader[0].ToString();//处方号

                    items.Order.SequenceNO = this.Reader.IsDBNull(2) ? 1 : FS.FrameWork.Function.NConvert.ToInt32(this.Reader[1].ToString());//处方内顺号
                    ...
                    items.Order.Item.Qty = this.Reader.IsDBNull(7) ? 0 : FS.FrameWork.Function.NConvert.ToInt32(this.Reader[7].ToString());//数量
                    ...
                    items.Order.InjectCount = this.Reader.IsDBNull(16) ? 0 : FS.FrameWork.Function.NConvert.ToInt32(this.Reader[16].ToString());//院注次数
                    items.Order.DoseOnce = this.Reader.IsDBNull(17) ? 0 : FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[17].ToString());//一次用量

                    items.Order.DoseUnit = this.Reader.IsDBNull(18) ? "" : this.Reader[18].ToString();//一次用量单位                    

                    items.BaseDose = this.Reader.IsDBNull(19) ? 0 : FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[19].ToString());//基本剂量

                    items.Order.Item.PackQty = this.Reader.IsDBNull(20) ? 0 : FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[20].ToString());//包装数量                    
                    items.IsMainDrug = this.Reader.IsDBNull(21) ? false : FS.FrameWork.Function.NConvert.ToBoolean(this.Reader[21].ToString());//是否主药

                    items.GlassNum = this.Reader.IsDBNull(22) ? 0 : FS.FrameWork.Function.NConvert.ToInt32(this.Reader[22].ToString());//分瓶数量
        ...
        public int InsertPrecontractInejctItem(List<FS.HISFC.Models.Nurse.InjectInfo> itemList)
        {
            ...
            string str = "";
            if (this.Sql.GetCommonSql("INJECT_INSERT", ref str) == -1)
            {
            ...
            try
            {
                foreach (FS.HISFC.Models.Nurse.InjectInfo inject in itemList)
                {
                    string strsql = str;
        ...
        /// <returns>null失败</returns>
        public List<FS.HISFC.Models.Nurse.InjectInfo> QueryInjectItem(string cardNo, DateTime date)
        {
            string strsql = "";
            if (this.Sql.GetCommonSql("INJECT_GETINJECTINFO_BY_CARDNO_DATE", ref strsql) == -1)
            {
            ...
            try
            {
                while (this.Reader.Read())
                {
                    FS.HISFC.Models.Nurse.InjectInfo inject = new FS.HISFC.Models.Nurse.InjectInfo();
                    ...
                    inject.Order.Patient.Birthday = this.Reader.IsDBNull(4) ? DateTime.MinValue : FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[4].ToString());

                    inject.Name = this.Reader.IsDBNull(5) ? "" : this.Reader[5].ToString();//注射次数，比如第一次注射，没有地方，用NAME存

                    inject.PrecontractDate = this.Reader.IsDBNull(6) ? DateTime.MinValue : FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[6].ToString());//预约注射日期
                    ...
                    inject.Order.DoseOnce = this.Reader.IsDBNull(12) ? 0 : FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[12].ToString());//一次用量

                    inject.Order.DoseUnit = this.Reader.IsDBNull(13) ? "" : this.Reader[13].ToString();//一次用量单位

                    inject.GlassNum = this.Reader.IsDBNull(14) ? 0 : FS.FrameWork.Function.NConvert.ToInt32(this.Reader[14].ToString());//接瓶数
                    ...
                    inject.Order.Qty = this.Reader.IsDBNull(18) ? 0 : FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[18].ToString());//开立数量

                    inject.BaseDose = this.Reader.IsDBNull(19) ? 0 : FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[19].ToString());//基本剂量
                    inject.Order.Item.PackQty = this.Reader.IsDBNull(20) ? 0 : FS.FrameWork.Function.NConvert.ToDecimal(this.Reader[20].ToString());//包装数量
                    ...
                    inject.IsMainDrug = this.Reader.IsDBNull(23) ? false : FS.FrameWork.Function.NConvert.ToBoolean(this.Reader[23].ToString());//是否主药
                    ...
                    inject.Order.InjectCount = this.Reader.IsDBNull(30) ? 0 : FS.FrameWork.Function.NConvert.ToInt32(this.Reader[30].ToString());//院注次数
        ...
        public int UpdateInjectItemState(FS.HISFC.Models.Nurse.InjectInfo inject)
        {
            string strsql = "";
            if (this.Sql.GetCommonSql("INJECT_UPDATE_RECORDID", ref strsql) == -1)
            {
                return -1;
            }
            try
        ...
        /// <returns>null失败</returns>
        public List<FS.HISFC.Models.Nurse.InjectInfo> QueryAlreadyDosageInjectItem(string cardNo, DateTime date)
        {
            string strsql = "";
            if (this.Sql.GetCommonSql("INJECT.INJECTCONFIRM.QUERY.CARDNO.DATE", ref strsql) == -1)
            {
        ...
        /// <returns>-1失败，1成功</returns>
        public int UpdateAlreadyDosageInjectItemState(FS.HISFC.Models.Nurse.InjectInfo inject)
        {
            string strsql = "";
            if (this.Sql.GetCommonSql("INJECT.INJECTCONFIRM.UPDATE", ref strsql) == -1)
            {
                return -1;
            }
            try
        ...
        /// <param name="date">注射日期</param>
        /// <returns>null失败</returns>
        public List<FS.HISFC.Models.Nurse.InjectInfo> QueryAlreadyPrecontractInjectItem(string cardNo, DateTime date)
        {
            string strsql = "";
            if (this.Sql.GetCommonSql("INJECT_GETAlreadyPrecontractPatient_BY_CARDNO_DATE", ref strsql) == -1)
            {
        ...
        /// <returns>-1失败，1成功</returns>
        public int UpdateAlreadyPrecontractInjectItem(FS.HISFC.Models.Nurse.InjectInfo inject)
        {
            string strsql = "";
            if (this.Sql.GetCommonSql("INJECT_UPDATE_ALREADYPRECONTRACTITEM", ref strsql) == -1)
            {
                return -1;
            }
            try
