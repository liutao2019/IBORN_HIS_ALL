...
namespace FS.HISFC.BizLogic.Nurse.InjectManager
{
    ...
    ///  />
    /// </summary> 
    public class InjectRecordMgr : FS.FrameWork.Management.Database
    {
        ...
        public List<FS.HISFC.Models.Nurse.InjectRecord> QueryAll()
        {
            return null;
        }
        ...
        public int InsertOperEnv(FS.HISFC.Models.Nurse.InjectRecord injectRecord)
        {
            string strsql = "";
            if (this.Sql.GetCommonSql("INJECT.INJECTRECORD.INSERT", ref strsql) == -1)
            {
