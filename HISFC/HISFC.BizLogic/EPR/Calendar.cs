...
{
    public class Calendar : FS.FrameWork.Management.Database
    {
        ...
        public int InsertCalendar(FS.HISFC.Models.Base.Calendar calendar)
        {
        ...
        public ArrayList QueryCalendar()
        {
            ...
            FS.HISFC.Models.Base.Calendar calendar = null;
            ...
            try
            {
                ...
                {
                    calendar = new FS.HISFC.Models.Base.Calendar();
                    calendar.ID = this.Reader[0].ToString();
                    calendar.Name = this.Reader[1].ToString();
                    calendar.CalendarDate = FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[2].ToString());
                    calendar.ParamXML = this.Reader[3].ToString();
                    calendar.Oper.ID = this.Reader[4].ToString();
                    calendar.Oper.OperTime = FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[5].ToString());
