...
namespace FS.HISFC.BizLogic.EPR
{
    ...
    /// </summary>
    public class Message : FS.FrameWork.Management.Database
    {
        public Message()
        {
        ...
        public ArrayList QueryMessage(string oper)
        {
            ...
            FS.HISFC.Models.Base.Message message = null;
            ...
            try
            {
                ...
                {
                    message = new FS.HISFC.Models.Base.Message();
                    message.ID = this.Reader[0].ToString();
                    message.Oper.OperTime = FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[1].ToString());
                    ...
                    message.IsRecieved = FS.FrameWork.Function.NConvert.ToBoolean(this.Reader[9].ToString());
                    ...
                    message.ReplyType = FS.FrameWork.Function.NConvert.ToInt32(this.Reader[13].ToString());
