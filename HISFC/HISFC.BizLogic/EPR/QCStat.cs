...
namespace FS.HISFC.BizLogic.EPR
{
    ...
    public class QCStat : FS.FrameWork.Management.Database 
    {
        ...
        /// 插入统计结果
        /// </summary>
        /// <param name="result">FS.FrameWork.Models.NeuObject,ID为患者编码，Memo为患者入院日期，Name为质控ID，User01为质控名称，User02为质控结果，User03为统计日期</param>
        /// <returns></returns>
        ...
        /// <returns>ArrayList 中每个Item为FS.FrameWork.Models.NeuObject,ID为患者编码，Memo为患者入院日期，Name为质控ID，User01为质控名称，User02为质控结果，User03为统计日期</returns>
