...
namespace FS.HISFC.BizLogic.EPR
{
    ...
    public class EMR : FS.FrameWork.Management.Database
    {
        ...
        /// </summary>
        /// <returns></returns>
        [ObsoleteAttribute("该方法已过时，更改为int SetEMRLocked(string fileID, FS.HISFC.Models.RADT.PatientInfo patient, FS.FrameWork.Models.NeuObject obj, bool isLocked)")]
        ...
        //<returns></returns>
        [ObsoleteAttribute("该方法已过时，更改为bool IsEMRLocked(string fileID, ref FS.FrameWork.Models.NeuObject obj)")]
