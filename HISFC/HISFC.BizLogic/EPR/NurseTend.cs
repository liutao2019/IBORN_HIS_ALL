...
namespace FS.HISFC.BizLogic.EPR
{
    ...
    ///  />
    /// </summary>
    public class NurseTend:FS.FrameWork.Management.Database
    {
        #region 护理记录设置
        /// <summary>
        /// 取得所有在用护理记录设置
        ...
        public ArrayList QueryNurseSheetSettingList()
        {
            ...
            FS.HISFC.Models.Base.Message obj = null;
            ...
            try
            {
                ...
                {
                    obj = new FS.HISFC.Models.Base.Message();   //ID
                    ...
                    obj.Oper.OperTime = FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[7].ToString()); //Oper_Date
                    lis.Add(obj);
                }
        ...
        public void SetNurseSheetingSetting(string strXml, FS.HISFC.Models.EPR.NurseSheetSetting setting)
        {
            if (setting == null)
            {
                setting = new FS.HISFC.Models.EPR.NurseSheetSetting();
            }
            ...
            if (elmColumns != null && elmColumns.SelectNodes("Column") != null)
            {
                ...
                setting.Columns = new FS.HISFC.Models.EPR.NurseSheetSettingColumn[elmColumnList.Count];
                for (int i = 0; i < elmColumnList.Count; i++)
                {
                    XmlElement elmColumn = (XmlElement)elmColumnList[i];
                    setting.Columns[i] = new FS.HISFC.Models.EPR.NurseSheetSettingColumn();
                    ...
                    {
                        setting.Columns[i].Style = (FS.HISFC.Models.EPR.ColumnStyle)Enum.Parse(typeof(FS.HISFC.Models.EPR.ColumnStyle), elmColumn.Attributes["Style"].Value);
                    }
                    else
                    {
                        setting.Columns[i].Style = FS.HISFC.Models.EPR.ColumnStyle.文本框;
                    }
        ...
        public string GetXmlFromNurseSheetSetting(FS.HISFC.Models.EPR.NurseSheetSetting setting)
        {
            System.Xml.XmlDocument doc = new System.Xml.XmlDocument();
            ...
            //{
            //    string fileName = FS.NFC.Interface.Classes.Function.GetTempFileName() + ".bmp";
