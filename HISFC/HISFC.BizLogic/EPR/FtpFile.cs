...
namespace FS.HISFC.Management.File
{
	/// <summary>
	/// FtpFile 的摘要说明。
	/// </summary>
	public class FtpFile:FS.FrameWork.Management.Database
	{
		public FtpFile()
		{
			//
		...
		{
			FS.HISFC.Models.File.FtpFile  file; 
			...
			try
			{
				...
				{
					file  = new FS.HISFC.Models.File.FtpFile();
					try
					{
		...
		public int UpdateFtpFileInfo(FS.HISFC.Models.File.FtpFile info )
		{
			string strSql = "";
		...
		public int DeleteFtpFileInfo(FS.HISFC.Models.File.FtpFile info)
		{
		...
		public int InsertFtpFileInfo(FS.HISFC.Models.File.FtpFile info)
		{
			string strSql = "";
