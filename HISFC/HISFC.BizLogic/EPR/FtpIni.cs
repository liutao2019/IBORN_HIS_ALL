...
namespace FS.HISFC.Management.File
{
	...
	/// FtpIni 的摘要说明。
	/// </summary>
	public class FtpIni :FS.FrameWork.Management.Database
	{
		public FtpIni()
		{
			//
		...
		{
			FS.HISFC.Models.File.Ftpini info ;
			...
			try
			{
				...
				{
					info = new FS.HISFC.Models.File.Ftpini();
					try
					{
		...
		public int UpdateFtpIni(FS.HISFC.Models.File.Ftpini info)
		{
			string strSql = "";
		...
		public int DeleteFtpIni(FS.HISFC.Models.File.Ftpini info)
		{
			string strSql = "";
		...
		public int InsertFtpIni(FS.HISFC.Models.File.Ftpini info)
		{
			string strSql = "";
