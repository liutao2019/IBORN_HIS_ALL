...
namespace FS.HISFC.BizLogic.Privilege
{
    ...
    /// 权限基础操作类
    /// </summary>
    public class PrivLogic : DataBase
    {
        #region PrivLogic 成员
        /// <summary>
        /// 插入权限
        ...
        /// <returns></returns>
        public int Insert(FS.HISFC.BizLogic.Privilege.Model.Priv resource)
        {
        ...
        public int Delete(string resourceId)
        {
            ...
            //}
            string sql = "";
            if (this.GetSQL("SECURITY.RESOURCE.DELETE", ref sql) == -1) return -1;
            try
            {
        ...
        public int Delete(Priv priv)
        {
            ...
            //}
            string sql = "";
            if (this.GetSQL("SECURITY.RESOURCE.DELETEFORONEOP", ref sql) == -1) return -1;
            try
            {
        ...
        public int Update(Priv res)
        {
            ...
            string sql = "";
            if (this.GetSQL("SECURITY.RESOURCE.UPDATE", ref sql) == -1) return -1;
            try
            {
                sql = string.Format(sql, args);
            }
        ...
        /// <returns></returns>
        public IList<FS.HISFC.BizLogic.Privilege.Model.Priv> Query(string resourceType)
        {
            ...
            string sql = "";
            if (this.GetSQL("SECURITY.RESOURCE.UPDATE", ref sql) == -1) return null;
            try
            {
        ...
        public int InsertResRoleMap(Priv resource, string roleId, string permission, string param)
        {
            ...
            string sql = "";
            if (this.GetSQL("SECURITY.RESOURCE.ADDROLEMAP", ref sql) == -1) return -1;
            try
            {
                sql = string.Format(sql, args);
            }
        ...
        public int DelResRoleMap(string resourceId, string roleId)
        {
            ...
            //}
            string sql = "";
            if (this.GetSQL("SECURITY.RESOURCE.DELROLEMAP", ref sql) == -1) return -1;
            try
            {
        ...
        public int DelResRoleMap(string privId)
        {
            ...
            string sql = "";
            if (this.GetSQL("SECURITY.RESOURCE.DELROLEMAPBYRESOURCE", ref sql) == -1) return -1;
            try
            {
        ...
        public IDictionary<Priv, IList<Operation>> QueryPermission(string resTypeId, string resId, Role role)
        {
            ...
            string sql = "";
            if (this.GetSQL("SECURITY.RESOURCE.QUERYPERMISSION", ref sql) == -1) return null;
            try
            {
                sql = string.Format(sql, args);
            }
        ...
        public IDictionary<Priv, IList<Operation>> QueryPermission(string resTypeId, Role role)
        {
            ...
            string sql = "";
            if (this.GetSQL("SECURITY.RESOURCE.QUERYPERMISSIONBYROLE", ref sql) == -1) return null;
            try
            {
