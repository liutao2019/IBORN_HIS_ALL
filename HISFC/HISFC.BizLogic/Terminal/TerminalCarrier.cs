...
namespace FS.HISFC.BizLogic.Terminal
{
    ...
    ///  />
    /// </summary>
    public class TerminalCarrier : FS.FrameWork.Management.Database
    {
        ...
        /// <returns></returns>         
        public int InsertTerminalCarrier(FS.HISFC.Models.Terminal.TerminalCarrier terminalCarrier)
        {
            string strSQL = "";
        ...
        /// <param name="terminalCarrier"></param>
        /// <returns></returns>
        private string[] GetTerminalCarrierParam(FS.HISFC.Models.Terminal.TerminalCarrier terminalCarrier)
        {
        ...
        /// <param name="terminalCarrier"></param>
        /// <returns></returns>
        private string[] GetTerminalCarrierParam2(FS.HISFC.Models.Terminal.TerminalCarrier terminalCarrier)
        {
            string[] strParam = new string[] { 
        ...
        /// <param name="terminalCarrier"></param>
        /// <returns></returns>
        public int UpdateTerminalCarrier(FS.HISFC.Models.Terminal.TerminalCarrier terminalCarrier)
        {
            string strSQL = "";
            //更新取药科室信息
        ...
        /// <param name="terminal"></param>
        /// <returns>医技设备信息集合</returns>
        public FS.HISFC.Models.Terminal.TerminalCarrier GetItem(string terminal, string deptCode)
        {
            string strSQL = null;
            string strWhere = null;
        ...
        private FS.HISFC.Models.Terminal.TerminalCarrier GetComponentDetail2(string strSQL)
        {

            FS.HISFC.Models.Terminal.TerminalCarrier terminal = null;
            try
            {
