        ...
        private ArrayList QueryGroup(string strSql)
        {
            ...
            try
            {
                ...
                while (this.Reader.Read())
                {
                    ...
                    info.OwnRate = FS.FrameWork.Function.NConvert.ToDecimal(Reader[8]);//自费比例 
                    info.PayRate = FS.FrameWork.Function.NConvert.ToDecimal(Reader[9]);//自付比例9
                    info.PubRate = FS.FrameWork.Function.NConvert.ToDecimal(Reader[10].ToString());//公费比例10
                    info.EcoRate = FS.FrameWork.Function.NConvert.ToDecimal(Reader[11]);//优惠比例11
                    info.ValidState = (FS.HISFC.Models.Base.EnumValidState)(FS.FrameWork.Function.NConvert.ToInt32(Reader[12].ToString()));//停用标志12
