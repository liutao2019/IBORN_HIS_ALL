...
namespace FS.HISFC.BizLogic.Operation
{
	...
	public abstract class OpsReport : FS.FrameWork.Management.Database 
	{
		...
		public ArrayList GetReport03(DateTime BeginTime,DateTime EndTime)
		{
			...
			FS.HISFC.Models.Base.SexEnumService sex = new FS.HISFC.Models.Base.SexEnumService();//性别
			//获取年龄
			...
			FS.FrameWork.Models.NeuObject OpsKind = new FS.FrameWork.Models.NeuObject();//手术分类
			#endregion
