...
namespace FS.HISFC.BizLogic.Registration
{
	...
	/// 医生出诊排班管理类
	/// </summary>
	public class DoctSchema:FS.FrameWork.Management.Database
	{
		/// <summary>
		/// 
		/// </summary>
		...
		/// 午别实体
		/// </summary>
		private FS.HISFC.Models.Registration.Noon noon=null;
		/// <summary>
		/// 排班实体
		/// </summary>
		private FS.HISFC.Models.Registration.DoctSchema schema=null;
		...
		/// <returns></returns>
		public int Insert(FS.HISFC.Models.Registration.DoctSchema schema)
		{	
			string sql="";
			...
			try
			{
				sql=string.Format(sql,schema.SeeDate,schema.Week,schema.NoonID,schema.Doctor.ID,
					...
					schema.PreRegLimit,FS.FrameWork.Function.NConvert.ToInt32(schema.IsValid),schema.StopReason.ID,schema.StopReason.Name,
		...
		/// <returns></returns>
		public int Insert(FS.HISFC.Models.Registration.Noon noon)
		{
			string sql="";
		...
		/// <param name="schema"></param>
		/// <returns></returns>
		public int Delete(FS.HISFC.Models.Registration.DoctSchema schema)
		{
			string sql="";
		...
		/// <param name="noon"></param>
		/// <returns></returns>
		public int Delete(FS.HISFC.Models.Registration.Noon noon)
		{
			string sql="";
		...
		/// <param name="schema"></param>
		/// <returns></returns>
		public int Update(FS.HISFC.Models.Registration.DoctSchema schema)
		{
			string sql="";
			...
			try
			{
				sql=string.Format(sql,schema.ID,schema.RegLimit,schema.PreRegLimit,FS.FrameWork.Function.NConvert.ToInt32(schema.IsValid),
		...
		public ArrayList Query()
		{
			...
			try
			{
				...
				{
					noon=new FS.HISFC.Models.Registration.Noon();
					noon.ID=this.Reader[2].ToString();//id
					noon.Name=this.Reader[3].ToString();//name

					if(Reader.IsDBNull(4)==false)
						noon.BeginTime=FS.FrameWork.Function.NConvert.ToDateTime(Reader[4].ToString());//开始时间
					if(Reader.IsDBNull(5)==false)
						noon.EndTime=FS.FrameWork.Function.NConvert.ToDateTime(Reader[5].ToString());//结束时间
					if(Reader.IsDBNull(6)==false)
						noon.IsUrg=FS.FrameWork.Function.NConvert.ToBoolean(Reader[6].ToString());//是否急诊
		...
		/// <returns></returns>
		public ArrayList Query(DateTime seatDate,FS.FrameWork.Models.NeuObject dept,string noonID)
		{
			string sql="",where="";
		...
		/// <returns></returns>
		public FS.HISFC.Models.Registration.DoctSchema Query(DateTime seeDate,string noon,string doctID)
		{
			string sql="",where="";
			...
			if(al==null||al.Count==0)
				...
				return (FS.HISFC.Models.Registration.DoctSchema)al[0];
		}
		/// <summary>
		/// 按sql查询排班信息
		/// </summary>
		...
		private ArrayList QuerySchema(string sql)
		{
			...
			try
			{
				...
				while(this.Reader.Read())
				{
					schema=new FS.HISFC.Models.Registration.DoctSchema();
					schema.SeeDate=FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[2].ToString());//出诊时间
					...
					if(this.Reader.IsDBNull(13)==false)
						schema.RegLimit=FS.FrameWork.Function.NConvert.ToInt32(this.Reader[13].ToString());//挂号限额
					if(this.Reader.IsDBNull(14)==false)
                        schema.PreRegLimit=FS.FrameWork.Function.NConvert.ToInt32(this.Reader[14].ToString());//预约挂号限额
					schema.HasReg=FS.FrameWork.Function.NConvert.ToInt32(this.Reader[16].ToString());//已挂
					schema.HasPreReg=FS.FrameWork.Function.NConvert.ToInt32(this.Reader[17].ToString());//预约已挂
					schema.IsValid=FS.FrameWork.Function.NConvert.ToBoolean(this.Reader[20].ToString());
					...
					schema.StopDate=FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[24].ToString());
					schema.Memo=this.Reader[25].ToString();//备注
					schema.OperID=this.Reader[26].ToString();//操作时间
					schema.OperDate=FS.FrameWork.Function.NConvert.ToDateTime(this.Reader[27].ToString());
