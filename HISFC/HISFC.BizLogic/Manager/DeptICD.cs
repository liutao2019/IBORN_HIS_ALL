...
namespace FS.HISFC.BizLogic.Manager
{
    ...
    public class DeptICD : DataBase
    {
        ...
        /// <returns></returns>
        public int InsertDeptDiag(FS.FrameWork.Models.NeuObject deptDiag)
        {
            string strSql = "";

            if (this.GetSQL("Manager.DeptDiag.InsertDiag", ref strSql) == -1)
            {
        ...
        /// <returns></returns>
        public int DeleteDeptDiag(FS.FrameWork.Models.NeuObject deptDiag)
        {
            string strSql = "";

            if (this.GetSQL("Manager.DeptDiag.DeleteDiag", ref strSql) == -1)
            {
                this.Err = this.Sql.Err;
                return -1;
            }
        ...
        public ArrayList QueryDeptDiagByDept(string deptID)
        {
            ...
            if (this.GetSQL("Manager.DeptDiag.QueryDiagByDept", ref strSql) == -1)
            {
                this.Err = this.Sql.Err;
                return null;
            }
