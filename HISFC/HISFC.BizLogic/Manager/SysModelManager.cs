...
namespace FS.HISFC.BizLogic.Manager
{
	...
	/// 
	/// </summary>
	public class SysModelManager : DataBase
	{
		...
		public SysModel LoadByPrimaryKey(string id0)
		{
			...
			if (this.GetSQL("Manager.SysModelManager.LoadByPrimaryKey",ref strSql)==-1) return null;
			try
			{
		...
		public int InsertSysModel(SysModel info)
		{
			...
			if (this.GetSQL("Manager.SysModelManager.InsertSysModel",ref strSql)==-1) return -1;
			try
			{
		...
		{			
			string strSql = "";
			if (this.GetSQL("Manager.SysModelManager.UpdateSysModel",ref strSql)==-1) return -1;
		...
		public int Delete(string sysCode)
		{
			...
			if (this.GetSQL("Manager.SysModelManager.DeleteQuery",ref deleteQuery)==-1) return -1;
			try
			{
			...
			string strSql = "";
			if (this.GetSQL("Manager.SysModelManager.DeleteSysModel",ref strSql)==-1) return -1;
