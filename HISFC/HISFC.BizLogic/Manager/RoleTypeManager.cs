...
namespace FS.HISFC.BizLogic.Manager
{
	...
	/// 
	/// </summary>
	public class RoleTypeManager : DataBase
	{
		...
		public int InsertRoleType(RoleType info)
		{
			...
			if (this.GetSQL("Manager.RoleTypeManager.InsertRoleType",ref strSql)==-1) return -1;
			try
			{
		...
		{			
			string strSql = "";
			if (this.GetSQL("Manager.RoleTypeManager.UpdateRoleType",ref strSql)==-1) return -1;
		...
		{
			string strSql = "";
			if (this.GetSQL("Manager.RoleTypeManager.DeleteRoleType",ref strSql)==-1) return -1;
