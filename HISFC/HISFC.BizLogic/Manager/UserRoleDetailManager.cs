...
namespace FS.HISFC.BizLogic.Manager
{
	...
	/// 
	/// </summary>
	public class UserRoleDetailManager : DataBase
	{
		...
		public UserRoleDetail LoadByPrimaryKey(string id)
		{
			...
			if (this.GetSQL("Manager.UserRoleDetailManager.LoadByPrimaryKey",ref strSql)==-1) return null;
			try
			{
		...
		public int InsertUserRoleDetail(UserRoleDetail info)
		{
			...
			if (this.GetSQL("Manager.UserRoleDetailManager.InsertUserRoleDetail",ref strSql)==-1) return -1;
			try
			{
		...
		{			
			string strSql = "";
			if (this.GetSQL("Manager.UserRoleDetailManager.UpdateUserRoleDetail",ref strSql)==-1) return -1;
		...
		{
			string strSql = "";
			if (this.GetSQL("Manager.UserRoleDetailManager.DeleteUserRoleDetail",ref strSql)==-1) return -1;
		...
		{
			string strSql = "";
			if (this.GetSQL("Manager.UserRoleDetailManager.DeleteByRoleCode",ref strSql)==-1) return -1;
