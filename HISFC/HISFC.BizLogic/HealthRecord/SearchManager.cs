    ...
    public  class SearchManager : FS.FrameWork.Management.Database
    {
        ...
        public int QueryDeptCaseInfo(DateTime dtBegin, DateTime dtEnd, ref DataSet ds)
        {
            ...
            try
            {
                ...
                {
                    this.Err = "获取SQL语句失败, 索引Case.SearchManager.QueryDeptCaseInfo";
                    return -1;
                }
                //组建查询语句 
        ...
        /// <summary>
        /// 查询一段时间内，按科室出院患者未录入病案信息明细
        /// </summary>
        /// <param name="date">出院时间</param>
        /// <param name="dept">科室明细</param>
        /// <returns></returns>
        public int QueryDeptCaseInfoDetail(DateTime date, string dept, ref DataSet ds)
        {
            ...
            try
            {
                ...
                {
                    this.Err = "获取SQL语句失败, 索引Case.SearchManager.QueryDeptCaseInfoDetail";
                    return -1;
                }
                //组建查询语句 
