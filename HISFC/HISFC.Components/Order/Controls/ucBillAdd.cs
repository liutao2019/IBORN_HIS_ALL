...
namespace FS.HISFC.Components.Order.Controls
{
    ...
    public partial class ucBillAdd : UserControl
    {
        ...
        public bool IsNull(FS.FrameWork.WinForms.Controls.NeuTextBox obj)
        {
            ...
            {
                MessageBox.Show(FS.FrameWork.Management.Language.Msg("文本框不能为空！"));
                return false;
            }
        }
        ...
        private bool IsRepeat()
        {
            ...
            for (int i = 0; i < arr.Count; i++)
            {
                ...
                {
                    MessageBox.Show(FS.FrameWork.Management.Language.Msg("名字重复！"));
                    bRet = false;
                }
            }
            return bRet;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(FS.FrameWork.Management.Language.Msg("执行单类别不能为空"));
                return;
            }
            ...
            else
            {
                ...
                {
                    MessageBox.Show(FS.FrameWork.Management.Language.Msg("更新成功！"));
                    r.Result1 = txtExecBillName.Text;
                    this.FindForm().Close();
                }
                else
                {
                    MessageBox.Show(FS.FrameWork.Management.Language.Msg("更新失败"));
                }
            }
        }
