...
namespace FS.HISFC.Components.Order.Controls
{
    ...
    public partial class ucOrderCompound : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        {
            toolBarService.AddToolButton("日期", "时间段区间设定", FS.FrameWork.WinForms.Classes.EnumImageList.S设置, true, false, null);
            toolBarService.AddToolButton("全选", "全选", FS.FrameWork.WinForms.Classes.EnumImageList.Q全选, true, false, null);
            toolBarService.AddToolButton("全不选", "全不选", FS.FrameWork.WinForms.Classes.EnumImageList.Q清空, true, false, null);
        ...
        {
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm(Language.Msg("正在加载打印接口信息.."));
        ...
        protected int AddDataToFp(FS.HISFC.Models.Order.ExecOrder execOrder,int iRowIndex)
        {
            ...
            else
            {
                ...
                if (patient == null)
                {
                    MessageBox.Show(Language.Msg("根据患者流水号获取患者信息发生错误") + CacheManager.RadtIntegrate.Err);
                    return -1;
                }
        ...
        protected int ShowCompounding()
        {
            ...
            if (al == null)
            {
                MessageBox.Show(Language.Msg("待配液信息查询失败") + CacheManager.OutOrderMgr.Err);
                return -1;
            }
