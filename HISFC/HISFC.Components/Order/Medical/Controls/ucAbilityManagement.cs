...
namespace FS.HISFC.Components.Order.Medical.Controls
{
    ...
    ///  />
    /// </summary>
    public partial class ucAbilityManagement : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        /// </summary>
        private FS.HISFC.Models.Order.Medical.Ability ability = new FS.HISFC.Models.Order.Medical.Ability();

        /// <summary>
        /// 资质业务类

        /// </summary>
        private FS.HISFC.BizLogic.Order.Medical.Ability aby = new FS.HISFC.BizLogic.Order.Medical.Ability();

        /// <summary>
        /// 帮助类

        /// </summary>
        private FS.FrameWork.Public.ObjectHelper ehSpeciality = new FS.FrameWork.Public.ObjectHelper();
        private FS.FrameWork.Public.ObjectHelper ehVocationType = new FS.FrameWork.Public.ObjectHelper();
        private FS.FrameWork.Public.ObjectHelper ehLevel = new FS.FrameWork.Public.ObjectHelper();
        private FS.FrameWork.Public.ObjectHelper ehEdu = new FS.FrameWork.Public.ObjectHelper();
        private FS.FrameWork.Public.ObjectHelper ehDept = new FS.FrameWork.Public.ObjectHelper();
        ...
        private void NewAbility()
        {
            ...
            {
                FS.HISFC.Models.Base.Employee empls = new FS.HISFC.Models.Base.Employee();
                empls = tv.SelectedNode.Tag as FS.HISFC.Models.Base.Employee;
        ...
        private void SaveAbility()
        {
            ...
            FS.HISFC.Models.Order.Medical.Ability abilityFC = new FS.HISFC.Models.Order.Medical.Ability();
            ...
            List<FS.HISFC.Models.Order.Medical.Ability> abList = new List<FS.HISFC.Models.Order.Medical.Ability>();
        ...
        private void tv_AfterSelect(object sender, TreeViewEventArgs e)
        {
            if (tv.SelectedNode != null)
            {
                if (tv.SelectedNode.ToolTipText == "人员")
                {
                    List<FS.HISFC.Models.Order.Medical.Ability> abList;
                    FS.HISFC.Models.Base.Employee empls = new FS.HISFC.Models.Base.Employee();
                    empls = tv.SelectedNode.Tag as FS.HISFC.Models.Base.Employee;
                ...
                {
                    List<FS.HISFC.Models.Order.Medical.Ability> abList;
                    FS.HISFC.Models.Base.Department depts = new FS.HISFC.Models.Base.Department();
                    depts = tv.SelectedNode.Tag as FS.HISFC.Models.Base.Department;
        ...
        private void Init()
        {
            ...
            this.cbSpeciality.AddItems(GetConstant(FS.HISFC.Models.Base.EnumConstant.SPECIALITY));

            this.cbVocationType.IsListOnly = true;
            this.cbVocationType.AddItems(GetConstant(FS.HISFC.Models.Base.EnumConstant.VOCATIONTYPE));
        }
        ...
        {
            ehSpeciality.ArrayObject = GetConstant(FS.HISFC.Models.Base.EnumConstant.SPECIALITY);//专业
            ehVocationType.ArrayObject = GetConstant(FS.HISFC.Models.Base.EnumConstant.VOCATIONTYPE);//执业类型
            FS.HISFC.BizLogic.Manager.Department deptMgr = new FS.HISFC.BizLogic.Manager.Department();
            ehDept.ArrayObject = deptMgr.GetDeptNoNurse();//科室
            ehEdu.ArrayObject = GetConstant(FS.HISFC.Models.Base.EnumConstant.EDUCATION);//学历
            ehLevel.ArrayObject = GetConstant(FS.HISFC.Models.Base.EnumConstant.LEVEL);//职级
        }
        ...
        private void FillFP(List<FS.HISFC.Models.Order.Medical.Ability> abList)
        {
            if (abList == null)
            {
            ...
            {
                FS.HISFC.Models.Order.Medical.Ability abtemp = new FS.HISFC.Models.Order.Medical.Ability();
                //根据记录行数动态加载FarPoint的行，每次循环加一行

                this.fpAbility_Sheet1.Rows.Add(rowCount, 1);
                abtemp = abList[rowCount] as FS.HISFC.Models.Order.Medical.Ability;
        ...
        private bool CheckDataValid()
        {
            ...
            int recordCount = FS.FrameWork.Function.NConvert.ToInt32(strRecordCount);
        ...
        private FS.HISFC.Models.Order.Medical.Ability FillObj()
        {
            FS.HISFC.Models.Order.Medical.Ability abtemp = new FS.HISFC.Models.Order.Medical.Ability();
