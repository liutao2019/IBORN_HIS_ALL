namespace FS.HISFC.Components.Order.OutPatient.Controls
{
    partial class ucInject
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tvPatientList1 = new FS.FrameWork.WinForms.Controls.NeuTreeView();
            ...
            this.neuSpread1.Size = new System.Drawing.Size(484, 166);
            ...
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 1).Value = "操作员";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "操作时间";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "收取数量";
            this.neuSpread1_Sheet1.Columns.Get(0).Label = "项目名称";
            this.neuSpread1_Sheet1.Columns.Get(0).Locked = true;
            this.neuSpread1_Sheet1.Columns.Get(0).Width = 207F;
            this.neuSpread1_Sheet1.Columns.Get(1).Label = "操作员";
            ...
            this.neuSpread1_Sheet1.Columns.Get(2).Label = "操作时间";
        ...
        "每组*医嘱数量"};
            ...
            this.neuSpread1_Sheet1.Columns.Get(3).Label = "收取数量";
        ...
        private FS.FrameWork.WinForms.Controls.NeuTreeView tvPatientList1;
