...
namespace FS.HISFC.Components.Order.Forms
{
    ...
    public partial class frmMedcialTeam : Form
    {
        ...
        /// 医疗组信息
        /// </summary>
        private FS.HISFC.Models.Order.Inpatient.MedicalTeam medicalTeam = new FS.HISFC.Models.Order.Inpatient.MedicalTeam();

        /// <summary>
        /// 医疗组业务层
        /// </summary>
        private FS.HISFC.BizLogic.Order.MedicalTeam medicalTeamLogic = new FS.HISFC.BizLogic.Order.MedicalTeam();
        ...
        private void Save()
        {
            ...
            FS.HISFC.Models.Order.Inpatient.MedicalTeam medcialTeamClone = this.MedicalTeam.Clone();
