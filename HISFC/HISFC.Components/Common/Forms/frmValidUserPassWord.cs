...
{ /// <summary>
    ...
    public partial class frmValidUserPassWord : Form
    {
        ...
        private void btOK_Click(object sender, EventArgs e)
        {
            ...
            //strPassWord = FS.HisDecrypt.Encrypt(strPassWord);
            //{FE5ED8FD-0B48-438b-A362-946D70846053}
            //strPassWord = FS.HisCrypto.HisDecrypt.Encrypt(strPassWord);
            //{DF872D00-4B21-40af-B299-CF3016DC7C6E}
            strPassWord = FS.HisCrypto.DESCryptoService.DESEncrypt(strPassWord, FS.FrameWork.Management.Connection.DESKey);
