...
namespace FS.HISFC.Components.Common.Controls
{
    ...
    public partial class ucUserCommonText : UserControl
    {
        ...
        public void RefreshList()
        {
            ...
            //获得当前操作员工
            FS.HISFC.Models.Base.Employee p = manager.Operator as FS.HISFC.Models.Base.Employee;
            if (p == null) return;
        ...
        {
            FS.HISFC.BizLogic.File.DataFile datafileManager = new FS.HISFC.BizLogic.File.DataFile();
