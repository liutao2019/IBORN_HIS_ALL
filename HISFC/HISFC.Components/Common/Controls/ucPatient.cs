...
namespace FS.HISFC.Components.Common.Controls
{
    public partial class ucPatient : UserControl
    {
        ...
        public void InitializeContral(bool[] bArray)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < 16; i++)
                {
                    ...
                    {
                        int ilocId = 0;
                        arrObj[j] = (FS.FrameWork.WinForms.Controls.NeuPanel)myALContral[i];
                        ilocId = j;
        ...
        public void SetPatientInfo(FS.HISFC.Models.RADT.PatientInfo pInfo)
        {

            if (pInfo == null)
            {
                pInfo = new FS.HISFC.Models.RADT.PatientInfo();
            }
            try
            {
                ...
                this.txtCautioner.Text = pInfo.Surety.Name;//担保人
                ...
                this.txtCautionMoney.Text = pInfo.Surety.SuretyCost.ToString();//担保金额
        ...
        private string GetStrPatientInfo(FS.HISFC.Models.RADT.PatientInfo pInfo)
        {
        ...
        public void GetPatientInfo()
        {
            try
            {
                ...
                myPatientInfo.Surety.Name = this.txtCautioner.Text;
        ...
        private void ucPatient_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //初始化结算方式
                this.cmbBalanceType.AddItems(Constant.GetList(FS.HISFC.Models.Base.EnumConstant.PAYKIND));
