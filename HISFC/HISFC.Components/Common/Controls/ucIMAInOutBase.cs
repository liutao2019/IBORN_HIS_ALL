...
namespace FS.HISFC.Components.Common.Controls
{
    ...
    public partial class ucIMAInOutBase : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        {
            toolBarService.AddToolButton("删  除", "删除明细信息", FS.FrameWork.WinForms.Classes.EnumImageList.S删除, true, false, null);
            toolBarService.AddToolButton("申请单", "显示申请信息", FS.FrameWork.WinForms.Classes.EnumImageList.X新建, true, false, null);
            toolBarService.AddToolButton("入库单", "显示入库单据", FS.FrameWork.WinForms.Classes.EnumImageList.X信息, true, false, null);
            toolBarService.AddToolButton("出库单", "显示出库单据", FS.FrameWork.WinForms.Classes.EnumImageList.X修改, true, false, null);
            toolBarService.AddToolButton("采购单", "显示采购单据", FS.FrameWork.WinForms.Classes.EnumImageList.Z作废信息, true, false, null);
            toolBarService.AddToolButton("导  入", "导入入库信息", FS.FrameWork.WinForms.Classes.EnumImageList.T添加, true, false, null);
        ...
        public int SetTargetDept(bool isCompany,bool isPrivInOut,bool isAddSelf , FS.HISFC.Models.IMA.EnumModuelType companyType, FS.HISFC.Models.Base.EnumDepartmentType deptType)
        {
            ...
            if (isCompany)
            {
                ...
                {                   
                    ...
                    case FS.HISFC.Models.IMA.EnumModuelType.Material:          //物资
                        ...
                        //{
                        //    MessageBox.Show(FS.FrameWork.Management.Language.Msg("加载物资供货公司列表失败" + companyManager.Err));
                        //    return -1;
                        //}
                        break;
                    case FS.HISFC.Models.IMA.EnumModuelType.Phamacy:           //药品
                        ...
                        if (this.alTargetDept == null)
                        {
                            MessageBox.Show(FS.FrameWork.Management.Language.Msg("加载药品供货公司列表失败" + phaConstantManager.Err));
                            return -1;
                        }
                        break;
                }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (this.alTargetDept == null)
                    {
                        MessageBox.Show(FS.FrameWork.Management.Language.Msg("根据科室类别获取科室列表发生错误") + managerIntegrate.Err);
                        return -1;
                    }
                    foreach (FS.FrameWork.Models.NeuObject info in this.alTargetDept)
                    {
        ...
        public int SetTargetPerson(bool isAllEmployee,FS.HISFC.Models.Base.EnumEmployeeType employeeType)
        {
            ...
            {
                MessageBox.Show(FS.FrameWork.Management.Language.Msg("根据人员类别获取人员列表发生错误") + managerIntegrate.Err);
                return -1;
            }
