...
namespace FS.HISFC.Components.Common.Controls
{
    ...
    /// [创建时间: 2006-12]<br></br>
    /// </summary>
    public partial class ucIMAListSelecct : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        public delegate void SelectListHandler(string listCode, string state, FS.FrameWork.Models.NeuObject targetDept);
        ...
        /// 当前操作的权限类型
        /// </summary>
        private FS.FrameWork.Models.NeuObject privType = null;
        ...
        public DateTime BeginDate
        {
            get
            {
                return FS.FrameWork.Function.NConvert.ToDateTime(this.dtpBegin.Text).Date;
            }
        }
        ...
        public DateTime EndDate
        {
            get
            {
                return FS.FrameWork.Function.NConvert.ToDateTime(this.dtpEnd.Text).Date.AddDays(1);
            }
        }
        ...
        private void fpSpread1_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            if (this.SelecctListEvent != null)
            {
                ...
                FS.FrameWork.Models.NeuObject company = new FS.FrameWork.Models.NeuObject();
