namespace FS.HISFC.Components.Common.Controls
{
    partial class tvDoctorGroup
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            this.AllowDrop = true;
            this.DragDrop += new System.Windows.Forms.DragEventHandler(this.tvDoctorGroup_DragDrop);
            this.AfterSelect += new System.Windows.Forms.TreeViewEventHandler(this.tvDoctorGroup_AfterSelect);
            this.DragEnter += new System.Windows.Forms.DragEventHandler(this.tvDoctorGroup_DragEnter);
            this.ItemDrag += new System.Windows.Forms.ItemDragEventHandler(this.tvDoctorGroup_ItemDrag);
            this.DragOver += new System.Windows.Forms.DragEventHandler(this.tvDoctorGroup_DragOver);
