...
namespace FS.HISFC.Components.Common.Controls
{
    ...
    public partial class tvItemLevel : FS.FrameWork.WinForms.Controls.NeuTreeView
    {
        ...
        //    //				}
        //    //			}
        //    if (moveNode.Tag as FS.HISFC.Models.Fee.Item.ItemLevel == null) //是组套父节点 返回
        //    {
        //        return;
        //    }
        //    if ((moveNode.Tag as FS.HISFC.Models.Fee.Item.ItemLevel).UserCode == "F")//是文件夹节点 返回
        //    {
        //        return;
        //    }
        //    if (aimNode.Tag as FS.HISFC.Models.Fee.Item.ItemLevel == null)//目标节点 是父节点
        //    {
        //        return;
        //    }
        //    if ((aimNode.Tag as FS.HISFC.Models.Fee.Item.ItemLevel).UserCode != "F")//目标节点不是文件夹
        //    {
        //        return;
        //    }
