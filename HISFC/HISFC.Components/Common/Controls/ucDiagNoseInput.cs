...
{ /// <summary>
    ...
    ///		修改描述=''
    ///  />
    /// <备注： 本控件可以通过属性设置，来实现分别保存医生录入诊断和病案室录入诊断
    /// />
    /// </summary>
    public partial class ucDiagNoseInput : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolBarService.AddToolButton("刷新", "刷新", FS.FrameWork.WinForms.Classes.EnumImageList.S刷新, true, false, null);
            toolBarService.AddToolButton("删除", "删除", FS.FrameWork.WinForms.Classes.EnumImageList.S删除, true, false, null);
            toolBarService.AddToolButton("打印", "打印", FS.FrameWork.WinForms.Classes.EnumImageList.D打印, true, false, null);
