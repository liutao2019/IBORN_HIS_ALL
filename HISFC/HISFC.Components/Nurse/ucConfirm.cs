...
namespace FS.HISFC.Components.Nurse
{
    public partial class ucConfirm : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        {
            this.toolBarService.AddToolButton("列表", "", FS.FrameWork.WinForms.Classes.EnumImageList.M默认, true, false, null);
            this.toolBarService.AddToolButton("全选", "", FS.FrameWork.WinForms.Classes.EnumImageList.Q全选, true, false, null);
            this.toolBarService.AddToolButton("取消", "", FS.FrameWork.WinForms.Classes.EnumImageList.Q取消, true, false, null);
        ...
        private void AddDetail(FS.HISFC.Models.Nurse.Inject info)
        {
            ...
            this.neuSpread1_Sheet1.SetValue(row, 4, this.GetDoctByID(info.Item.Order.ReciptDoctor.ID), false);//开单医生
