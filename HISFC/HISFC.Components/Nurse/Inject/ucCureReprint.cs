...
namespace FS.HISFC.Components.Nurse.Inject
{
    ...
    ///		/>
    /// </summary>
    public partial class ucCureReprint : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        #region 构造函数
        ...
        private void AddInjectToTable(FS.HISFC.Models.Nurse.Inject inject)
        {
            DataRow dr = this.dt.NewRow();
            this.dt.Rows.Add(dr);
            dr["患者姓名"] = inject.Patient.Name;
            dr["开单医生"] = inject.Item.Order.ReciptDoctor.Name;
