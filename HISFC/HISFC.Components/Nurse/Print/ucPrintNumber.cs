...
namespace FS.HISFC.Components.Nurse.Print
{
    ...
    ///		/>
    /// </summary>
    public partial class ucPrintNumber : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.Nurse.IInjectNumberPrint
    {
        #region 构造函数
        ...
        /// 整合的管理业务层
        /// </summary>
        private HISFC.BizProcess.Integrate.Manager interManager = new FS.HISFC.BizProcess.Integrate.Manager();
