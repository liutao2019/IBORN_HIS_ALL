...
namespace FS.HISFC.Components.Nurse
{
    public partial class ucSeat : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        {
            this.toolBarService.AddToolButton("添加房间", "添加一个新的房间", (int)FS.FrameWork.WinForms.Classes.EnumImageList.X新建, true, false, null);
            this.toolBarService.AddToolButton("删除房间", "删除一个已经房间", (int)FS.FrameWork.WinForms.Classes.EnumImageList.Z注销, true, false, null);
            this.toolBarService.AddToolButton("增加", "增加明细", (int)FS.FrameWork.WinForms.Classes.EnumImageList.T添加, true, false, null);
            this.toolBarService.AddToolButton("删除", "删除明细", (int)FS.FrameWork.WinForms.Classes.EnumImageList.S删除, true, false, null);
