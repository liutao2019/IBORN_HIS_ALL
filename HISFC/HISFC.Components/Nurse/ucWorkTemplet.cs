...
namespace FS.HISFC.Components.Nurse
{
    ...
    public partial class ucWorkTemplet : UserControl
    {
        ...
        /// 排班模版类
        /// </summary>
        protected FS.HISFC.BizLogic.Nurse.WorkTemplet workTemplet = new FS.HISFC.BizLogic.Nurse.WorkTemplet();
        /// <summary>
        /// 午别列表
        /// </summary>
        ...
        public void Query(string deptID)
        {
            ...
            try
            {
                foreach (FS.HISFC.Models.Nurse.WorkTemplet templet in al)
                {
        ...
        public int Save()
        {
            ...
            this.workTemplet.SetTrans(FS.FrameWork.Management.PublicTrans.Trans);
        ...
        /// <returns></returns>
        private int SaveAdd(FS.HISFC.BizLogic.Nurse.WorkTemplet templetMgr, ArrayList alAdd, ref string Err)
        {
            try
            {
                foreach (FS.HISFC.Models.Nurse.WorkTemplet templet in alAdd)
                {
        ...
        /// <param name="Err"></param>
        /// <returns></returns>
        private int SaveModify(FS.HISFC.BizLogic.Nurse.WorkTemplet templetMgr, ArrayList alModify, ref string Err)
        {
            try
            {
                foreach (FS.HISFC.Models.Nurse.WorkTemplet templet in alModify)
                {
                    int returnValue = 0;
        ...
        /// <param name="Err"></param>
        /// <returns></returns>
        private int SaveDel(FS.HISFC.BizLogic.Nurse.WorkTemplet templetMgr, DataTable dvDel, ref string Err)
        {
            try
            {
        ...
        private ArrayList GetChanges(DataTable dt)
        {
            ...
            if (dt != null)
            {
                try
                {
                    ...
                    {
                        FS.HISFC.Models.Nurse.WorkTemplet templet = new FS.HISFC.Models.Nurse.WorkTemplet();
                        ...
                        templet.Oper.ID = FS.FrameWork.Management.Connection.Operator.ID;
                        this.al.Add(templet);
                    }
                }
                catch (Exception e)
