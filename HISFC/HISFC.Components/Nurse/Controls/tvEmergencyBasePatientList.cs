...
namespace FS.HISFC.Components.Nurse.Controls
{
    ...
    ///  />
    /// </summary>
    public class tvEmergencyBasePatientList : FS.HISFC.Components.Common.Controls.tvPatientList
    {
        ...
        private void RefreshList()
        {
            ...
            for (int i = 0; i < this.myPatients.Count; i++)
            {
                ...
                //类型为叶
                if (this.myPatients[i].GetType().ToString() == "FS.HISFC.Models.Registration.Register")
                {
                    try
                    {
                        
                        FS.HISFC.Models.Registration.Register PatientInfo = (FS.HISFC.Models.Registration.Register)this.myPatients[i];
                ...
                else if (this.myPatients[i].GetType().ToString() == "FS.HISFC.Models.RADT.Patient")
                {
                    FS.HISFC.Models.RADT.Patient PatientInfo = (FS.HISFC.Models.RADT.Patient)this.myPatients[i];
                    obj.ID = PatientInfo.PID.PatientNO;
                    obj.Name = PatientInfo.Name;
                    obj.Memo = "";
                    obj.User01 = "";
                ...
                else if (this.myPatients[i].GetType().ToString() == "FS.FrameWork.Models.NeuObject")
                {
                    obj = (FS.FrameWork.Models.NeuObject)this.myPatients[i];
        ...
        public void ModifiyNode(System.Windows.Forms.TreeNode node, FS.HISFC.Models.Registration.Register patientInfo)
        {
            try
            {
        ...
        public void AddTreeNode(int branch, FS.FrameWork.Models.NeuObject nodeTextInfo, object nodeTag)
        {
        ...
        /// <param name="branch">一级节点索引</param>
        /// <param name="patientInfo">患者信息</param>
        public void AddTreeNode(int branch, FS.HISFC.Models.Registration.Register patientInfo)
        {
            try
            {
        ...
        private void tvEmergencyObservePatientList_MouseMove(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            if (this.bIsShowPatientNo)
            {
                ...
                FS.HISFC.Models.Registration.Register info = null;
                System.Drawing.Point p = new System.Drawing.Point(e.X, e.Y);
                node = this.GetNodeAt(p);
                if (node == null) return;
                info = node.Tag as FS.HISFC.Models.Registration.Register;
                if (info == null) return;
