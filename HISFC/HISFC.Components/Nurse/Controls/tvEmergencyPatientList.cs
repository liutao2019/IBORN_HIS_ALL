...
namespace FS.HISFC.Components.Nurse.Controls
{
    ...
    ///  />
    /// </summary>
    public partial class tvEmergencyPatientList:FS.HISFC.Components.Nurse.Controls.tvEmergencyBasePatientList
    {
        public tvEmergencyPatientList()
        {
            ...
            //if (FS.FrameWork.Management.Connection.Instance != null)
            this.Refresh();
        }
        ...
        FS.HISFC.BizLogic.Registration.Register manager = null;
        ...
        public override void Refresh()
        {
            ...
            if (manager == null)
            {
                manager = new FS.HISFC.BizLogic.Registration.Register();
            }
            ...
            addPatientList(al, FS.HISFC.Models.Base.EnumInState.R, EnumPatientType.Arrive);

            // {1C0814FA-899B-419a-94D1-789CCC2BA8FF}
            //显示本护理站出关登记的患者
            al.Add("出观登记患者|" + EnumPatientType.PreOut.ToString());
            addPatientList(al, FS.HISFC.Models.Base.EnumInState.P, EnumPatientType.PreOut);

            al.Add("留观转住院|" + EnumPatientType.PreIn.ToString());
            addPatientList(al, FS.HISFC.Models.Base.EnumInState.E, EnumPatientType.PreIn);

            //显示本护理站出院登记的患者
            al.Add("留观结束患者|" + EnumPatientType.Out.ToString());
            addPatientList(al, FS.HISFC.Models.Base.EnumInState.B, EnumPatientType.Out);
            addPatientList(al, FS.HISFC.Models.Base.EnumInState.C, EnumPatientType.Out);
            //显示所有患者列表
            this.SetPatient(al);
        ...
        //    //addPatientList(al, FS.HISFC.Models.Base.EnumInState.I, EnumPatientType.ShiftIn);

        //    ////显示本护理站转科申请的患者
        //    //al.Add("转出患者|" + EnumPatientType.ShiftOut.ToString());
        //    //addPatientList(al, FS.HISFC.Models.Base.EnumInState.I, EnumPatientType.ShiftOut);
