...
namespace FS.HISFC.Components.Terminal.Confirm
{
	...
	///  />
	/// </summary>
    public partial class ucTerminalConfirm : FS.FrameWork.WinForms.Controls.ucBaseControl
	{
        ...
        public bool IsNeedOper
        {
            ...
            {
                isNeedOper = value;
                this.ucItemApply.IsNeedOper = value;
            }
        }
		...
		public void InitUC()
		{
            ...
            this.ucItemApply.IsConfirmItem = this.isConfirmItem;//{D861514B-EEF3-4e93-99F7-21D03BBBD917}
		...
		public void Save()
		{
            ...
            try
            {
                for (int i = 0; i < this.ucItemApply.RowCount; i++)
                {
                    ...
                    //apply = this.ucItemApply.GetRow(i, FS.FrameWork.Management.PublicTrans.Trans);
