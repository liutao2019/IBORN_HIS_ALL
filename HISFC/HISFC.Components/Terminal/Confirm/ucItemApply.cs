...
namespace FS.HISFC.Components.Terminal.Confirm
{
	...
	///  />
	/// </summary>
	public partial class ucItemApply : FS.FrameWork.WinForms.Controls.ucBaseControl
	{
		public ucItemApply()
		{
			InitializeComponent();
        ...
        public void GetApplyByRegister(bool boolClear, bool boolCardNo, bool boolOther)
		{
			...
			for (int i = 0;i < this.fpSpread1_Sheet1.RowCount;i++)
			{
                ...
                this.Lock(i, (int)DisplayField.ItemTotalPrice, true);
                this.Lock(i, (int)DisplayField.PaceageName, true);
			}
		}
