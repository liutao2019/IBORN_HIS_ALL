...
namespace FS.HISFC.Components.Terminal.Confirm
{
    ...
    ///  />
    /// </summary>
    public partial class ucTerminalCarrier : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        {
            toolBarService.AddToolButton("增加", "新增", (int)FS.FrameWork.WinForms.Classes.EnumImageList.T添加, true, false, null);
        ...
        private void Init()
        {
            ...
            //当前操作科室
            this.operDeptCode = ((FS.HISFC.Models.Base.Employee)this.terminalManager.Operator).Dept.ID;
        ...
        private FS.HISFC.Models.Terminal.TerminalCarrier terminal = new FS.HISFC.Models.Terminal.TerminalCarrier();
        ...
        private void ShowMaintenanceForm(string inputType, FS.HISFC.Models.Terminal.TerminalCarrier terminal)
        {
        ...
        public int Delete()
        {
            ...
            //t.BeginTransaction();
            this.terminalManager.SetTrans(FS.FrameWork.Management.PublicTrans.Trans);
        ...
        public int QueryDesign(string deptId)
        {
            ...
            foreach (FS.HISFC.Models.Terminal.TerminalCarrier terminal in al)
            {
        ...
        private int SetTerminal(FS.HISFC.Models.Terminal.TerminalCarrier terminal)
        {
        ...
        protected override int OnSetValue(object neuObject, TreeNode e)
        {
            ...
            //dept = e.Tag as FS.HISFC.Models.Base.Department;
        ...
        protected override void OnLoad(EventArgs e)
        {
            try
            {
                this.dept = ((FS.HISFC.Models.Base.Employee)this.terminalManager.Operator).Dept;
