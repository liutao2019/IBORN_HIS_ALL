...
namespace FS.HISFC.Components.Terminal.Confirm
{
    ...
    ///  />
    /// </summary>
    public partial class ucAddTerminalCarrier : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        {
            FS.HISFC.BizProcess.Integrate.Manager consManager = new FS.HISFC.BizProcess.Integrate.Manager();
            ...
            {
                FS.FrameWork.Models.NeuObject obj = alConstant[i] as FS.FrameWork.Models.NeuObject;
            ...
            //FS.FrameWork.Models.NeuObject deviceType = new FS.FrameWork.Models.NeuObject();
            //for (int i = 0; i < alType.Count; i++)
            //{
            //    FS.FrameWork.Models.NeuObject obj = alType[i] as FS.FrameWork.Models.NeuObject;
            //    deviceType = new FS.FrameWork.Models.NeuObject();
        ...
        /// 全局变量TerminalCarrier
        /// </summary>
        private FS.HISFC.Models.Terminal.TerminalCarrier terminal = null;
        ...
        public delegate void SaveTerminalHandler(FS.HISFC.Models.Terminal.TerminalCarrier Terminal);
        ...
        /// 医技设备管理类 
        /// </summary>
        private FS.HISFC.BizLogic.Terminal.TerminalCarrier terminalManager = new FS.HISFC.BizLogic.Terminal.TerminalCarrier();
        ...
        /// 设备实体类
        /// </summary>
        FS.HISFC.Models.Terminal.TerminalCarrier terminalCarrier = new FS.HISFC.Models.Terminal.TerminalCarrier();

        /// <summary>
        /// 设备类型  //HIS 5.0 移植 设备部分独立化实现 此处对于设备业务层的引用稍后处理
        /// </summary>
        //FS.HISFC.BizLogic.Equipment.Kind kindManager = new FS.HISFC.BizLogic.Equipment.Kind();
        #endregion
        ...
        /// 属性TerminalCarrier
        /// </summary>
        public FS.HISFC.Models.Terminal.TerminalCarrier Terminal
        {
            get
            {
                this.GetItem();
            ...
            set
            {
                if (value == null)
                {
                    this.terminal = new FS.HISFC.Models.Terminal.TerminalCarrier();
                }
                else
                {
                    this.terminal = value;
        ...
        public int validate()
        {
            ...
            if (!FS.FrameWork.Public.String.ValidMaxLengh(this.txtDesignCode.Text, 50))
            {
        ...
        /// 从控件中取数据，保存在item中 
        /// </summary>
        private FS.HISFC.Models.Terminal.TerminalCarrier GetItem()
        {
            if (this.terminal == null)
                terminal = new FS.HISFC.Models.Terminal.TerminalCarrier();

            this.terminal.Dept.ID = ((FS.HISFC.Models.Base.Employee)this.terminalManager.Operator).Dept.ID;
            ...
            this.terminal.DisengagedTime = FS.FrameWork.Function.NConvert.ToDateTime(this.dtbFreeDate.Text);
            this.terminal.DoctorQuota = FS.FrameWork.Function.NConvert.ToDecimal(this.txtDoc.Text);
            this.terminal.SelfQuota = FS.FrameWork.Function.NConvert.ToDecimal(this.txtSelfQuota.Text);
            this.terminal.WebQuota = FS.FrameWork.Function.NConvert.ToDecimal(this.txtWebQuota.Text);
            ...
            this.terminal.SortId = FS.FrameWork.Function.NConvert.ToDecimal(this.txtSortId.Text);
            if (this.chbIsprestoptime.Checked)
                this.terminal.IsPrestopTime = "1";
            else
                this.terminal.IsPrestopTime = "0";
            this.terminal.PreStopTime = FS.FrameWork.Function.NConvert.ToDateTime(this.dtbPreStopTime.Text);
            this.terminal.PreStartTime = FS.FrameWork.Function.NConvert.ToDateTime(this.dtbPreStartTime.Text);
            this.terminal.AvgTurnoverTime = FS.FrameWork.Function.NConvert.ToDecimal(this.txtAvgTime.Text);
        ...
        protected virtual int Save()
        {
            ...
            //t.BeginTransaction();
            terminalManager.SetTrans(FS.FrameWork.Management.PublicTrans.Trans);

            FS.HISFC.Models.Terminal.TerminalCarrier terminal = this.GetItem();
        ...
        private void txtDoc_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                this.txtDayQuota.Text = (FS.FrameWork.Function.NConvert.ToDecimal(this.txtDoc.Text) + FS.FrameWork.Function.NConvert.ToDecimal(this.txtSelfQuota.Text) + FS.FrameWork.Function.NConvert.ToDecimal(this.txtWebQuota.Text)).ToString();
            }
            catch (Exception ex)
            {
                this.txtDoc.Text = "";
        ...
        private void txtName_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            FS.HISFC.BizProcess.Integrate.Manager mySpell = new FS.HISFC.BizProcess.Integrate.Manager();

            spCode = (FS.HISFC.Models.Base.Spell)mySpell.Get(this.txtName.Text.ToString());
        ...
        private void txtSortId_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            try
            {
                decimal d = (FS.FrameWork.Function.NConvert.ToDecimal(this.txtSortId.Text)) % 1;
            }
            catch (Exception e3)
            {
                this.txtSortId.Text = "";
