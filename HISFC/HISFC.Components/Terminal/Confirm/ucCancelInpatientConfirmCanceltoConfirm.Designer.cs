...
{
    partial class ucCancelInpatientConfirmCanceltoConfirm
    {
        /// <summary>
        /// 必需的设计器变量。
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "确认人";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "确认科室";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "取消时间";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "处方号";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "处方内流水号";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "执行设备";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "执行技师";
            ...
            this.neuSpread1_Sheet1.Columns.Get(8).Label = "取消时间";
            this.neuSpread1_Sheet1.Columns.Get(8).Width = 98F;
            this.neuSpread1_Sheet1.Columns.Get(9).Label = "处方号";
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "执行人";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "执行设备";
            ...
            // 
            // ucCancelInpatientConfirmCancel
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 12F);
            this.Controls.Add(this.neuPanel2);
            this.Controls.Add(this.neuPanel1);
            this.Name = "ucCancelInpatientConfirmCancel";
