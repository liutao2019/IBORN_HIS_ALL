...
namespace FS.HISFC.Components.Terminal.Booking
{
	...
	///  />
	/// </summary>
	public partial class ucMedTechBookingTemplet : FS.FrameWork.WinForms.Controls.ucBaseControl
	{
		...
		/// 工具栏服务类
		/// </summary>
		protected FS.FrameWork.WinForms.Forms.ToolBarService toobarService = new ToolBarService();
		...
		{
			// 临时科室实体
			FS.FrameWork.Models.NeuObject dept = operEnvironment.Dept;
		...
		private void InitItem()
		{
			...
			foreach (FS.HISFC.Models.Terminal.MedTechItem obj in deptItemList)
			{
                foreach (FS.HISFC.Models.Base.Const con in alReturn)
                {
        ...
        protected override ToolBarService OnInit ( object sender , object neuObject , object param )
        {
            ...
            this.toobarService.AddToolButton ( "删除" , "删除执行记录" , ( int ) FS.FrameWork.WinForms.Classes.EnumImageList.S删除 , true , false , this.DeleteEvent );
            this.toobarService.AddToolButton ( "项目" , "项目" , ( int ) FS.FrameWork.WinForms.Classes.EnumImageList.K科室 , true , false , this.DeptEvent );
            this.toobarService.AddToolButton ( "设备" , "设备" , ( int ) FS.FrameWork.WinForms.Classes.EnumImageList.S设备 , true , false , this.EquipmentEvent );
            this.operEnvironment.ID = FS.FrameWork.Management.Connection.Operator.ID;
            this.operEnvironment.Name = FS.FrameWork.Management.Connection.Operator.Name;
            this.operEnvironment.Dept = ( ( FS.HISFC.Models.Base.Employee ) FS.FrameWork.Management.Connection.Operator ).Dept;
		...
		private void neuButtonQuery_Click(object sender, EventArgs e)
		{
			...
			else
			{
				...
				{
                    FS.HISFC.Models.Terminal.MedTechItem medTechItemTemp = (FS.HISFC.Models.Terminal.MedTechItem)node.Tag;
					// 业务
					FS.HISFC.BizProcess.Integrate.Terminal.Booking bookingIntegrate = new FS.HISFC.BizProcess.Integrate.Terminal.Booking ();
					// 拼音码
