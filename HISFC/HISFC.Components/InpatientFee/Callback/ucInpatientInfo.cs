...
namespace FS.HISFC.Components.InpatientFee.Controls
{
    ...
    public partial class ucInpatientInfo : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        /// 住院患者信息
        /// </summary>
        private FS.HISFC.Models.RADT.PatientInfo patientInfoObj = null;
        ...
        /// 住院患者信息
        /// </summary>
        public FS.HISFC.Models.RADT.PatientInfo PatientInfoObj
        {
            set
            {
                if (value != null)
        ...
        public virtual void Clear()
        {
            ...
            {
                if (control.GetType() == typeof(FS.FrameWork.WinForms.Controls.NeuTextBox))
                {
                    ((FS.FrameWork.WinForms.Controls.NeuTextBox)control).Text = "";
                }
            }
        }
        #endregion
