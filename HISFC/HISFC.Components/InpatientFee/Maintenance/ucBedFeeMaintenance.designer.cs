namespace FS.HISFC.Components.InpatientFee.Maintenance
{
    partial class ucBedFeeMaintenance
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.neuSpread1_Sheet1.Columns.Get(9).CellType = checkBoxCellType3;
            this.neuSpread1_Sheet1.Columns.Get(9).Label = "非在院计费";
            this.neuSpread1_Sheet1.Columns.Get(10).CellType = checkBoxCellType4;
        ...
        "停用",
        "废弃"};
            this.neuSpread1_Sheet1.Columns.Get(11).CellType = comboBoxCellType1;
            ...
            this.neuSpread1_Sheet1.Columns.Get(12).CellType = numberCellType3;
