...
namespace FS.HISFC.Components.InpatientFee.Maintenance
{
    ...
    public partial class ucBedFeeMaintenance : UserControl, FS.FrameWork.WinForms.Forms.IMaintenanceControlable
    {
        ...
        private void SetValue(FS.HISFC.Models.Fee.BedFeeItem bedFeeItem, int row)
        {
        ...
        public int Add()
        {
            ...
            FS.HISFC.Models.Fee.BedFeeItem obedFeeItem = new FS.HISFC.Models.Fee.BedFeeItem();
        ...
        public int Modify()
        {
            ...
            FS.HISFC.Models.Fee.BedFeeItem bedFeeItem = this.neuSpread1_Sheet1.Rows[activeRow].Tag as FS.HISFC.Models.Fee.BedFeeItem;
        ...
        public int Query()
        {
            ...
            {
                FS.HISFC.Models.Fee.BedFeeItem bedFeeItem = bedFeeItemList[i] as FS.HISFC.Models.Fee.BedFeeItem;
        ...
        int ucModify_Save(FS.HISFC.Models.Fee.BedFeeItem bedFeeItem)
        {
            // [2007/02/06] 新增加的代码
            //判断是否已经添加了
