...
{
    public partial class ucComparesyb : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucComparesyb()
        {
            InitializeComponent();
        ...
        private void InitColumnProHis()
        {
            ...
            if (compareType.ToString()!=CompareTypes.Undrug.ToString())
            {
                ...
                this.fpHisItem_Sheet1.Columns[2].Visible = true;
                this.fpHisItem_Sheet1.Columns[3].Visible = true;
                ...
                this.fpHisItem_Sheet1.Columns[7].Visible = true;
                this.fpHisItem_Sheet1.Columns[8].Visible = true;
                this.fpHisItem_Sheet1.Columns[9].Visible = true;
                this.fpHisItem_Sheet1.Columns[10].Visible = true;
            ...
            else 
            {
                ...
                this.fpHisItem_Sheet1.Columns[4].Visible = true;
                this.fpHisItem_Sheet1.Columns[5].Width = width * 8;
                this.fpHisItem_Sheet1.Columns[6].Visible = true;
                this.fpHisItem_Sheet1.Columns[7].Visible = true;
            ...
            if (isDrug)
            {
                ...
                if (alHisItem != null)
                {
                    foreach (FS.HISFC.Models.Pharmacy.Item obj in alHisItem)
                    {
                        ...
                        row["通用名"] = obj.NameCollection.RegularName;
        ...
        public void Compare()
        {
            ...
            {
                //FS.HISFC.Models.Fee.Item objHis = new FS.HISFC.Models.Fee.Item();
