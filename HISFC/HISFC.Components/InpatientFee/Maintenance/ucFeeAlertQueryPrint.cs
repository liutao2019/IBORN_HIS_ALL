...
{
    public partial class ucFeeAlertQueryPrint :FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private int initTreeView()
        {
            ...
            if (this.ISAllNurse == true)
            {
                ...
                foreach (FS.FrameWork.Models.NeuObject neuObject in alNures)
                {
                    ...
                    //foreach (FS.FrameWork.Models.NeuObject myOjbect in alDept)
                    //{
        ...
        protected ArrayList GetPatient(TreeNode Node)
        {
            ...
            if (this.ISAllNurse == true)
            {
                ...
                else if (Node.Level == 1)
                {
                    ...
                    //F0BF027A-9C8A-4bb7-AA23-26A5F3539586
                    alPatientInfo = this.radtIntegrate.QueryPatientByNurseCellAndStateForAlert((Node.Tag as FS.FrameWork.Models.NeuObject).ID, FS.HISFC.Models.Base.EnumInState.I);
                ...
                else
                {
                    ...
                    alPatientInfo = this.radtIntegrate.QueryPatientByNurseCellAndDeptForAlert((Node.Parent.Tag as FS.FrameWork.Models.NeuObject).ID, (Node.Tag as FS.FrameWork.Models.NeuObject).ID, FS.HISFC.Models.Base.EnumInState.I);
            ...
            else
            {
...

                {
                    ...
                    //{
                        //{62EAD92D-49F6-45d5-B378-1E573EC27728}
                        //alPatientInfo = this.radtIntegrate.QueryPatientByNurseCellAndDept((Node.Tag as FS.FrameWork.Models.NeuObject).ID, (Node.Nodes[0].Tag as FS.FrameWork.Models.NeuObject).ID, FS.HISFC.Models.Base.EnumInState.I);
                        //alPatientInfo = this.radtIntegrate.QueryPatientByNurseCellAndDeptForAlert((Node.Tag as FS.FrameWork.Models.NeuObject).ID, (Node.Nodes[0].Tag as FS.FrameWork.Models.NeuObject).ID, FS.HISFC.Models.Base.EnumInState.I);
                        alPatientInfo = this.radtIntegrate.QueryPatientByNurseCellAndStateForAlert((Node.Tag as FS.FrameWork.Models.NeuObject).ID, FS.HISFC.Models.Base.EnumInState.I);
                    //}
        ...
        protected void SetPatientToFP(ArrayList AlPatientInfo)
        {
            ...
            for (int i = 0; i < AlPatientInfo.Count; i++)
            {
                ...
                patientInfo = (FS.HISFC.Models.RADT.PatientInfo)AlPatientInfo[i];
        ...
        protected ArrayList SelectPatient()
        {
            ...
            for (int i = 0; i < this.neuSpread1_Sheet1.RowCount; i++)
            {
                ...
                {
                    FS.HISFC.Models.RADT.PatientInfo patientInfo = new FS.HISFC.Models.RADT.PatientInfo();
                    patientInfo = (FS.HISFC.Models.RADT.PatientInfo)this.neuSpread1_Sheet1.Rows[i].Tag;
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolBarService.AddToolButton("取消", "全不选", (int)FS.FrameWork.WinForms.Classes.EnumImageList.Q取消, true,false,null);
        ...
        {
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm("正在加载患者信息,请稍后");
