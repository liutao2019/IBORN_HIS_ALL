    ...
    public partial class ucPatientOut : System.Windows.Forms.UserControl, FS.FrameWork.WinForms.Forms.IInterfaceContainer//{2A467990-BDA3-4cb4-BB89-5801796EBC95} FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        public virtual int Save()
        {
            ...
            if (returnValue != 1)
            {
                ...
                MessageBox.Show(FS.FrameWork.Management.Language.Msg("待遇接口获得合同单位失败" + medcareInterfaceProxy.ErrMsg));
                return -1;
            }
            ...
            //    t.RollBack();
            //    medcareInterfaceProxy.Rollback();
            //    MessageBox.Show(FS.FrameWork.Management.Language.Msg("待遇接口获得患者信息失败" + medcareInterfaceProxy.ErrMsg));
            //    return -1;
            //}
            //出院登记(带改)
            ...
            if (returnValue != 1)
            {
                FS.FrameWork.Management.PublicTrans.RollBack();
                medcareInterfaceProxy.Rollback();
                MessageBox.Show(FS.FrameWork.Management.Language.Msg("待遇接口获出院登记失败" + medcareInterfaceProxy.ErrMsg));
                return -1;
            }
