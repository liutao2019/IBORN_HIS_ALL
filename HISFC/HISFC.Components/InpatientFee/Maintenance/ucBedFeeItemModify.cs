...
namespace FS.HISFC.Components.InpatientFee.Maintenance
{
    ...
    public partial class ucBedFeeItemModify : UserControl
    {
        ...
        public delegate int ClickSave(FS.HISFC.Models.Fee.BedFeeItem bedFeeItem);
        ...
        /// 原始床位费用信息
        /// </summary>
        private FS.HISFC.Models.Fee.BedFeeItem originalFeeItem = null;
        #endregion
        ...
        protected virtual int Confirm()
        {
            ...
            try
            {
                ...
                funIntegrate.SaveChange<FS.HISFC.Models.Fee.BedFeeItem>("BedF", isInsert, false, this.bedFeeItem.FeeGradeCode + "-" +  this.bedFeeItem.ID, this.originalFeeItem, this.bedFeeItem);
