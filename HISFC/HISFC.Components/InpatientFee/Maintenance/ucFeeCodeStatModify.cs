...
namespace FS.HISFC.Components.InpatientFee.Maintenance
{
    ...
    public partial class ucFeeCodeStatModify : UserControl
    {
        ...
        {              
            ...
            this.feeCodeStat.SortID = FS.FrameWork.Function.NConvert.ToInt32(this.txtPrintOrder.Text);//打印顺序
            ...
            this.feeCodeStat.ValidState = (FS.HISFC.Models.Base.EnumValidState) NConvert.ToInt32(this.cmbValidState.Tag);//有效性标识
