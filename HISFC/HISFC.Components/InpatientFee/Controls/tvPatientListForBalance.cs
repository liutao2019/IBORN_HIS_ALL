...
{
    public partial class tvPatientListForBalance : FS.HISFC.Components.Common.Controls.tvPatientList
    {
        public tvPatientListForBalance()
        {
            InitializeComponent();
        ...
        public string ShowType = "OutApply";

        public string ShowDept = "1";

        public tvPatientListForBalance(IContainer container)
        {
            container.Add(this);
