...
{
    public partial class ucSurety : FS.FrameWork.WinForms.Controls.ucBaseControl,FS.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        /// <summary>
        /// [功能描述: 住院患者担保]<br></br>
        /// [创 建 者: nxy]<br></br>
        ...
        FS.FrameWork.Public.ObjectHelper payWayHelper = new FS.FrameWork.Public.ObjectHelper();

        FS.FrameWork.Public.ObjectHelper suretyWayHelper = new FS.FrameWork.Public.ObjectHelper();

        FS.FrameWork.Public.ObjectHelper bankHelper = new FS.FrameWork.Public.ObjectHelper();

        /// <summary>
        /// 担保打印接口
        /// </summary>
        FS.HISFC.BizProcess.Interface.FeeInterface.IPrintSurety iPrintSurety = null;
        #endregion
        #region 方法
        ...
        private int InitControl()
        {
            ...
            //支付方式
            ArrayList alPayWay = this.managerIntegrate.GetConstantList(FS.HISFC.Models.Base.EnumConstant.PAYMODES);
            ...
            ArrayList alBackList = this.managerIntegrate.GetConstantList(FS.HISFC.Models.Base.EnumConstant.BANK);
        ...
        {
            this.iPrintSurety = FS.FrameWork.WinForms.Classes.UtilInterface.CreateObject(this.GetType(), typeof(FS.HISFC.BizProcess.Interface.FeeInterface.IPrintSurety)) as FS.HISFC.BizProcess.Interface.FeeInterface.IPrintSurety;
        ...
        private int QuerySuretyDetail(string inpatientNO)
        {
            ...
            {
                FS.HISFC.Models.RADT.PatientInfo p = alSuretyDetail[i] as FS.HISFC.Models.RADT.PatientInfo;
        ...
        private void ReceiveSure()
        {
            ...
            {
                FS.FrameWork.WinForms.Classes.Function.Msg("请输入担保金额!", 111);
                this.txtSureCost.Focus();
                this.txtSureCost.SelectAll();
                return;
            }
            if (FS.FrameWork.Function.NConvert.ToDecimal(this.txtSureCost.Text) < 0)
            {

                FS.FrameWork.WinForms.Classes.Function.Msg("担保金额应大于零!", 111);
                this.txtSureCost.Focus();
                this.txtSureCost.SelectAll();
                return;
            ...
            {
                FS.FrameWork.WinForms.Classes.Function.Msg("请选择担保人！", 111);
            ...
            myPatientInfo.Surety.SuretyPerson = this.cmbSurePerson.SelectedItem as FS.FrameWork.Models.NeuObject;
        ...
        private void ReturnSuretyCost()
        {
            ...
            try
            {
                patientInfo = this.neuSpread1_Sheet1.ActiveRow.Tag as FS.HISFC.Models.RADT.PatientInfo;
            }
            catch (Exception)
            {
            ...
            FS.HISFC.Models.RADT.PatientInfo p = patientInfo.Clone();
        ...
        private void Reprint()
        {
            ...
            //付给正值
            FS.HISFC.Models.RADT.PatientInfo tempPatientInfo = p.Clone();
        ...
        private void PrintSurety(FS.HISFC.Models.RADT.PatientInfo patientInfo)
        {
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolBarService.AddToolButton("收取", "收取担保金", (int)FS.FrameWork.WinForms.Classes.EnumImageList.J借入, true, false, null);
            toolBarService.AddToolButton("返还", "返还担保金", (int)FS.FrameWork.WinForms.Classes.EnumImageList.J借出, true, false, null);
            toolBarService.AddToolButton("补打", "补打担保金", (int)FS.FrameWork.WinForms.Classes.EnumImageList.D打印, true, false, null);
        ...
        public Type[] InterfaceTypes
        {
            get
            {
                ...
                type[0] = typeof(FS.HISFC.BizProcess.Interface.FeeInterface.IPrintSurety);
                return type;
