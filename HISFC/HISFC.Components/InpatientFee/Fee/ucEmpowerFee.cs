...
namespace FS.HISFC.Components.InpatientFee.Fee
{
    ...
    ///  />
    /// </summary>
    public partial class ucEmpowerFee : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        #region 变量
        ...
        {
            toolBarservice.AddToolButton("授权", "", FS.FrameWork.WinForms.Classes.EnumImageList.R入库单, true, false, null);
            toolBarservice.AddToolButton("作废", "", FS.FrameWork.WinForms.Classes.EnumImageList.R入库单, true, false, null);
        ...
        private void Authorized()
        {
            ...
            {               
                ...
                FS.HISFC.Models.Fee.EmpowerFeeOper empowerFeeOper = new FS.HISFC.Models.Fee.EmpowerFeeOper();
        ...
        private void QueryAllEmpowered()
        {
            ...
            {
                System.Data.DataTable dt = empowerFeeManager.QueryAllEmpowered(dtpBegin.Value.ToString("yyyy-MM-dd HH:mm:ss"), dtpEnd.Value.ToString("yyyy-MM-dd HH:mm:ss"));
                if (dt != null)
                {
