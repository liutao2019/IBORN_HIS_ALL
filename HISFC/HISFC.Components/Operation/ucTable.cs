...
namespace FS.HISFC.Components.Operation
{
    ...
    public partial class ucTable : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private void Init()
        {
            this.imageList1.Images.Add(FS.FrameWork.WinForms.Classes.Function.GetImage(FS.FrameWork.WinForms.Classes.EnumImageList.F分解));
            this.imageList1.Images.Add(FS.FrameWork.WinForms.Classes.Function.GetImage(FS.FrameWork.WinForms.Classes.EnumImageList.B病历));
        }
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            this.toolBarService.AddToolButton( "-", "-", FS.FrameWork.WinForms.Classes.EnumImageList.T添加, true, false, null );
            this.toolBarService.AddToolButton("增加房间", "增加房间", FS.FrameWork.WinForms.Classes.EnumImageList.T添加, true, false, null);
            this.toolBarService.AddToolButton("删除房间", "删除房间", FS.FrameWork.WinForms.Classes.EnumImageList.S删除, true, false, null);
