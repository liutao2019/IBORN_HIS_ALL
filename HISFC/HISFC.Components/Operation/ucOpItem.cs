...
namespace FS.HISFC.Components.Operation
{
    ...
    public partial class ucOpItem : UserControl
    {
        ...
        private FS.HISFC.BizProcess.Integrate.Common.ControlParam controlParamMgr = new FS.HISFC.BizProcess.Integrate.Common.ControlParam();
        ...
        public int Init()
        {
            ...
            if (isUserICD9)
            {
                al = itemMgr.QueryOperationICDItems();
            }
            else
            {
            ...
            if (al == null)
            {
                MessageBox.Show("查询手术项目字典信息错误！\r\n" + itemMgr.Err, "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return -1;
            }
