namespace Neusoft.HISFC.Components.Operation
{
    partial class ucArrangementSpread
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 0).Value = "病区";
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 7).Value = "麻醉类别";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 8).Value = "麻醉方式";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "手术医生";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 10).Value = "手术时间";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "洗手";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 12).Value = "巡回";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 13).Value = "房号";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 14).Value = "手术台号";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 15).Value = "允许医生查看";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 16).Value = "洗手2";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 17).Value = "巡回2";
            this.fpSpread1_Sheet1.ColumnHeader.Rows.Get(0).Height = 48F;
            this.fpSpread1_Sheet1.Columns.Get(0).Label = "病区";
            this.fpSpread1_Sheet1.Columns.Get(0).Locked = true;
            this.fpSpread1_Sheet1.Columns.Get(0).Width = 124F;
            ...
            this.fpSpread1_Sheet1.Columns.Get(7).Label = "麻醉类别";
            this.fpSpread1_Sheet1.Columns.Get(7).Width = 83F;
            this.fpSpread1_Sheet1.Columns.Get(8).Label = "麻醉方式";
            this.fpSpread1_Sheet1.Columns.Get(8).Locked = true;
            this.fpSpread1_Sheet1.Columns.Get(8).Width = 121F;
            this.fpSpread1_Sheet1.Columns.Get(9).Label = "手术医生";
            ...
            this.fpSpread1_Sheet1.Columns.Get(10).CellType = dateTimeCellType1;
            this.fpSpread1_Sheet1.Columns.Get(10).Label = "手术时间";
            this.fpSpread1_Sheet1.Columns.Get(10).Width = 83F;
            this.fpSpread1_Sheet1.Columns.Get(11).CellType = textCellType1;
            this.fpSpread1_Sheet1.Columns.Get(11).Label = "洗手";
            this.fpSpread1_Sheet1.Columns.Get(15).CellType = checkBoxCellType1;
            this.fpSpread1_Sheet1.Columns.Get(15).Label = "允许医生查看";
