...
namespace FS.HISFC.Components.Operation
{
    ...
    public partial class ucTableSpread : UserControl
    {
        ...
        public void DeleteItem()
        {
            if (this.room == null)
            {
                MessageBox.Show( "请选择需要删除的手术台", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information );
                return;
            }
            DialogResult rs = MessageBox.Show( "确认删除当前选择的手术台吗？\n 删除后请注意点击保存按钮生效", "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Information );
