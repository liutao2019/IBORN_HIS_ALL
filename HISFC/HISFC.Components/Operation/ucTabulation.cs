...
namespace FS.HISFC.Components.Operation
{
    public partial class ucTabulation : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        {
            toolBarService.AddToolButton("上周", "上周", (int)FS.FrameWork.WinForms.Classes.EnumImageList.S上一个, true, false, null);
            toolBarService.AddToolButton("下周", "下周", (int)FS.FrameWork.WinForms.Classes.EnumImageList.X下一个, true, false, null);
            toolBarService.AddToolButton( "向上", "向上", (int)FS.FrameWork.WinForms.Classes.EnumImageList.S上一个, true, false, null );
            toolBarService.AddToolButton( "向下", "向下", (int)FS.FrameWork.WinForms.Classes.EnumImageList.X下一个, true, false, null ); 
