...
namespace FS.HISFC.Components.Operation.OutpatientApplication
{
    ...
    public partial class ucApplicationForm : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        ...
        private bool isOwnPrivilege = false;
        ...
        public PatientInfo PatientInfo
        {
            set
            {
                ...
                //this.lblPhone.Text = value.PVisit.PatientLocation.Bed.Name;
        ...
        public FS.HISFC.Models.Operation.OperationAppllication OperationApplication
        {
            ...
            set
            {
                ...
                ArrayList alReg = regMana.QueryPatient(value.PatientInfo.ID);
                ...
                this.cmbSpecial.SelectedIndex = int.Parse(value.BloodNum.ToString());//是否特殊手术
        ...
        private void Init()
        {
            ...
            //术者{BF4583B0-B5C7-490e-8AB3-1B6708E7A162}

            alRetTmp = Environment.IntegrateManager.QueryEmployee4(FS.HISFC.Models.Base.EnumEmployeeType.D);
        ...
        private int GetValue()
        {
            ...
            //{2D90BEDC-96B2-4a4f-8197-21DF10F5EE17}
            if (!string.IsNullOrEmpty(operationApplication.PatientInfo.PVisit.PatientLocation.Dept.ID))
            {
                operationApplication.PatientInfo.PVisit.PatientLocation.Dept = Environment.IntegrateManager.GetDepartment(operationApplication.PatientInfo.PVisit.PatientLocation.Dept.ID);
            }

            if (string.IsNullOrEmpty(operationApplication.PatientInfo.PVisit.PatientLocation.Bed.Name))
            {
                operationApplication.PatientInfo.PVisit.PatientLocation.Bed.Name = "/";
            }
            ...
            //患者来源
            this.operationApplication.PatientSouce = "1";//住院患者
        ...
        private void cmbDoctor_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                // "LEVELOPERATETYPE"
                if (isOwnPrivilege)// {84F6ADEA-7781-4560-8D59-AE7D95754D5D}
                {
