...
namespace FS.HISFC.Components.Operation
{
    ...
    ///  />
    /// </summary>
    public partial class ucApplicationzdly2 : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucApplicationzdly2()
        {
            InitializeComponent();
            this.Init();
        ...
        public ucApplicationzdly2(PatientInfo patient, NeuObject item)
            : this()
        {
            ...
            foreach (TreeNode node in this.tvApply.Nodes[0].Nodes)
            {
                ...
                for (int i = al.Count - 1; i >= 0; i--)
                {
                    ...
                    if (apply.PatientInfo.ID == patient.ID)
                    {
                        ...
                        if (apply.ExecStatus == "6") child.Text = child.Text + "『已手术未收费』";
        ...
        private void ucQueryInpatientNo1_myEvent()
        {
            ...
            TreeNode root4 = new TreeNode("已完成未收费手术", 22, 22);//按顺序排不好吗？非得放这里 医院提的
            root4.Tag = "6";
            tvApply.Nodes.Add(root4);
