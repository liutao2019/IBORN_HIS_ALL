namespace FS.HISFC.Components.Operation.Report
{
    partial class ucReportDoctor
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 0).Value = "医生姓名";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 1).Value = "科室名称";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "手术例数";
            this.fpSpread1_Sheet1.Columns.Get(0).Label = "医生姓名";
            this.fpSpread1_Sheet1.Columns.Get(0).Width = 163F;
            this.fpSpread1_Sheet1.Columns.Get(1).Label = "科室名称";
            this.fpSpread1_Sheet1.Columns.Get(1).Width = 202F;
            this.fpSpread1_Sheet1.Columns.Get(2).Label = "手术例数";
            ...
            this.lblTitle.Text = "按医生分类汇总统计手术例数";
            // 
            // lblTime
            // 
