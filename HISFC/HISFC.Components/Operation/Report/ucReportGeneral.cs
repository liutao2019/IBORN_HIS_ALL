...
#region 事件
        ...
        protected override int OnQuery()
        {
            ...
            {
                iRowTotal =
                    FS.FrameWork.Function.NConvert.ToInt32(this.fpSpread1_Sheet1.Cells[i, 1].Value) + //特大手术数
                    FS.FrameWork.Function.NConvert.ToInt32(this.fpSpread1_Sheet1.Cells[i, 2].Value) + //大手术数
                    FS.FrameWork.Function.NConvert.ToInt32(this.fpSpread1_Sheet1.Cells[i, 3].Value) + //中手术数
                    FS.FrameWork.Function.NConvert.ToInt32(this.fpSpread1_Sheet1.Cells[i, 4].Value);  //小手术数
            ...
            {
                iColTotal =
                    FS.FrameWork.Function.NConvert.ToInt32(this.fpSpread1_Sheet1.Cells[0, j].Value) + //普通手术数
                    FS.FrameWork.Function.NConvert.ToInt32(this.fpSpread1_Sheet1.Cells[1, j].Value) + //急诊手术数
                    FS.FrameWork.Function.NConvert.ToInt32(this.fpSpread1_Sheet1.Cells[2, j].Value);  //感染手术数
