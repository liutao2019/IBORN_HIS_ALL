namespace FS.HISFC.Components.Operation.Report
{
    partial class ucReportSpecial
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "手术名称";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "时间";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "价格";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "金额";
