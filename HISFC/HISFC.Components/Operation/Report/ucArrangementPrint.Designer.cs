...
{
    partial class ucArrangementPrint
    {
        /// <summary> 
        /// 必需的设计器变量。
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "手术台序";
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 15).Value = "助手";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 16).Value = "洗手护士";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 17).Value = "巡回护士";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 18).Value = "麻醉医生";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 19).Value = "总巡";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 20).Value = "接班人员";
            ...
            this.fpSpread1_Sheet1.Columns.Get(2).Label = "手术台序";
            this.fpSpread1_Sheet1.Columns.Get(2).Width = 34F;
            ...
            this.fpSpread1_Sheet1.Columns.Get(6).Width = 22F;
            this.fpSpread1_Sheet1.Columns.Get(7).Label = "年龄";
            this.fpSpread1_Sheet1.Columns.Get(7).Width = 45F;
            ...
            this.fpSpread1_Sheet1.Columns.Get(9).Width = 73F;
            ...
            this.fpSpread1_Sheet1.Columns.Get(11).Width = 168F;
            this.fpSpread1_Sheet1.Columns.Get(12).Label = "是否特殊手术";
            this.fpSpread1_Sheet1.Columns.Get(12).Width = 47F;
            this.fpSpread1_Sheet1.Columns.Get(13).Label = "特殊说明";
            this.fpSpread1_Sheet1.Columns.Get(13).Width = 92F;
            this.fpSpread1_Sheet1.Columns.Get(14).Label = "主刀医生";
            this.fpSpread1_Sheet1.Columns.Get(14).Width = 58F;
            this.fpSpread1_Sheet1.Columns.Get(15).Label = "助手";
            this.fpSpread1_Sheet1.Columns.Get(15).Width = 54F;
            this.fpSpread1_Sheet1.Columns.Get(16).Label = "洗手护士";
            this.fpSpread1_Sheet1.Columns.Get(16).Width = 56F;
            this.fpSpread1_Sheet1.Columns.Get(17).Label = "巡回护士";
            this.fpSpread1_Sheet1.Columns.Get(17).Width = 53F;
            this.fpSpread1_Sheet1.Columns.Get(18).Label = "麻醉医生";
            this.fpSpread1_Sheet1.Columns.Get(18).Width = 0F;
            this.fpSpread1_Sheet1.Columns.Get(19).Label = "总巡";
            this.fpSpread1_Sheet1.Columns.Get(19).Width = 55F;
            this.fpSpread1_Sheet1.Columns.Get(20).Label = "接班人员";
            this.fpSpread1_Sheet1.Columns.Get(20).Width = 58F;
