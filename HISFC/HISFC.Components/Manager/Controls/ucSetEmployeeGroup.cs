...
namespace FS.HISFC.Components.Manager.Controls
{
        ...
        FS.FrameWork.WinForms.Forms.IMaintenanceControlable
    {
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolService.AddToolButton("添加", "", FS.FrameWork.WinForms.Classes.EnumImageList.T添加.GetHashCode(), true, false, null);
            toolService.AddToolButton("修改", "", FS.FrameWork.WinForms.Classes.EnumImageList.X修改.GetHashCode(), true, false, null);
            toolService.AddToolButton("删除", "", FS.FrameWork.WinForms.Classes.EnumImageList.S删除.GetHashCode(), true, false, null);
            toolService.AddToolButton("打印", "", FS.FrameWork.WinForms.Classes.EnumImageList.D打印预览.GetHashCode(), true, false, null);
            this.Init();
            return toolService;
        }
