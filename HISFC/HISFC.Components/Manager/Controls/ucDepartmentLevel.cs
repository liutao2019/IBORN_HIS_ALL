    ...
    public partial class ucDepartmentLevel : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        public void AddUser()
        {
            ...
            if (dept != null)
            {
                ...
                //创建临时窗口用来修改数据
                FS.FrameWork.WinForms.Classes.Function.PopForm.Text = "人员属性";
        ...
        public void AddDepartment()
        {
            ...
            //创建临时窗口用来修改数据
            FS.FrameWork.WinForms.Classes.Function.PopForm.Text = "科室属性";
        ...
        public void DelDepartment()
        {
            ...
            if (dept != null)
            {
               ...
               FS.HISFC.BizLogic.Manager.UserPowerDetailManager userMgr = new FS.HISFC.BizLogic.Manager.UserPowerDetailManager();
                ...
                {
                    FS.FrameWork.Management.PublicTrans.RollBack(); ;
                    Function.ShowMessage("科室结构删除失败，请向系统管理员报告错误信息：" + errInfo, MessageBoxIcon.Error);
                    return;
                }
