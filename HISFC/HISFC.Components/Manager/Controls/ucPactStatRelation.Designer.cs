...
{
	partial class ucPactStatRelation
	{
		/// <summary> 
		/// 必需的设计器变量。
		/// </summary>
		...
		private void InitializeComponent()
		{
            ...
            this.fpCompany = new FS.FrameWork.WinForms.Controls.NeuFpEnter(this.components);
        ...
        private FS.FrameWork.WinForms.Controls.NeuFpEnter fpCompany;
