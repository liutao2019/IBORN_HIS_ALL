...
namespace FS.HISFC.Components.Manager.Controls
{
    ...
    public partial class ucPrivUserManager : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        void initInfo()
        {
            ...
            this.comboPersonDuty.AddItems(GetConstant(FS.HISFC.Models.Base.EnumConstant.POSITION));//系统常数枚举类
        ...
        private bool ValidateState()
        {
            ...
            {
                MessageBox.Show("人员姓名过长，请保持五十位汉字或一百位字符！", "提示", MessageBoxButtons.OK);
                this.txtPersonName.Focus();
                return false;
            }
        ...
        {
            //by cube 2011-07-05 科室结构维护和人员科室维护使用不同控件，对信息修改造成不一致问题
            ...
            employee.SortID = FS.FrameWork.Function.NConvert.ToInt32(this.txtSortID.Text);//顺序号
        ...
        private void Save()
        {
            ...
            if (ValidateState())
            {
                ...
                this.userMgr.SetTrans(FS.FrameWork.Management.PublicTrans.Trans);//人员权限分配明细管理类-设置当前事务
                this.psMgr.SetTrans(FS.FrameWork.Management.PublicTrans.Trans);//人员管理类-设置当前事务
                try
                {
                    #region 人员信息维护
        ...
        /// <summary>
        /// 添加全选功能  {247981BF-D6A5-465d-9AC5-66C41EE1F099}
        /// </summary>
