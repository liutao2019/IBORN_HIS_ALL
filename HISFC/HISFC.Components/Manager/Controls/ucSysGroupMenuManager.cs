    ...
    public partial class ucSysGroupMenuManager : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucSysGroupMenuManager()
        {
            ...
            if (DesignMode == false)
            {
                ...
                {
                    MessageBox.Show(FS.FrameWork.Management.Language.Msg("创建菜单维护窗口出错！") + ex.Message);
                }
            }
        }
        ...
        {
            toolBarService.AddToolButton("新建组", "添加新组", FS.FrameWork.WinForms.Classes.EnumImageList.T添加.GetHashCode(), true, false, null);
            toolBarService.AddToolButton("删除组", "删除改组", FS.FrameWork.WinForms.Classes.EnumImageList.S删除.GetHashCode(), true, false, null);
