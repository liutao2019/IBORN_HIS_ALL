...
namespace FS.HISFC.Components.Manager
{
    ...
    public partial class ucAddShiftType : UserControl
    {
        ...
        {
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm(FS.FrameWork.Management.Language.Msg("正在载入信息 请稍候..."));
            ...
            try
            {
                ...
                if (oHandle == null)
                {
                    ...
                    MessageBox.Show(FS.FrameWork.Management.Language.Msg("未能由输入信息获取类型 请检查是否输入正确"));
                    return;
                }
                ...
                {
                    FS.FrameWork.WinForms.Classes.Function.HideWaitForm();
                    MessageBox.Show(FS.FrameWork.Management.Language.Msg("该实体信息已存在 请删除原信息后重新添加"));
                ...
                if (alProperty != null)
                {
                    ...
                    {
                        FS.FrameWork.WinForms.Classes.Function.HideWaitForm();
                        MessageBox.Show(FS.FrameWork.Management.Language.Msg("该实体类无满足条件的属性信息"));
                        return;
                    }
