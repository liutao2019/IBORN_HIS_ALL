...
namespace FS.HISFC.Components.Manager.Controls
{
    ...
    public partial class ucInOutDept : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        {          
            toolBarService.AddToolButton("增加科室", "增加入出库科室", FS.FrameWork.WinForms.Classes.EnumImageList.X信息, true, false, null);
            toolBarService.AddToolButton("删除", "删除入出库科室", FS.FrameWork.WinForms.Classes.EnumImageList.S删除, true, false, null);
