...
{
    public partial class FrmSetDeptForItem : Form
    {
        ...
        private int InitData()
        {
            ...
            {
                //只取门诊住院终端手术的科室
                if (dpt.DeptType.ID.ToString() == "C" || dpt.DeptType.ID.ToString() == "I" || dpt.DeptType.ID.ToString() == "T" || dpt.DeptType.ID.ToString() == "OP")
                {
                    deptList.Add( dpt );
                }
            }
