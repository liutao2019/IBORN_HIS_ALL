...
namespace FS.HISFC.Components.Manager.Forms
{
    public partial class frmMaintenacePop : Form
    {
        ...
        private List<FS.HISFC.BizLogic.Privilege.Model.Resource> resoucesList = null;
        ...
        public frmMaintenacePop(List<FS.FrameWork.Models.NeuObject> resoucesTypes)
        {
            judgeOperation = 0;
            resoucesTypeList = resoucesTypes;
            InitializeComponent();
            this.BackColor = FS.FrameWork.WinForms.Classes.Function.GetSysColor(EnumSysColor.Blue);
            FS.FrameWork.WinForms.Classes.Function.SetFarPointStyle(fpSpread_Info);
        ...
        /// </summary>
        /// <param name="resoucesTypes"></param>
        public frmMaintenacePop(ReportPrint reportPrint, List<FS.FrameWork.Models.NeuObject> resoucesTypes, Dictionary<string, string> resourceTypesMapping1)
        {
            judgeOperation = 1;
        ...
        {
            resoucesList = new FS.HISFC.BizLogic.Privilege.ResourceProcess().QueryNoneRoot();
        }
        ...
        private void InitUpateInfo()
        {
            ...
            for (int i = 0; i < interfaceContainer.InterfaceTypes.Length; i++)
            {
                ...
                if (dicReportPrintControl.Count != 0 && dicReportPrintControl.Keys.Contains(interfaceContainer.InterfaceTypes[i].FullName))
                {
                    ...
                    this.fpSpread_Info_Sheet1.Cells[i, 3].Text =FS.FrameWork.Function.NConvert.ToBoolean( dicReportPrintControl[interfaceContainer.InterfaceTypes[i].FullName].State).ToString();
        ...
        private ReportPrint GetParamInfo()
        {
            ...
            {
                reportInfo.ContainerType = (cmbType.SelectedValue as FS.FrameWork.Models.NeuObject).ID;
            }
            ...
            for (int i = 0; i < fpSpread_Info_Sheet1.Rows.Count; i++)
            {
                ...
                state = FS.FrameWork.Function.NConvert.ToInt32(fpSpread_Info_Sheet1.Cells[i, 3].Text.ToString()).ToString(); ;
