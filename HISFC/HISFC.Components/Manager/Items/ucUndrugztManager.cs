...
//        //private FS.Common.Class.EditTypes editType; //标识
...
//            cbEnter.Checked = FS.neuFC.Function.NConvert.ToBoolean(info.confirmFlag);//确认标志
//            cbValid.Checked = !FS.neuFC.Function.NConvert.ToBoolean(info.validState);//有效标志
//            if (info.User01 == "1")
//            {
...
//                info.sortId = FS.neuFC.Function.NConvert.ToInt32(textBox5.Text); //序号
//                if (cbEnter.Checked)
//                {
