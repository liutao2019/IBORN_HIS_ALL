namespace FS.HISFC.Components.MTOrder.Forms
{
    partial class frmSelectClinic
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.neuSpread1.Size = new System.Drawing.Size(497, 148);
            ...
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "门诊/住院流水号";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "看诊日期";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "姓名";
            this.neuSpread1_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "可预约数量";
            ...
            this.neuSpread1_Sheet1.Columns.Get(2).Label = "门诊/住院流水号";
            this.neuSpread1_Sheet1.Columns.Get(2).Locked = true;
            this.neuSpread1_Sheet1.Columns.Get(2).Width = 102F;
            this.neuSpread1_Sheet1.Columns.Get(3).CellType = textCellType2;
            this.neuSpread1_Sheet1.Columns.Get(3).Label = "看诊日期";
            ...
            this.neuSpread1_Sheet1.Columns.Get(5).Label = "可预约数量";
