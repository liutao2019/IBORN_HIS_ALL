...
namespace FS.HISFC.Components.OutpatientFee.Controls
{
    ...
    /// 发票重打
    /// </summary>
    public partial class ucRePrintInvoiceforatm : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Forms.IInterfaceContainer, IReprintInvoice
    {
        #region 成员
        /// <summary>
        /// 重打发票是否走号
        ...
        void ucTrvInvoice_evnInvoiceSelectChange(object sender, FS.HISFC.Models.Fee.Outpatient.Balance invoice)
        {
            ...
            this.checkBox1.Checked = getOpenEleInvoiceFlag(currentBalance.Invoice.ID);
        }

        private bool getOpenEleInvoiceFlag(string invoiceno)
        {
            string sql = "select * from com_opb_eleinvoiceopeninfo where inpatientnoorinvoiceno='" + invoiceno + "'";
        ...
        public override FS.FrameWork.WinForms.Forms.ToolBarService Init(object sender, object neuObject, object param)
        {
            ...
            toolBarService.AddToolButton("打印发票副本", "打印发票副本", (int)FS.FrameWork.WinForms.Classes.EnumImageList.C重打, true, false, null); 
            toolBarService.AddToolButton("医保确认单打印", "打印广州医保自费确认书", (int)FS.FrameWork.WinForms.Classes.EnumImageList.C重打, true, false, null);

            toolBarService.AddToolButton("生成电子发票", "生成电子发票", (int)FS.FrameWork.WinForms.Classes.EnumImageList.T添加, true, false, null);
            toolBarService.AddToolButton("冲红电子发票", "冲红电子发票", (int)FS.FrameWork.WinForms.Classes.EnumImageList.C查找, true, false, null);
        ...
        public override void ToolStrip_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            switch (e.ClickedItem.Text)
            {
                ...
                case "清单补打":
                    ...
                    PrintOutPatientGuide(2);
                    break;
                case "医保确认单打印":

                    PrintOutPatientGuide(4);
                    break;
                ...
                case "生成电子发票":
                        //this.SerializeEntityNew();   this.tbInvoiceNo.Text.ToString();
                     frmEleInvoice frmEle = new frmEleInvoice();
                     frmEle.StartPosition = FormStartPosition.CenterScreen;
                     frmEle.SetPatientInfo(this.currentBalance);
                        //FS.HISFC.Models.Fee.Outpatient.Balance currBalance = this.currentBalance;
                        //string a = currBalance.Invoice.ID;
                     frmEle.Show();
                     break;
                case "冲红电子发票":
                     frmEleInvoiceManager frmelemana = new frmEleInvoiceManager();
                     frmelemana.StartPosition = FormStartPosition.CenterScreen;
                     frmelemana.Show();
                     break;
                default:
                    break;
        ...
        protected void QueryBalances(string invoiceNo, out string errMsg)
        {
            ...
            ////{2044475C-E8CE-454B-B328-90EAAC174D1A} 查询费用明细添加费别名称
            comFeeItemLists = outpatientManager.QueryFeeItemListsAndNameByInvoiceSequence(currentBalance.CombNO);//outpatientManager.QueryFeeItemListsByInvoiceSequence(currentBalance.CombNO);
        ...
        protected bool Print(int printType)
        {
            ...
            if (!isCanQuitOtherOper)//不予许交叉重打
            {
                ...
                //{78D065B0-2406-4425-BD1F-6DE91145684A}取消不能是本人补打发票权限
            ...
            if (!isCanReprintDayBalance)//不予许交叉重打
            {
                ...
                //{78D065B0-2406-4425-BD1F-6DE91145684A}取消日结不能补打权限
        ...
        private void PrintOutPatientGuide(int printType)
        {
            ...
            this.PrintGuide(patient, comBalances, comFeeItemLists, printType);
        ...
        private void PrintInvoiceCopy()
        {
            ...
            FS.HISFC.BizProcess.Interface.FeeInterface.IInvoicePrint iInvoicePrint = FS.FrameWork.WinForms.Classes.UtilInterface.CreateObject(
                this.GetType(), typeof(FS.HISFC.BizProcess.Interface.FeeInterface.IInvoicePrint)) as FS.HISFC.BizProcess.Interface.FeeInterface.IInvoicePrint;
            ...
            regInfo.DoctorInfo.SeeDate = ((FS.HISFC.Models.Registration.Register)currentBalance.Patient).DoctorInfo.SeeDate;
        ...
        protected bool CancelInvoicePrint()
        {
            ...
            if (this.isCopyRecipes)
            {
                ...
                foreach (FeeItemList f in alOldFeeItemLists)
                {
                    ...
                    f.Item.SpecialFlag2 = FS.FrameWork.Function.NConvert.ToInt32(f.IsConfirmed).ToString();
