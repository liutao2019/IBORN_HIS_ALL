...
namespace FS.HISFC.Components.OutpatientFee.Controls
{
    public partial class ucQuitItemApply : ucQuitFee
    {
        ...
        /// 操作项目类别 默认为全部
        /// </summary>
        [Category("控件设置"), Description("操作项目类别 默认为全部")]
        ...
        protected override int GetItemList()
        {
            ...
            //显示已确认退药信息 {077FF0B0-466D-4d24-B3B2-DDCE4BC7F4BF} 门诊退药确认后可以取消
            ...
            for (int i = 0; i < drugConfirmList.Count; i++)
            {
                ...
                this.fpSpread2_Sheet1.Cells[i + drugApplyedList.Count, (int)DrugListQuit.Flag].Text = "确认";
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolBarService.AddToolButton("保存申请", "保存申请信息", (int)FS.FrameWork.WinForms.Classes.EnumImageList.B保存, true, false, null);
