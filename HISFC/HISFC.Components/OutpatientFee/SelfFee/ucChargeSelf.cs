...
namespace FS.HISFC.Components.OutpatientFee.SelfFee
{
    ...
    public partial class ucChargeSelf : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.FeeInterface.ISIReadCard
    {
        ...
        #region 电子申请单接口
        //houwb 去掉电子申请单功能 2020-2-25 00:08:12
        ...
        protected virtual int SaveFee()
        {
            ...
            if (invoiceType == "2")//默认发票模式,需要trans支持
            {
                ...
                FS.FrameWork.Management.PublicTrans.RollBack();//由于此时并不一定要收费,所以取出发票号就回滚,避免发票走号
            }
            else//其他方式不需要Trans支持
            {
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolBarService.AddToolButton("开始累计", "开始累计", (int)FS.FrameWork.WinForms.Classes.EnumImageList.M默认, true, false, null);
            toolBarService.AddToolButton("取消累计", "取消累计", (int)FS.FrameWork.WinForms.Classes.EnumImageList.Q取消, true, false, null);
            toolBarService.AddToolButton("结束累计", "结束累计", (int)FS.FrameWork.WinForms.Classes.EnumImageList.Q全选, true, false, null);
