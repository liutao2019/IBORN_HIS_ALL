...
namespace FS.HISFC.Components.OutpatientFee.ObservanceFee
{
    public partial class ucObservanceCharge : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        /// <summary>
        /// 留观患者划价
        /// </summary>
        ...
        /// 挂号综合业务层
        /// </summary>
        private FS.HISFC.BizProcess.Integrate.Registration.Registration registerIntegrate = new FS.HISFC.BizProcess.Integrate.Registration.Registration();
        ...
        /// 患者挂号信息
        /// </summary>
        FS.HISFC.Models.Registration.Register rInfo = null;

        /// <summary>
        /// 操作员
        /// </summary>
        FS.HISFC.Models.Base.Employee empl = null;
        ...
        private int LoadPatient()
        {
            ...
            ArrayList al = registerIntegrate.PatientQueryByNurseCell(employee.Dept.ID, FS.HISFC.Models.Base.EnumInState.I.ToString());
            if (al == null)
            {
                MessageBox.Show("查询留观患者信息失败！" + registerIntegrate.Err);
                return -1;
            }
            foreach (FS.HISFC.Models.Registration.Register r in al)
            {
        ...
        private int Save()
        {
            ...
            foreach (FS.HISFC.Models.Fee.Outpatient.FeeItemList f in alFee)
            {
                ...
                f.InvoiceCombNO = "";
                f.FeeOper.ID = "";
                f.RecipeOper.Dept.ID = (outPatientFeeManager.Operator as FS.HISFC.Models.Base.Employee).Dept.ID;
                f.RecipeOper.ID = outPatientFeeManager.Operator.ID;
                f.FTSource = "2";
            }
            string errText = string.Empty;
            FS.FrameWork.Management.PublicTrans.BeginTransaction();
            bool result = feeIntegrate.ClinicFee(FS.HISFC.Models.Base.ChargeTypes.Save, rInfo, null, null, alFee, null, null, ref errText);
            if (!result)
            {
        ...
        {
            tooBarService.AddToolButton("删除", "删除", FS.FrameWork.WinForms.Classes.EnumImageList.S删除, true, false, null);
            tooBarService.AddToolButton("划价", "划价", FS.FrameWork.WinForms.Classes.EnumImageList.H划价保存, true, false, null);
        ...
        {
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm("正在加载数据，请等待....");
            Application.DoEvents();
            empl = outPatientFeeManager.Operator as FS.HISFC.Models.Base.Employee;
        ...
        private void tvPatient_NodeMouseClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            rInfo = e.Node.Tag as FS.HISFC.Models.Registration.Register;
