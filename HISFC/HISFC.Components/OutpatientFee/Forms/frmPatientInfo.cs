...
namespace FS.HISFC.Components.OutpatientFee.Forms
{
    public partial class frmPatientInfo : Form
    {
        ...
        private bool isNeedJZD = false;//是否需要记账单号

        [Category("控件设置"),Description("是否需要记账单号,true:是；false：否。")]
        ...
        private void tbJZDNO_KeyDown(object sender, KeyEventArgs e)
        {
            this.cmbClass.Focus();
        }
    }
