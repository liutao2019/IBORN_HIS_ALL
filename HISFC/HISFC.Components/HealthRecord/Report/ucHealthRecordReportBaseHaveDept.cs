...
namespace FS.HISFC.Components.HealthRecord.Report
{
    ...
    /// </summary>
    public partial class ucHealthRecordReportBaseHaveDept : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Forms.IReport
    {
        /// <summary>
        /// 从通用报表移植过来 修改一下 2011-8-9 chengym
        /// </summary>
        public ucHealthRecordReportBaseHaveDept()
        {
            InitializeComponent();
        }
        ...
        public int Query()
        {
            ...
            string deptCode = "ALL";
            if (this.cmbDept.Tag != null && this.cmbDept.Text.ToString()!="")
            {
                deptCode = this.cmbDept.Tag.ToString();
            }
            this.myDataSet = new DataSet();
            //int parm = report.ExecQuery(reportParm, ref this.myDataSet, myBeginDate.ToString(), myEndDate.ToString(), var.ID, var.Dept.ID, this.reportID);
            int parm = report.ExecQuery(reportParm, ref this.myDataSet, myBeginDate.ToString(), myEndDate.ToString(), deptCode, this.reportID);
        ...
        private void ucReportBase_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.deptType != "")
                {
                    ...
                    //System.Collections.ArrayList alDept = deptManager.GetDeptment(deptType);
        ...
        {
            return this.SetParm(parm, reportID);
        }
