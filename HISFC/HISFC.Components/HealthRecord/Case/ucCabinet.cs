...
namespace FS.HISFC.Components.HealthRecord.Case
{
    ...
    ///  />
    /// </summary>
    public partial class ucCabinet : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucCabinet()
        {
            InitializeComponent();
        ...
        /// </summary>
        FS.HISFC.BizLogic.HealthRecord.Case.CaseCabinet cabinetMrg = new FS.HISFC.BizLogic.HealthRecord.Case.CaseCabinet();
        ...
        {
            FS.HISFC.Models.HealthRecord.Case.CaseCabinet caseCabinet = new FS.HISFC.Models.HealthRecord.Case.CaseCabinet();
            int currRow = this.SpCabinet.ActiveRowIndex;

            caseCabinet = this.SpCabinet.Rows[currRow].Tag as FS.HISFC.Models.HealthRecord.Case.CaseCabinet;
        ...
        protected void Init()
        {
            this.txtOper.Text = ((FS.HISFC.Models.Base.Employee)FS.FrameWork.Management.Connection.Operator).Name;
        ...
        {
            FS.HISFC.Models.HealthRecord.Case.CaseCabinet cabinetObj = new FS.HISFC.Models.HealthRecord.Case.CaseCabinet();
            this.SpCabinet.RowCount = arrayList.Count;

            for (int i = 0; i < arrayList.Count; i++)
            {
                cabinetObj = arrayList[i] as FS.HISFC.Models.HealthRecord.Case.CaseCabinet;
        ...
        private int Valid()
        {
            ...
            if (!FS.FrameWork.Public.String.ValidMaxLengh(this.txtStoreNO.Text, 50))
            {
            ...
            if (!FS.FrameWork.Public.String.ValidMaxLengh(this.txtCabinetNO.Text, 50))
            {
            ...
            if (!FS.FrameWork.Public.String.ValidMaxLengh(this.txtMemo.Text, 200))
            {
        ...
        protected int Save()
        {
            FS.HISFC.Models.HealthRecord.Case.CaseCabinet cabinet = new FS.HISFC.Models.HealthRecord.Case.CaseCabinet();
            ...
            cabinet.OperEnv.ID = ((FS.HISFC.Models.Base.Employee)FS.FrameWork.Management.Connection.Operator).ID;
            ...
            this.cabinetMrg.SetTrans(FS.FrameWork.Management.PublicTrans.Trans);
