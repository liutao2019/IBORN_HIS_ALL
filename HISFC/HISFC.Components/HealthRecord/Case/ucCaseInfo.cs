...
namespace FS.HISFC.Components.HealthRecord.Case
{
    ...
    ///  />
    /// </summary>
    public partial class ucCaseInfo : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucCaseInfo()
        {
            InitializeComponent();
        ...
        /// 病案基本信息维护
        /// </summary>
        private FS.HISFC.BizLogic.HealthRecord.Case.CaseInfo caseInfoMrg = new FS.HISFC.BizLogic.HealthRecord.Case.CaseInfo();
        ...
        /// </summary>
        private FS.HISFC.BizProcess.Integrate.HealthRecord.Case.Case caseMrg = new FS.HISFC.BizProcess.Integrate.HealthRecord.Case.Case();

        /// <summary>
        /// 病案信息
        /// </summary>
        private FS.HISFC.Models.HealthRecord.Case.CaseInfo caseInformation = new FS.HISFC.Models.HealthRecord.Case.CaseInfo();
        ...
        protected override int OnSave(object sender, object neuObject)
        {
            ...
            caseInfo.InType = FS.FrameWork.Function.NConvert.ToInt32(this.cmbInType.Tag);
            ...
            this.caseInfoMrg.SetTrans(FS.FrameWork.Management.PublicTrans.Trans);
        ...
        private void SetFpSpeard()
        {
            ...
            {
                caseInfo = caseList[i] as FS.HISFC.Models.HealthRecord.Case.CaseInfo;
        ...
        private void SetSingleRow(int index, FS.HISFC.Models.HealthRecord.Case.CaseInfo caseInfo)
        {
            ...
            if (caseInfo.InDept == null) caseInfo.InDept = new FS.HISFC.Models.Base.Department();
        ...
        {
            this.caseInformation = fpSpread_Sheet.ActiveRow.Tag as FS.HISFC.Models.HealthRecord.Case.CaseInfo;
