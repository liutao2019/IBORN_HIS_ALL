...
namespace FS.HISFC.Components.HealthRecord.Case
{
    ...
    ///  />
    /// </summary>
    public partial class ucCaseBill : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucCaseBill()
        {
            InitializeComponent();
        ...
        /// </summary>
        private FS.HISFC.BizProcess.Integrate.HealthRecord.Case.CaseBill caseBillIntegrate = new FS.HISFC.BizProcess.Integrate.HealthRecord.Case.CaseBill();

        /// <summary>
        /// 当前登录科室
        /// </summary>
        private FS.HISFC.Models.Base.Department loginDept = new FS.HISFC.Models.Base.Department();

        /// <summary>
        /// 当前登录操作员

        /// </summary>
        private FS.HISFC.Models.Base.Employee loginEmpl = new FS.HISFC.Models.Base.Employee();
        ...
        /// </summary>
        private FS.HISFC.Models.HealthRecord.Case.CaseBill currentCaseBill = new FS.HISFC.Models.HealthRecord.Case.CaseBill();
        ...
        /// </summary>
        private FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState currentState = FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InRequest;
        ...
        /// </summary>
        private FS.HISFC.Models.HealthRecord.Case.CaseBill CurrentCaseBill
        {
            get
            {
        ...
        private int InitCaseBillTree()
        {
            ...
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm( "正在加载树结点..." );
        ...
        private int QueryByCardNo( string cardNo )
        {
            ...
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm( "正在检索病历信息..." );
            ...
            FS.HISFC.Models.HealthRecord.Case.CaseBill tempBill = new FS.HISFC.Models.HealthRecord.Case.CaseBill();
        ...
        {
            List<HISFC.Models.HealthRecord.Case.CaseBill> caseBillList = new List<FS.HISFC.Models.HealthRecord.Case.CaseBill>();

            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm( "正在加载单据信息..." );
        ...
        /// <param name="caseBill">病历单据</param>
        /// <returns>行号</returns>
        private int GetRowID( FS.HISFC.Models.HealthRecord.Case.CaseBill caseBill )
        {
            for ( int i = 0; i < this.neuSpread1_Sheet1.RowCount; i++ )
            {
                FS.HISFC.Models.HealthRecord.Case.CaseBill rowBill = this.neuSpread1_Sheet1.Rows [i].Tag as FS.HISFC.Models.HealthRecord.Case.CaseBill;
        ...
        {
            FS.HISFC.Models.HealthRecord.Case.CaseBill caseBill = new FS.HISFC.Models.HealthRecord.Case.CaseBill();
            ...
            {
                caseBill = caseBillList [0] as FS.HISFC.Models.HealthRecord.Case.CaseBill;
        ...
        private int MakeCase()
        {
            try
            {
                if ( this.currentCaseBill.Memo == "New"  )
                {
                    ...
                    this.currentCaseBill.CaseBillState = FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InRequest;

                }
                else
                {
                    if ( this.currentCaseBill.CaseBillState == FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InRequest )
                    {
                    ...
                    else if ( this.currentCaseBill.CaseBillState == FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.OutAuditing )
                    {
        ...
        private int SaveBill()
        {
            if ( this.neuSpread1_Sheet1.RowCount > 0 )
            {
                if ( DialogResult.Yes == MessageBox.Show( "是否保存？", "提示信息", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1 ) )
                {
                    ...
                    this.caseBillIntegrate.SetTrans(FS.FrameWork.Management.PublicTrans.Trans);
                    ...
                    {
                        FS.HISFC.Models.HealthRecord.Case.CaseBill caseBill = row.Tag as FS.HISFC.Models.HealthRecord.Case.CaseBill;
                        ...
                        if ( caseBill.Memo == "Old" )
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    case FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InRequest:
                                        ...
                                        break;
                                    case FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.OutAuditing:
                                        ...
                                        caseBill.CaseBillState = FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.OutAuditing;
                                        break;
                                    case FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InConfirm:
                                        caseBill.InConfirmOper.ID = this.loginEmpl.ID;
                                        caseBill.InConfirmOper.OperTime = operTime;
                                        caseBill.CaseBillState = FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InConfirm;
                                        break;
                                }
        ...
        private void InitUC()
        {
            ...
            this.neuTextBoxStatus.Text = this.GetOperateState( this.operateState );
            this.currentCaseBill = new FS.HISFC.Models.HealthRecord.Case.CaseBill();
            this.DisplayCaseCount();
            this.currentState = FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InRequest;
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit( object sender, object neuObject, object param )
        {
            try
            {
                this.loginEmpl = FS.FrameWork.Management.Connection.Operator as FS.HISFC.Models.Base.Employee;
                ...
                toolbarService.AddToolButton( "新建", "新建病历出入库单", FS.FrameWork.WinForms.Classes.EnumImageList.T添加, true, false, null );
            }
            catch ( Exception exception )
            {
        ...
        private void neuTreeViewBill_NodeMouseClick( object sender, TreeNodeMouseClickEventArgs e )
        {
            ...
            if ( e.Node.Level == 2 )
            {
                try
                {
                    FS.FrameWork.Models.NeuObject node = e.Node.Tag as FS.FrameWork.Models.NeuObject;
                    ...
                    switch ( parentNode.Text )
                    {
                        case "已经申请入库":
                            ...
                            break;
                        case "等待出库审核":
                            this.currentState = FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.OutAuditing;
                            break;
                        case "等待入库确认":
                            this.currentState = FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InConfirm;
                            break;
                    }

                    if ( this.currentState != FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InRequest )
                    {
                    ...
                    if ( this.currentState == FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InConfirm )
                    {
        ...
        private void neuSpread1_CellClick( object sender, FarPoint.Win.Spread.CellClickEventArgs e )
        {
            if ( this.neuSpread1_Sheet1.RowCount >0 && e.Row >= 0 )
            {
                try
                {
                    this.CurrentCaseBill = this.neuSpread1_Sheet1.Rows [e.Row].Tag as FS.HISFC.Models.HealthRecord.Case.CaseBill;
