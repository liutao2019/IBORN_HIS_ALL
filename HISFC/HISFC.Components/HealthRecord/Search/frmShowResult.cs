...
namespace FS.HISFC.Components.HealthRecord.Search
{
    public partial class frmShowResult : Form
    {
        ...
        private void frmShowResult_Load(object sender, System.EventArgs e)
        {
            ...
            this.ilMenu.Images.Add(FS.FrameWork.WinForms.Classes.Function.GetImage(FS.FrameWork.WinForms.Classes.EnumImageList.D打印));
            this.ilMenu.Images.Add(FS.FrameWork.WinForms.Classes.Function.GetImage(FS.FrameWork.WinForms.Classes.EnumImageList.L列表));
            this.ilMenu.Images.Add(FS.FrameWork.WinForms.Classes.Function.GetImage(FS.FrameWork.WinForms.Classes.EnumImageList.T退出));
