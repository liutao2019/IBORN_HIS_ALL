...
{
    public partial class ucCasePrint : UserControl, FS.HISFC.BizProcess.Interface.HealthRecord.HealthRecordInterface
    {
        public ucCasePrint()
        {
            InitializeComponent();
        ...
        public void LoadInfo()
        {
            try
            {
                ...
                this.birthInComboBox.AddItems(Constant.GetList(FS.HISFC.Models.Base.EnumConstant.AREA));
                //初始化民族信息
                this.nationComboBox.ShowCustomerList = false;
                this.nationComboBox.AddItems(Constant.GetList(FS.HISFC.Models.Base.EnumConstant.NATION));
                //初始化籍贯信息
                this.districtComboBox.ShowCustomerList = false;
                this.districtComboBox.AddItems(Constant.GetList(FS.HISFC.Models.Base.EnumConstant.DIST));
                //初始化与患者关系信息
                this.relationComboBox.ShowCustomerList = false;
                this.relationComboBox.AddItems(Constant.GetList(FS.HISFC.Models.Base.EnumConstant.RELATIVE));
                //初始化入院情况信息
