...
namespace FS.HISFC.Components.HealthRecord.CaseFirstPage
{
    public partial class ucZhongRiCaseFirstPrint : UserControl, FS.HISFC.BizProcess.Interface.HealthRecord.HealthRecordInterface
    {
        ...
        void FS.HISFC.BizProcess.Interface.HealthRecord.HealthRecordInterface.ControlValue(FS.HISFC.Models.HealthRecord.Base obj)
        {
            ...
            this.txtDiagYear.Text = myItem.DiagDate.Year.ToString(); //确诊日期
            this.txtDiagMonth.Text = myItem.DiagDate.Month.ToString(); //确诊日期
            this.txtDiagDay.Text = myItem.DiagDate.Day.ToString(); //确诊日期
            ...
            this.txtDeptChiefDonm.Text = myItem.ClinicDoc.Name;//科主任
            ...
            this.txtMrQual.Text = myItem.MrQuality; //病案质量
            this.txtQcDocd.Text = myItem.QcDoc.Name;//质控医生
            this.txtQcNucd.Text = myItem.QcNurse.Name;//质控护士
