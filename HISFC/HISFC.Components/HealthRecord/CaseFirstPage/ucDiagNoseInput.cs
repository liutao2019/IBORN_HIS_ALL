...
namespace FS.HISFC.Components.HealthRecord.CaseFirstPage
{
    ...
    public partial class ucDiagNoseInput : UserControl
    {
        ...
        private void SetRow(FS.HISFC.Models.HealthRecord.Diagnose info, DataRow row, bool tempBool)
        {
            ...
            row["诊断名称"] = CaseFirstPage.Funtion.ReplaceSingleQuotationMarks(info.DiagInfo.ICD10.Name,false);//1
            ...
            row["ICD名称"] = CaseFirstPage.Funtion.ReplaceSingleQuotationMarks(info.Memo,false);
            //设置fpSpread1 的属性
        }
        ...
        {
            this.fpEnter1_Sheet1.Columns[(int)Col.DiagKind].Width = 59; //诊断类别
            this.fpEnter1_Sheet1.Columns[(int)Col.Icd10Code].Width = 124;//ICD10
            //this.fpEnter1_Sheet1.Columns[(int)Col.Icd10Name].Locked = true;
            this.fpEnter1_Sheet1.Columns[(int)Col.Icd10Name].Width = 150;//诊断名称
            this.fpEnter1_Sheet1.Columns[(int)Col.OutState].Width = 65; //出院情况
            this.fpEnter1_Sheet1.Columns[(int)Col.OperationFlag].Width = 40; //有无手术
            this.fpEnter1_Sheet1.Columns[(int)Col.Disease].Width = 40; //30种疾病
            this.fpEnter1_Sheet1.Columns[(int)Col.CLPa].Width = 40; //病理符合
            this.fpEnter1_Sheet1.Columns[(int)Col.Perior].Width = 51; //分期
            this.fpEnter1_Sheet1.Columns[(int)Col.Level].Width = 50; //分级
            this.fpEnter1_Sheet1.Columns[(int)Col.DubDiag].Width = 40; //是否疑诊
            ...
            this.fpEnter1_Sheet1.Columns[(int)Col.ICD].Width = 124;//标准icd诊断
            this.fpEnter1_Sheet1.Columns[(int)Col.IcdName].Width = 150;//标准icd诊断名称
            ...
            {
                fpEnter1_Sheet1.Columns[(int)Col.DiagKind].Visible = true;//诊断类别
                fpEnter1_Sheet1.Columns[(int)Col.Icd10Code].Visible = true;//icd10编码
                fpEnter1_Sheet1.Columns[(int)Col.Icd10Name].Locked = false;//icd10名称
                fpEnter1_Sheet1.Columns[(int)Col.Icd10Name].Width = 320;//icd10名称
                fpEnter1_Sheet1.Columns[(int)Col.Icd10Name].Visible = true;//icd10名称
                fpEnter1_Sheet1.Columns[(int)Col.OutState].Visible = false;//出院情况
                fpEnter1_Sheet1.Columns[(int)Col.OperationFlag].Visible = false;//有无手术
                fpEnter1_Sheet1.Columns[(int)Col.Disease].Visible = false;//30种疾病
                fpEnter1_Sheet1.Columns[(int)Col.CLPa].Visible = false;//病理符合
                ...
                fpEnter1_Sheet1.Columns[(int)Col.DubDiag].Visible = true;//是否疑诊
                fpEnter1_Sheet1.Columns[(int)Col.IsDraftExamine].Visible = false;//是否拟诊
                fpEnter1_Sheet1.Columns[(int)Col.ICD].Visible = false;//标准icd编码
                fpEnter1_Sheet1.Columns[(int)Col.IcdName].Visible = false;//标准icd名称
                fpEnter1_Sheet1.Columns[12].Visible = true;//诊断日期
                fpEnter1_Sheet1.Columns[15].Visible = false;//诊断医生
                fpEnter1_Sheet1.Columns[16].Visible = true;//诊断医生姓名
        ...
        public bool GetDiagnosInfo(List<FS.HISFC.Models.HealthRecord.Diagnose> list)
        {
            try
            {
                ...
                for (int row = 0; row < this.fpEnter1_Sheet1.RowCount; row++)
                {
                    ...
                    info.DiagInfo.ICD10.Name = CaseFirstPage.Funtion.ReplaceSingleQuotationMarks(this.fpEnter1_Sheet1.Cells[row, (int)Col.Icd10Name].Text,true);//ICD名称
                    ...
                    info.DiagInfo.DiagDate = FS.FrameWork.Function.NConvert.ToDateTime(this.fpEnter1_Sheet1.Cells[row, 12].Text);//11诊断日期 保存GetInfoFromPanel（）传入
                    ...
                    info.DiagInfo.Doctor.ID = this.fpEnter1_Sheet1.Cells[row, 15].Text;//诊断医师代码
                    info.DiagInfo.Doctor.Name = this.fpEnter1_Sheet1.Cells[row, 16].Text;//诊断医师
                    info.DiagInfo.Dept.ID = ((FS.HISFC.Models.Base.Employee)FS.FrameWork.Management.Connection.Operator).Dept.ID;
                    info.DiagInfo.IsValid = true;
                    info.Pvisit.Memo = "0";//是否拟诊
                    info.Memo = CaseFirstPage.Funtion.ReplaceSingleQuotationMarks(this.fpEnter1_Sheet1.Cells[row, (int)Col.IcdName].Text,true);//ICD诊断名称
                    info.PerssonType = FS.HISFC.Models.Base.ServiceTypes.I;
                    info.IsValid = true;
                    list.Add(info);
                }
