...
namespace FS.HISFC.Components.HealthRecord.CaseFirstPage
{
    ...
    /// 2012-2-3
    /// </summary>
    public partial class ucCaseFirstPrintBackImage : UserControl,FS.HISFC.BizProcess.Interface.HealthRecord.HealthRecordInterface
    {
        /// <summary>
        /// 
        /// </summary>
        public ucCaseFirstPrintBackImage()
        {
            InitializeComponent();
        }
        ...
        void FS.HISFC.BizProcess.Interface.HealthRecord.HealthRecordInterface.ControlValue(FS.HISFC.Models.HealthRecord.Base info)
        {
            try
            {
                ...
                if (info.PatientInfo.Age == "0" || info.PatientInfo.Age == "-")
                {
                    ...
                    else if (info.AgeUnit.IndexOf("岁") < 0 && info.AgeUnit.IndexOf("月") < 0 && info.AgeUnit.IndexOf("天") > 0)//整天
                    {
                        ...
                        foreach (FS.HISFC.Models.HealthRecord.Diagnose diagNose in al)
                        {
                            ...
                            if (diagNose.DiagInfo.DiagType.ID == "1")
                            {
                                ...
                                else if (diagNose.DiagInfo.ICD10.Name.Length > diagNameNum && diagNose.DiagInfo.ICD10.Name.Length <= diagNameNum+4)
                                {
                                    this.txtMainDiag1.Visible = true;
                                    this.txtMainDiag1.Text = CaseFirstPage.Funtion.ReplaceSingleQuotationMarks(diagNose.DiagInfo.ICD10.Name, false);//主要诊断
                                    this.txtMainDiag1.Font = new System.Drawing.Font("宋体", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
                                }
                                else if (diagNose.DiagInfo.ICD10.Name.Length > diagNameNum+4)
                                {
                                    ...
                                    this.txtMainDiagName1.Font = new System.Drawing.Font("宋体", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
                                    this.txtMainDiagName2.Font = new System.Drawing.Font("宋体", 9F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
                                }
