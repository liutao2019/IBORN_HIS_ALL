...
namespace FS.HISFC.Components.Account.Controls
{
    public partial class ucAccountManagerQuery : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private void btQuery_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(FS.FrameWork.Management.Language.Msg("请输入所要查询的条件！"), FS.FrameWork.Management.Language.Msg("提示"), MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
            try
            {
                FS.FrameWork.WinForms.Classes.Function.ShowWaitForm(FS.FrameWork.Management.Language.Msg("正在加载数据，请稍后^^！"));
                ...
                if (list == null)
                {
                    MessageBox.Show(FS.FrameWork.Management.Language.Msg("查询数据失败！"), FS.FrameWork.Management.Language.Msg("提示"), MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
        ...
        private void neuSpread1_CellClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            if (list == null)
            {
                MessageBox.Show(FS.FrameWork.Management.Language.Msg("查询数据失败！"), FS.FrameWork.Management.Language.Msg("错误"), MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
