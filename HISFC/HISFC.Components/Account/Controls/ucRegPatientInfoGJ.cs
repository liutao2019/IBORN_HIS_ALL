...
{
    public partial class ucRegPatientInfoGJ : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucRegPatientInfoGJ()
        {
            InitializeComponent();
        }
        ...
        /// 是否必须输入联系电话
        /// </summary>
        private bool isInputPHONE = true;

        /// <summary>
        /// 是否必须按顺序跳转
        /// </summary>
        private bool isInSequentialOrder = true;
        ...
        private void ChangeTabIdex(bool isNeedChange)
        {
            if (isNeedChange)
            {
                ...
                this.ComPact.TabIndex = 3;
                this.txtYear.TabIndex = 4;
                this.txtMonth.TabIndex = 5;
                this.txtDays.TabIndex = 6;
                this.txtAge.TabIndex = 7;
                this.cmbHomeAddress.TabIndex = 8;
        ...
        private void SetPatient()
        {
            ...
            this.txtFirstName.Text = patientInfo.First_Name;
            this.txtMiddleName.Text = patientInfo.Middle_Name;
            this.txtLastName.Text = patientInfo.Last_Name;
            ...
            this.cmbArea.Text = this.patientInfo.AreaCode;            //地区
            ...
            this.cmbProfession.Text = this.patientInfo.Profession.ID; //职业
            ...
            this.neuTextBox4.Text = this.patientInfo.Kin.RelationDoorNo;//联系人地址门牌号 

            this.txbInsurance.Text = this.patientInfo.Insurance.Name;//保险公司名称
            this.txbKnowWay.Text = this.patientInfo.KnowWay;//從何途徑獲知我們的醫療中心
            this.txbCity.Text = this.patientInfo.City;//城市
            this.txbState.Text = this.patientInfo.State;//省
            this.txbMobile.Text = this.patientInfo.Mobile;//手机
            this.txbNoOfChildren.Text = this.patientInfo.NoOfChildren;//有几个孩子
            this.txbWorkAddress.Text = this.patientInfo.WorkAddress;//工作地址
            this.txbLinkManHome.Text = this.patientInfo.LinkManHome;//紧急联系人（本国）
            this.txbLinkPhoneHome.Text = this.patientInfo.LinkPhoneHome;//紧急联系人（本国）电话
        ...
        public virtual bool InputValid()
        {
            ...
            //判断字符超长证件号
            if (!FS.FrameWork.Public.String.ValidMaxLengh(this.txtIDNO.Text, 50))
            {
        ...
        public FS.HISFC.Models.RADT.PatientInfo GetPatientInfomation()
        {
            ...
            patientInfo.AreaCode = this.cmbArea.Text.ToString();//地区
            ...
            patientInfo.Profession.ID = this.cmbProfession.Text.ToString();//职业
            ...
            patientInfo.Insurance.Name=this.txbInsurance.Text;//保险公司名称
            //patientInfo.Memo = this.txbKnowWay.Text;//從何途徑獲知我們的醫療中心
            patientInfo.First_Name = this.txtFirstName.Text;
            patientInfo.Middle_Name = this.txtMiddleName.Text;
            patientInfo.Last_Name = this.txtLastName.Text;
            patientInfo.Kin.RelationDoorNo = neuTextBox4.Text;//联系人地址门牌号
            ...
            #region add by CJF 2016-11-15 {61A874F4-EC08-4c82-A9AF-26B9C097A8C8}
            patientInfo.KnowWay = this.txbKnowWay.Text.Trim();//從何途徑獲知我們的醫療中心
            patientInfo.City = this.txbCity.Text.Trim();//城市
            patientInfo.State=this.txbState.Text.Trim() ;//省
            patientInfo.Mobile=this.txbMobile.Text.Trim() ;//手机
            patientInfo.NoOfChildren=this.txbNoOfChildren.Text.Trim() ;//有几个孩子
            patientInfo.WorkAddress=this.txbWorkAddress.Text.Trim() ;//工作地址
            patientInfo.LinkManHome=this.txbLinkManHome.Text.Trim() ;//紧急联系人（本国）
            patientInfo.LinkPhoneHome=this.txbLinkPhoneHome.Text.Trim() ;//紧急联系人（本国）电话
            #endregion 
            return patientInfo;
        }
        ...
        private void neuTextBox3_TextChanged(object sender, EventArgs e)
        {
            this.SetGJName();
        }

        private void SetGJName()
        {
            this.txtName.Text = this.txtFirstName.Text.Trim() + " "
