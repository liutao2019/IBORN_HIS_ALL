...
namespace FS.HISFC.Components.Account.Controls.IBorn
{
    ...
    /// 就诊卡发放
    /// </summary>
    public partial class ucCardManagerIBorn : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        public ucCardManagerIBorn()
        {
            InitializeComponent();
            if (DesignMode)
            {
        ...
        /// 是否可以停用院内卡
        /// </summary>
        private bool isCanStopCardNo = false;
        ...
        /// 是否显示当日办卡所有操作人的记录
        /// </summary>
        private bool isShowDayAllOper = true;
        /// <summary>
        /// 是否显示当日办卡所有操作人的记录
        /// </summary>
        [Category("控件设置"), Description("是否显示当日办卡所有操作人的记录")]
        public bool IsShowDayAllOper
        {
            get
            {
                return isShowDayAllOper;
            }
            set
            {
                isShowDayAllOper = value;
            }
        }
        /// <summary>
        /// 默认有效期的年数
        /// </summary>
        [Category("控件设置"), Description("默认有效期的年数")]
        public int Years
        {
            get
            {
        ...
        /// 是否可以停用院内就诊卡
        /// </summary>
        [Category("控件设置"), Description("是否可以停用院内就诊卡")]
        public bool IsCanStopCardNo
        {
            get
            {
                return isCanStopCardNo;
            }
            set
            {
                isCanStopCardNo = value;
            }
        }
        /// <summary>
        /// 是否可以手动输入会员卡号
        /// </summary>
        [Category("控件设置"), Description("是否可以手动输入会员卡号")]
        public bool IsCanEditMakeNO
        {
            get
            {
                return isCanEditMakeNO;
            }
            set
            {
                isCanEditMakeNO = value;
            }
        }
        /// <summary>
        /// 是否读身份证号判断检索患者信息
        ...
        [Category("输入设置"), Description("现住址是否必须输入！")]
        public bool IsInputNowHome
        {
            get
            {
                return this.ucRegPatientInfo1.IsMustNowHome;// {0AFA59AE-59B4-4140-83B1-54DA5B98ED5E}
            }
            set
            {
                this.ucRegPatientInfo1.IsMustNowHome = value;
            }
        }
        ...
        [Category("输入设置"), Description("紧急联系人是否必须输入！")]
        public bool IsInputLinkMan
        {
            get
            {
                return this.ucRegPatientInfo1.IsInputLinkMan;
            }
            set
            {
                this.ucRegPatientInfo1.IsInputLinkMan = value;
            }
        }
        [Category("输入设置"), Description("紧急联系人电话是否必须输入！")]
        public bool IsInputLinkPhone
        {
            get
            {
                return this.ucRegPatientInfo1.IsInputLinkPhone;
            }
            set
            {
                this.ucRegPatientInfo1.IsInputLinkPhone = value;
            }
        }
        ...
        /// <summary>
        /// 是否提示身份证号码相同，1提示是否继续、2仅提示、3不提示// {74621CF6-D26C-44aa-87DC-C68D0867BAC5}
        /// </summary>
        private int isTooltipIDENO = 1;
        /// <summary>
        /// 是否提示身份证号码相同，1提示是否继续、2仅提示、3不提示
        /// </summary>
        [Category("控件设置"), Description("是否提示身份证号码相同，1提示是否继续、2仅提示、3不提示")]
        public int IsTooltipIDENO
        {
            get
            {
                return isTooltipIDENO;
            }
            set
            {
                isTooltipIDENO = value;
            }
        }
        /// <summary>
        /// 名字和电话相同时是否提示，1提示是否继续、2仅提示、3不提示
        /// </summary>
        private int isTooltipNameAndPhone = 1;

        /// <summary>
        /// 是否提示身份证号码相同，1提示是否继续、2仅提示、3不提示
        /// </summary>
        [Category("控件设置"), Description("名字和联系电话相同时是否提示，1提示是否继续、2仅提示、3不提示")]
        public int IsTooltipNameAndPhone
        {
            get
            {
                return isTooltipNameAndPhone;
            }
            set
            {
                isTooltipNameAndPhone = value;
            }
        }


        /// <summary>
        /// 身份证不正确，1提示是否继续、2仅提示、3不提示
        /// </summary>
        ...
        public int IsTooltipCARDID
        {
            get
            {
                return this.ucRegPatientInfo1.IsTooltipCARDID;
            }
            set
            {
                this.ucRegPatientInfo1.IsTooltipCARDID = value;
            }
        }
        /// <summary>
        /// 会员卡默认卡等级设置// {A8727D4C-D43A-4a86-9E5C-ABCD357F00C5}
        /// </summary>
        private string defaultCardType = string.Empty;
        /// <summary>
        /// 是否提示身份证号码相同，1提示是否继续、2仅提示、3不提示
        /// </summary>
        [Category("控件设置"), Description("会员卡默认卡等级设置，如：“A,1|B,2|C,3”--卡号开头首字符，默认卡等级编码")]
        ...
        private bool Valid()
        {
            ...
            if (this.cmbMarkType.Tag.ToString() == "Account_CARD")
            {
                if (string.IsNullOrEmpty(this.txtMarkNo.Text) || string.IsNullOrEmpty(this.cmbMemCardType.Tag.ToString()))
        ...
        /// <summary>
        /// 换卡// {D59C1D74-CE65-424a-9CB3-7F9174664504}
        /// </summary>
        public void UpdateCard()
        {
            ...
            {
                MessageBox.Show("没有可更新的患者信息！");
                return;
            }
            if (string.IsNullOrEmpty(this.txtMarkNo.Text.Trim()))
            {
            ...
            string tempCardNO = patientInfo.PID.CardNO;
            //当tempCardNO为空的时候是正常发卡操作，当不为空的时候是补发新卡
            //当正常发卡操作的时候回新建立CardNO形成新的患者信息
            //在补发的时候只更新患者信息
            if (!string.IsNullOrEmpty(tempCardNO))
            {
                ...
                if (isAotuStopAccountCard && lstHistoryCard.Count > 0)
                {
                    bool isFalse = this.uc_StopCardEvent(lstHistoryCard);
                    if (!isFalse)
                    {
                        return;
                    }
            ...
            accountCard.MarkNO = this.txtMarkNo.Text.Trim(); // {AE74D7CC-B573-48a7-9EAD-60340E3F01C9}
            ...
            if (this.cmbMarkType.Tag.ToString() == "Account_CARD")
            {
                accountCard.BegTime = this.dtBegTime.Value;
                accountCard.EndTime = this.dtEndTime.Value;
                accountCard.AccountLevel.ID = this.cmbMemCardType.Tag.ToString();
            }
            else
            {
                accountCard.BegTime = DateTime.MinValue;
                accountCard.EndTime = DateTime.MinValue;
            ...
            if (this.cmbMarkType.Tag.ToString() != "Card_No")
            {
                ...
                string mCardNo = this.txtMarkNo.Text.Trim();
                if (Function.WriterMCard(mCardNo, ref error) < 0)
                {
                    MessageBox.Show("写入卡号失败" + error);
        ...
        protected virtual void Save()
        {
            ...
            // {43039B87-7610-44b1-A8CB-A67A8A5FE2CA}
            string strMsg = string.Empty;
            if (this.BlnIDCardNoOnly)  //证件号唯一性的判断：身份证号；姓名和联系电话；
            {
                string strIDCardType = string.Empty;
                string strIDCardNo = string.Empty;
                string strCardNo = string.Empty;
                string strName = string.Empty;
                string strSexCode = string.Empty;
                string strPhone = string.Empty;
                this.ucRegPatientInfo1.GetIdCardInfo(out strIDCardType, out strIDCardNo, out strCardNo);
                this.ucRegPatientInfo1.GetPatientInfo(out strName, out strSexCode, out strPhone);

                //姓名和联系电话 判断
                if (!string.IsNullOrEmpty(strName) && !string.IsNullOrEmpty(strPhone) && strPhone != "-")
                {
                    //查找患者信息
                    //List<AccountCard> list = accountManager.GetAccountCard(strName, "", "", "", "", "", "", strPhone, "");
                    List<FS.HISFC.Models.RADT.PatientInfo> list = new List<FS.HISFC.Models.RADT.PatientInfo>();
                    list = this.accountManager.QueryPatientInfoByWhere("", strName, strPhone, "");// {CDB01BF4-B40F-4cdc-9F0D-23F074290136}

                    if (list != null && list.Count > 0)// {06A6BD92-97A6-4f01-8B6E-533B35CBF2DD}
                    {
                        FS.HISFC.Models.RADT.PatientInfo ac = list[0];

                        if (this.IsTooltipNameAndPhone == 1)// {0304EC3C-ECA4-4b90-8040-5EBEC93F2EA5}
                        {
                        ...
                        else if (this.IsTooltipNameAndPhone == 2)
                        {
                            strMsg = Language.Msg(string.Format("已存在相同 【姓名】和【联系电话】,病历号为：{0} \r\n不允许重复办理", ac.PID.CardNO));
                ...
                //证件类型
                if (!string.IsNullOrEmpty(strIDCardType) && !string.IsNullOrEmpty(strIDCardNo) && strIDCardNo != "-")
                {
                    //查找患者信息
                    ...
                    List<FS.HISFC.Models.RADT.PatientInfo> list = new List<FS.HISFC.Models.RADT.PatientInfo>();
                    list = this.accountManager.QueryPatientInfoByWhere(strIDCardNo, "", "", "");// {CDB01BF4-B40F-4cdc-9F0D-23F074290136}

                    if (list != null && !string.IsNullOrEmpty(strCardNo))
                    {
                        for (int idx = 0; idx < list.Count; idx++)
                        {
                            if (list[idx].PID.CardNO == strCardNo)
                            {
                                list.RemoveAt(idx);
                                idx--;
                            }
                    ...
                    if (list != null && list.Count > 0)
                    {
                        ...
                        if (isTooltipIDENO == 1)
                        {
                            if (MessageBox.Show(strMsg + "是否继续?", "系统提示", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.No)
                            {
                                return;
                            }
                        }
                        else if (isTooltipIDENO == 2)
                        {
                            MessageBox.Show(strMsg + "不允许重复办理！");
                            return;
                        }
                        else { }
                    }
            ...
            if (AllowNoCardSaveType.Contains(MarkType.ID))
            {
                ...
                if (MarkType.ID == "Card_No")// {43039B87-7610-44b1-A8CB-A67A8A5FE2CA}
                {
                    markNO = cardNo;
                }
            ...
            this.Clear();// {D59C1D74-CE65-424a-9CB3-7F9174664504}
        ...
        private void ClearData()
        {
            ...
            this.cmbMarkType.Tag = "Account_CARD";
            cmbMarkType_SelectedIndexChanged(null, null);
            ...
            this.dtBegTime.Value = FS.FrameWork.Function.NConvert.ToDateTime(DateTime.Now.ToLongDateString() + " 00:00:00");
            this.dtEndTime.Value = FS.FrameWork.Function.NConvert.ToDateTime(DateTime.Now.AddYears(years).ToLongDateString() + " 23:59:59");
            cmbMemCardType.Tag = "1";
        ...
        private int BulidCard(AccountCard tempAccountCard)
        {
            try
            {
                ...
                if (this.cmbMarkType.Tag.ToString() == "Account_CARD")
                {
                    ...
                    account = accountManager.GetAccountByCardNoEX(tempAccountCard.Patient.PID.CardNO);
                    if (account != null)// {E0AC3772-A789-461e-B7B9-81705AD348A9}
                    {
                        if (this.accountManager.UpdateAccountLevel(account.ID, tempAccountCard.AccountLevel.ID) < 0)
                        {
                            return -1;
                        }
                    }
        ...
        protected virtual int QueryPatientInfo()
        {
            ...
            if (string.IsNullOrEmpty(patient.Name) == true)
            {
                ...
                //    return -1;
                //}
                if (string.IsNullOrEmpty(patient.Name) && string.IsNullOrEmpty(patient.PID.CaseNO) && string.IsNullOrEmpty(patient.IDCard) && string.IsNullOrEmpty(patient.SSN) && string.IsNullOrEmpty(patient.PhoneHome))
                {
                    MessageBox.Show("请输入信息再查询！");
                    return -1;
                }
        ...
        protected virtual int QueryPatientInfoInDay(string operCode, string days)
        {
            ...
            if (this.isShowDayAllOper == true)// {3218011F-CCDA-49f3-B468-06F25B3F7F72}
            {
                operCode = "ALL";
            }
            ...
            List<FS.HISFC.Models.Base.Employee> currDeptAllOperCodeList = new List<FS.HISFC.Models.Base.Employee>();
            currDeptAllOperCodeList = accountManager.GetCurrDeptEmployee(currDept.HospitalID);


            List<AccountCard> list = accountManager.GetAccountCardInDays(operCode, days);
            List<AccountCard> currList = new List<AccountCard>();
            if (list == null)
            {
            ...
            foreach (AccountCard obj1 in list)
            {

                foreach (FS.HISFC.Models.Base.Employee obj in currDeptAllOperCodeList)
                {
                    if (obj.ID == obj1.Patient.User01)
                    {
                        currList.Add(obj1);
                    }
            ...
            try
            {
                ...
                this.spPatientInDay.Rows.Count = currList.Count;
                int count = 0, beginIndex = 0, rangCount = 1;
                count = currList.Count;

                for (int i = 0; i < count; i++)
                {
                    AccountCard tempCard = currList[i];
                    ...
                    if (string.IsNullOrEmpty(tempCard.AccountLevel.Name))
                    {
                        this.spPatientInDay.Cells[i, 10].Text = markTypeHelp.GetName(tempCard.MarkType.ID);
                    }
                    else
                    {
                        this.spPatientInDay.Cells[i, 10].Text = tempCard.AccountLevel.Name;
                    }
                    this.spPatientInDay.Cells[i, 11].Text = tempCard.BegTime.ToLongDateString();// {E0AC3772-A789-461e-B7B9-81705AD348A9}

                    this.spPatientInDay.Cells[i, 12].Text = tempCard.EndTime.ToLongDateString();
        ...
        {
            if (string.IsNullOrEmpty(patientName) && string.IsNullOrEmpty(idCardType) && string.IsNullOrEmpty(idCard))
            {
                return -1;
            }
            ...
            try
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    List<AccountCard> listC = accountManager.GetLostAccountCard(list[i].Patient.PID.CardNO);// accountCard.Patient.PID.CardNO//{29A7499E-D68C-4D38-904C-81F51F91DBFF}获取卡的信息
                    ...
                    {
                        this.spPatient.Cells[i, 10].Text = tempCard.AccountLevel.Name;
                    }
                    this.spPatient.Cells[i, 11].Text = tempCard.BegTime.ToLongDateString();

                    this.spPatient.Cells[i, 12].Text = tempCard.EndTime.ToLongDateString();
                    //{29A7499E-D68C-4D38-904C-81F51F91DBFF}添加办卡人信息
                    FS.HISFC.BizProcess.Integrate.Manager managerIntegrate = new FS.HISFC.BizProcess.Integrate.Manager();
                    this.spPatient.Cells[i, 13].Text = managerIntegrate.GetEmployeeInfo(listC[0].CreateOper.ID).Name;
                    // managerIntegrate.QueryEmployee(FS.HISFC.Models.Base.EnumEmployeeType.O, listC[0].CreateOper.ID);
        ...
        {
            for (int col = 0; col < this.spPatient.Columns.Count - 4; col++)
            {
        ...
        private void ucCardManager_Load(object sender, EventArgs e)
        {
            ...
            ArrayList al2 = managerIntegrate.GetConstantList("InfoOperAuthor");

            this.toolBar.SetToolButtonEnabled("修改", false);
            foreach (NeuObject conObj in al2)
            {
                if (FS.FrameWork.Management.Connection.Operator.ID == conObj.ID || ((FS.HISFC.Models.Base.Employee)FS.FrameWork.Management.Connection.Operator).IsManager)
                {
                    this.toolBar.SetToolButtonEnabled("修改", true);
                    break;
                }
            }
            ...
            this.dtEndTime.Value = FS.FrameWork.Function.NConvert.ToDateTime(DateTime.Now.AddYears(years).ToLongDateString() + " 23:59:59");
            this.cmbMarkType.SelectedIndex = 0;
            this.cmbMarkType.Tag = "Account_CARD";// {A8727D4C-D43A-4a86-9E5C-ABCD357F00C5}
            ...
            //this.ucRegPatientInfo1.IsMustInputIDNO = true;
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolBar.AddToolButton("修改结算类型", "修改结算类型", (int)FS.FrameWork.WinForms.Classes.EnumImageList.X修改, true, false, null);
            toolBar.AddToolButton("换卡", "换卡", (int)FS.FrameWork.WinForms.Classes.EnumImageList.X信息, true, false, null);
            toolBar.AddToolButton("刷卡", "刷卡", (int)FS.FrameWork.WinForms.Classes.EnumImageList.B报警, true, false, null);
            toolBar.AddToolButton("家庭成员", "家庭成员", (int)FS.FrameWork.WinForms.Classes.EnumImageList.M明细, true, false, null);
                ...
                case "家庭成员":
                    {
                        ...
                        if (!string.IsNullOrEmpty(this.ucRegPatientInfo1.CardNO))
                        {
                            ucAccountFamilyInfo ucAccountFamilyInfo = new ucAccountFamilyInfo();

                            HISFC.Models.RADT.PatientInfo patientInfo = new FS.HISFC.Models.RADT.PatientInfo();
                            patientInfo = managerIntegrate.QueryComPatientInfo(this.ucRegPatientInfo1.CardNO);
                            if (patientInfo != null)
                            {
                                ucAccountFamilyInfo.PatientInfo = patientInfo;
                                FS.FrameWork.WinForms.Classes.Function.ShowControl(ucAccountFamilyInfo);
                            }
                        }
                        else
                        {
                ...
                case "刷卡":
                    {
                        ...
                        txtMedicalCardNo.SelectAll();
                        txtMedicalCardNo.Text = ";" + mCardNo;
                        txtMedicalCardNo.Focus();
        ...
        /// <summary>
        /// 修改患者结算类别{fa76c153-d727-439d-9e93-aa86bfad208b}
        /// </summary>
        private void ModifyPatientCardType()
        {
            //ArrayList list = managerIntegrate.QueryConstantList("ModifyPactEmp");
            //string empid = FS.FrameWork.Management.Connection.Operator.ID;

            if (this.ucRegPatientInfo1 == null || string.IsNullOrEmpty(this.ucRegPatientInfo1.CardNO.Trim()))
            {
                MessageBox.Show("请先找到客户信息！");
                return;
            }
            string cardno = this.ucRegPatientInfo1.CardNO.Trim();
            string pactcode = this.ucRegPatientInfo1.PatientPactInfo.ID;//合同单位ID
            string pactname = this.ucRegPatientInfo1.PatientPactInfo.Name; //合同单位名称

            if (accountManager.UpdatePatientPactByCardNO(pactcode, pactname, cardno) > 0)
            {
        ...
        protected virtual void ModifyPatientInfo()
        {
            ...
            if (accountCard == null)
            {
                accountCard = this.accountManager.GetAccountCard(patient.PID.CardNO, "Card_No");
            }
            if (accountCard != null)
            {
                if (accountCard.MarkType.ID == "Account_CARD")// {49E44612-BEDA-4e3e-8F4E-254D4A7525EA}
                {
                    resultValue = this.accountManager.UpdateAccountCardInfo(accountCard.MarkNO, accountCard.MarkType, this.cmbMemCardType.Tag.ToString(), this.dtBegTime.Value, this.dtEndTime.Value);
                    if (resultValue < 0)
                    {
                        FrameWork.Management.PublicTrans.RollBack();
                        MessageBox.Show("生成变更记录失败！");
            ...
            //{839B57B8-B74C-4818-9647-9881A0CE9013}
            //HISFC.Models.RADT.PatientInfo inpatientInfo = new FS.HISFC.Models.RADT.PatientInfo();

            //ArrayList al = this.radtIntegrate.GetPatientInfomationByCardNo(patientInfo.PID.CardNO);
            //if (al.Count > 0)
            //{
            //    inpatientInfo = (HISFC.Models.RADT.PatientInfo)al[0];
            //}

            ////{839B57B8-B74C-4818-9647-9881A0CE9013}
            ////修改住院信息（姓名，性别，年龄，证件号）
            //inpatientInfo.Name = patient.Name;
            //inpatientInfo.Sex.ID = patient.Sex.ID;
            //inpatientInfo.Birthday = patient.Birthday;
            //inpatientInfo.Age = patient.Age;
            //inpatientInfo.IDCard = patient.IDCard;
            //inpatientInfo.IDCardType.ID = patient.IDCardType.ID;
            //inpatientInfo.IDCardType.Name = patient.IDCardType.Name;
            //inpatientInfo.Pact = patient.Pact;
            //inpatientInfo.Country = patient.Country;
            //inpatientInfo.Nationality = patient.Nationality;
            //inpatientInfo.DIST = patient.DIST;
            //inpatientInfo.Profession = patient.Profession;
            //inpatientInfo.CompanyName = patient.CompanyName;
            //inpatientInfo.PhoneBusiness = patient.PhoneBusiness;
            //inpatientInfo.MaritalStatus.ID = patient.MaritalStatus.ID;
            //inpatientInfo.AddressHome = patient.AddressHome;
            ////inpatientInfo.User01 = patient.User01;
            //inpatientInfo.PhoneHome =  patient.PhoneHome;
            //inpatientInfo.Kin = patient.Kin;
            //inpatientInfo.Memo = patient.Memo;
            //inpatientInfo.HomeZip = patient.HomeZip;
            //inpatientInfo.AddressHomeDoorNo = patient.AddressHomeDoorNo;
            //inpatientInfo.Email = patient.Email;
            //if (this.radtIntegrate.UpdatePatient(inpatientInfo) <= 0)
            //{
            //    MessageBox.Show("更新住院信息失败！");
            //}
        ...
        private void menuItem1_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(tempCard.Patient.PID.CardNO))
            {
                ...
                this.txtCardNo.Text = "" + tempCard.Patient.PID.CardNO;//{9043E842-7A83-4213-AB6D-E7E04B2EF76E} lfhm
            }
        ...
        private void menuItem3_Click(object sender, EventArgs e)
        {
            ...
            if (tempCard.MarkType.ID.ToString() == "Card_No" && !isCanStopCardNo)
            {
        ...
        protected virtual void QueryPatientInfoByCardNO()
        {
            ...
            if (accountCard.MarkType.ID == "Account_CARD")
            {
                cmbMarkType.Tag = accountCard.MarkType.ID;
                if (accountCard.BegTime != DateTime.MaxValue && accountCard.BegTime != DateTime.MinValue)
                {
                    dtBegTime.Value = accountCard.BegTime;
                    dtEndTime.Value = accountCard.EndTime;
                }
                cmbMemCardType.Tag = accountCard.AccountLevel.ID;
            }
            else
            {
                cmbMarkType.Tag = "Card_No";
            }
            ...
            {
                this.txtCardNo.Visible = true;
                this.txtCardNo.Text = "" + this.accountCard.Patient.PID.CardNO;//{9043E842-7A83-4213-AB6D-E7E04B2EF76E} lfhm
            }
            FS.HISFC.Models.RADT.PatientInfo patient = this.ucRegPatientInfo1.GetPatientInfomation();
        ...
        /// 
        /// </summary>
        private bool isAotuStopAccountCard = true;

        /// <summary>
        /// 
        /// </summary>
        [Category("控件设置"), Description("是否自动停止所有卡（除院内卡以外）,否则提示"), DefaultValue(false)]
        public bool IsAotuStopAccountCard// {E0AC3772-A789-461e-B7B9-81705AD348A9}
        {
            get
            {
                return isAotuStopAccountCard;
            }
            set
            {
                isAotuStopAccountCard = value;
            }
        }
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            ...
            if (keyData == Keys.F2)
            {
                ...
                string error = "";
                this.txtMarkNo.Focus();
                if ((this.cmbMarkType.Tag.ToString() == "Account_CARD" || this.cmbMarkType.Text.ToString() == "会员卡"))// {B2FD84F8-BAAA-43a7-A8C2-96EBD3D55C3B}(this.txtMarkNo.Focused)
                {
                    if (Function.OperMCard(ref mCardNo, ref error) == -1)
                    {
                        CommonController.Instance.MessageBox(error, MessageBoxIcon.Error);
                    ...
                    //mCardNo = mCardNo.Substring(mCardNo.Length - 10, 10);

                    this.txtMarkNo.SelectAll();
                    this.txtMarkNo.Text = mCardNo;
                    string str = mCardNo.Substring(0, 1);// {A8727D4C-D43A-4a86-9E5C-ABCD357F00C5}

                    string[] defaultStr = this.defaultCardType.Split('|');
                    foreach (string str1 in defaultStr)
                    {
                        string[] strCode = str1.Split(',');

                        if (strCode[0] == str && strCode != null)
                        {
                            this.cmbMemCardType.Tag = strCode[1];
                        }
        ...
        private void txtName_KeyDown(object sender, KeyEventArgs e)// {D55B4DFA-DA91-42b0-8163-27036100E89E}
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                //{05024624-3FF4-44B5-92BF-BD4C6FAF6897}添加电话查询
                ...
                if (frmQuery.DialogResult == DialogResult.OK)
                {
                    ...
                    this.txtMedicalCardNo.Text = frmQuery.PatientInfo.PID.CardNO;
