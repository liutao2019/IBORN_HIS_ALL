...
namespace FS.HISFC.Components.Material.Pay
{
    ...
    /// </summary>
    public partial class ucUnpayListPrint : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        /// 设置打印数据
        /// </summary>
        public void SetPrintValue(string strTime,FS.HISFC.Models.Material.MaterialCompany company,string strDeptName, List<FS.HISFC.Models.Material.Pay> payList)
        {
            #region label赋值
            ...
            foreach (FS.HISFC.Models.Material.Pay pay in payList)
            {
