...
namespace FS.HISFC.Components.Material.Base
{
    ...
    public partial class ucApplyLists : UserControl
    {
        ...
        private void dtpBeginTime_ValueChanged(object sender, EventArgs e)
        {
            ...
            foreach (FarPoint.Win.Spread.Row r in neuSpread1_Sheet1.Rows)
            {
                if (FS.FrameWork.Function.NConvert.ToDateTime(neuSpread1_Sheet1.Cells[r.Index, 4].Text) < dtpBeginTime.Value)
                {
                    this.neuSpread1_Sheet1.Rows[r.Index].Visible = false;
                }
            }
        ...
        private void dtpEndTime_ValueChanged(object sender, EventArgs e)
        {
            ...
            foreach (FarPoint.Win.Spread.Row r in neuSpread1_Sheet1.Rows)
            {
                if (FS.FrameWork.Function.NConvert.ToDateTime(neuSpread1_Sheet1.Cells[r.Index, 4].Text) > dtpEndTime.Value)
                {
                    this.neuSpread1_Sheet1.Rows[r.Index].Visible = false;
                }
            }
        ...
        private void btOK_Click(object sender, EventArgs e)
        {
            foreach (FarPoint.Win.Spread.Row r in neuSpread1_Sheet1.Rows)
            {
                if (FS.FrameWork.Function.NConvert.ToBoolean(neuSpread1_Sheet1.Cells[r.Index, 0].Value))
                {
        ...
        private void btSelectAll_Click(object sender, EventArgs e)
        {
            foreach (FarPoint.Win.Spread.Row r in neuSpread1_Sheet1.Rows)
            {
                neuSpread1_Sheet1.Cells[r.Index, 0].Value = !FS.FrameWork.Function.NConvert.ToBoolean(neuSpread1_Sheet1.Cells[r.Index, 0].Value);
            }
        } 
