...
namespace FS.HISFC.Components.RADT.Controls
{
    ...
    /// 住院患者床位等级维护
    /// </summary>
    public partial class ucPatientBedGrade : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private void SetBedLvlInfo(FS.HISFC.Models.RADT.PatientInfo patientInfo)
        {
            FS.HISFC.Models.Base.Bed bed=managerIntegrate.GetBed(patientInfo.PVisit.PatientLocation.Bed.ID);
            ...
            if (alFeeItem != null)
            {
                ...
                {
                    FS.HISFC.Models.Fee.BedFeeItem bedFeeItem = alFeeItem[i] as FS.HISFC.Models.Fee.BedFeeItem;
                    FS.HISFC.Models.Fee.Item.Undrug item = this.feeIntegrate.GetUndrugByCode(bedFeeItem.ID);
                    ...
                    //查找个人价格
                    FS.HISFC.Models.Fee.BedFeeItem personFeeItem = this.feeIntegrate.QueryBedFeeItemForPatient(patientInfo.ID, bed.ID, bedFeeItem.PrimaryKey);
                    ...
                    {
                        if (item.ValidState != ((int)FS.HISFC.Models.Base.EnumValidState.Valid).ToString())
                        {
                            bedFeeItem.ValidState = FS.HISFC.Models.Base.EnumValidState.Invalid;
                        }
                        bedFeeItem.OldPrice = price;
                    ...
                    if (bedFeeItem.ValidState == FS.HISFC.Models.Base.EnumValidState.Valid)
                    {
        ...
        private void SetFeeItemListInfo(FS.HISFC.Models.Fee.BedFeeItem bedFeeItem)
        {
            ...
            this.neuSpread1_Sheet1.SetValue(row, 9, FS.FrameWork.Function.NConvert.ToBoolean(bedFeeItem.ExtendFlag));
        ...
        private void SetFeeItemInfo(FS.HISFC.Models.Fee.BedFeeItem bedFeeItem)
        {
            ...
            this.ckExtFlag.Checked = FS.FrameWork.Function.NConvert.ToBoolean(bedFeeItem.ExtendFlag);
        ...
        {
            FS.HISFC.Models.Fee.BedFeeItem bedFeeItem = this.gbFeeItem.Tag as FS.HISFC.Models.Fee.BedFeeItem;
            
            if (bedFeeItem != null&&this.patientInfo!=null)
            {
                bedFeeItem.Price = FS.FrameWork.Function.NConvert.ToDecimal(this.ntxtPrice.Text);
                bedFeeItem.BedNO = this.patientInfo.PVisit.PatientLocation.Bed.ID;
                bedFeeItem.PatientID = this.patientInfo.ID;
                bedFeeItem.Qty = FS.FrameWork.Function.NConvert.ToDecimal(this.ntxtQty.Text);
                ...
                //if (bedFeeItem.Price <= bedFeeItem.OldPrice)
                //{
                //    MessageBox.Show(this, string.Format("项目【{0}】价格小于原始价格", bedFeeItem.Name), "提示", MessageBoxButtons.OK, MessageBoxIcon.Error);
                //    return -1;
                //}
                if (bedFeeItem.Qty <= 0)
                {
        ...
        {
            if (e.Tag is FS.HISFC.Models.RADT.PatientInfo)
            {
                FS.HISFC.Models.RADT.PatientInfo patientInfo = e.Tag as FS.HISFC.Models.RADT.PatientInfo;
                this.Clear();
        ...
        void neuSpread1_SelectionChanged(object sender, FarPoint.Win.Spread.SelectionChangedEventArgs e)
        {
            ...
            {
                this.ClearFeeItem();
                FS.HISFC.Models.Fee.BedFeeItem bedFeeItem = this.neuSpread1_Sheet1.Rows[this.neuSpread1_Sheet1.ActiveRowIndex].Tag as FS.HISFC.Models.Fee.BedFeeItem;
        ...
        void cmbItemInfo_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                FS.HISFC.Models.Fee.Item.Undrug undrug=this.feeIntegrate.GetItem(this.cmbItemInfo.Tag.ToString());
