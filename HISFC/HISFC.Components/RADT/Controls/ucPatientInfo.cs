...
namespace FS.HISFC.Components.RADT.Controls
{
    ...
    public partial class ucPatientInfo : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        protected override int OnSetValue(object neuObject, TreeNode e)
        {
            ...
            this.SetPatientInfo(neuObject as FS.HISFC.Models.RADT.PatientInfo);
            return base.OnSetValue(neuObject, e);
        }
        protected FS.HISFC.BizProcess.Integrate.Manager manager = new FS.HISFC.BizProcess.Integrate.Manager();
        protected FS.HISFC.BizLogic.RADT.InPatient Inpatient = new FS.HISFC.BizLogic.RADT.InPatient();
        protected FS.HISFC.Models.RADT.PatientInfo patientInfo = null;

        //{B71C3094-BDC8-4fe8-A6F1-7CEB2AEC55DD}
        //FS.HISFC.BizProcess.Integrate.Manager = new FS.HISFC.BizProcess.Integrate.Fee();
        #region 属性
        /// <summary>
        /// 性别是否允许修改
        /// </summary>
        ...
        public bool MemoReadOnly
        {
            get
            {
                return rtbMemo.Enabled;
            }
            set
            {
                rtbMemo.Enabled = value;
            }
        }
        #endregion
        ...
        protected void InitControl()
        {
            try
            {
                ...
                this.cmbRelation.AddItems(manager.GetConstantList(FS.HISFC.Models.Base.EnumConstant.RELATIVE));
                ...
                //this.cmbMemo.AddItems(manager.GetConstantList(FS.HISFC.Models.Base.EnumConstant.REMARK));
        ...
        {
            if (patientInfo.PID.PatientNO.Contains("B"))// {407F4A63-CC38-4842-BFDA-995E1C3FC664}
            {
                this.btBedChange.Visible = false;
            }
            else
            {
                this.btBedChange.Visible = true;
            }

            if (patientInfo.Birthday.Hour > 0)
            {
                dtBirthday.CustomFormat = "yyyy-MM-dd HH:mm";
            }
            else
            {
            ...
            if (patientInfo.Memo == "")
                ...
                this.rtbMemo.Text = patientInfo.Memo;						//备注
            ...
            this.rtbAllergyInfo.Text = patientInfo.AllergyInfo;

            //{C51FF9AF-5031-44b3-A397-E19F817E33D5}
            this.ucPatientLabel1.getUserLabelByHisCardNo(patientInfo.PID.CardNO);
        }
        ...
        public void ClearPatintInfo()
        {
            ...
            this.rtbMemo.Text = "";        //特注
            this.Enabled = true;
            this.txtDeptName.Text = "";	//患者所在科室

            this.rtbAllergyInfo.Text = "";	//过敏源
        ...
        /// </summary>
        /// <param name="PatientInfo"></param>
        protected bool GetPatientInfo(FS.HISFC.Models.RADT.PatientInfo patientInfo)
        {
            ...
            patientInfo.AllergyInfo = this.rtbAllergyInfo.Text;//过敏源
            ...
            if (!FS.FrameWork.Public.String.ValidMaxLengh(this.rtbMemo.Text, 200))
            {
            ...
            {
                patientInfo.Memo = this.rtbMemo.Text;
            }
        ...
        {// {249D5ADE-8BE6-4c90-A8D1-F99540D24A64}
            ///以下代码可运行
            if (patientInfo == null)
            {
                return;
            }
            ucPatientCertificatePrint print = new ucPatientCertificatePrint();
            print.SetPatientInfo(patientInfo);
            print.PrintPreview();
            //print.Print();
        }
        // {407F4A63-CC38-4842-BFDA-995E1C3FC664}
        private void btBedChange_Click(object sender, EventArgs e)
        {
            ...
            ucBedChange1.SetType = BedType.Change;

            ucBedChange1.PatientInfo = this.patientInfo;

            FS.FrameWork.WinForms.Classes.Function.PopShowControl(ucBedChange1);
