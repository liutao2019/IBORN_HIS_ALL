...
namespace FS.HISFC.Components.RADT.Controls
{
    ...
    public partial class ucInpatientToOutpatient : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private bool IsValid()
        {
            ...
            //{
            //    FS.FrameWork.WinForms.Controls.Classes.Function.Msg("该患者已经出院!", 111);
            ...
            //{
            //    FS.FrameWork.WinForms.Controls.Classes.Function.Msg("预交金额大于0,不能无费退院", 111);
            //    this.ucQueryInpatientNo.Focus();
            ...
            //{
            //    FS.FrameWork.WinForms.Controls.Classes.Function.Msg("已发生费用或结算记录,不能无费退院", 111);
            //    this.ucQueryInpatientNo.Focus();
