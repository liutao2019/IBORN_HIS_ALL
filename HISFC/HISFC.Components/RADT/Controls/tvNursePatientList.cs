...
namespace FS.HISFC.Components.RADT.Controls
{
    ...
    ///  />
    /// </summary>
    public partial class tvNursePatientList : FS.HISFC.Components.Common.Controls.tvPatientList
    {
        #region 初始化
        ...
        FS.HISFC.BizProcess.Integrate.RADT radtIntegrate = null;
                    ...
                    for (int i = 0; i < types.Length; i++)
                    {
                        try
                        {
                            if (!string.IsNullOrEmpty(types[i])
                                && Enum.IsDefined(typeof(EnumPatientType), FS.FrameWork.Function.NConvert.ToInt32(types[i])))
                            {
                                EnumPatientType paitentType = (EnumPatientType)FS.FrameWork.Function.NConvert.ToInt32(types[i]);
        ...
        private ArrayList GetPatientList(EnumPatientType patientType)
        {
            ...
            FS.HISFC.Models.Base.EnumInState Status = FS.HISFC.Models.Base.EnumInState.I;
            ...
            {
                Status = FS.HISFC.Models.Base.EnumInState.I;
                ...
                if (alDept == null || alDept.Count < 2)
                {
                    ...
                    foreach (FS.HISFC.Models.RADT.PatientInfo pInfo in al1)
                    {
