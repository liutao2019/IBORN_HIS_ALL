...
//{723DB273-E312-4bc6-9879-C7B311D157D9}
        ...
        public void ShowNurse()
        {
            ...
            deptNode.ImageIndex = 0;// (int)FS.FrameWork.WinForms.Classes.EnumImageList.T房间;
            ...
            foreach (FS.HISFC.Models.RADT.PatientInfo patientInfo in al)
            {
                ...
                patientNode.ImageIndex = 5;// (int)FS.FrameWork.WinForms.Classes.EnumImageList.A人员;
