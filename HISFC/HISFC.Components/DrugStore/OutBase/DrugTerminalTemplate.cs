    ...
    public partial class DrugTerminalTemplate : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private void ShowTemplateData( )
        {
           ...
           this.neuSpread1_Sheet1.Rows.Count = 0;
            ...
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm( Language.Msg("正在加载终端模板信息...." ));
        ...
        private bool isValid( )
        {
            ...
            for( int i = 0 ; i < this.neuSpread1_Sheet1.Rows.Count ; i++ )
            {
                ...
                if( info.TerminalProperty == FS.HISFC.Models.Pharmacy.EnumTerminalProperty.普通)
                {
                    isValid = true;
                }               
            }
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm(Language.Msg( "正在加载门诊终端信息...." ));
            Application.DoEvents( );
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit( object sender , object NeuObject , object param )
        {
            ...
            //增加工具栏
            this.toolBarService.AddToolButton( "新建模板" , "新建模板" , FS.FrameWork.WinForms.Classes.EnumImageList.X新建 , true , false , null );
            this.toolBarService.AddToolButton( "删除模板" , "删除整个模板" , FS.FrameWork.WinForms.Classes.EnumImageList.Q清空 , true , false , null );
            this.toolBarService.AddToolButton( "执行模板" , "执行模板设置" , FS.FrameWork.WinForms.Classes.EnumImageList.Z执行 , true , false , null );
            this.toolBarService.AddToolButton( "增加终端" , "增加终端到模板" , FS.FrameWork.WinForms.Classes.EnumImageList.T添加 , true , false , null );
            this.toolBarService.AddToolButton( "删除终端" , "删除单条终端" , FS.FrameWork.WinForms.Classes.EnumImageList.S删除 , true , false , null );
            this.toolBarService.AddToolButton( "删除窗口" , "删除模板中的发药窗口" , FS.FrameWork.WinForms.Classes.EnumImageList.Q取消 , true , false , null );
            this.toolBarService.AddToolButton( "删除配药台" , "删除模板中的配药台" , FS.FrameWork.WinForms.Classes.EnumImageList.Z注销 , true , false , null );
