...
namespace FS.HISFC.Components.DrugStore.Base
{
    ...
    public partial class ucPharmacyFunctionList : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private void ShowDrugList(string fCode, int fLevl)
        {
            ...
            FS.HISFC.BizLogic.Pharmacy.Constant cItem = new FS.HISFC.BizLogic.Pharmacy.Constant();
        ...
        private void menuAdd_Click(object sender, EventArgs e)
        {
            ...
            if (this.tvFunction.SelectedNode != null)
            {
                ...
                girdLevel = this.tvFunction.SelectedNode.Level + 1;             //根据树节点层次设置药理作用级别  {FF5503FA-0057-413e-BF08-5A8C1DCF7ED8} {2CB17497-9DE7-4688-BDFC-DC64C954B0A1}
            }
            else
            {
                nodecode = "-1";
        ...
        private void neuSpread1_CellClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            FS.HISFC.BizLogic.Pharmacy.Item Pitem = new FS.HISFC.BizLogic.Pharmacy.Item();
