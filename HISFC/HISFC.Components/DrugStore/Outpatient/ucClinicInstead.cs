...
namespace FS.HISFC.Components.DrugStore.Outpatient
{
    ...
    /// <修改记录>
    ///    1.设置终端后自动刷新左侧终端显示列表 by Sunjh 2010-9-10 {405F3104-5981-4cc4-8662-E9879A842AAC}
    /// </修改记录>
    /// </summary>
    public partial class ucClinicInstead : FS.FrameWork.WinForms.Controls.ucBaseControl,FS.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        ...
        {
            //增加工具栏
            this.toolBarService.AddToolButton("刷新", "刷新患者列表显示，检索未打印过的处方", FS.FrameWork.WinForms.Classes.EnumImageList.S刷新, true, false, null);
            this.toolBarService.AddToolButton("设置终端", "设置需同时摆药的药房及终端", FS.FrameWork.WinForms.Classes.EnumImageList.S设置, true, false, null);
        ...
        protected override int OnSave(object sender, object neuObject)
        {
            ...
            {
                MessageBox.Show(FS.FrameWork.Management.Language.Msg("请选择当前终端"));
                return -1;
            }
        ...
        public override void ToolStrip_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            switch (e.ClickedItem.Text)
            {
                ...
                case "设置终端":
                    this.Set();
                    //设置终端后自动刷新左侧终端显示列表 by Sunjh 2010-9-10 {405F3104-5981-4cc4-8662-E9879A842AAC}
                    this.ShowList("0");
                    break;
            }
        ...
        protected virtual void Init()
        {
            ...
            if (alDept == null)
            {
                MessageBox.Show(FS.FrameWork.Management.Language.Msg("加载科室列表发生错误"));
                return;
            }
            ...
            if (alTerminal == null)
            {
                MessageBox.Show(FS.FrameWork.Management.Language.Msg("加载发药终端列表发生错误") + drugStoreManager.Err);
                return;
            }
            ...
            if (alPerson == null)
            {
                MessageBox.Show(FS.FrameWork.Management.Language.Msg("加载人员列表发生错误"));
                return;
            }
