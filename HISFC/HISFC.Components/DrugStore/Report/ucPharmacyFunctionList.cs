    ...
    public partial class ucPharmacyFunctionList : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
     ...
     /// <param name="iFtrue"></param>
        ...
        private void ShowDrugList(string fCode, int fLevl)
        {
            ...
            {
                case 1:
                     al = cItem.QueryItemListByFunctionID(fCode, 1);
                    break;
                case 2:
                     al = cItem.QueryItemListByFunctionID(fCode, 2);
                     break;
                case 3:
                     al = cItem.QueryItemListByFunctionID(fCode, 3);
                    break;
            }
        ...
        private void neuSpread1_CellClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            FS.HISFC.Models.Pharmacy.Item al = new FS.HISFC.Models.Pharmacy.Item();
