...
namespace FS.HISFC.Components.DrugStore.Report
{
    ...
    ///  />
    /// </summary>
    public partial class ucOutWorkQuery : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucOutWorkQuery()
        {
            InitializeComponent();
        }
        ...
        private int Init()
        {
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm("正在加载查询数据 请稍候");
        ...
        protected override void OnLoad(EventArgs e)
        {
            try
            {
                if (!Common.Classes.Function.ChoosePiv("0300"))
                {
