...
and     (('{3}' = 'A') or ('{3}' = '0' and pha_sto_recipe.card_no = '{2}')
        ...
        protected void DataInit()
        {
            ...
            //{07972AB4-B44B-43e2-AE2C-478A19E8EBC1}只加载医生20120510modify
        ...
        public override int Print(object sender, object neuObject)
        {
            ...
            if (terminal.TerimalPrintType == FS.HISFC.Models.Pharmacy.EnumClinicPrintType.标签)
            {
        ...
        private void txtQueryData_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (e.KeyCode == Keys.Space && this.cmbQueryType.SelectedValue != null && this.cmbQueryType.SelectedValue.ToString() == "4" && this.personHelper!= null)
            {
                ...
                if (FS.FrameWork.WinForms.Classes.Function.ChooseItem(this.personList, new string[] { "编码", "人员姓名", "" }, new bool[] { false, true, true, false, false, false, false, false, false }, new int[] { 100, 160, 80 }, ref personInfo) == 0)
                {
                    return;
                }
                else
