...
namespace FS.HISFC.Components.DrugStore
{
    ...
    public partial class ucAddStock : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private void RetrieveData( )
        {
            ...
            //取药品数据
            List<FS.HISFC.Models.Pharmacy.Item> al = item.QueryItemList( true );
            ...
            this.drugTypeHelper.ArrayObject = manager.GetConstantList( FS.HISFC.Models.Base.EnumConstant.ITEMTYPE );
            this.qualityHelper.ArrayObject = manager.GetConstantList( FS.HISFC.Models.Base.EnumConstant.DRUGQUALITY );
        ...
        protected override void OnLoad( EventArgs e )
        {
            ...
            this.isHavePriv = FS.HISFC.BizProcess.Integrate.Pharmacy.ChoosePiv("0301");
            this.privDept = ((FS.HISFC.Models.Base.Employee)(item.Operator)).Dept;
