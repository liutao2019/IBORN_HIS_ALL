...
{
    public partial class ucNetRegConfirm : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        /// 集成平台挂号业务层
        /// </summary>
        FS.HISFC.BizLogic.Registration.NetRegister netRegManager = new FS.HISFC.BizLogic.Registration.NetRegister();
        ...
        /// 性别服务类
        /// </summary>
        FS.HISFC.Models.Base.SexEnumService sexService = new FS.HISFC.Models.Base.SexEnumService();
        ...
        private int GetNetRegister()
        {
            ...
            try
            {
                ...
                DateTime dtbegin = FS.FrameWork.Function.NConvert.ToDateTime(dtBegin.Value.Date.ToString("yyyy-MM-dd") + " 00:00:00");
                DateTime dtend = FS.FrameWork.Function.NConvert.ToDateTime(dtEnd.Value.Date.ToString("yyyy-MM-dd") + " 23:59:59");
        ...
        private void SetFP(DataRow dr)
        {
            ...
            this.fpReg_Sheet1.Cells[count, 0].Text = FS.FrameWork.Function.NConvert.ToDateTime(dr[1]).ToString("yyyy-MM-dd"); //看诊时间 
            ...
            this.fpReg_Sheet1.Cells[count, 5].Text = FS.FrameWork.Function.NConvert.ToDateTime(dr[6].ToString()).ToString("yyyy-MM-dd");//出生日期
        ...
        /// <param name="dr"></param>
        /// <returns></returns>
        private FS.HISFC.Models.Registration.Register GetReg(DataRow dr)
        {
            ...
            r.TranType = FS.HISFC.Models.Base.TransTypes.Positive;//正交易
            ...
            r.Birthday = FS.FrameWork.Function.NConvert.ToDateTime(dr[6]);//出生日期			
            ...
            r.IsFee = true;
            r.Status = FS.HISFC.Models.Base.EnumRegisterStatus.Valid;
            r.IsSee = false;
        ...
        private int Confirm()
        {
            ...
            FS.HISFC.Models.Registration.Register r = this.GetReg(dr);
            if (r == null) return -1;
        ...
        /// <returns></returns>
        private int InserPatientInfo(FS.HISFC.Models.Registration.Register r,ref string errText)
        {
