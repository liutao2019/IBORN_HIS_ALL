namespace FS.HISFC.Components.Registration
{
    partial class ucChooseBookingDate
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fpSpread1.Size = new System.Drawing.Size(825, 224);
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 11).Value = "看诊科室";
            this.fpSpread1_Sheet1.ColumnHeader.Rows.Get(0).Height = 34F;
            this.fpSpread1_Sheet1.Columns.Get(0).Label = "预约日期";
            this.fpSpread1_Sheet1.Columns.Get(0).Width = 188F;
            ...
            this.fpSpread1_Sheet1.Columns.Get(11).Label = "看诊科室";
            this.fpSpread1_Sheet1.Columns.Get(11).Width = 152F;
            ...
            this.Size = new System.Drawing.Size(834, 234);
