namespace FS.HISFC.Components.Registration
{
	partial class ucRegLevel
	{
		...
		private void InitializeComponent()
		{
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 9).Value = "急诊";
            ...
            this.fpSpread1_Sheet1.Columns.Get(1).Width = 54F;
            textCellType3.MaxLength = 8;
            this.fpSpread1_Sheet1.Columns.Get(2).CellType = textCellType3;
            this.fpSpread1_Sheet1.Columns.Get(2).Label = "助记码";
            this.fpSpread1_Sheet1.Columns.Get(2).Width = 54F;
            numberCellType1.DecimalPlaces = 0;
            numberCellType1.FixedPoint = false;
            numberCellType1.MaximumValue = 99999;
            ...
            this.fpSpread1_Sheet1.Columns.Get(4).Width = 54F;
            ...
            this.fpSpread1_Sheet1.Columns.Get(6).Width = 54F;
            ...
            this.fpSpread1_Sheet1.Columns.Get(9).CellType = checkBoxCellType6;
            this.fpSpread1_Sheet1.Columns.Get(9).Label = "急诊";
