...
{
    public partial class ucRegConstant : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.HISFC.BizProcess.Interface.Common.IControlParamMaint
    {
        ...
        public int Init()
        {
            ...
            al = this.managerIntegrate.QueryPactUnitOutPatient();
            if (al.Count > 0)
            {
                ...
                {
                    if (((FS.FrameWork.Models.NeuObject)al[i]).ID == defoultPactId)
                    {
        ...
        private ArrayList GetAllControlValue()
        {
            ...
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Display_RegLevel_ColumnNumber;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Display_RegDept_ColumnNumber;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Display_RegPact_ColumnNumber;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Display_RegProfessor_ColumnNumber;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_RegProfessor_IsFirstDept;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Dialog_IsPub;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Display_Only_Dept;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_IsMultAdd;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Allow_Beyond_Limit;
            ...
            //}
            //tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            //tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_IsICD;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Jump_To_Yuyue;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Jump_To_YuyueTime;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Alow_Quanyuan;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_IsSaveMsg;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Schama_Doct_IsDoctType;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_IsInputRegLevel;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_IsBookingBeforeLocal;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Is_AirCondition;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_IsDivision_ProLevel;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Allow_QuitReg_Days;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Allow_PubPatient_RegLimitCost;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Default_Noon;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_GetRecipe_Way;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_InvoiceType;
            ...
            tempControlObj = new FS.HISFC.Models.Base.ControlParam();
            tempControlObj.ID = FS.HISFC.BizProcess.Integrate.RegistrationConstant.Const_Display_DefaultPact;
