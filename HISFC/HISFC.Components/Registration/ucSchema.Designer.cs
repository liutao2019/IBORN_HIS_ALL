namespace FS.HISFC.Components.Registration
{
	partial class ucSchema
	{
		...
		private void InitializeComponent()
		{
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 23).Value = "停诊人ID";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 24).Value = "停诊日期";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 25).Value = "诊室编码";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 26).Value = "诊室";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 27).Value = "诊台编码";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 28).Value = "诊台";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 29).Value = "ScheduleType";
            ...
            this.fpSpread1_Sheet1.Columns.Get(23).Label = "停诊人ID";
            this.fpSpread1_Sheet1.Columns.Get(23).Width = 58F;
            ...
            this.fpSpread1_Sheet1.Columns.Get(24).Label = "停诊日期";
            this.fpSpread1_Sheet1.Columns.Get(24).Width = 129F;
            this.fpSpread1_Sheet1.Columns.Get(25).Label = "诊室编码";
            this.fpSpread1_Sheet1.Columns.Get(25).Visible = false;
            this.fpSpread1_Sheet1.Columns.Get(25).Width = 120F;
            this.fpSpread1_Sheet1.Columns.Get(26).Label = "诊室";
            this.fpSpread1_Sheet1.Columns.Get(26).Locked = false;
            this.fpSpread1_Sheet1.Columns.Get(26).Width = 120F;
            this.fpSpread1_Sheet1.Columns.Get(27).Label = "诊台编码";
            this.fpSpread1_Sheet1.Columns.Get(27).Locked = false;
            this.fpSpread1_Sheet1.Columns.Get(27).Visible = false;
            this.fpSpread1_Sheet1.Columns.Get(28).Label = "诊台";
            this.fpSpread1_Sheet1.Columns.Get(28).Locked = false;
            this.fpSpread1_Sheet1.Columns.Get(28).Width = 120F;
