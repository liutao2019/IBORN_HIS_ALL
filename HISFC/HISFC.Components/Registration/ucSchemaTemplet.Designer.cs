namespace FS.HISFC.Components.Registration
{
    partial class ucSchemaTemplet
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 16).Value = "备注";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 17).Value = "StopReasonID";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 18).Value = "停诊原因";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 19).Value = "诊室编码";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 20).Value = "诊室";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 21).Value = "诊台编码";
            this.fpSpread1_Sheet1.ColumnHeader.Cells.Get(0, 22).Value = "诊台";
            ...
            this.fpSpread1_Sheet1.Columns.Get(6).Label = "RegLevlCode";
            this.fpSpread1_Sheet1.Columns.Get(6).Width = 0F;
            ...
            this.fpSpread1_Sheet1.Columns.Get(9).CellType = dateTimeCellType1;
            this.fpSpread1_Sheet1.Columns.Get(9).Label = "开始时间";
            ...
            this.fpSpread1_Sheet1.Columns.Get(10).CellType = dateTimeCellType2;
            this.fpSpread1_Sheet1.Columns.Get(10).Label = "结束时间";
            ...
            this.fpSpread1_Sheet1.Columns.Get(14).Width = 37F;
            ...
            textCellType9.StringTrim = System.Drawing.StringTrimming.EllipsisCharacter;
            this.fpSpread1_Sheet1.Columns.Get(16).CellType = textCellType9;
            this.fpSpread1_Sheet1.Columns.Get(16).Label = "备注";
            this.fpSpread1_Sheet1.Columns.Get(16).Width = 140F;
            this.fpSpread1_Sheet1.Columns.Get(17).Label = "StopReasonID";
            this.fpSpread1_Sheet1.Columns.Get(17).Width = 33F;
            this.fpSpread1_Sheet1.Columns.Get(18).Label = "停诊原因";
            this.fpSpread1_Sheet1.Columns.Get(18).Width = 98F;
            this.fpSpread1_Sheet1.Columns.Get(19).Label = "诊室编码";
            this.fpSpread1_Sheet1.Columns.Get(19).Visible = false;
            this.fpSpread1_Sheet1.Columns.Get(20).Label = "诊室";
            this.fpSpread1_Sheet1.Columns.Get(20).Locked = false;
            this.fpSpread1_Sheet1.Columns.Get(21).Label = "诊台编码";
            this.fpSpread1_Sheet1.Columns.Get(21).Visible = false;
            this.fpSpread1_Sheet1.Columns.Get(22).Label = "诊台";
            this.fpSpread1_Sheet1.Columns.Get(22).Locked = false;
