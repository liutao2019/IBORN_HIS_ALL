...
{
    public partial class ucDoctTemplet : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucDoctTemplet()
        {
            InitializeComponent();
        ...
        private void ucTempletForm_Load(object sender, EventArgs e)
        {
            ...
            //{
                ...
                this.Text = FS.FrameWork.Management.Language.Msg( "专家排班模板维护" );
            //}
        ...
        private void InitDept()
        {
            ...
            TreeNode parent = new TreeNode( FS.FrameWork.Management.Language.Msg( "出诊科室" ) );
            ...
            foreach (FS.HISFC.Models.Base.Department dept in al)// {63B27717-4D42-46d6-9AE3-CE89853E9B5E
            {
