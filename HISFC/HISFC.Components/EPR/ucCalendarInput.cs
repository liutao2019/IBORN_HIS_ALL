...
{
    public partial class ucCalendarInput : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        #region 变量
        private FS.HISFC.Models.Base.Calendar calendar = new FS.HISFC.Models.Base.Calendar();
        ...
        private void ucCalendarInput_Load(object sender, EventArgs e)
        {
            ...
            this.comOperName.Text = FS.FrameWork.Management.Connection.Operator.Name;

            this.comOperName.Tag = FS.FrameWork.Management.Connection.Operator.ID;
        }
        ...
        private int Save()
        {
            ...
            try
            {
                ...
                int returnValue = FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.AddCalender(calendar);
       ...
       /// <returns></returns>
        ...
        /// </summary>
        /// <returns></returns>
        private FS.HISFC.Models.Base.Calendar CovertCalendarFromPanel()
        {
            calendar.CalendarDate = FS.FrameWork.Function.NConvert.ToDateTime(this.calendarDate.Text.Trim());
            ...
            calendar.Oper.OperTime = FS.FrameWork.Function.NConvert.ToDateTime(this.OperDate.Text.Trim());
        ...
        private void AddNewRow(FS.HISFC.Models.Base.Calendar calendar)
        {
