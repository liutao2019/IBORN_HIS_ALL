...
namespace FS.HISFC.Components.EPR
{
    ...
    public partial class ucEMRControl : FS.FrameWork.WinForms.Controls.ucBaseControl,FS.FrameWork.WinForms.Forms.IInterfaceContainer    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            this.btnEncap.Image = FS.FrameWork.WinForms.Classes.Function.GetImage(FS.FrameWork.WinForms.Classes.EnumImageList.F封帐);
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolbar.AddToolButton("模板", "显示模板", FS.FrameWork.WinForms.Classes.EnumImageList.T添加, true, false, null);
            toolbar.AddToolButton("患者", "选择患者", FS.FrameWork.WinForms.Classes.EnumImageList.G顾客, true, false, null);
            toolbar.AddToolButton("组套", "显示组套", FS.FrameWork.WinForms.Classes.EnumImageList.X信息, true, false, null);
            toolbar.AddToolButton("历史", "显示历史记录", FS.FrameWork.WinForms.Classes.EnumImageList.C查询历史, true, false, null);
            toolbar.AddToolButton("管理", "管理病历记录", FS.FrameWork.WinForms.Classes.EnumImageList.S设置, true, false, null);
            toolbar.AddToolButton("字体", "更改字体", FS.FrameWork.WinForms.Classes.EnumImageList.R日消耗, true, false, null);
            toolbar.AddToolButton("续打", "续打病历", FS.FrameWork.WinForms.Classes.EnumImageList.D打印预览, true, false, null);
        ...
        private void printpage(ref FS.FrameWork.WinForms.Classes.Print print)
        {
            ...
            bool autoExtend = ((FS.FrameWork.EPRControl.emrPanel)this.ucDataFileLoader1.CurrntPanel).自动分页;
