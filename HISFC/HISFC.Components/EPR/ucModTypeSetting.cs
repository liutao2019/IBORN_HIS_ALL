...
{
	public delegate void ParamHandler(FS.HISFC.Models.File.DataFileParam obj);
	/// <summary>
	...
	public class ucModTypeSetting : System.Windows.Forms.UserControl
	{
		...
		protected FS.HISFC.Models.File.DataFileParam datafileparam = null;
		...
		private void btnOK_Click(object sender, System.EventArgs e)
		{
			...
			{
				if(FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.InsertParam(this.datafileparam)==-1) 
				{
			...
			{
                if (FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.UpdateParam(this.datafileparam) == -1)
				{
					FS.HISFC.BizProcess.Factory.Function.RollBack();
					MessageBox.Show(FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.Err);
					return ;
