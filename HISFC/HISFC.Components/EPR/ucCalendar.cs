...
{
    public partial class ucCalendar : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucCalendar()
        {
            InitializeComponent();
        ...
        public int InitCalendarData()
        {
            ArrayList calendarLis =
                FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.QueryCalendar();
            ...
            foreach (FS.HISFC.Models.Base.Calendar calendar in calendarLis)
            {
        ...
        {
            ArrayList calendarLis =
                FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.QueryCalendar(dtBegin, dtEnd);
            ...
            foreach (FS.HISFC.Models.Base.Calendar calendar in calendarLis)
            {
                ...
                this.neuSpread1_Sheet1.SetValue(row, 1, calendar.Name);
                this.neuSpread1_Sheet1.SetValue(row, 2, calendar.Type);
                FS.HISFC.Models.Base.Employee oper = managerManager.GetPersonByID(calendar.Oper.ID);
        ...
        {
            toolBarService.AddToolButton("增加", "增加", FS.FrameWork.WinForms.Classes.EnumImageList.T添加, true, false, null);
       ...
       /// </summary>
        public void AddNewCalendar()
        {
            ...
            FS.FrameWork.WinForms.Classes.Function.PopForm.Text = "增加";
            FS.FrameWork.WinForms.Classes.Function.PopShowControl(calendarInput);
        ...
        {
            DateTime dtBegin = FS.FrameWork.Function.NConvert.ToDateTime(this.beginDate.Text.Trim());

            DateTime dtEnd = FS.FrameWork.Function.NConvert.ToDateTime(this.endDate.Text.Trim());
