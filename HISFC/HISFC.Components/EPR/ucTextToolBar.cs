...
namespace FS.HISFC.Components.EPR
{
	...
	public class ucTextToolBar : System.Windows.Forms.UserControl
	{
		...
		private void ucTextToolBar_Load(object sender, System.EventArgs e)
		{
            ...
            //bCanModified = FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.GetMedicalPermission(FS.HISFC.Models.EPR.EnumPermissionType.EMR, 5);
		}
		...
		private void checkBox1_CheckedChanged(object sender, System.EventArgs e)
		{
            ...
            //{
            //    FS.FrameWork.EPRControl.IControlTextable ic = c as FS.FrameWork.EPRControl.IControlTextable;
            //    if(ic!=null)
            //    {
		...
		private FS.FrameWork.EPRControl.emrPanel  myCurrentPanel = null;
		
		protected Color SHOWCOLOR = Color.Red;
		private void btnShow_Click(object sender, System.EventArgs e)
		{
            //if(myValue.GetType()==typeof(FS.FrameWork.EPRControl.ucDiseaseRecord))
            //{
		...
		private void comboBox1_SelectedIndexChanged(object sender, System.EventArgs e)
		{
            //try
            //{
            //    if(this.myValue.GetType()==typeof(FS.FrameWork.EPRControl.ucDiseaseRecord))
            //    {
            //        this.CurrentControl = myValue;//重新读取
            //    }
            //    if(currentIC!=null)currentIC.IsOnSaveSuperText = false;
		...
		public object CurrentControl
		{
			set
			{
                ...
                //    if(value.GetType() == typeof(FS.FrameWork.EPRControl.emrMultiLineTextBox))
                //    {
                ...
                //    else
                //    {
                //        currentIC = value as FS.FrameWork.EPRControl.IControlTextable;
                //        if(currentIC !=null)
                //        {
                //            myCurrentTextControl = null;
		...
		public Control CurrentPanel
		{
			set
			{
				...
				Reset();
				if(value!=null)this.myCurrentPanel = value.Controls[0] as FS.FrameWork.EPRControl.emrPanel;
			}
		}
		public void Reset()
		{
