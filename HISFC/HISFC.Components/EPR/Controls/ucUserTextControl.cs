...
namespace FS.HISFC.Components.EPR.Controls
{
    ...
    public partial class ucUserTextControl : UserControl
    {
        ...
        //eusoft.HISFC.Management.Manager.Spell manager = new FS.HISFC.Management.Manager.Spell();
        /// <summary>
        /// 设置数值
        /// </summary>
        /// <returns></returns>
        ...
        protected int GetValue()
        {
            ...
            try
            {
                ...
                ArrayList al = FS.HISFC.BizProcess.Factory.Function.IntegrateManager.GetGroupList(code, type);
        ...
        public int Save()
        {
            ...
            {
                i = FS.HISFC.BizProcess.Factory.Function.IntegrateManager.InsertUserText(this.myUserText);
            }
            else
            {
                i = FS.HISFC.BizProcess.Factory.Function.IntegrateManager.UpdateUserText(this.myUserText);
            }
            if (i == -1)
            {
