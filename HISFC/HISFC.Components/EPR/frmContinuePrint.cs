...
namespace FS.HISFC.Components.EPR
{
	...
	internal class frmContinuePrint : System.Windows.Forms.Form
	{
		...
		public frmContinuePrint(RichTextBox c,Control panel)
		{
			...
			this.SetColor(FS.FrameWork.Function.NConvert.ToInt32(c.Tag));
        ...
        private void continuePrint(Control c, int page, bool bTitle, Control panel)
        {
            ...
            string file = FS.FrameWork.WinForms.Classes.Function.CurrentPath + FS.FrameWork.WinForms.Classes.Function.TempPath + "1.bmp";
