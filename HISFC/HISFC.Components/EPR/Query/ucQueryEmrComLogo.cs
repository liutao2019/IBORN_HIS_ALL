...
"to_char(o.oper_date,'yyyy-mm-dd hh24:mi:ss') as 操作日期, o.index1 as 住院号,o.index2 as 患者姓名 " +
 ...
 "where o.type='2' and o.memo='结点修改' and o.oper_code=e.empl_code and o.oldvalue is not null and o.oldvalue <>'-'";
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolBar.AddToolButton("查询日志", "查询日志", FS.FrameWork.WinForms.Classes.EnumImageList.C查询, true, false, null);
            toolBar.AddToolButton("导出EXCEL", "导出到EXCEL", FS.FrameWork.WinForms.Classes.EnumImageList.F复制, true, false, null);
            return toolBar;
        }
