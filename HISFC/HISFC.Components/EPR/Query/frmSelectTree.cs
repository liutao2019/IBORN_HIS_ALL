...
namespace FS.HISFC.Components.EPR.Query
{
	...
	/// frmSelectTree 的摘要说明。
	/// </summary>
	public class frmSelectTree : System.Windows.Forms.Form
	{
...
//		ArrayList arrTree;
		...
		{
			//从数据库读数据
			ds = FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.GetNodePath();
		...
		private void CreateTree()
		{
			...
			{
				string[] fullpath = dr[0].ToString().Split('\\');
				string parpath = "电子病历";
