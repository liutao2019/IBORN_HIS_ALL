...
namespace FS.HISFC.Components.EPR.Query
{
    public partial class ucQueryPatient : UserControl,Interface.ISearchPatient
    {
		...
		private void load_QuerySetting()
		{
			try
			{
                strFileName = "HIS_QUERY_SETTING.xml"; //TemplateDesignerHost.Function.SystemPath  + "HIS_QUERY_SETTING.xml";
...
//			
		...
		private void f_fillCombo(System.Object sender, string s)
		{
			string[] ss;
			bool b  = false;
			if (s.Length > 5)
        ...
        public event FS.HISFC.Components.EPR.Interface.ObjectHandle OnSelectedPatient;
        ...
        private void fpSpread1_CellDoubleClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            ...
            FS.HISFC.Models.RADT.PatientInfo p = FS.HISFC.BizProcess.Factory.Function.IntegrateRADT.QueryPatientInfoByInpatientNO(s);
            if (p == null)
            {
