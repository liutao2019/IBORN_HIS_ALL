...
namespace FS.HISFC.Components.EPR.Query
{
	...
	public class frmQuery : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.ucConditions1 = new FS.HISFC.Components.EPR.Query.ucConditions();
            ...
            this.ucConditions1.Query += new FS.HISFC.Components.EPR.Query.QueryHandler(this.ucquery1_Query);
...
//		protected FS.HISFC.Management.EPR.EMR manager = new FS.HISFC.Management.EPR.EMR();
//        protected FS.HISFC.Management.File fileParam = new FS.HISFC.Management.File.DataFileParam();
		...
		private void frmQuery_Load(object sender, System.EventArgs e)
		{
            ...
            FS.HISFC.Models.File.DataFileParam param = FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.GetDataFileParam("0") ;
            ArrayList al = FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.GetNodePathList(param.Name);
		...
		public string GetWhereString(ArrayList arr)
		{
			...
			for(int i=0;i<arr.Count;i++)
			{
				...
				FS.FrameWork.Models.NeuObject obj = (FS.FrameWork.Models.NeuObject)arr[i];
		...
		private void ucquery1_Query(System.Object sender, QueryEventArgs e)
		{
		...
		{
             ds = FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.QueryEMRByNode(strWhere);
			if(ds == null) 
			{
		...
		{
			FS.HISFC.Models.File.DataFileInfo dt = new FS.HISFC.Models.File.DataFileInfo();
//			FS.HISFC.Management.File.DataFileInfo managerFileInfo = new FS.HISFC.Management.File.DataFileInfo();
            dt = FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.GetFile(fileid);
			if(dt == null)
			{
		...
		private void Filter()
		{
            ...
            for (int i = 0; i < this.fpSpread1_Sheet1.RowCount; i++)
            {
                ...
                int iValue = FS.FrameWork.Function.NConvert.ToInt32(hat[inpatientNo]);
                iValue = iValue + 1;
        ...
        private void fpSpread1_CellClick(object sender, FarPoint.Win.Spread.CellClickEventArgs e)
        {
            if (this.fpSpread1_Sheet1.RowHeader.Cells[e.Row, 0].Text == "+" && e.RowHeader)
            {
                ...
                System.Data.DataSet myds  = FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.QueryEMRByNode(strWhere);
