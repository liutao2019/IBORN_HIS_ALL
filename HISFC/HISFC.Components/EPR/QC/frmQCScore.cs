...
namespace FS.HISFC.Components.EPR.QC
{
	...
	public class frmQCScore : System.Windows.Forms.Form
	{
		...
		private FS.HISFC.Components.EPR.QC.ucQCScore ucQCScore1;
		...
		private void InitializeComponent()
		{
            ...
            this.ucQCScore1 = new FS.HISFC.Components.EPR.QC.ucQCScore();
		...
		//FS.HISFC.Management.RADT.InPatient manager = new FS.HISFC.Management.RADT.InPatient();

		private void ucQueryInpatientNo1_myEvent()
		{
			//查询到患者
			if(this.ucQueryInpatientNo1.InpatientNo == null || this.ucQueryInpatientNo1.InpatientNo.Trim()=="") return;
            this.ucQCScore1.PatientInfo = FS.HISFC.BizProcess.Factory.Function.IntegrateRADT.QueryPatientInfoByInpatientNO(this.ucQueryInpatientNo1.InpatientNo);
