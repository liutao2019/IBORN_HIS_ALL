...
namespace FS.HISFC.Components.EPR
{
	...
	public class ucQCScoreSetInput : System.Windows.Forms.UserControl
	{
		...
		private FS.FrameWork.WinForms.Controls.NeuComboBox cboType;
        ...
        FS.HISFC.Models.EPR.QCScore curQCScoreSet = null;
		/// <summary>
		/// 
		/// </summary>
		...
		{
			curQCScoreSet = obj as FS.HISFC.Models.EPR.QCScore;
		...
		private void InitializeComponent()
		{
            ...
            this.cboType = new FS.FrameWork.WinForms.Controls.NeuComboBox();
		...
		//private FS.HISFC.Models.EPR.QCScore curQCScoreSet = null;//当前权限

		private FS.FrameWork.WinForms.Forms.frmEasyChoose frmShowPerson= null;//选择人员
		private void ucQCScoreSetInput_Load(object sender, EventArgs e)
		{
			try
			{
				frmShowPerson =new FS.FrameWork.WinForms.Forms.frmEasyChoose(FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.GetQCConditionList());
		...
		//显示人员事件
		private void frmShowPerson_SelectedItem(FS.FrameWork.Models.NeuObject sender)
		{
			this.txtID.Text = ((FS.FrameWork.Models.NeuObject)sender).ID;
			this.txtName.Text = ((FS.FrameWork.Models.NeuObject)sender).Name;
		}
		...
		private void okButton_Click(object sender, System.EventArgs e)
		{
			...
			curQCScoreSet = new FS.HISFC.Models.EPR.QCScore();
			...
			curQCScoreSet.User02 = FS.FrameWork.Management.Connection.Operator.ID;
			curQCScoreSet.User03 = System.DateTime.Now.ToLongDateString();

			FS.HISFC.BizProcess.Factory.Function.BeginTransaction();

            if (FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.SetQCScoreSet(this.curQCScoreSet) == -1)
			{
