...
namespace FS.HISFC.Components.EPR.QC
{
    public partial class ucQCStat : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        {
            FS.FrameWork.WinForms.Classes.Function.PopForm.Text = "条件显示设置";
            ...
            if (dr == DialogResult.OK)
            {
                if (alNewSelectionCondition.Count > 0)
                {
                    try
                    {
                        ...
                        FS.HISFC.BizProcess.Factory.Function.IntegrateEPR.SaveSetting(new FS.FrameWork.Models.NeuObject("1", "质控统计设置", ""), sb.ToString());
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            //toolBarService.AddToolButton("导出", "导出到本地文件", FS.FrameWork.WinForms.Classes.EnumImageList.M默认, true, false, null);
        ...
        {
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm("正在查询质控信息，请稍候。");
