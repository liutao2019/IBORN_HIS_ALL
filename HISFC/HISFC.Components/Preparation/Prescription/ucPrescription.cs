...
namespace FS.HISFC.Components.Preparation
{
    ...
    public partial class ucPrescription : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        ...
        {
            toolBarService.AddToolButton("增加成品", "增加新制剂成品", FS.FrameWork.WinForms.Classes.EnumImageList.X新建, true, false, null);
            toolBarService.AddToolButton("增加明细", "增加制剂成品原料明细", FS.FrameWork.WinForms.Classes.EnumImageList.T添加, true, false, null);
            toolBarService.AddToolButton("删除", "删除制剂成品或成品原料明细", FS.FrameWork.WinForms.Classes.EnumImageList.S删除, true, false, null);
        ...
        protected FS.HISFC.Models.Pharmacy.Item SelectDrug()
        {
            ...
            if (FS.FrameWork.WinForms.Classes.Function.ChooseItem(this.alDrugList, new string[] { "药品编码", "药品名称", "规格" }, new bool[] { false, true, true }, new int[] { 80, 120, 80 }, ref info) == 0)
            {
                return null;
            }
            else
