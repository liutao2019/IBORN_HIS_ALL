...
namespace FS.HISFC.Components.Preparation.Prescription
{
    ...
    public partial class ucPrescriptionContainer : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        protected override FS.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolBarService.AddToolButton("删除成品", "删除制剂成品信息", FS.FrameWork.WinForms.Classes.EnumImageList.S删除, true, false, null);
            toolBarService.AddToolButton("删除处方", "删除制剂处方明细", FS.FrameWork.WinForms.Classes.EnumImageList.Q清空, true, false, null);
