namespace FS.HISFC.Components.Pharmacy.Check
{
    partial class ucCheckSpecial
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.neuFpEnter1.SetItem += new FS.FrameWork.WinForms.Controls.NeuFpEnter.setItem(this.neuFpEnter1_SetItem);
            this.neuFpEnter1.KeyEnter += new FS.FrameWork.WinForms.Controls.NeuFpEnter.keyDown(this.neuFpEnter1_KeyEnter);
            // 
            // neuFpEnter1_Sheet1
            // 
