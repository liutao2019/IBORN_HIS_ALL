...
namespace FS.HISFC.Components.Pharmacy.Check
{
    ...
    ///		/>
    /// </summary>
    public partial class ucCheckSpecial : FS.FrameWork.WinForms.Controls.ucBaseControl, FS.FrameWork.WinForms.Classes.IPreArrange
    {
        #region 构造函数
        ...
        /// 用户权限科室列表
        /// </summary>
        private List<FS.FrameWork.Models.NeuObject> privDeptList = null;
        ...
        {
            toolBarService.AddToolButton("删    除", "删除当前选择数据", FS.FrameWork.WinForms.Classes.EnumImageList.S删除, true, false, null);
        ...
        private void InitDeptTree()
        {
            ...
            foreach (FS.FrameWork.Models.NeuObject dept in this.privDeptList)
            {
        ...
        {
            ArrayList alQuality = this.consManager.GetList(FS.HISFC.Models.Base.EnumConstant.DRUGQUALITY);
        ...
        private void AddNewRow()
        {
            ...
            drNew["科室编码"] = (this.tvDept.SelectedNode.Tag as FS.FrameWork.Models.NeuObject).ID;
        ...
        {
            string deptCode = (e.Node.Tag as FS.FrameWork.Models.NeuObject).ID;
        ...
        private int neuFpEnter1_KeyEnter(Keys key)
        {
            ...
            if (this.neuFpEnter1_Sheet1.ActiveColumnIndex == 2)
            {
                ...
                FS.FrameWork.Models.NeuObject obj = listBox.GetSelectedItem() as FS.FrameWork.Models.NeuObject;
        ...
        {
            this.operCode = ((FS.HISFC.Models.Base.Employee)FS.FrameWork.Management.Connection.Operator).ID;
            //加载基础信息维护权限科室-0301
