...
namespace FS.HISFC.Components.Pharmacy.Base
{
    ...
    public partial class ucSpeUnit : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        {
            toolBarService.AddToolButton("增加", "新增多级单位信息", FS.FrameWork.WinForms.Classes.EnumImageList.X新建, true, false, null);
            toolBarService.AddToolButton("删除", "删除多级单位信息", FS.FrameWork.WinForms.Classes.EnumImageList.S删除, true, false, null);
