...
namespace FS.HISFC.Components.Pharmacy.Base
{
    ...
    public partial class ucDeptRadix : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        {
            toolBarService.AddToolButton("新增区间", "新增基数药管理时间区间", FS.FrameWork.WinForms.Classes.EnumImageList.X新建, true, false, null);
            toolBarService.AddToolButton("增加科室", "新增基数药科室", FS.FrameWork.WinForms.Classes.EnumImageList.X新建, true, false, null);
            toolBarService.AddToolButton("增加明细", "新增基数药信息", FS.FrameWork.WinForms.Classes.EnumImageList.T添加, true, false, null);
            toolBarService.AddToolButton("删除科室", "删除基数科室信息", FS.FrameWork.WinForms.Classes.EnumImageList.S删除, true, false, null);
            toolBarService.AddToolButton("删除明细", "删除基数药信息", FS.FrameWork.WinForms.Classes.EnumImageList.X修改, true, false, null);
            toolBarService.AddToolButton("消耗统计", "统计时间段内的消耗量", FS.FrameWork.WinForms.Classes.EnumImageList.Z暂存, true, false, null);
        ...
        protected void ExpandStat()
        {
            ...
            if (FS.FrameWork.WinForms.Classes.Function.ChooseDate(ref dtBegin, ref dtEnd) == 1)
            {
                ...
                FS.FrameWork.WinForms.Classes.Function.ShowWaitForm(Language.Msg("正在进行药品消耗量统计 请稍候..."));
