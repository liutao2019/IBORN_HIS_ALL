...
namespace FS.HISFC.Components.Pharmacy.Report
{
    ...
    /// [创建时间: 2008-12-21]   
    /// </summary>
    public partial class ucQueryCheckLogs : FS.FrameWork.WinForms.Controls.ucBaseControl
    {
        #region 构造方法
        ...
        /// 药品本地业务类
        /// </summary>
        FS.HISFC.BizLogic.Pharmacy.CheckLog checkLogManager = new FS.HISFC.BizLogic.Pharmacy.CheckLog();
        ...
        private void FillToFp(ArrayList checkLogs)
        {
            ...
            for (int i = 0; i < checkLogs.Count; i++)
            {
                ...
                checkObj = checkLogs[i] as FS.HISFC.Models.Pharmacy.Check;
