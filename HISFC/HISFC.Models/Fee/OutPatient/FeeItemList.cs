...
namespace FS.HISFC.Models.Fee.Outpatient
{
	...
	public class FeeItemList : FeeItemBase
	{
        ...
        /// </summary>
        private string itemRateFlag = null;
        ...
        /// </summary>
        private FS.FrameWork.Models.NeuObject medicalGroupCode = null;
		...
		public string ExamineFlag
		{
			get
			{
                if (this.examineFlag == null)
                {
                    this.examineFlag = string.Empty;
                }
        ...
        public string ItemRateFlag 
        {
            get 
            {
                if (this.itemRateFlag == null)
                {
                    this.itemRateFlag = string.Empty;
                }
        ...
        public FS.FrameWork.Models.NeuObject MedicalGroupCode
        {
            get
            {
                if (medicalGroupCode == null)
                {
                    medicalGroupCode = new FS.FrameWork.Models.NeuObject();
                }
                return medicalGroupCode;
            }
            set
            {
                medicalGroupCode = value;
            }
        }

        private FS.FrameWork.Models.NeuObject doctDeptInfo;
        /// <summary>
        ...
        public FS.FrameWork.Models.NeuObject DoctDeptInfo
        {
            get
            {
                if (doctDeptInfo == null)
                {
                    doctDeptInfo = new FS.FrameWork.Models.NeuObject();
                }
        ...
        {
            get { return this.isPackage; }
            set { this.isPackage = value; }
        }

        /// <summary>
        /// 体检组套
        /// </summary>
        public string CheckBodyPackage { set; get; }
       ...
       // {4B7EF27D-EAB1-43d7-AF5C-524B76310866}
        ...
        {
            FeeItemList f= base.Clone() as FeeItemList;
            if (this.medicalGroupCode != null)
            {
                f.medicalGroupCode = this.medicalGroupCode.Clone();
            }

            if (this.doctDeptInfo != null)
            {
                f.doctDeptInfo = this.doctDeptInfo.Clone();
            }
            return f;
		} 
        ...
        public FS.HISFC.Models.SIInterface.Compare CompareItem
        {
            get
            {
                return null;
        ...
        private FS.FrameWork.Models.NeuObject regDeptInfo = null;
        ...
        private FS.FrameWork.Models.NeuObject doctInfo = null;
		/// <summary>
