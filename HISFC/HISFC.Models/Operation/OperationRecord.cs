...
namespace FS.HISFC.Models.Operation 
{
    ...
    /// </summary>
    [Serializable]
    public class OperationRecord : FS.FrameWork.Models.NeuObject
	{
...
#region 字段
        private OperationAppllication operationAppliction;
#endregion
		///<summary>
		...
		public OperationAppllication OperationAppllication
        {
            get
            {
                if (this.operationAppliction == null)
                    this.operationAppliction = new OperationAppllication();

                return this.operationAppliction;
            }
            set
            {
                this.operationAppliction = value;
            }
        }
        ...
        private DateTime opsEndDate = DateTime.MinValue;
        /// <summary>
        /// 手术结束时间
        /// </summary>
        public DateTime OpsEndDate
        {
            get
            {
                return this.opsEndDate;
            }
            set
            {
                this.opsEndDate = value;
            }
        }
		...
		/// 术前准备状态 （好、差、一般等）
		/// </summary>
		public FS.FrameWork.Models.NeuObject BeforeReady = new FS.FrameWork.Models.NeuObject();
...
//		public string SpecialComment = "";
        ...
        /// 是否外院专家
        /// </summary>
        private bool isOtherHosDoc;
        /// <summary>
        /// 是否外院专家
        /// </summary>
        public bool IsOtherHosDoc
        {
            get
            {
                return this.isOtherHosDoc;
            }
            set
            {
                this.isOtherHosDoc = value;
            }
        }
        /// <summary>
        /// 特殊仪器设备
        /// </summary>
        private string specialDevoice;
        /// <summary>
        /// 特殊仪器设备
        /// </summary>
        public string SpecialDevoice
        {
            get
            {
                return this.specialDevoice;
            }
            set
            {
                this.specialDevoice = value;
            }
        } 
        #endregion
		/// <summary>
