...
namespace FS.HISFC.Models.Pharmacy
{
    ...
    public class DrugQualityEnumService : FS.HISFC.Models.Base.EnumServiceBase
	{
        public DrugQualityEnumService()
		{
            ...
            this.Items[EnumQuality.S] = "毒麻药(旧)";
            this.Items[EnumQuality.S1] = "毒药";
            this.Items[EnumQuality.S2] = "麻药";
            this.Items[EnumQuality.V] = "贵药";
            this.Items[EnumQuality.T] = "大输液";
            this.Items[EnumQuality.P] = "精神药品(旧)";
            this.Items[EnumQuality.P1] = "一类精神药品";
            this.Items[EnumQuality.P2] = "二类精神药品";
