...
namespace FS.HISFC.Models.Pharmacy
{
    ...
    public class Check : StorageBase
	{
        ...
        private decimal otherAdjustNum;	//其他盘点数量，一般指发药机盘点数量，包含在盘点总数量中
        ...
        /// <summary>
        /// 其他盘点数量，一般指发药机盘点数量，包含在盘点总数量中
        /// </summary>
        public decimal OtherAdjustQty
        {
            get
            {
                return otherAdjustNum;
            }
            set
            {
                otherAdjustNum = value;
            }
        }
