...
namespace FS.HISFC.Models.HealthRecord.Case
{
    ...
    /// </summary>
    [Serializable]
    public class CaseInfo : FS.FrameWork.Models.NeuObject
    {
        public CaseInfo()
        {
        ...
        /// </summary>
        private FS.HISFC.Models.Base.Department inDept = new FS.HISFC.Models.Base.Department();

        /// <summary>
        /// 病案所在人员信息

        /// </summary>
        private FS.HISFC.Models.Base.Employee inEmployee = new FS.HISFC.Models.Base.Employee();
        ...
        /// </summary>
        private FS.FrameWork.Models.NeuObject caseState = new FS.FrameWork.Models.NeuObject();

        /// <summary>
        /// 病历缺失状态

        /// </summary>
        private FS.FrameWork.Models.NeuObject loseState = new FS.FrameWork.Models.NeuObject();
        ...
        /// </summary>
        public FS.HISFC.Models.Base.Department InDept
        {
            get
            {
                return this.inDept;
        ...
        /// </summary>
        public FS.HISFC.Models.Base.Employee InEmployee
        {
            get
            {
        ...
        /// </summary>
        public FS.FrameWork.Models.NeuObject CaseState
        {
            get
            {
        ...
        /// </summary>
        public FS.FrameWork.Models.NeuObject LoseState
        {
            get
            {
