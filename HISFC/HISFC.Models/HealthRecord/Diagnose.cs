...
namespace FS.HISFC.Models.HealthRecord
{
    ...
    public class Diagnose : FS.FrameWork.Models.NeuObject
    {
        ...
        /// 患者类别 0 门诊患者 1 住院患者
        /// </summary>
        private FS.HISFC.Models.Base.ServiceTypes perssonType;

        /// <summary>
        /// 患者类别 0 门诊患者 1 住院患者
        /// </summary>
        public FS.HISFC.Models.Base.ServiceTypes PerssonType
        {
            get
            {
                return perssonType;
        ...
        /// 是否初诊
        /// </summary>
        public string Diagnosis_flag
        {
            get { return diagnosis_flag; }
            set { diagnosis_flag = value; }
        }
