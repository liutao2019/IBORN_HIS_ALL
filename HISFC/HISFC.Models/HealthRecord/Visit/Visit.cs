...
namespace FS.HISFC.Models.HealthRecord.Visit
{
    ...
    public class Visit : Case.CaseInfo
    {
        ...
        /// </summary>
        private FS.HISFC.Models.HealthRecord.Visit.LinkWay linkway = new LinkWay();
        ...
        /// </summary>
        public FS.HISFC.Models.HealthRecord.Visit.LinkWay Linkway
        {
            get
            {
                return this.linkway;
        ...
        /// </summary>
        [Obsolete("使用Linkway相应的字段存！", true)]
        private FS.HISFC.Models.Base.Const lastVisitType = new FS.HISFC.Models.Base.Const();
        ...
        /// </summary>
        [Obsolete("使用Linkway相应的字段存！", true)]
        public FS.HISFC.Models.Base.Const LastVisitType
        {
            get
            {
