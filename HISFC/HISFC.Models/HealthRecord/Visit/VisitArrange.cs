...
namespace FS.HISFC.Models.HealthRecord.Visit
{
    ...
    /// </summary>
    [Serializable]
    public class VisitArrange : FS.FrameWork.Models.NeuObject
    {
        #region 变量
        ...
        /// 随访环境
        /// </summary>
        FS.HISFC.Models.Base.OperEnvironment visitOper = new FS.HISFC.Models.Base.OperEnvironment();
        ...
        /// 随访环境
        /// </summary>
        public FS.HISFC.Models.Base.OperEnvironment VisitOper
        {
            get
            { 
                return visitOper;
