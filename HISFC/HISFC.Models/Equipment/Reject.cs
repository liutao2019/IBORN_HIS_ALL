...
{
    [System.Serializable]
    public class Reject:FS.FrameWork.Models.NeuObject
    {
        /// <summary>
        /// 构造函数
        ...
        {
            get { return rejectMethod; }
            set { rejectMethod = value; }
        }
        ...
        {
            Reject reject = base.Clone() as Reject;

            reject.deptInfo = this.deptInfo.Clone();
            reject.equInfo = this.equInfo.Clone();
