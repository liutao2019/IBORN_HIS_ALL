...
namespace FS.HISFC.Models.Base
{
    ...
    public class FT : NeuObject
	{
        ...
        /// </summary>
        private string bedOverDeal=string.Empty;
        ...
        /// </summary>
        private decimal defTotCost;

        /// <summary>
        /// 欠费金额
        /// </summary>
        private decimal arrearCost;

        /// <summary>
        /// 测算金额(终端科室没有确认的项目费用)add by zhy
        /// </summary>
        private decimal terminalCost;
        ...
        /// 优惠金额备份
        /// </summary>
        public decimal BakRebateCost
        {
            get 
            {
                return bakRebateCost; 
            }
            set 
            { 
                bakRebateCost = value; 
