...
using FS.HISFC.Models.MedTech.Base;
...
namespace FS.HISFC.Models.MedTech.Booking
{
    ...
    public class BookingApplyInfo : Spell,IPatientItemApply,ISort
    {
        ...
        private FS.HISFC.Models.Fee.FeeItemBase feeItem = null;
        ...
        /// 项目预约扩展信息
        /// </summary>
        private FS.HISFC.Models.Base.DeptItem deptitem = new DeptItem();
        ...
        /// </summary>
        private FS.HISFC.Models.MedTech.Booking.BookingStateEnumService bookState = new FS.HISFC.Models.MedTech.Booking.BookingStateEnumService();

        private FS.HISFC.Models.Base.EnumBookingState bookingState = new EnumBookingState();
        /// <summary>
        ///当前序号
        /// </summary>
        private int sortId;
        ...
        /// </summary>
        private FS.FrameWork.Models.NeuObject recipeNo;

        /// <summary>
        /// 开单科室

        /// </summary>
        private FS.HISFC.Models.Base.Department recipeDept;
        ...
        /// 预约登记操作环境
        /// </summary>
        private FS.HISFC.Models.Base.OperEnvironment bookingOper = new OperEnvironment();
        ...
        /// </summary>
        public FS.HISFC.Models.Base.EnumBookingState BookingState
        {
            get
            {
        ...
        public FS.HISFC.Models.Fee.FeeItemBase FeeItem 
        {
            get 
            {
                return this.feeItem;
        ...
        /// 交易类型
        /// </summary>
        public FS.HISFC.Models.Base.TransTypes TransType
        {
            get
            {
        ...
        /// </summary>
        public FS.HISFC.Models.MedTech.Booking.BookingStateEnumService BookState
        {
            get 
            {
                return bookState; 
        ...
        /// </summary>
        public FS.FrameWork.Models.NeuObject RecipeNo
        {
            get { return recipeNo; }
            set { recipeNo = value; }
        }
        ...
        /// </summary>
        public FS.HISFC.Models.Base.OperEnvironment BookingOper
        {
