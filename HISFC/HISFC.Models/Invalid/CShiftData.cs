...
namespace FS.HISFC.Models.Invalid
{
	/// <summary>
	/// CShitData 的摘要说明。
	/// 变更的实体
	...
	/// </summary>
    [Serializable]
    public class CShiftData :FS.FrameWork.Models.NeuObject
	{
		public CShiftData()
		{
			//
		...
		///克隆函数
		///</summary>
		public new CShiftData  Clone()
		{
			return this.MemberwiseClone() as CShiftData;
		}
