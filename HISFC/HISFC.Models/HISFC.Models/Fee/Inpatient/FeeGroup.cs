...
namespace FS.HISFC.Models.Fee.Inpatient
{
    ...
    public class FeeGroup :FS.FrameWork.Models.NeuObject
    {
        #region 变量
        /// <summary>
        /// 患者信息
        ...
        /// 执行科室
        /// </summary>
        FS.FrameWork.Models.NeuObject execDept = new FS.FrameWork.Models.NeuObject();

        /// <summary>
        /// 复合项目信息
        /// </summary>
        FS.FrameWork.Models.NeuObject package = new FS.FrameWork.Models.NeuObject();
