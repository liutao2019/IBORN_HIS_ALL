...
namespace FS.HISFC.Models.Fee.Outpatient
{
    ...
    /// 
    [System.Serializable]
	public class BalanceExtend : FS.FrameWork.Models.NeuObject {
		...
		{
			FS.HISFC.Models.Fee.Outpatient.BalanceExtend obj = base.Clone() as FS.HISFC.Models.Fee.Outpatient.BalanceExtend;
