...
namespace FS.HISFC.Models.HealthRecord.Visit
{
    ...
    public class VisitRecord : Case.CaseInfo
    {
        ...
        /// </summary>
        private HISFC.Models.Base.Const circs = new FS.HISFC.Models.Base.Const();

        /// <summary>
        /// 症状表现
        /// </summary>
        private HISFC.Models.Base.Const symptom = new FS.HISFC.Models.Base.Const();
        ...
        /// 转移部位
        /// </summary>
        private HISFC.Models.Base.Const transferPosition = new FS.HISFC.Models.Base.Const();
        ...
        /// </summary>
        private HISFC.Models.Base.Const sequela = new FS.HISFC.Models.Base.Const();
        ...
        /// 死因编码
        /// </summary>
        private HISFC.Models.Base.Const deadReason = new FS.HISFC.Models.Base.Const();
        ...
        /// 随访方式
        /// </summary>
        private HISFC.Models.Base.Const visitType = new FS.HISFC.Models.Base.Const();

       /// <summary>
        /// 随访操作环境
       /// </summary>
        private HISFC.Models.Base.OperEnvironment visitOper = new FS.HISFC.Models.Base.OperEnvironment();
        
        /// <summary>
        /// 随访结果录入操作环境
        /// </summary>
        private HISFC.Models.Base.OperEnvironment resultOper = new FS.HISFC.Models.Base.OperEnvironment();
        ...
        /// 随访结果
        /// </summary>
        private HISFC.Models.Base.Const visitResult = new FS.HISFC.Models.Base.Const();
