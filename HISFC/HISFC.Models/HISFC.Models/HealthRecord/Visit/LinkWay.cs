...
namespace FS.HISFC.Models.HealthRecord.Visit
{
    ...
    public class LinkWay : Case.CaseInfo
    {
        ...
        /// 联系方式类别
        /// </summary>
        private HISFC.Models.Base.Const linkWayType = new FS.HISFC.Models.Base.Const();
        ...
        /// 联系人与患者的关系
        /// </summary>
        private HISFC.Models.Base.Const relation = new FS.HISFC.Models.Base.Const();
        ...
        /// 创建或修改的环境
        /// </summary>
        private FS.HISFC.Models.Base.OperEnvironment operEnvi = new FS.HISFC.Models.Base.OperEnvironment();
        ...
        /// 创建或修改的环境
        /// </summary>
        public FS.HISFC.Models.Base.OperEnvironment OperEnvi
        {
            get
            {
