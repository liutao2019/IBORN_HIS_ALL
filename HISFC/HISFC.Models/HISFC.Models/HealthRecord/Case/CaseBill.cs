...
namespace FS.HISFC.Models.HealthRecord.Case
{
    ...
    /// </summary>
    [Serializable]
    public class CaseBill : FS.FrameWork.Models.NeuObject
    {
        ...
        /// 入库申请操作环境
        /// </summary>
        private HISFC.Models.Base.OperEnvironment inRequestOper = new FS.HISFC.Models.Base.OperEnvironment();

        /// <summary>
        /// 入库申请病区
        /// </summary>
        private HISFC.Models.Base.Department inRequestNurse = new FS.HISFC.Models.Base.Department();

        /// <summary>
        /// 入库申请物流分区
        /// </summary>
        private FS.FrameWork.Models.NeuObject inRequestPartition = new FS.FrameWork.Models.NeuObject();

        /// <summary>
        /// 出库审核操作环境
        /// </summary>
        private HISFC.Models.Base.OperEnvironment outAuditingOper = new FS.HISFC.Models.Base.OperEnvironment();

        /// <summary>
        /// 出库审核病区
        /// </summary>
        private FS.FrameWork.Models.NeuObject outAuditingNurse = new FS.FrameWork.Models.NeuObject();

        /// <summary>
        /// 入库确认操作环境
        /// </summary>
        private HISFC.Models.Base.OperEnvironment inConfirmOper = new FS.HISFC.Models.Base.OperEnvironment();

        /// <summary>
        /// 单据类型
        /// </summary>
        private HISFC.Models.Base.Const billType = new FS.HISFC.Models.Base.Const();

        /// <summary>
        /// 物流发送操作环境
        /// </summary>
        private HISFC.Models.Base.OperEnvironment sendOper = new FS.HISFC.Models.Base.OperEnvironment();

        /// <summary>
        /// 物流接收操作环境
        /// </summary>
        private HISFC.Models.Base.OperEnvironment receiveOper = new FS.HISFC.Models.Base.OperEnvironment();
        ...
        /// 申请的目标对象：可以是科室、病区
        /// </summary>
        private HISFC.Models.Base.Department fromDept = new FS.HISFC.Models.Base.Department();
        ...
        /// 入库申请物流分区
        /// </summary>
        public FS.FrameWork.Models.NeuObject InRequestPartition
        {
            get
            {
        ...
        /// 出库审核病区
        /// </summary>
        public FS.FrameWork.Models.NeuObject OutAuditingNurse
        {
            get
            {
