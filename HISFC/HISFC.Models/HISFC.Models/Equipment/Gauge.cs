...
{
    [System.Serializable]
    public class Gauge:FS.FrameWork.Models.NeuObject
    {
        /// <summary>
        /// 构造函数
        ...
        /// 检测单据号
        /// </summary>
        private string gaugeListCode;

        /// <summary>
        /// 检测费用

        /// </summary>
        private decimal gaugeFee;

        /// <summary>
        /// 检测日期

        /// </summary>
        private DateTime gaugeDate;

        /// <summary>
        /// 检测人员

        /// </summary>
        private string gaugeOper;

        /// <summary>
        /// 检测单位(部门)
        /// </summary>
        private string gaugeDept;

        /// <summary>
        /// 检测内容

        /// </summary>
        private string gaugeCont;
        ...
        /// </summary>
        private string wasteOper;

        /// <summary>
        /// 作废科室
        /// </summary>
        private string wasteDept;

        /// <summary>
        /// 作废仓库
        /// </summary>
        private string wasteDepot;
        ...
        /// </summary>
        public string GaugeClass
        {
            get { return gaugeClass; }
            set { gaugeClass = value; }
        }
        ...
        /// 检测单据号
        /// </summary>
        public string GaugeListCode
        {
            get { return gaugeListCode; }
            set { gaugeListCode = value; }
        }
        ...
        /// </summary>
        public DateTime GaugeDate
        {
            get { return gaugeDate; }
            set { gaugeDate = value; }
        }
        ...
        /// </summary>
        public string GaugeOper
        {
            get { return gaugeOper; }
            set { gaugeOper = value; }
        }
        ...
        /// 检测单位(部门)
        /// </summary>
        public string GaugeDept
        {
            get { return gaugeDept; }
            set { gaugeDept = value; }
        }
        ...
        /// </summary>
        public string GaugeCont
        {
            get { return gaugeCont; }
            set { gaugeCont = value; }
        }
        ...
        /// 申请仓库
        /// </summary>
        public string ApplyDepot
        {
            get { return applyDepot; }
            set { applyDepot = value; }
        }
        ...
        {
            get { return approveDept; }
            set { approveDept = value; }
        }

        /// <summary>
        /// 核准仓库
        /// </summary>
        public string ApproveDepot
        {
            get { return approveDepot; }
            set { approveDepot = value; }
        }
        ...
        /// 作废仓库
        /// </summary>
        public string WasteDepot
        {
            get { return wasteDepot; }
            set { wasteDepot = value; }
        }
        ...
        public new Gauge Clone()
        {
            Gauge gauge = base.Clone() as Gauge;

            gauge.deptInfo = this.deptInfo.Clone();
            gauge.equInfo = this.equInfo.Clone();
