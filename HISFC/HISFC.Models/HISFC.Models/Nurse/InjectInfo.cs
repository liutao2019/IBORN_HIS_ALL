...
namespace FS.HISFC.Models.Nurse
{
    ...
    /// 
    [System.Serializable]
    public class InjectInfo : FS.FrameWork.Models.NeuObject
    {
        public InjectInfo()
        {
        }
        ...
        /// 医嘱信息        
        /// </summary>
        private FS.HISFC.Models.Order.OutPatient.Order order = new FS.HISFC.Models.Order.OutPatient.Order();
        ...
        private FS.FrameWork.Models.NeuObject dosage = new FS.FrameWork.Models.NeuObject();
        ...
        /// 基本剂型
        /// </summary>
        public FS.FrameWork.Models.NeuObject Dosage
        {
            get
            {
                return this.dosage;
    ...
    /// 枚举服务
    /// </summary>
    public class EnumInjectSateService : FS.HISFC.Models.Base.EnumServiceBase
    {
