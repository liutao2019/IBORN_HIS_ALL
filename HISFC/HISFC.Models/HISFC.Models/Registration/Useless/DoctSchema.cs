...
namespace FS.HISFC.Models.Registration
{
    ...
    public class DoctSchema
	{
		...
		/// 出诊医生
		/// </summary>
		protected FS.FrameWork.Models.NeuObject doctor=new FS.FrameWork.Models.NeuObject();
		/// <summary>
		/// 医生类别代码
		/// </summary>
		...
		/// 出诊诊室
		/// </summary>
		protected FS.FrameWork.Models.NeuObject room=new FS.FrameWork.Models.NeuObject();
		/// <summary>
		/// 诊台
		/// </summary>
		...
		/// 停诊原因
		/// </summary>
		protected FS.FrameWork.Models.NeuObject stopReason=new FS.FrameWork.Models.NeuObject();
		/// <summary>
		/// 停止人
		/// </summary>
	...
	/// 午别实体
	/// </summary>
	public class Noon:FS.HISFC.Models.Base.Spell {
