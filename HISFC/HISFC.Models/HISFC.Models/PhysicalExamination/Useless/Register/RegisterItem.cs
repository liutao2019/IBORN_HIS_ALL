namespace FS.HISFC.Models.PhysicalExamination.Useless.Register 
{
	...
	/// </summary>
    [System.Serializable]
    public class RegisterItem : FS.HISFC.Models.PhysicalExamination.Management.Item
	{
		#region 私有变量
		...
		/// 项目的定性结果
		/// </summary>
		private FS.HISFC.Models.PhysicalExamination.Management.ItemQualitativeResult qualitativeResult;

		/// <summary>
		/// 项目的执行信息
		/// </summary>
		private FS.HISFC.Models.PhysicalExamination.Confirm.Confirm confirm;
		...
		/// 项目的定性结果
		/// </summary>
		public FS.HISFC.Models.PhysicalExamination.Management.ItemQualitativeResult QualitativeResult
		{
			get
			{
		...
		/// 项目的执行信息
		/// </summary>
		public FS.HISFC.Models.PhysicalExamination.Confirm.Confirm Confirm
		{
			get
			{
				return this.confirm;
