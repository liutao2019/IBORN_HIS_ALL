...
namespace FS.HISFC.Models.HRM
{
    ...
    /// </summary>
    [Serializable]
    public class HRMEmployee:FS.HISFC.Models.Base.Employee
    {
        #region 变量
        /// <summary>
        /// 学历
        /// </summary>
        private FS.FrameWork.Models.NeuObject studyExperience = new FS.FrameWork.Models.NeuObject();
        ...
        /// 学位
        /// </summary>
        private FS.FrameWork.Models.NeuObject degree = new FS.FrameWork.Models.NeuObject();
        ...
        /// 政治面貌
        /// </summary>
        private FS.FrameWork.Models.NeuObject polityVisage = new FS.FrameWork.Models.NeuObject();

        /// <summary>
        /// 外语
        /// </summary>
        private FS.FrameWork.Models.NeuObject foreignLanguage = new FS.FrameWork.Models.NeuObject();
        ...
        /// 学历
        /// </summary>
        public FS.FrameWork.Models.NeuObject StudyExperience
        {
            set
            {
        ...
        /// 学位
        /// </summary>
        public FS.FrameWork.Models.NeuObject Degree
        {
            set
            {
                this.degree = value;
        ...
        /// 政治面貌
        /// </summary>
        public FS.FrameWork.Models.NeuObject PolictyVisage
        {
            set
            {
        ...
        /// 外语
        /// </summary>
        public FS.FrameWork.Models.NeuObject ForeignLanguage
        {
            set
            {
