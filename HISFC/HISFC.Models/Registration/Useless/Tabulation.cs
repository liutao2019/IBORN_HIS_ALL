...
namespace FS.HISFC.Models.Registration
{
	...
	/// </summary>
    [Serializable]
    public class Tabulation:FS.FrameWork.Models.NeuObject
	{
		public Tabulation()
		{
			//
	...
	/// 排班类型实体
	/// </summary>
	public class WorkType:FS.HISFC.Models.Base.Spell
	{		
		public WorkType()
		{
		}
	...
	public class TabularType:FS.FrameWork.Models.NeuObject
	{
		/* by MaoKb
		 *05.7.26*/
