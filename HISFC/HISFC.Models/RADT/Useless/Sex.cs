...
namespace FS.HISFC.Models.RADT
{
	...
	/// <example> 如何使用list例子
	/// <code>
	///     Dim c As New FS.HISFC.Models.RADT.Patient
	...
	///
	///		Dim i As Int16
	///		Dim a As New FS.HISFC.Models.RADT.Sex
	...
	/// </code>
	/// </example>
	[Obsolete("已经过期，更改为EnumSex",true)]
	public class Sex:FS.FrameWork.Models.NeuObject
	{
		/// <summary>
		/// 性别类
		/// </summary>
		...
		public enuSex GetIDFromName(string Name)
		{
			...
			return (FS.HISFC.Models.RADT.Sex.enuSex)int.Parse(Name);
		}
		/// <summary>
		/// 返回性别中文
		/// </summary>
