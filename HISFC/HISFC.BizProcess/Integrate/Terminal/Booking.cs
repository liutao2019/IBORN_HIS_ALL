...
using Item=FS.HISFC.BizLogic.Fee.Item;
using Spell=FS.HISFC.BizLogic.Manager.Spell;
...
namespace FS.HISFC.BizProcess.Integrate.Terminal
{
	public class Booking : IntegrateBase
	{
		...
		/// </summary>
        protected FS.HISFC.BizLogic.Terminal.Terminal serviceTerminal = new FS.HISFC.BizLogic.Terminal.Terminal();
		
		/// <summary>
		/// 医技预约排班模板业务层

		/// </summary>
		protected FS.HISFC.BizLogic.Terminal.MedTechItemTemp serviceMedTechItemTemp = new MedTechItemTemp();
		
		/// <summary>
		/// 医技预约排班业务层

		/// </summary>
		protected FS.HISFC.BizLogic.Terminal.MedTechItemArray serviceMedTechItemArray = new MedTechItemArray();
		
		/// <summary>
		/// 医技预约业务层

		/// </summary>
		protected FS.HISFC.BizLogic.Terminal.MedTechItemBook serviceMedTechItemBook = new MedTechItemBook();
		
		/// <summary>
		/// 人员管理业务层

		/// </summary>
		protected FS.HISFC.BizLogic.Manager.Person serviceEmployee = new Person();
		
		/// <summary>
		/// 组套管理业务层 
		/// </summary>
        //protected static FS.HISFC.BizLogic.Fee.UndrugComb serviceUndrugComb = new UndrugComb();
		...
		/// </summary>
		protected FS.HISFC.BizLogic.Manager.Constant serviceConstant = new Constant();
		
		/// <summary>
		/// 午别业务层

		/// </summary>
		protected FS.HISFC.BizLogic.Registration.DoctSchema serviceDoctSchema = new DoctSchema();
		
		/// <summary>
		/// 首拼码业务层
		/// </summary>
		protected FS.HISFC.BizLogic.Manager.Spell serviceSpell = new Spell();
		
		/// <summary>
		/// 非药品业务层
		/// </summary>
		protected FS.HISFC.BizLogic.Fee.Item serviceUndrug = new Item();
		...
		/// </summary>
		protected FS.HISFC.BizLogic.RADT.InPatient serviceInpatient = new InPatient();
		
		/// <summary>
		/// 门诊收费业务层

		/// </summary>
        //protected static FS.HISFC.BizLogic.Fee.Outpatient serviceOutpatient = new Outpatient();

		/// <summary>
		/// 科常用业务层
		/// </summary>
		public FS.HISFC.BizLogic.Manager.DeptItem serviceDeptItem = new DeptItem();
        /// <summary>
        /// 体检主信息

        /// </summary>
        public FS.HISFC.BizLogic.PhysicalExamination.Register registerMgr = new FS.HISFC.BizLogic.PhysicalExamination.Register();

        /// 医技设备业务层
        /// {250AAC5B-EC56-4e2e-B51A-8427AAFC9740}
        /// </summary>
        public FS.HISFC.BizLogic.Terminal.TerminalCarrier serviceCarrier = new TerminalCarrier();
		...
		protected void GetEnvironment()
		{
			...
			CurrentOperEnvironment.Dept = ((FS.HISFC.Models.Base.Employee)serviceTerminal.Operator).Dept;
		...
		public FS.HISFC.Models.Base.Employee GetEmployee(string employeeID)
		{
			this.SetDB(serviceTerminal);
		...
		public FS.HISFC.Models.Fee.Item.UndrugComb GetUndrugCombByCode(string combID)
		{
		...
		/// <returns>拼音码</returns>
		public FS.HISFC.Models.Base.Spell GetSpell(string name)
		{
			this.SetDB(serviceSpell);
			
			return (FS.HISFC.Models.Base.Spell)serviceSpell.Get(name);
		}
		...
		public FS.HISFC.Models.Fee.Item.Undrug GetValidItemByUndrugCode(string code)
		{
        ...
        public FS.HISFC.Models.Registration.Register GetByClinic(string clinicNO)
        {
            ...
            {
                FS.HISFC.Models.PhysicalExamination.Register examiObj = registerMgr.GetRegisterByClinicNO(clinicNO);
                if (examiObj.ID != "")
                {
                    #region  赋值
		...
		/// <returns>－1－失败；影响的行数</returns>
		public int InsertMedTechItemTemp(FS.HISFC.Models.Terminal.MedTechItemTemp medTechItemTemp)
		{
			this.SetDB(serviceMedTechItemTemp);
		...
		public int UpdateMedTechItemTemp(FS.HISFC.Models.Terminal.MedTechItemTemp medTechItemTemp)
		{
			this.SetDB(serviceMedTechItemTemp);
		...
		/// <param name="medTechItemTemp">医技预约模板</param>
		/// <returns>－1－失败；影响的行数</returns>
		public int InsertMedTechItemArrange(FS.HISFC.Models.Terminal.MedTechItemTemp medTechItemTemp)
		{
			this.SetDB(serviceMedTechItemArray);
		...
		/// <returns>－1－失败；影响的行数</returns>
		public int InsertMedTechApplyDetailInfo(FS.HISFC.Models.Terminal.MedTechBookApply medTechBookApply)
		{
			this.SetDB(serviceTerminal);
        ...
        /// <returns></returns>
        public int Insert(FS.HISFC.Models.Fee.Inpatient.FeeItemList fee)
        {
		...
		public int Insert(FS.HISFC.Models.Fee.Outpatient.FeeItemList feeItem)
		{
			this.SetDB(serviceTerminal);
