...
namespace FS.HISFC.BizProcess.Integrate.HealthRecord.Case
{
    ...
    public class CaseBill : IntegrateBase
    {
        ...
        /// 病历出库单业务层
        /// </summary>
        protected FS.HISFC.BizLogic.HealthRecord.Case.CaseBill caseBillFunction = new FS.HISFC.BizLogic.HealthRecord.Case.CaseBill();

        /// <summary>
        /// 病历基本信息业务层
        /// </summary>
        protected FS.HISFC.BizLogic.HealthRecord.Case.CaseInfo caseInfoFunction = new FS.HISFC.BizLogic.HealthRecord.Case.CaseInfo();

        /// <summary>
        /// 病历跟踪
        /// </summary>
        protected FS.HISFC.BizLogic.HealthRecord.Case.CaseTrackManager caseTrackFunction = new FS.HISFC.BizLogic.HealthRecord.Case.CaseTrackManager();
        ...
        {
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm( "正在加载已经申请入库树结点..." );

            Application.DoEvents();

            List<FS.FrameWork.Models.NeuObject> alreadyRequestList = new List<FS.FrameWork.Models.NeuObject>();

            this.SetDB( caseBillFunction );
            this.callReturn = caseBillFunction.QueryAlreadyRequestTreeNode( ref alreadyRequestList, this.GetDept(), fromDate, FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InRequest );
            if ( this.callReturn == -1 )
            {
            ...
            foreach ( FS.FrameWork.Models.NeuObject alreadyRequestBill in alreadyRequestList )
            {
        ...
        {
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm( "正在加载等待出库审核树结点..." );

            Application.DoEvents();

            List<FS.FrameWork.Models.NeuObject> waitAuditingList = new List<FS.FrameWork.Models.NeuObject>();

            this.SetDB( caseBillFunction );
            this.callReturn = caseBillFunction.QueryWaitAuditingTreeNode( ref waitAuditingList, this.GetDept(), fromDate, FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InRequest );
            if ( this.callReturn == -1 )
            {
                this.Err = caseBillFunction.Err;
                FS.FrameWork.WinForms.Classes.Function.HideWaitForm();
            ...
            foreach ( FS.FrameWork.Models.NeuObject waitAuditingBill in waitAuditingList )
            {
                TreeNode node = new TreeNode();
        ...
        {
            FS.FrameWork.WinForms.Classes.Function.ShowWaitForm( "正在加载等待入库确认树结点..." );

            Application.DoEvents();

            List<FS.FrameWork.Models.NeuObject> waitConfirmList = new List<FS.FrameWork.Models.NeuObject>();

            this.SetDB( caseBillFunction );
            this.callReturn = caseBillFunction.QueryWaitConfirmTreeNode( ref waitConfirmList, this.GetDept(), fromDate, FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.OutAuditing );
            if ( this.callReturn == -1 )
            {
                this.Err = caseBillFunction.Err;
                FS.FrameWork.WinForms.Classes.Function.HideWaitForm();
            ...
            foreach ( FS.FrameWork.Models.NeuObject waitConfirmBill in waitConfirmList )
            {
                TreeNode node = new TreeNode();
        ...
        /// <returns>－1－失败，1－成功</returns>
        public int QueryCaseBillByBillCode( ref List<FS.HISFC.Models.HealthRecord.Case.CaseBill> caseBillList, string billCode )
        {
            this.SetDB( caseBillFunction );
        ...
        public int Update( FS.HISFC.Models.HealthRecord.Case.CaseBill caseBill )
        {
            this.SetDB( caseBillFunction );
        ...
        /// <param name="caseBill">单据</param>
        /// <returns>－1－失败，影响的行数</returns>
        public int Delete( FS.HISFC.Models.HealthRecord.Case.CaseBill caseBill )
        {
            this.SetDB( caseBillFunction );
        ...
        /// <param name="caseBill">单据</param>
        /// <returns>－1－失败，1－成功</returns>
        public int Insert( FS.HISFC.Models.HealthRecord.Case.CaseBill caseBill )
        {
            this.SetDB( caseBillFunction );
        ...
        /// <returns>－1－失败，1－成功</returns>
        public int InsertCaseTrackAfterInConfirm( FS.HISFC.Models.HealthRecord.Case.CaseBill caseBill, string useType )
        {
            if ( caseBill.CaseBillState != FS.HISFC.Models.HealthRecord.Case.EnumCaseBillState.InConfirm )
            {
            ...
            FS.HISFC.Models.HealthRecord.Case.CaseTrack caseTrack = new FS.HISFC.Models.HealthRecord.Case.CaseTrack();
