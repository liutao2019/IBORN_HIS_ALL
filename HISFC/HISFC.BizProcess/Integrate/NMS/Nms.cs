...
namespace FS.HISFC.BizProcess.Integrate.NMS
{
    public class Nms : IntegrateBase
    {
        ...
        /// 权限业务层
        /// </summary>
        protected FS.HISFC.BizLogic.Manager.UserPowerDetailManager powerManager = new FS.HISFC.BizLogic.Manager.UserPowerDetailManager();
