...
namespace FS.HISFC.BizProcess.Integrate.Medical
{
    public class Ability
    {
        public static FS.HISFC.BizLogic.Order.Medical.Ability abilityMgr = new FS.HISFC.BizLogic.Order.Medical.Ability();
          /// <summary>
        /// 医疗权限检查方法
