...
namespace FS.HISFC.BizProcess.Interface.Pharmacy
{
    ...
    public interface IDrugPrint
    {
        ...
        /// 门诊患者信息
        /// </summary>
        FS.HISFC.Models.Registration.Register OutpatientInfo
        {
            get;
            set;
        }
        ...
        /// 住院患者信心
        /// </summary>
        FS.HISFC.Models.RADT.PatientInfo InpatientInfo
        {
            get;
            set;
        }
        ...
        void AddAllData(ArrayList al, FS.HISFC.Models.Pharmacy.DrugBillClass drugBillClass);
        ...
        void AddAllData(ArrayList al, FS.HISFC.Models.Pharmacy.DrugRecipe drugRecipe);
